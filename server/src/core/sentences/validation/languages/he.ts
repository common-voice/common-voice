...
const INVALIDATIONS: ValidatorRule[] = [
  ...
  },
  {
    ...
    error:
      'על המשפט להכיל רק אותיות בעברית וסימני פיסוק - אין להכליל סימנים אחרים או אותיות משפות אחרות',
  ...
  },
  {
    ...
    error:
      'אין להכליל ראשי-תיבות או קיצורים במשפט, ויש לוודא כי קיים רווח בין סימן פיסוק למילה המופיעה אחריו',
