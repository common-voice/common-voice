export const up = async function (db: any): Promise<any> {
  await db.runSql(`
    ...
    VALUES
      ('Common Voice Delta Segment 18.0', 'cv-corpus-18.0-delta-2024-06-14', TRUE, '2024-06-14', '2024-06-19', 2399246544, 1370463000, 'delta', 'cv-corpus-18.0-delta-2024-06-14/cv-corpus-18.0-delta-2024-06-14-{locale}.tar.gz')
