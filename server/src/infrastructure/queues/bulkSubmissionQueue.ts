...
import { addJobToQueue, addProcessorToQueue, attachEventHandlerToQueue, getQueue } from './queues';
...
export const setupBulkSubmissionQueue = () => {
  return pipe(
    ...
    IO.chainFirst(
      addProcessorToQueue(bulkSubmissionUploadProcessor)(BULK_SUBMISSION_UPLOAD_JOB_NAME)
    ),
