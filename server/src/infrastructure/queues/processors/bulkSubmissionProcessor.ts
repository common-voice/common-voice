...
import { BulkSubmissionImportJob, BulkSubmissionUploadJob } from '../types/BulkSubmissionJob';
...
export const bulkSubmissionImportProcessor = async (job: Job<BulkSubmissionImportJob>) => {
...
)(doesFileExistInBucket(BULK_SUBMISSION_BUCKET))(makePublicInBucket(BULK_SUBMISSION_BUCKET))(
