...
const CSP_HEADER = [
  ...
  `script-src 'self' 'unsafe-eval' 'sha256-fIDn5zeMOTMBReM1WNoqqk2MBYTlHZDfCh+vsl1KomQ=' https://www.google-analytics.com https://pontoon.mozilla.org https://sentry.prod.mozaws.net https://fullstory.com https://edge.fullstory.com`,
