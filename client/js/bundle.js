    ...
    function start() {
        ...
        */
        ...
        function RecordingScreen(element, microphone) {
            ...
            // }
            var visualizer = new viz_1.LinearAnalyzerNodeView(analyzerNode, levels, 384, 300);
            var radialVisualizer = new viz_1.RadialAnalyzerNodeView(analyzerNode, radialLevels, 300, 300);
            var spectrogramVisualizer = new viz_1.SpectogramAnalyzerNodeView(analyzerNode, spectrogram, 500, 300);
