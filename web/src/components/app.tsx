...
const SENTRY_DSN_WEB = 'https://40742891598c4900aacac78dd1145d7e@o1069899.ingest.sentry.io/6251028';
...
let LocalizedPage: any = class extends React.Component<LocalizedPagesProps, LocalizedPagesState> {
  ...
  shouldRedirectToRoot({ isContributable, route }: { isContributable: boolean; route: string }) {
  ...
  render() {
    const { locale, notifications, toLocaleRoute, location, languages } = this.props;
