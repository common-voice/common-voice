...
const GuidelinesPage = React.lazy(() => import('../pages/guidelines/guidelines'));
...
export default function Content({ location }: { location: any }) {
  ...
  return (
    <React.Suspense fallback={<Spinner />}>
      <Switch>
        <SentryRoute exact path={toLocaleRoute(URLS.ROOT)} component={HomePage} />
        <SentryRoute exact path={toLocaleRoute(URLS.SOURCE)} component={HomePage} />
        <SentryRoute path={toLocaleRoute(URLS.SOURCE_SPEAK)} component={SpeakPage} />
        <SentryRoute path={toLocaleRoute(URLS.SOURCE_LISTEN)} component={ListenPage} />
        ...
        <SentryRoute
          ...
          render={() => (
            <Redirect to={toLocaleRoute(isContributable(locale) ? URLS.SPEAK : URLS.ROOT)} />
          )}
        />
        <SentryRoute exact path={toLocaleRoute(URLS.LANGUAGES)} component={LanguagesPage} />
        <SentryRoute
          exact
        ...
        />
        <SentryRoute exact path={toLocaleRoute(URLS.DATASETS)} component={DatasetsPage} />
        <SentryRoute exact path={toLocaleRoute('/login-failure')} component={LoginFailure} />
        <SentryRoute exact path={toLocaleRoute('/login-success')} component={LoginSuccess} />
        <SentryRoute
          exact
          path={toLocaleRoute(URLS.PROFILE)}
          render={() => <Redirect to={toLocaleRoute(URLS.PROFILE_INFO)} />}
        />
        <SentryRoute path={toLocaleRoute(URLS.PROFILE + '/')} component={ProfileLayoutPage} />
        <SentryRoute path={toLocaleRoute(URLS.DASHBOARD)} component={DashboardPage} />
        <SentryRoute
        ...
        />
        <SentryRoute exact path={toLocaleRoute(URLS.ABOUT)} component={AboutPage} />
        <SentryRoute
          exact
        ...
        />
        <SentryRoute exact path={toLocaleRoute('/landing/sodedif')} component={LandingPage} />
        <SentryRoute
        ...
        />
        <SentryRoute exact path={toLocaleRoute(URLS.PARTNER)} component={PartnerPage} />
        <SentryRoute
          exact
        ...
        />
        <SentryRoute exact path={toLocaleRoute(URLS.GUIDELINES)} component={GuidelinesPage} />
        <SentryRoute
          exact
          path={toLocaleRoute(URLS.SENTENCE_COLLECTOR_REDIRECT)}
          component={SentenceCollectorRedirectPage}
        />
        <Route render={() => <ErrorPage errorCode="404" prevPath={location.state?.prevPath} />} />
      </Switch>
    </React.Suspense>
  );
}
