...
export const MicIcon = (props: any) => (
  <svg width="29" height="28" viewBox="0 0 29 28">
    ...
    <g fill="none" fillRule="evenodd" transform="translate(5)">
      ...
      <use fill="#000" fillRule="nonzero" xlinkHref="#mic-path" />
      <g fill="#FF4F5E" mask="url(#mic-mask)">
...
export const PlayOutlineIcon = (props: any) => (
  <svg width="24" height="24" viewBox="0 0 24 24">
    ...
    <g fill="none" fillRule="evenodd" transform="translate(4 2)">
      <mask id="play-outline-mask" fill="#fff">
        <use xlinkHref="#play-outline-path" />
      </mask>
      <use fill="#000" fillRule="nonzero" xlinkHref="#play-outline-path" />
      <g fill="#4A4A4A" mask="url(#play-outline-mask)">
...
export const RedoIcon = (props: any) => (
  <svg width="24" height="24" viewBox="0 0 24 24">
    ...
    <g fill="none" fillRule="evenodd" transform="translate(1 2)">
      <mask id="redo-mask" fill="#fff">
        <use xlinkHref="#redo-path" />
      </mask>
      <use fill="#000" fillRule="nonzero" xlinkHref="#redo-path" />
      <g fill="#4A4A4A" mask="url(#redo-mask)">
...
export const ShareIcon = (props: any) => (
  <svg width="24" height="24" viewBox="0 0 24 24">
    ...
    <g fill="none" fillRule="evenodd" transform="translate(3 1)">
      <mask id="share-mask" fill="#fff">
        <use xlinkHref="#share-path" />
      </mask>
      <use fill="#000" fillRule="nonzero" xlinkHref="#share-path" />
      <g fill="#4A4A4A" mask="url(#share-mask)">
...
export const StopIcon = (props: any) => (
  <svg width="28" height="28" viewBox="0 0 28 28">
    ...
    <g fill="none" fillRule="evenodd" transform="translate(2.333 2.333)">
      <mask id="stop-mask" fill="#fff">
        <use xlinkHref="#stop-path" />
      </mask>
      <use fill="#000" fillRule="nonzero" xlinkHref="#stop-path" />
      <g fill="#FF4F5E" mask="url(#stop-mask)">
