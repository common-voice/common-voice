...
const baseUseBulkFileUploadMock: ReturnType<typeof useBulkSubmissionUploadModule.default> = {
  handleDrop: jest.fn(),
  uploadStatus: 'off',
  fileInfo: {
    name: 'test-file.tsv',
...
describe('Bulk submission page', () => {
  ...
  it('handles file upload', async () => {
    ...
    jest.spyOn(useBulkSubmissionUploadModule, 'default').mockImplementation(() => ({
