...
const SingleSubmissionWrite: React.FC<SingleSubmissionWriteProps> = ({ getString }) => {
  ...
  return (
    <form className="guidelines-form" data-testid="single-submission-form" onSubmit={handleSubmit}>
