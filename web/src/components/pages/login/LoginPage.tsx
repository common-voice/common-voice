    ...
    <div className="w-screen h-screen flex justify-between flex-wrap">
      ...
      <div className="flex flex-col items-center p-4 flex-1 min-w-[480px]">
        <div className="bg-white p-8 rounded-lg max-w-md w-full space-y-4">
          <img
            src="/voicewall/img/falak-org-logo.svg"
            alt="falak-org-logo"
            height={95}
            width={260}
            className="mb-[6rem]"
          ...
          <form>
            ...
            <div className="flex items-center justify-between mb-4">
              <label className="flex items-center">
                ...
                <span className="ml-2 text-sm text-gray-600">الموافقة على الشروط والأحكام</span>
              </label>
              <p className="text-center text-sm text-[#219F8A] mt-4">لديك حساب؟</p>
            </div>
