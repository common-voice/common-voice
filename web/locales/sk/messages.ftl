...
contribution-misreadings-example-3-title = Obrie dinosaury z triasu-.
...
contribution-misreadings-example-5-title = My ideme von na kávu.
contribution-misreadings-example-5-explanation = [Nezhodný obsah]
contribution-misreadings-example-6-title = Ideme von na kávu.
contribution-misreadings-example-6-explanation = [Malo by byť „My ideme“]
...
contribution-background-noise-example-1-title = <strong> { zasmrkanie } </strong> Obrie dinosaury z <strong> { kychnutie } </strong> triasu.
contribution-background-noise-example-2-title = Obrie dino <strong> { zasmrkanie } </strong> z triasu.
contribution-background-noise-example-2-explanation = [Časť textu nie je možné počuť]
contribution-background-noise-example-3-title = <strong> { Praskot } </strong> obrie dinosaury <strong> { praskot } </strong> -riasu.
contribution-background-noise-example-3-explanation = [Časť textu nie je možné počuť]
