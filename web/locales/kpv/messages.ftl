...
loading = Восьтӧм...
email-opt-in-info = Ме кӧсъя, медым меным ыстісны уджмогъяс йылысь, менам удж серти прогресс йылысь электроннӧй письмӧяс да Common Voice йылысь юӧра бюллетеньяс.
email-opt-in-info-title = Пырӧдчӧй Common Voice ыстӧмъяс лыддьӧгӧ
email-opt-in-info-sub-with-challenge = Пӧлучитӧй тіян уджмогъяс йылысь казьтыштана, асланыд удж серти прогресс выльмӧдӧм йылысь да Common Voice йылысь юӧра бюллетеньяса электроннӧй письмӧяс
email-opt-in-privacy-v2 = Электроннӧй письмӧяс пӧлучитӧм бӧрйигӧн Ті сетаннныд сӧгласлун Mozilla-лы тайӧ юӧрнас вӧдитчӧм вылӧ, кыдзи тайӧс пасйӧма <privacyLink> Mozilla-лӧн йӧзӧдтӧмлун политикаын </privacyLink>.
...
status-contribute = Пырт ассьыд сёрнигор
status-hours =
    { $hours ->
...
accept-privacy-title = Йӧзӧдтӧмлун политика
...
contribute-more =
    { $count ->
       ...
       *[other] Верманныд-ӧ вӧчны нӧшта { $count }?
    }
