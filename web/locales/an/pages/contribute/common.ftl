...
contribution-background-noise-description = Queremos que los algoritmos d'aprendizache automatico sigan capables de maniar diferents ruidos de fondo. Se pueden acceptar rudios relativament fuertes, siempre que no impidan escuitar la totalidat d'o texto. La musica de fondo tranquila ye bien; la mosica masiau fuerte, que evite que haigaz se sentir totas las parolas, no lo ye.
