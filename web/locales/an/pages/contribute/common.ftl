...
contribution-volume-description = Ye normal que i haiga variacions de volumen entre lectors. Refusa-las nomás quan lo volumen sía tant alto que lo rechistro satura, u (mas comunment) si ye tant baixo que no puez sentir lo que s'ha dito sin la referencia d'o texto escrito.
...
contribution-just-unsure-description = Si te trobas con bella cosa no cubierta con estas directrices, vota seguntes lo tuyos millor cirterio. Si realment no lo puez decidir, preta lo botón Omitir y pasa a la siguient voz quan quieras.
