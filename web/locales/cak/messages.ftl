...
keep-track = Tak'waj rutz'ib'axik ri nasamajij chuqa' ri rutz'etoj nuk'ulem pa jalajöj ch'ab'äl.
...
faq-how-get-a = Ri rucholxe'el tzij Common Voice k'o richin niqasäx rik'in ri <licenseLink>CC0</licenseLink> ya'öl q'ij pa <datasetLink>ri ruxaq rucholxe'el qatzij</datasetLink>. Chuqa' yatikïr ye'aqasaj k'ïy taq cholxe'el wachel chi kiwa ri winaqi' pa re ruxaq re'.
faq-when-release2-q = ¿Jampe' xtel kitzijol ri kicholxe'el ri ch'aqa' chik taq ch'ab'äl pa Common Voice?
faq-when-release2-a = Ri ruwäch richin k'ïy ch'ab'äl, ruyakb'al rucholxe'el ri Common Voice, tajin nijosq'ïx chuqa' nicholajïx ruma ri tinamital. We nawajo' yojato' richin niqak'waj ri common Voice pa k'ak'a' taq ch'ab'äl, tab'etz'eta' <sentenceCollectorLink>Rusamajib'al Rumolik q'aptzij</sentenceCollectorLink> richin nitz'aqatisäx k'ak'a' taq q'aptzij pa ri molaj cholxe'el, chuqa' Mozilla <pontoonLink>Pontoon</pontoonLink> richin nitzalq'omïx ri ajk'amaya'l ruxaq. Xketz'aqatisäx k'ak'a' taq ch'ab'äl pa Common Voice richin kiyakik ch'ab'äl toq xkemolotäj 5000 jikïl taq q'aptzij.
faq-why-mission-q = ¿Achike ruma k'o pa taqel rutaqanem Mozilla ri Common Voice?
faq-why-mission-a = Mozilla nisamäj chi rij chi jantape' jaqäl chuqa' okel ri ajk'amaya'l chi qawa qonojel. Richin niqab'än ri' k'atzinel niqaya' uchuq'a' pan kiq'a' ri ajk'amaya'l nuk'unela' rik'in taq nimasamaj achi'el Common Voice. Richin yek'iyïr ri kina'ob'al ch'ab'äl rik'in nikik'owisaj kij ri relik taq chokoy, röj niqanimaj chi ütz chuqa' yekito' ri okisanela'. Ri ri' nuq'ajuj chi k'atzinel niqatz'ët kiwa ch'aqa' chik ch'ab'äl chuqa' yeyak jalajöj taq kik'oxomal chuqa' winaqirel taq tzij toq yekitz'ük chuqa' yekitojtob'ej kina'ob'al ch'ab'äl. Ri Common Voice jun tob'äl kichin winaqi', chuqa' ri taq rumolaj chuqa' taq rub'anonela' Mozilla chijun ri ruwach'ulew chuqa' tajin nikokisaj pa ri taq qanimasamaj.
faq-what-cv-and-deepspeech-q = ¿Achike kikojol ri Common Voice chuqa' ri Deep Speech?
faq-what-cv-and-deepspeech-a = Ri rucholxe'el tzij Common Voice nutz'aqatisaj ri ruk'wab'al retamaxik ch'ab'äl richin jaqäl rub'itz'ib' ri Deep Speech. Ri nab'ey ruwäch ri Deep Speech xelesäx pa noviembre richin ri 2017, chi ri toq rujalon wi pe ri'. Rik'in ri rucholxe'el tzij ri Common Voice, niqanimaj chi re runa'ob'al retamaxik ch'ab'äl rik'in jaqäl b'itz'ib', k'o ta chi wachel chi qawa qonojel. Niqoyob'ej chi re na'ob'äl re' tuya' q'ij chi ke ri b'anonela' richin yekitz'ük k'ïy taq tikojil chuqa' k'ak'a' taq samaj.
faq-is-goal-assistant-q = ¿La richin nunük' jun rachto'onel ch'ab'äl ri Common Voice?
faq-is-goal-assistant-a = Ri rurayib'al ri rucholxe'el tzij ri Common Voice ja chi xab'achike winäq k'o pa ruwach'ulew tutz'uku' jun retamaxik ch'ab'äl o xab'achike jun chik chokoy, ri nik'atzin ch'ab'äl chi re. Jun rachto'onel ch'ab'äl xa jun chi ke ri k'ïy taq chokoy tikirel nokisäx richin ninuk' jun rucholxe'el tzij.
faq-do-want-native-q = Man walaxib'en ta pe ruch'ab'exik chuqa' yich'o rik'in k'oxomal, ¿la niwajo' chuqa' ri nuch'ab'äl?
faq-do-want-native-a = Ja', ¡niqajo' ri ach'ab'äl! Jun peraj chi re ri rurayib'al ri Common Voice ja ri rumolik jampe' taq rub'eyal k'oxom richin chi kesamäj ri retamaxik ch'ab'äl jeb'ël kesamäj chi qawa qonojel. Re re' nub'än chi ri kito'ik winaqi' man aj nab'ey ta ch'ab'äl yalan e k'atzinel.
faq-why-different-speakers-q = ¿Achike ruma toq yek'atzin k'ïy jalajöj ch'ab'anela' richin jun ch'ab'äl?
...
about-listen-queue-text = Ri yakoj taq ch'ab'äl yetaq pa jun cholaj, akuchi' yenuk' richin ye'ak'axäx.
...
about-yes-votes = ≥ 2 Ütz juch'
about-yes-votes-text = Ka'i' jech'un okisanela' k'o chi nikijikib'a' jun ruyakoj ch'ab'äl richin niyak pa rucholxe'el tzij ri Common Voice.
about-no-votes = ≥ 2 Itzel juch'
about-no-votes-text = Toq jun okisanel man nujikib'a' ta jun yakoj ch'ab'äl, nitzolin pa cholaj. We kamul nixutüx, ri yakoj ch'ab'äl niq'axäx pa kimuqb'al yakoj.
about-dataset-new = Rucholxetzij Common Voice
...
size-gigabyte = GB
size-megabyte = MB
confirm-no-identify = <b>Naya' atzij</b> richin man natojtob'ej ta nakanoj ri retal kib'anikil ch'ab'anela' pa ri rucholxe' tzij ri Common Voice
...
listen-instruction = { $actionType }<playIcon></playIcon> ¿La pa rub'eyal xkisik'ij ri b'ab'?
listen-again-instruction = ¡Jeb'ël asamaj! <playIcon></playIcon> Tawak'axaj chik toq nawajo'
