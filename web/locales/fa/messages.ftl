...
add-avatar-clip = به نمایه خود تصویر اضافه کنید و سلام کنید!
create-voice-wave = ایجاد کردن موج صدا
...
about-avatar-clip = ایجاد کردن یک صدای شخصی سازی شده برای معرفی خود. کاربر دیگر این امکان را دارند تا برش صدای شما را گوش کنند.
...
datasets-positioning = به این صفحه به عنوان یک راهنما برای دادهای متن باز صدا نگاه کنید و با بزرگ شدن صدای مشترک این صفحه خانه‌ای است برای انتشار بروزرسانی‌ها.
language = زبان
...
dataset-description-hours =
    هراطلاعات ورودی شامل شده از یک Mp3 خاص و یک پرونده متنی می باشد. تعداد زیاد از <b>{ $total }</b> داده ها که ساعت ها ضبط شده اند و شامل ریزداده‌های جمعیت شناسی متشکل از سن، جنسیت،‌ و لهجه می‌باشد که به دقت موتور تشخیص صدا کمک می‌کند.
    
    این مجموعه داده در حال حاضر متشکل از <b>{ $valid }</b> ساعت ها داده تایید شده در<b>{ $languages }</b> زبان ها می باشد. با این حال ما همیشه در حال اضافه کردن زبان و صدا هستم. نگاهی به <languagesLink> صفحه زبان های </languagesLink> ما جهت مشارکت یا اضافه کردن زبان بیاندازید.
...
common-voice-info-new = سوالی در خصوص صدای مشترک دارید؟ ایده های برای بهبود سازی یا بازخورد های در مورد یک زبان خاص؟ به <discourseLink> انجمن های گفت‌وگو ما بپیوندید</discourseLink> و به من بگویید.
