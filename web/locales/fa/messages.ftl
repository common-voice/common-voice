...
home-title = پروژه آواهای مشترک ابتکار موزیلا برای کمک به آموزش ابزارهای یادگیری ماشین است تا بدانند مردم واقعی چگونه صحبت می‌کنند.
...
wall-of-text-more-mobile =
    ...
    که این باعث از بین رفتن نوآوری می‌شود. بنابراین ما پروژه آواهای مشترک را راه‌اندازی کردیم که یک پروژه برای کمک به در دسترس بودن تشخیص صدا برای همه است.
...
wall-of-text-second =
    ...
    که این باعث از بین رفتن نوآوری می‌شود. بنابراین ما آواهای مشترک که یک پروژه برای کمک به این‌که تشخیص صدا برای همه باز و دردسترس باشد را راه‌اندازی کرده‌ایم.
