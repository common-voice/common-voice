...
faq-where-src-from-q = متن منبع از کجا آمده است؟
faq-where-src-from-a =
    متن منبع ما از اهدا کمک کننده اصلی و همچنین گفتگو از اسکریپت های فیلم های عمومی مانند <italic> این زندگی شگفت انگیز است </italic> تشکیل شده است.
    
    شما می توانید جملات منبع خود را در این پوشه GitHub مشاهده کنید.
