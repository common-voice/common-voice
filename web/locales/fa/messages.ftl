...
yes-receive-emails = بله، برایم ایمیل بفرست. علاقه‌مندم در خصوص پروژه صدای مشترک اطلاعات کسب کنم.
...
privacy-info = ما قول می‌دهیم که اطلاعات شمارا با دقت اداره کنیم.  اطلاعات بیشتر در <privacyLink>نکات حریم شخصی</privacyLink>.
...
link-copied = پیوند برداشت شد
back-top = بازگشت به بالا
logout = خروج از سیستم

## Home Page

home-title = پروژه صدای مشترک ابتکار موزیلا برای کمک به آموزش ابزارهای یادگیری ماشین است تا بدانند مردم واقعی چگونه صحبت می‌کنند.
...
faq-what-cv-a =
    فن‌آوری تشخیص صدا، روش تعامل ما با ماشین‌ها را دگرگون می‌کند، اما سیستم‌های موجود در حال حاضر گران‌قیمت و اختصاصی هستند. صدای مشترک بخشی از ابتکار موزیلا است که فن‌آوری‌های شناسایی صدا را بهتر و برای همگان در دسترس قرار می‌دهد. صدای مشترک یک پایگاه‌داده بزرگ جهانی از صداهای اهدا شده است که به هر کسی اجازه می‌دهد که به سرعت برنامه‌های با قابلیت فعال صوتی را، به طور بالقوه در هر زبانی، آموزش دهد.
    
    ما نه تنها نمونه‌های صدا را از زبان‌هایی که به صورت گسترده صحبت می‌شوند جمع‌آوری می‌کنیم بلکه زبان‌های با جمعیت کم‌تر استفاده کنندگان را هم پوشش می‌دهیم. انتشار مجموعه داده متنوع از صداها به توسعه دهندگان، کارآفرینان و جوامع قدرت می‌دهد تا خودشان به این شکاف بپردازند. علاوه بر مجموعه داده‌های صدای مشترک، ما همچنین در حال ساخت یک موتور تشخیص گفتار متن‌باز به نام «Deep Speech» هستیم.
...
faq-when-release2-q = چه زمانی داده‌های صدای مشترک را به زبان‌های دیگر منتشر می‌کنید؟
faq-when-release2-a = نگارش چندزبانه مجموعه داده‌های صدای مشترک درحال حاضر توسط جامعه پشتیبانی می‌شود. اگر مایل هستید به ما در آوردن زبان جدید به صدای مشترک کمک کنید، <sentenceCollectorLink>ابزار مجموعه جملات</sentenceCollectorLink> را برای افزودن جملات تازه به مجموعه داده‌ها و موزیلا <pontoonLink>Pontoon</pontoonLink> را برای ترجمه خود وب‌سایت بررسی کنید. زبان‌های تازه به صدای مشترک مشارکت‌ کنندگان وقتی اضافه خواهد شد که ۵۰۰۰ جمله تایید شده جمع آوری شده باشد.
...
faq-what-is-cv = صدای مشترک چیست؟
faq-using-cv = استفاده از صدای مشترک
faq-description = صدای مشترک بخشی از ابتکار موزیلا در جهت کمک ماشین ها است تا یاد بگیرند افراد واقعی چگونه صحبت می‌کنند.
faq-search-for-answers =
    .label = جستجوی پاسخ‌ها

## ABOUT US

about-title = چرا صدای مشترک؟
about-subtitle = صدای مشترک بخشی از ابتکار موزیلا برای کمک به آموزش ماشین‌ها که چگونه افراد واقعی صحبت می‌کنند است. علاوه بر مجموعه داده‌های صدای مشترک، همچنین درحال ساخت یک موتور تشخیص گفتار متن‌باز به اسم گفتار عمیق هستیم.
...
about-yes-votes-text = برای واردکردن آن به مجموعه داده‌های صدای مشترک، یک برش صوتی باید توسط دو کاربر مجزا اعتبارسنجی شده باشد.
...
about-dataset-new = مجموعه داده‌های صدای مشترک
about-dataset-new-text = مجموعه داده‌های صدای مشترک شامل صدها هزار نمونه صداهایی است که به توسعه‌دهنده‌ها کمک می‌کند ابزارهای تشخیص گفتار بسازند.
about-clip-graveyard = قبرستان برش‌های صوتی
about-clip-graveyard-text = قبرستان کلیپ‌های صوتی شامل کلیپ‌های صوتی است که به مجموعه داده‌های صدای مشترک راه نیافته است. مانند مجموعه داده‌ها، قبرستان کلیپ‌های صوتی برای دریافت در دسترس است.
about-partners = همکاران
about-become-a-partner = همکار شوید
about-partnership =
    صدای مشترک یک پروژه مبتنی بر همکاری است، و ما وابسته به جامعه همکاران‌مان و مشارکت‌کنندگان هستیم تا بزرگ‌ترین مجموعه داده‌های متن‌باز صداها را بسازیم.
    
    ما از افراد و سازمان‌های زیر برای کمک به این پروژه تشکر می‌کنیم:
about-get-involved = مشارکت کنید
about-get-involved-text =
    می‌خواهید به بهترشدن صدای مشترک کمک کنید؟
...
datasets-positioning =
    به این صفحه به عنوان یک راهنما برای دادهای متن باز صدا نگاه کنید و با بزرگ شدن صدای مشترک این صفحه خانه‌ای است برای انتشار بروزرسانی‌ها.
    
    مجموعه داده‌های چندزبانهٔ صدای مشترک هم‌اکنون بزرگ‌ترین مجموعه داده‌های صوتی قابل دسترس برای عموم در نوع خودش است، اما فقط همین یکی نیست.
    
    به این صفحه به چشم یک مرکز مرجع برای دیگر مجموعه داده‌های صوتی متن‌باز نگاه کنید و چون صدای مشترک دائماً رشد می‌کند، خانه‌ای برای به‌روزرسانی‌های انتشار ما است.
language = زبان
...
confirm-no-identify = <b>شما موافقت می‌کنید</b> که سعی نکنید هویت صاحبان صدای مجموعه داده صدای مشترک را مشخص کنید
...
deepspeech-info = داده‌های صدای مشترک از موتور بررسی عمیق تشخیص صدای متن باز موزیلا بهره می‌برد که این امکان را به شما برای ساختن یک برنامه تشخیص صدا می‌دهد. <githubLink> صفحه اطلاعات گیتهاب </githubLink> ما را برای ورود به <discourseLink>گفتمان گفت‌ و گفت عمیق</discourseLink> مطالعه کنید و یادبگیرید چگونه آغاز کنید.
common-voice-info-new = سوالی دربارهٔ صدای مشترک دارید؟ ایده‌هایی برای بهبودسازی یا بازخوردهایی در مورد یک زبان خاص چطور؟ به <discourseLink>انجمن Discourse</discourseLink> ما بپیوندید و ما را آگاه کنید.
...
not-receiving-emails-info = شما هم اکنون بر روی وضعیت <bold>دریافت نکردن</bold> نامه‌های الکترونیکی،‌ یادآوری هدف و وضعیت پیشرفت خود و همچنین خبرنامه ها از صدای مشترک قرار دارید.
...
why-delete-recordings =
    ضبط‎های صدای مشترک توسط دانشگاهیان، کسب و کارهای کوچک و علاقه‎مندان به تشخیص صدا برای کمک به تربیت و رشد منابع عمومی مانند نمونه‎های صوتی استفاده می شود.
