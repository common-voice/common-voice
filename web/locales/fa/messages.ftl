...
home-title = پروژه صدای مشترک ابنکار موزیلا برای کمک به آموزش ابزارهای یادگیری ماشین است تا بداند مردم واقعی چگونه صحبت می‌کنند.
home-cta = صحبت کنید، مشارکت در اینجا!
wall-of-text-start = صدا طبیعی است، صدا انسانی است. به همین دلیل ما به ایجاد فن‌آوری صدای قابل استفاده برای ماشین‌های خود مجذوب شدیم. اما برای ایجاد سامانه‌های صوتی، مقدار بسیار بالایی از داده‌های صدا مورد نیاز است.
...
wall-of-text-first = صدا طبیعی است، صدا انسانی است. به همین دلیل است که ما برای ایجاد صدای قابل‌ استفاده در فن‌آوری ماشین‌های خود هیجان‌زده هستیم. اما برای ایجاد سامانه‌های صوتی، توسعه‌دهندگان به مقدار بسیار بالایی از داده‌های صدا نیاز دارند.
wall-of-text-second =
...
hours-recorded = ساعت‌های ضبط شده‌
hours-validated = ساعت‌های اعتبارسنجی شده
...
faq-important-a = صدا طبیعی است، صدا انسانی است. ساده‌ترین و طبیعی‌ترین راه برای برقراری ارتباط است. می‌خواهیم توسعه‌دهندگان قادر به ایجاد چیزهای شگفت انگیزی از مترجم هم‌زمان تا دستیار اداری صوتی باشند. اما در حال حاضر داده‌های قابل دسترس به اندازه کافی برای ساخت این نوع برنامه‌ها وجود ندارد. ما امیدواریم که صدای مشترک چیز‌هایی که توسعه‌دهندگان برای نوآوری نیاز دارند را به آن‌ها خواهد داد.
...
language-section-in-progress-description = زبان‌های در حال پیش‌رفت هم‌اکنون برای مشارکت توسط جوامع ما در حال ساخت هستند. روند پیشرفت آن‌ها نشان‌دهنده جایی است که آن‌ها از نظر ترجمه وب‌سایت و مراحل جمع‌آوری مجموعه جمله‌ها هستند.
language-section-launched = منتشر شده
language-section-launched-new-description = برای زبان‌های راه اندازی شده، وب‌سایت با موفقیت به ترجمه و جمله‌های کافی برای آن جمع آوری شده است، تا بتوانید از طریق <italic>گفتن</italic> و <italic>شنیدن</italic> مشارکت کنید.
