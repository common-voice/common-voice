...
faq-what-a = فن‌آوری تشخیص صدا می‌تواند راه ارتباط ما با ماشین‌ها را متحول کند، اما سیستم‌ها در حال حاضر گران‌قیمت و اختصاصی هستند. صدای مشترک پروژه‌ای است که فن‌آوری تشخیص صدا را به راحتی برای همه قابل‌ دسترسی می‌کند. مردم صدای خود را به یک پایگاه داده عظیم اهدا می‌کنند که به هرکسی اجازه می‌دهد به سرعت و به راحتی برنامه‌های صوتی را آموزش دهند. تمام اطلاعات صوتی برای توسعه‌دهندگان در دسترس خواهد بود.
faq-important-q = چرا مهم است؟
faq-important-a = صدا طبیعی و انسانی است. ساده‌ترین و طبیعی‌ترین راه برای برقراری ارتباط. می‌خواهیم توسعه‌دهندگان قادر به ایجاد چیزهای شگفت انگیزی از مترجم هم‌زمان تا دستیار اداری صوتی باشند. اما در حال حاضر داده‌های قابل دسترس به اندازه کافی برای ساخت این نوع برنامه‌ها وجود ندارد. ما امیدواریم که صدای مشترک چیز‌هایی که توسعه‌دهندگان برای نوآوری نیاز دارند را به آن‌ها بدهد.
faq-get-q = چگونه می‌توانم اطلاعات صدای مشترک را دریافت کنم؟
faq-get-a = مجموعه داده‌ها در حال حاضر در <downloadLink>صفحه دریافت</downloadLink> ما تحت مجوز <licenseLink>CC-0</ licenseLink> در دسترس است.
faq-mission-q = چرا صدای مشترک بخشی از ماموریت موزیلا است؟
faq-mission-a = موزیلا متعهد است که وب را برای همه باز و قابل دسترس نگه دارد. برای انجام این کار، نیاز داریم از طریق پروژه‌هایی مانند صدای مشترک سازندگان وب را تقویت کنیم. از آن‌جا که فناوری‌های صوتی به طور گسترده ای توسط برنامه‌های تخصصی غرق می شوند، ما بر این باوریم که باید تمام کاربران آن را به طور مساوی در اختیار داشته باشد. می بینیم که وقتی ما تست های صوتی را انجام می دهیم و تست می کنیم، نیاز است که زبان ها، فونت ها و ترکیبات بیشتری را شامل شود. موزیلا می‌خواهد دسترسی به اینترنت سالم را ببیند، یعنی دسترسی به اطلاعات صوتی برای سازندگان وب در دسترس است تا بتوانند پروژه های جدید و خلاقانه را توسعه دهند. صدای مشترک یک منبع عمومی خواهد بود که به تیم‌ها و توسعه دهندگان موزیلا در سراسر جهان کمک می کند.
faq-native-q = من یک متکلم { $lang } غیر محلی هستم و با لهجه صحبت می‌کنم، آیا هنوز صدای من را می‌خواهید؟
faq-native-a = بله، قطعاً صدای شما را می‌خواهیم! بخشی از هدف صدای مشترک، جمع آوری لهجه‌های مختلف تا حد امکان است تا کامپیوتر ها بتوانند بهتر صحبت کردن <bold>همه</bold> افراد را درک کنند.
faq-firefox-q = آیا تبدیل گفتار به متن، از طریق صدای مشترک، هرگز بخشی از فایرفاکس می‌شود؟
faq-firefox-a = صدای مشترک دارای پتانسیل نامحدودی است و ما در واقع در حال بررسی رابط‌های گفتاری در بسیاری از محصولات موزیلا، از جمله فایرفاکس هستیم.
faq-quality-q = کیفیت مورد نیاز برای این‌که از صداها استفاده شود چیست؟
faq-quality-a = ما می‌خواهیم کیفیت صدا منعکس کننده کیفیت که موتورهای تشخیص گفتاری باشند که در زندگی واقعی می‌بینیم. بنابراین، تنوع مورد نیاز است. موتورهای تشخیص گفتار یاد می‌گیرند چگونه با شرایط مختلف—گفتگوهای پس‌زمینه، صدای ماشین، صدای پنکه—بدون مشکل برخورد کنند.
faq-hours-q = چرا ۱۰,۰۰۰ ساعت هدف ما برای ضبط صدا است؟
faq-hours-a = این تقریبا تعداد ساعت‌هایی است که برای آموزش سیستم تولید STT مورد نیاز است.
faq-source-q = این متن‌ها از کجا می‌آیند؟
faq-source-a1 = جمله‌های کنونی از طرف مشارکت کنندگان اهدا شده است و هم‌چنین دیالوگ فیلم‌های عمومی مانند <italic>این یک زندگی شگفت انگیز است.</italic>
faq-source-a2 = شما می‌توانید جمله‌های منبع ما را در <dataLink>این پوشه‌ی گیت‌هاب</dataLink> مشاهده کنید.
...
data-download-modal = شما درحال دریافت یک فایلی به حجم <size>{ $size } گیگابایت</size> هستید، ادامه دهیم؟
