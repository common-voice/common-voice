...
donate-banner-cta-explanation = ყოველწლიურად მილიონ დოლარს აღწევს მონაცემთა კრებულის განთავსებისა და მომსახურების გაუმჯობესების ხარჯები 100-ზე მეტი ენისგან შემდგარი ერთობისთვის, რომელიც სრულადაა ჩვენზე დამოკიდებული. <strong>თუ თქვენთვის ღირებულია მონაცემთა გახსნილობა და მრავალფეროვნება – გაიღეთ შემოწირულობა ახლავე!</strong>
# Text wrapped in <mark></mark> will have a white background.
