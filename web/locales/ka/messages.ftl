...
share-text = დაგვეხმარეთ, რომ ვასწავლოთ მანქანებს, თუ როგორ საუბრობენ ადამიანები, ჩაწერეთ თქვენი ხმა და მოგვაწოდეთ შემოწირულობის სახით { $link }
...
status-hours =
    { $hours ->
        [one] ერთ შემოწმებულ საათამდე ცოტაღაა დარჩენილი!
       *[other] { $hours } შემოწმებულ საათამდე ცოტაღაა დარჩენილი!
    }
# Variables:
...
faq-mission-a = Mozilla იღწვის ინტერნეტის გახსნილობისა და საყოველთაო ხელმისაწვდომობისთვის. ამისთვის კი საჭიროა ვებშემმუშავებლების მხარდაჭერა და მოძლიერება ისეთი პროექტების საშუალებით, როგორიცაა Common Voice. გამომდინარე იქიდან, რომ ხმოვანი ტექნოლოგიები თანდათან ანაცვლებს ჩვეულებრივ პროგრამებს, მიგვაჩნია, რომ ყველა მომხმარებელს, ასევე თანაბრად უნდა მოემსახუროს. ჩვენ გვესმის, რომ საჭიროა მეტი ენის, აქცენტისა და დემოგრაფიული თავისებურებების გათვალისწინება, ხმოვანი ტექნოლოგიების დამუშავებისა და გამოცდისთვის. Mozilla-ს სურს რომ ინტერნეტი გახდეს ჯანსაღი და მეტად ძლიერი. ეს გულისხმობს იმას, რომ ახალ შემმუშავებლებსა და გამომგონებლებს, წვდომა ჰქონდეთ ხმოვან მონაცემებთან იმისთვის, რომ დანერგონ სიახლეები და შექმნან გამორჩეული პროექტები. Common Voice იქნება საჯაროდ ხელმისაწვდომი რესურსი, რომელიც გამოადგება Mozilla-ში მომუშავე გუნდებსა და შემმუშავებლებს, მთელ მსოფლიოში.
faq-native-q = ჩემთვის არაა { $lang } მშობლიური ენა და ვსაუბრობ აქცენტით, მაინც გამოგადგებათ ჩემი ხმის ჩანაწერი?
faq-native-a = დიახ, ჩვენ სწორედაც, რომ თქვენი ხმის ჩანაწერი გვესაჭიროება! Common Voice-ის მიზანია, რაც შეიძლება მეტი განსხვავებული აქცენტის შეგროვება, რომ კომპიუტერებმა უკვე შეძლონ <bold>თითოეული</bold> ადამიანის საუბრის გაგება.
...
faq-quality-q = როგორის ხარისხის ხმოვანი ჩანაწერია გამოსადეგი?
faq-quality-a = ჩვენ გვესაჭიროება ისე ხარისხის ხმოვანი ჩანაწერები, როგორი ხარისხითაც ხდება ხმოვანი მონაცემების შეყვანა, შესაბამისი ტექნოლოგიებით სარგებლობისას. ანუ, სხვადასხვა ხარისხის. ამის შედეგად, ხმის ამომცნობ სისტემებს შეეძლება მონაცემების აღქმა, განსხვავებულ გარემო პირობებში—ხმაურისას, ხალხმრავლობისას, ტრანსპორტით მგზავრობისას—შეცდომების გარეშე.
...
faq-source-a1 = წინადადებები მოგვაწოდეს მოხალისეებმა, ასევე გამოყენებულია საუბრის მონაკვეთები, საყოველთაო საკუთრებაში არსებული ფილმებიდან, როგორიცაა <italic>ეს მშვენიერი ცხოვრება.</italic>
faq-source-a2 = მოცემული წინადადებების წყარო, შეგიძლიათ იხილოთ ჩვენს <dataLink>GitHub საქაღალდეში</dataLink>.

## Profile

profile-why-title = რა საჭიროა პროფილი?
profile-why-content = თქვენ შესახებ გარკვეული ინფორმაციის მოწოდებით, თქვენ მიერ გადმოგზავნილი ხმოვანი მონაცემები Common Voice-ში, მეტად გამოსადეგი იქნება იმ ხმოვანი ამოცნობის სისტემებისთვის, რომლებიც ამ მონაცემებს სიზუსტის გასაუმჯობესებლად იყენებს.
...
data-download-modal = თქვენ იწყებთ <size>{ $size }გბ</size> მოცულობის მონაცემების ჩამოტვირთვას, გსურთ განაგრძოთ?
...
data-get-started = <speechBlogLink>დაიწყეთ ხმის ამოცნობით</speechBlogLink>
