...
faq-where-src-from-q = საიდანაა ტექსტები აღებული?
faq-where-src-from-a =
    ტექსტების წყაროა მოხალისეთა ნამუშევრები და აგრეთვე აღებულია საუბრების ჩანაწერები, საყოველთაო საკუთრებაში არსებული ფილმებიდან, როგორიცაა <italic>ცხოვრება მშვენიერია</italic>.
    
    ჩვენი წინადადებების წყაროები შეგიძლიათ იხილოთ ჩვენს GitHub-საქაღალდეში.
