...
datasets-headline = ჩვენ ვქმნით ღია წყაროს მქონე, მრავალენოვან ხმოვანი ჩანაწერების მონაცემთა კრებულს, რომლის გამოყენებაც ნებისმიერ მსურველს შეეძლება თავისი ხმოვანი შესაძლებლობების მქონე პროგრამების დასახვეწად.
...
confirm-size = ყველაფერი მზადაა, რომ ჩამოიტვირთოს <b>{ $size }</b>
size-gigabyte = გბ
size-megabyte = მბ
...
whats-inside = რა შეიცავს Common Voice-ის მონაცემთა კრებული?
dataset-description-hours =
    თითოეული მონაცემი წარმოდგენილია უნიკალური MP3-ისა და შესაბამისი ტექსტური ფაილით. <b>{ $total }</b> ჩაწერილი საათის უმეტესობა მონაცემთა კრებულში, ასევე შეიცავს დემოგრაფიულ ინფორმაციასაც, როგორიცაა ასაკი, სქესი და აქცენტი, რაც შეიძლება მეტად გამოსადეგი იყოს, ხმის ამოცნობის საშუალებების სიზუსტის დასახვეწად.
    
    მონაცემთა კრებული, ამჯამად შედგება <b>{ $valid }</b> საათიანი დამოწმებული ჩანაწერებისგან ენებისთვის <b>{ $languages }</b>, მაგრამ მუდმივად ემატება ახალი ჩანაწერები და ენები. გადახედეთ ჩვენს <languagesLink>ენების გვერდს</languagesLink>, ახალი ენის მოთხოვნისთვის ან წვლილის შეტანის დასაწყებად.
