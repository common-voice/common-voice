...
rm-sursilv = რეტორომანული სურსირვანული
ro = რუმინული
ru = რუსული
sah = სახა
sc = სარდინიული
...
wall-of-text-second = მსხვილი კომპანიების მიერ გამოყენებული მონაცემები, არაა ხელმისაწვდომი ხალხის დიდი ნაწილისთვის. ჩვენ ვფიქრობთ, რომ ეს აფერხებს განვითარებას და სიახლეების დანერგვას. სწორედ ამიტომაც გავუშვით პროექტი Common Voice, რომ ხმის ამოცნობის ტექნოლოგიები გაგვეხადა ღია და საყოველთაოდ ხელმისაწვდომი.
...
speak-paragraph = ხმის ჩანაწერების გაკეთება წარმოადგენს ჩვენი ღია მონაცემთა კრებულის შექმნის არსებით ნაწილს; ზოგიერთის აზრით, ყველაზე მხიარულ ნაწილსაც.
...
profile-not-required = პროფილის ქონა არაა სავალდებული, თუმცა შემოტანილ წვლილს მეტად სარგებლიანს გახდის
...
keep-track = შეგეძლებათ თვალი მიადევნოთ თქვენი მუშაობის მიმდინარეობას და სხვადასხვა ენებთან დაკავშირებულ გაზომვებს.
compare-progress = შეძლებთ თქვენი მუშაობის მიმდინარეობის შედარებას სხვა მოხალისეებთან, მთელი მსოფლიოდან.
...
demographic-deidentified = დამატებით მითითებულ დემოგრაფიულ მონაცემებს (მაგ. ასაკი, სქესი, ენა და აქცენტი) მოცილდება ვინაობის აღმნიშვნელი მონაცემები თქვენ მიერ წარდგენილ ჩანაწერებში და არასდროს გასაჯაროვდება თქვენს პროფილზე.
...
leaderboard-visibility =
    .label = მიმომხილველთა ჩამონათვალში ჩვენება
hidden = დამალული
visible = ხილული
native-language =
    .label = მშობლიური ენა
...
contribution-experience = წვლილის შეტანის გამოცდილება
skip-submission-feedback = გამოხმაურების გაგზავნის გამოტოვება
skip-submission-description = წვლილის შეტანისას გამოხმაურების გაგზავნა გამოტოვებული იქნება „წარდგენის“ ღილაკზე დაჭერით. წვლილის შეტანა გაგრძელდება პირდაპირი, მომდევნო 5 ჩანაწერის ან შემოწმების გაკეთებისას.
...
faq-when-release-q = როდის გამოუშვებთ Common Voice-ს მონაცემებს სხვა ენებისთვის?
faq-when-release-a = Common Voice-ის მრავალენოვანი ვარიანტი, ამჟამად მუშავდება და იხვეწება მოხალისეების ერთობის მიერ. თუ გსურთ უკეთ გაეცნოთ ამ სამუშაოებს, შეგიძლიათ <contactLink>დაგვიკავშირდეთ</contactLink>. გამოქვეყნება იგეგმება 2019 წლის იანვრისთვის. შემდეგ კი თანდათან დაემატება ახალი ენები და ხმის ჩანაწერები, როგორც კი ხელმისაწვდომი გახდება. განმეორებითი გამოშვებებისთვის დროის შუალედი, ჯერჯერობით არაა განსაზღვრული.
...
faq-is-goal-assistant-q = Common Voice-ის მიზანი ხმოვანი დამხმარის შექმნაა?
...
faq-where-src-from-q = სად არის ტექსტი წყარო?
...
hours-recorded-explanation = ხმის ჩანაწერების ხანგრძლივობა საათებში, რაც ამ დროისთვისაა შეგროვებული.
...
language-section-launched-new-description = გაშვებული ენებისთვის საიტი უკვე სრულადაა თარგმნილი, წინადადებებიც საკმარისადაა შეგროვებული და შესაძლებელია როგორც ხმის <italic>ჩაწერა</italic>, ასევე ჩანაწერების <italic>მოსმენა</italic> შესამოწმებლად.
...
clips-you-validated = თქვენი მიერ დამოწმებული
