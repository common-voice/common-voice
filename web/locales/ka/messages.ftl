...
faq-what-cv-a-2 =
    ...
    ჩვენ არა მხოლოდ ფართოდ გავრცელებული ენებისთვის ვაგროვებთ ნიმუშებს, არამედ მცირერიცხოვან ხალხთა ენებისთვისაც. სხვადასხვა სახის მონაცემთა კრებულის გამოქვეყნება, მოაძლიერებს შემმუშავებლებს, დაწესებულებებსა და ერთობებს და გაუჩენს სურვილს, თავადვე შეავსონ ყველა დანაკლისი.
...
contribution-misreadings-description-extended-list-3 = შემოკლებულია სიტყვა, მაგალითად წაკითხულია „არაა“, მაგრამ წერია „არ არის“ ან პირიქით.
contribution-misreadings-description-extended-list-4 = აკლია ბოლო სიტყვა ან ბგერა, ჩაწერის დროზე ადრე შეწყვეტის გამო.
contribution-misreadings-description-extended-list-5 = სიტყვა გამეორებულია, ამოკითხვის რამდენიმე მცდელობის გამო.
...
sc-howto-addsen-post-1 =
    ...
    მართალია, ბგერითი შედგენილობისა და სიტყვების მრავალფეროვნება წინადადებებში მეტად მნიშვნელოვანია, თუმცა ამასთან, ვცდილობთ
