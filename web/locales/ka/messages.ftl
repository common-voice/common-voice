...
sc-howto-findpd-text =
    გახსოვდეთ, რომ წინადადებების გამოსაქვეყნებლად გვესაჭიროება ნებართვა,
    ასე რომ ყოველთვის გადაამოწმეთ, არის თუ არა ტექსტი <wikipediaLink>საყოველთაო საკუთრებაში</wikipediaLink>. თუ არ აქვს რამე მითითება,
    შეეხმიანეთ ტექსტის მფლობელს და ჰკითხეთ, თუ მოგცემთ გამოყენების უფლებას.
...
sc-howto-findpd-partner-1 =
    ბევრი საჯარო დაწესებულება არსებობს, რომელთაც შეიძლება სურდეს თანამშრომლობა
    და ჰქონდეს, დიდი ოდენობის ტექსტი შესაწირად, საყოველთაო საკუთრების სახით. შეეხმიანეთ ადგილობრივ უნივერსიტეტებს,
    სამთავრობო და ღია ორგანიზაციებს ამ პროექტზე სასაუბროდ და სთხოვეთ მხარდაჭერა.
