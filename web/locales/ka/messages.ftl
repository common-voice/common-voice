...
download-delta-explainer = გარკვეული ცვლილებებია. ნაწილობრივი „დელტა“ გამოშვებები მოიცავს მხოლოდ წინა გამოშვების შემდგომ დამატებულ ჩანაწერებს. <deltaLink>გაეცანით ვრცლად ამ სიახლეს</deltaLink>.
