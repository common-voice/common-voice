...
faq-what-cv-a = ხმის ამოცნობის საშუალებები ძირფესვიანად ცვლის მანქანასთან ურთიერთობის გზებს, მაგრამ ამჟამად ხელმისაწვდომი სისტემები ძვირია და კერძო საკუთრებას წარმოადგენს. Common Voice წარმოადგენს Mozilla-ს წამოწყებას, ხმის ამოცნობის საშუალებების გასაუმჯობესებლად და საყოველთაო ხელმისაწვდომობისთვის უზრუნველსაყოფად. Common Voice დიდი მოცულობის მონაცემთა კრებულია, რომელიც შედგება შემოწირული ხმის ჩანაწერებისგან და ნებისმიერ მსურველს დაეხმარება, სწრაფად და მარტივად შეასწავლოს მის ხმის ამომცნობი საშუალებების მქონე პროგრამას, ყველა ენა.
