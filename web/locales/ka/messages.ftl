...
datasets-positioning = ჩვენ მიგვაჩნია, რომ დიდი და საჯაროდ ხელმისაწვდომი ხმოვან მონაცემთა კრებული ხელს შეუწყობს სიახლეების დანერგვასა და ჯანსაღი მეტოქეობის განვითარებას მანქანურ სწავლებაზე დაფუძნებულ ხმოვან ტექნოლოგიებში.
language = ენა
