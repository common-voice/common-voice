...
demo-contribute-card-header = მზად ხართ დაამატოთ ხმა დაამატოთ ან ყური დაუგდოთ?
demo-contribute-card-body = ახლა, ვინაიდან უკვე უკეთ გაიცანით Common Voice, არ გსურთ გამოცადოთ? დაწკაპეთ მიკროფონის ნიშანზე და ამოიკითხეთ წინადადებები ხმამაღლა. <br/><br/>თუ გირჩევნიათ სხვების ხმოვანი შემოწირულობების შემოწმება, დაწკაპეთ გაშვების ნიშანზე. ემთხვევა თუ არა მოსმენილი სიტყვები ეკრანზე გამოსახულს.
...
demo-dashboard-card-body = ყველა შემოწირული და შემოწმებული ხმოვანი ჩანაწერი, აღირიცხება მაჩვენებლების გვერდზე, წინსვლის სახით თითოეული ენისთვის, რომლისთვისაც წვლილი შეგაქვთ. დიახ, წვლილის შეტანა შეგიძლიათ ერთზე მეტი ენისთვის!<br/><br/> მაჩვენელბების გვერდზე, თვალი ადევნეთ თქვენს სტატისტიკას, შეადარეთ თქვენი საქმიანობა ერთობის დანარჩენი წევრებისას და მიუთითეთ შემოწირულობის სამიზნე რაოდენობა, თითოეული დღისთვის ან კვირისთვის.
