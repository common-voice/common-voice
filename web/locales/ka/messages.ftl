...
contribution-misreadings-description = მოსმენისას, ყურადღებით გადაამოწმეთ, ჩანაწერში ისმის თუ არა ზუსტად იგივე, რაც დაწერილია; უარყავით, თუ მცირე ხარვეზს მაინც შეამჩნევთ. <br />ხშირი შეცდომებია:
...
contribution-misreadings-description-extended-list-3 = შემოკლებულია სიტყვა, მაგალითად წაკითხულია „არაა“ და წერია „არ არის“, ან პირიქით.
...
contribution-varying-pronunciations-description = სიფრთხილე გამოიჩინეთ, ჩანაწერის უარყოფისას, როცა საქმე ეხება სიტყვის შეცდომით წარმოთქმას, მახვილის არასწორად დასმას ან კითხვის ნიშნის უგულებელყოფას. ვინაიდან, მსოფლიოში მრავალი სხვადასხვა სახის გამოთქმა არსებობს, ზოგიერთი მათგანი კი შეიძლება, არ გქონდეთ გაგონილი ადგილობრივ ენაში. გთხოვთ, ისინიც გაითვალისწინეთ, ვინც შესაძლოა, თქვენგან განსხვავებულად საუბრობდნენ.
...
contribution-varying-pronunciations-example-1-explanation = [„ხოლმ(ე)“ წინადადების ბოლო ხმოვანი, ზოგ დიალექტში შეიძლება დაგრძელდეს, ზოგში – არა]
contribution-varying-pronunciations-example-2-title = დილით აუცილებლად დაგხვდება, არა?
contribution-varying-pronunciations-example-2-explanation = [კითხვის დამადასტურებელი ნაწილაკი („არა“), ყოველთვის მახვილის ქვეშაა ქართულში]
...
contribution-background-voices-description = ხალხმრავალი ყაყანი შორიდან მისაღებია, მაგრამ დამატებითი ხმები არასასურველია, რომ მანქანურმა ალგორითმმა არ ამოიცნოს ის სიტყვები, რომლებიც არ წერია. თუ ტექსტში არარსებული სიტყვები ხმოვან ჩანაწერში მკაფიოდ ისმის, მაშინ უნდა უარყოთ. უმეტესად, ეს ეხება შემთხვევებს, როცა ტელევიზორია ჩართული ან იქვე ახლოს, ვინმე საუბრობს.
