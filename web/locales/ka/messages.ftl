...
sc-howto-cite-item-3 =
    საყოველთაო საკუთრების იმ ტექსტებისთვის, რომლებიც ინტერნეტში არ მოიპოვება, აკადემიური სახით მითითება შეგიძლიათ
    მაგ. „Jess (2021) ჩემი საჯარო ლიცენზიის პოემებიდან"
