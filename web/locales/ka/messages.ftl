...
dataset-description-hours =
    თითოეული მონაცემი წარმოდგენილია უნიკალური MP3-ისა და შესაბამისი ტექსტური ფაილით. <b>{ $total }</b> ჩაწერილი საათის უმეტესობა მონაცემთა კრებულში, ასევე შეიცავს დემოგრაფიულ ინფორმაციასაც, როგორიცაა ასაკი, სქესი და აქცენტი, რაც შეიძლება მეტად გამოსადეგი რომ იყოს, ხმის ამოცნობის საშუალებების სიზუსტის დასახვეწად.
