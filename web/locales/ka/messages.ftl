...
resource-playbook-info = <playbookLink>მოიძიეთ სასარგებლო მითითებები</playbookLink> Common Voice-ის შესახებ სრულად, დაწყებული თარგმნის მიმდინარეობიდან, დასრულებული მონაცემთა კრებულის გამოყენებამდე, აგრეთვე იხილეთ, როგორ შეგიძლიათ შემოუერთდეთ ჩვენს ერთობას.
