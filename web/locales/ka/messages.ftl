...
data-download-singleword-callout-v2 = მოხმარების კვლევის საფუძველზე შედგენილი ცალკეული კრებული, ციფრებისა და დიახ/არა ბრძანებების ხმოვანი ამოცნობის დასახვეწად.
...
demo-contribute-card-body = ახლა, ვინაიდან უკვე უკეთ გაიცანით Common Voice, ხომ არ გამოცდიდით? დაწკაპეთ მიკროფონის ნიშანზე და ამოიკითხეთ წინადადებები ხმამაღლა. <br/><br/>თუ გირჩევნიათ სხვების ხმოვანი შემოწირულობების შემოწმება, დაწკაპეთ გაშვების ნიშანზე. ნახეთ, ემთხვევა თუ არა მოსმენილი სიტყვები ეკრანზე გამოსახულს.
