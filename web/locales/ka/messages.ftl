...
faq-what-cv-and-deepspeech-a = Common Voice მონაცემთა კრებულის ჩართვა მოხდება Mozilla-ს ღია წყაროს მქონე, ხმის ამომცნობ ძრავაში Deep Search. პირველი ვერსია Deep Voice-ის გამოვიდა 2017 წლის ნოემბერში და მისი განვითარება დღემდე მიმდინარეობს. Common Voice-ის კრებულის საშუალებით, გვჯერა რომ ხმის ამოცნობის ტექნოლოგიები ხელმისაწვდომი გახდება ყველასთვის. ჩვენ ვიმედოვნებთ, რომ ეს უბიძგებს შემმუშავებლებს დანერგონ სიახლეები და შექმნან ახლებური სახის პროდუქტები და მომსახურებები.
...
faq-what-quality-a = ჩვენ გვსურს, რომ Common Voice-ს მონაცემთა კრებულის დახმარებით, ხმის ტექსტად ქცევის ძრავებს შეეძლოთ ხმის ამოცნობა ბუნებრივ გარემოში, ასე რომ გვესაჭიროება მრავალფეროვნება. ამასთან, განსხვავებულად მოსაუბრეთა ერთობის, განსხვავებული ხარისხის ხმოვანი ჩანაწერები ხმის ტექსტად ქცევის ძრავებს შეასწავლის ხმის ამოცნობას სხვადასხვა გარემოში, ხმაურისას, მანქანის მოძრაობისას და ა.შ. საკმარისია, ჩანაწერში ხმა ისმოდეს გარკვევით და იგი გამოსადეგი იქნება კრებულისთვის.
