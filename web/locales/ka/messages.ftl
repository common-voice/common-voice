...
citation =
    .label = წყარო
what-can-i-add = რა სახის წინადადების დამატება შეიძლება?
new-sentence-rule-1 = <noCopyright>საავტორო უფლებით</noCopyright> შეუზღუდავი (<cc0>cc-0</cc0>)
new-sentence-rule-2 = არაუმეტეს 15 სიტყვის შემცველი
new-sentence-rule-3 = გრამატიკულად გამართული
new-sentence-rule-4 = გამართული მართლწერით
new-sentence-rule-5 = ციფრებისა და საგანგებო ნიშნების გარეშე
new-sentence-rule-6 = უცხო დამწერლობების ასოების გარეშე
new-sentence-rule-7 = სათანადო წყაროს დამოწმებით
...
how-to-cite-explanation-bold = წყაროდ გამოდგება ბმული ან ნაწარმოების სრული სახელწოდება.
how-to-cite-explanation = თუ თავად შეადგინეთ, საკმარისია მიეთითოს <italicizedText>„საკუთარი ნამუშევარი“</italicizedText>. წყაროს დართვა იმიტომაა აუცილებელი, რომ შეგვეძლოს მასალის მოძიება, რათა გადავამოწმოთ, ნამდვილად საყოველთაო საკუთრებაშია თუ არა და საავტორო უფლებებით ხომ არ იკრძალება გამოყენება. უფრო ვრცლად წყაროს მითითების შესახებ იხილეთ ჩვენი <guidelinesLink>გზამკვლევის გვერდზე</guidelinesLink>.
