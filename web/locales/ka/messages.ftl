...
share-text = დაგვეხმარეთ, რომ ვასწავლოთ მანქანებს, თუ როგორ საუბრობენ ნამდვილი ადამიანები, შემოგვწირეთ თქვენი ხმა ბმულზე { $link }
...
wall-of-text-more-desktop =
    ...
    წაიკითხეთ წინადადება და დაეხმარეთ მანქანებს შეისწავლონ, როგორ საუბრობენ ნამდვილი ადამიანები. შეამოწმეთ სხვა მოხალისეების ნამუშევრებიც ხარისხის გასაუმჯობესებლად. ძალიან მარტივია!
