...
contribution-varying-pronunciations-example-1-explanation = [„ხოლმ(ე)“ წინადადების ბოლო ხმოვანი, ზოგ დიალექტში შეიძლება დაგრძელდეს]
...
contribution-background-voices-description = ხალხმრავალი ყაყანი ხმადაბლა ფონზე მისაღებია, მაგრამ დამატებითი ხმები არასასურველია, რომ მანქანურმა ალგორითმმა არ ამოიცნოს ის სიტყვები, რომლებიც დაწერილი არაა. თუ მკაფიოდ ისმის ტექსტში არარსებული სიტყვები , ჩანაწერი უნდა უარყოთ. უმეტესად, ეს ეხება შემთხვევებს, როცა ტელევიზორია ჩართული ან იქვე ახლოს, ვინმე საუბრობს.
...
contribution-volume-title = ხმის სიდიდე
contribution-volume-description = განსხვავება ბუნებრივია მკითხველთა ხმის დონეებს შორის. უარყავით მხოლოდ მაშინ, როცა იმდენად ხმამაღალია, რომ ჩანაწერი წყდება ან (უფრო ხშირად) იმდენად ხმადაბალია, რომ ვერ ახერხებთ აზრის გამოტანას, ტექსტის წაკითხვის გარეშე.
contribution-reader-effects-title = ხმაზე ზემოქმედება
contribution-reader-effects-description = ჩანაწერების უმეტესობაში, ხალხი ბუნებრივი ხმით საუბრობს. ამასთან, შეგიძლიათ გამონაკლისის სახით მიიღოთ უჩვეულო ხმით ჩაწერილებიც, რომლებიც შეიცავს ყვირილს, ჩურჩულს ან ხელოვნურ, „სამსახიობო“ შესრულებით წარმოთქმულს. გთხოვთ, უარყოთ ნამღერი ან კომპიუტერული პროგრამით ამოკითხული ჩანაწერები.
