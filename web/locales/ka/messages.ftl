...
rich-data = თქვენ მიერ წარდგენილი მასალა იქნება გამდიდრებული დემოგრაფიული მონაცემებით, ვინაობის გაუმხელად. გასაჯაროებამდე, ამ მონაცემებიდან ვაცილებთ ვინაობის აღმნიშვნელი ნაწილს.
...
recordings-and-locale-public = ჩანაწერებისა რაოდენობა და ის ენები, რომლებშიც წვლილი შეგაქვთ იქნება ხილული.
...
de-identified = ვინაობის მონაცემები მოცილებულია
