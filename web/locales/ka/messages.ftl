...
listen-abort-title = დასრულდეს ჩანაწერების შემოწმება?
listen-abort-cancel = შემოწმების გაგრძელება
listen-abort-confirm = შემოწმების დასრულება
...
single-sentence-submission = წინადადებების სათითოოდ შეტანა
bulk-sentence-submission = წინადადებების ერთიანად გადაგზავნა
...
sc-bulk-upload-instruction = ჩავლებით გადმოიტანეთ ფაილი ან <uploadButton>ატვირთეთ ფაილი</uploadButton>
