...
about-language-req-subtitle = ვიღაც მოითხოვს ენის დამატებას.
...
about-voice-contrib-subtitle = ხალხი შემოვა და შემოგვწირავს ჩანაწერებს.
about-voice-validation-title = ჩანაწერის დამოწმება
about-voice-validation-subtitle = სხვები შეამოწმებენ ამ ჩანაწერებს.
about-dataset-release-title = კრებულის გამოცემა
about-dataset-release-subtitle = კრებული გამოვა სამ თვეში ერთხელ.
...
contribution-varying-pronunciations-description-extended = მეორე მხრივ, თუ ფიქრობთ რომ მკითხველი პირველად გადააწყდა ამ სიტყვას და უბრალოდ, შეცდომა დაუშვა მისი წარმოთქმისას, გთხოვთ უარყოთ. თუ არ ხართ დარწმუნებული, გამოიყენეთ გამოტოვების ღილაკი.
