...
faq-where-src-from-a =
    ტექსტების წყაროები მოწოდებულია მოხალისეების მიერ დ აგრეთვე აღებულია საუბრების ჩანაწერები, საყოველთაო საკუთრებაში არსებული ფილმებიდან, როგორიცაა <italic>ცხოვრება მშვენიერია</italic>.
    
    ჩვენი წინადადებების წყაროები შეგიძლიათ იხილოთ ჩვენს GitHub-საქაღალდეში.
faq-why-not-ask-read-q = რატომ არ თხოვთ ხალხს ამოიკითხონ ტექსტები წიგნებიდან ან ვიკიპედიის სტატიებიდან სხვადასხვა ენებზე?
