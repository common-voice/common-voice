...
about-dataset-text = Common Voice-ის მონაცემთა კრებული შედგება ასეულ ათასობით ხმის ჩანაწერისგან, რომელიც გამოადგება შემმუშავებლებს, ხმის ამომცნობი საშუალებების შექმნაში.
