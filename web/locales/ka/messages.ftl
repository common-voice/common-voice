...
contribution-misreadings-description-extended-list-3 = წაკითხულია შემოკლებულად, მაგალითად „არაა“ ნაცვლად „არ არისა“ და პირიქით.
...
contribution-misreadings-example-5-title = გრძელდება გზის მშენებლობა ქალაქისაკენ.
contribution-misreadings-example-6-title = გრძელდება გზის მშენებლობა ქალაქისკენ.
contribution-misreadings-example-6-explanation = [უნდა იყოს „ქალაქისაკენ“]
contribution-misreadings-example-7-title = გაგრძელდება გზის მშენებლობა ქალაქისკენ.
contribution-misreadings-example-7-explanation = [ტექსტის თავში „გა-“ წინსართი არაა]
