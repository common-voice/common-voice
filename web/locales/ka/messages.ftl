...
contribution-misreadings-description-extended-list-2 = აკლია <strong>„ც“</strong> სიტყვის ბოლოს.
contribution-misreadings-description-extended-list-3 = წაკითხულია შემოკლებულად, მაგალითად „არაა“ ნაცვლად „არ არის“, ან პირიქით.
...
contribution-misreadings-example-5-title = დაკეტილი აღარ არის ზამთარში გზა.
contribution-misreadings-example-6-title = დაკეტილი აღარაა ზამთარში გზა.
contribution-misreadings-example-6-explanation = [უნდა იყოს „აღარ არის“]
contribution-misreadings-example-7-title = გადაკეტილი აღარ არის ზამთარში გზა.
contribution-misreadings-example-7-explanation = [ტექსტში „გა-“ წინსართი არ იყო]
contribution-misreadings-example-8-title = რაც გინახავს, ვეღარ ნახავ.
contribution-misreadings-example-8-explanation = [არ ემთხვევა ამოკითხული]
...
contribution-varying-pronunciations-example-1-explanation = [„ხოლმეე“ წინადადების ბოლო ხმოვანი, ზოგ დიალექტში შეიძლება დაგრძელდეს]
...
contribution-background-noise-example-2-explanation = [ტექსტი ნაწილი არ ისმის]
contribution-background-noise-example-3-fixed-title = <strong>[შიშინი]</strong> თავმჯდომარეც უკვე <strong>[შხრიალი]</strong> -რჩეულია.
contribution-background-voices-title = ხმები უკანა ფონზე
