...
misreadings-explanation-3 = აკლია „შე-“, „გა-“ წინსართები დასაწყისში ან ეწერა „ჰკითხა“, მაგრამ ისმის „კითხა“.
misreadings-explanation-4 = მოკვეცილია ბრუნვის ნიშანი სიტყვის ბოლოს, წაკითხულია „სამხრეთ აფრიკა“, მაგრამ ეწერა „სამხრეთი აფრიკა“.
...
misreadings-explanation-7 = სიტყვა დამარცვლილი ან გამეორებულია ამოკითხვის რამდენიმე მცდელობის გამო.
...
misreadings-tip-1 = [მოკვეცილია ბრუნვის ნიშანი „დავითი-ს“, აკლია ა-სავრცობი „ერის-ა“ და „თავდადების-ა-თვის“]
...
background-noise-tip-2 = [ამოკითხული განმეორებულია ან ნაწილობრივ არ ისმის]
...
adding-sentences-subheader-special-characters-explanation-1 = მხოლოდ ის ასონიშნებია მისაღები, რომელთაც ამ ენაში იყენებენ. მაგალითად, „Ω“ ბერძნული ანბანის ასოა და ქართულში არ გამოიყენება, ამიტომ ვერც ვერასდროს აღმოჩნდება ქართულ ნაწერში.
...
adding-sentences-subheader-offensive-content-explanation = თუ წინადადება შეურაცხმყოფელი ან შეუფერებელი ენითაა – მაგალითად, შეიცავს უხეშ სიტყვებს ან სხვა სახით არღვევს ჩვენს <communityGuidelines>ერთობაში მონაწილეობის დებულებებს</communityGuidelines> – უნდა უარყოთ წინადადება. აგრეთვე შეგიძლიათ დაგვიკავშირდეთ მისამართზე <emailFragment>commonvoice@mozilla.com</emailFragment> საკითხის ფართოდ განხილვისთვის.
