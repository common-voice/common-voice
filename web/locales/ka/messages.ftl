...
sc-howto-addsen-item-2 =
    ...
    მაგალითად, „2409“ შესაძლოა სწორად წაიკითხონ, როგორც „ორი-ოთხი-ნული-ცხრა“ და
    „ორი ათას ოთხას ერთი”.
...
sc-howto-addsen-item-4 =
    ...
    ისეთი განსხვავებული სიმბოლოების ჩართვა, როგებიცაა „@“ ან „#“.
...
sc-howto-findpd-partner-1 =
    ბევრი საჯარო დაწესებულება არსებობს, რომელთაც შეიძლება სურდეთ თანამშრომლობა
    და ჰქონდეთ, დიდი ოდენობის ტექსტი შესაწიერად, საყოველთაო საკუთრების სახით. შეეხმიანეთ ადგილობრივ უნივერსიტეტებს,
    სამთავრობო და ღია ორგანიზაციებს ამ პროექტზე სასაუბროდ და სთხოვეთ დახმარება.
sc-howto-findpd-partner-2 =
    ...
    წინადადებების მოძიებაში თქვენს ენაზე.
