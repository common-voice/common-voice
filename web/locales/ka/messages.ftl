...
contribution-background-voices-description = ხალხმრავალი ყაყანი ხმადაბლა ფონზე მისაღებია, მაგრამ დამატებითი ხმები არასასურველია, რომ მანქანურმა ალგორითმა არ ამოიცნოს ის სიტყვები, რომლებიც არაა დაწერილი. თუ მკაფიოდ ისმის ტექსტში არარსებული სიტყვები , ჩანაწერი უნდა უარყოთ. უმეტესად, ეს ხდება შემთხვევებს, როცა ტელევიზორია ჩართული ან იქვე ახლოს, ვინმე საუბრობს.
