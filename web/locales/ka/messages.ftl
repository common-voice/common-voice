...
contribution-misreadings-description = მოსმენისას, ყურადღებით გადაამოწმეთ, ჩანაწერში ზუსტად ისმის თუ არა, რაც წერია; უარყავით, თუ მცირე ხარვეზს მაინც იპოვით. <br />ხშირი შეცდომებია:
