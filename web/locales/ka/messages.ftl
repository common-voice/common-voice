...
wall-of-text-more-desktop =
    ...
    წაიკითხეთ წინადადებები და დაგვეხმარეთ რომ შევასწავლოთ მანქანებს, თუ როგორ საუბრობენ სინამდვილეში ადამიანები. შეამოწმეთ სხვა მოხალისეების ნამუშევრებიც, ხარისხის გასაუმჯობესებლად. ძალიან მარტივია!
...
shortcut-rerecord-toggle-label = ხელახლა ჩაწერა
...
faq-description = Common Voice პროექტი არის Mozilla-ს წამოწყების ნაწილი, რომ შევასწავლოთ მანქანებს, თუ როგორ საუბრობენ სინამდვილეში ადამიანები.
...
about-subtitle = Common Voice პროექტი არის Mozilla-ს წამოწყების ნაწილი, რომ შევასწავლოთ მანქანებს, თუ როგორ საუბრობენ სინამდვილეში ადამიანები. გარდა Common Voice-ის მონაცემთა კრებულისა, ჩვენ ასევე ვმუშაობთ ღია წყაროს მქონე, ხმის ამომცნობ ძრავაზე, სახელწოდებით Deep Speech.
about-header-description =
    ...
    ჩვენ კი გვინდა, რომ ხმოვანი მონაცემები გავხადოთ თავისუფლი და საჯაროდ ხელმისაწვდომი, ამასთან უზრუნველვყოთ, რომ ეს მონაცემები სრულად მოიცავს ადამიანების მრავალფეროვნებას. ერთად ჩვენ შეგვიძლია გავხადოთ ხმის ამოცნობა უკეთესი ყველასთვის.
...
about-dataset = Common Voice მონაცემთა კრებული
about-dataset-text = როდესაც მომხმარებელი უარყოფს ხმოვან ჩანაწერს, იგი დაუბრუნდება რიგს. თუ მეორედაც უარყოფენ, ხმის ჩანაწერი გადავა ჩანაწერების სასაფლაოზე.
