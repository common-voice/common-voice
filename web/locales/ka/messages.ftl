...
background-voices-explanation = ხმადაბალი ფონური ხმაური მისაღებია, მაგრამ თუ სხვა ადამიანის სიტყვები გარკვევით გესმით, ჩანაწერი უნდა უარყოთ. ჩვეულებრივ, ეს ეხება შემთხვევებს, როცა ტელევიზორია ახლოს ჩართული ან იქვე რამდენიმე ადამიანი საუბრობს.
...
reader-effects-explanation = ჩანაწერების უმეტესობაში ხალხი ბუნებრივი ხმით საუბრობს. ამასთანავე, შეგიძლიათ გამონაკლისის სახით მიიღოთ უჩვეულო ხმით ჩაწერილებიც, რომლებიც შეიცავს ყვირილს, ჩურჩულს ან ხელოვნურ, „სამსახიობო“ შესრულებით წარმოთქმულს. გთხოვთ, უარყოთ ნამღერი და კომპიუტერული პროგრამით ამოკითხული ჩანაწერები.
