...
speak-paragraph = ხმის ჩანაწერების შექმნა წარმოადგენს ჩვენი ღია მონაცემთა კრებულის შექმნის არსებით ნაწილს; ზოგიერთის აზრით, ყველაზე მხიარულ ნაწილსაც.
speak-goal-text = ჩანაწერები გაკეთებულია
