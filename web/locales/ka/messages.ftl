...
listen-paragraph = ჩანაწერების გადამოწმებაც ძალზე მნიშვნელოვანია Common Voice-ის მთავარი მიზნისთვის. მოუსმინეთ და დაგვეხმარეთ ხარისხიანი ღია წყაროს მქონე ხმოვანი მონაცემების შექმნაში.
...
datasets-positioning =
    ...
    ეს გვერდი გამოგადგებათ ცნობარის სახით, სადაც თავმოყრილია სხვა ღია წყაროს ხმოვანი კრებულებიც და ვინაიდან Common Voice განაგრძობს ზრდას, მომდევნო გამოშვებების შესახებ სიახლეებიც აქედან შეგიძლიათ შეიტყოთ.
language = ენა
...
confirm-join-mailing-list = მინდა შემოვუერთდე Common Voice-ის ელფოსტის ჯგუფს
...
example = მაგალითი
varying-pronunciations-explanation-1 = მეტყველების განსხვავებული კილოები მისასალმებელია ჩვენთან! მეტი სიფრთხილე გამოიჩინეთ, სანამ ჩანაწერს უარყოფთ, როცა საქმე ეხება სიტყვის შეცდომით წარმოთქმას, მახვილის არასწორად დასმას ან კითხვის ნიშნის უგულებელყოფას. ვინაიდან მსოფლიოში მრავალი სხვადასხვა სახის გამოთქმა არსებობს, რომელთაგანაც ზოგიერთი შეიძლება არ გქონდეთ გაგონილი ადგილობრივ საზოგადოებაში. გთხოვთ, ისინიც გაითვალისწინოთ, ვინც შესაძლოა, თქვენგან განსხვავებულად საუბრობდნენ.
varying-pronunciations-explanation-2 = მეორე მხრივ, თუ ფიქრობთ, რომ მკითხველი პირველად გადააწყდა ამ სიტყვას და ნამდვილად შეცდომით ამოიკითხა, გთხოვთ უარყოთ. თუ არ ხართ დარწმუნებული, გამოიყენეთ გამოტოვების ღილაკი.
varying-pronunciations-example = ფეხბურთის გუნდის სახელი ბრჭყალებში იყო ჩასმული.
varying-pronunciations-tip-1 = [დასავლურქართული კილოთი წაკითხვისას ზოგჯერ იკარგვის „რ“ და ისმის „პჭყალები“]
varying-pronunciations-tip-2 = [„ფეხბურთში“ ძნელი წარმოსათქმელია „ხ“ და „ბ“ ერთად, ამიტომ ძალაუნებურად ითქმის „ფე-ღ-ბურთი“]
offensive-content-explanation = წინადადებები მოწმდება ჩვენი ერთობის ზედამხედველობით, თუმცა შეიძლება ახლდეს ნაკლოვანებები. თუ წააწყდით ან მოისმინეთ წინადადება, რომელიც შეურაცხგყოფთ ან გაღიზიანებთ – თუნდაც არღვევს ჩვენს <participationGuidelines>ერთობაში მონაწილეობის დებულებებს</participationGuidelines> – გთხოვთ, გამოიყენოთ საჩივრის ღილაკი. აგრეთვე შეგიძლიათ დაგვიკავშირდეთ მისამართზე <emailFragment>commonvoice@mozilla.com</emailFragment>.
...
misreadings-explanation-4 = მოკვეცილია ბრუნვის ნიშანი სიტყვის ბოლოს, წაკითხულია „სამხრეთ აფრიკა“, თუმცა ეწერა „სამხრეთი აფრიკა“.
misreadings-explanation-5 = შემოკლებითაა წაკითხული „არაა“, მაშინ როცა ეწერა „არ არის“ ან პირიქით, ანდა სავრცობის გარეშეა „ამისათვის“ და „ამისთვის“.
misreadings-explanation-6 = აკლია ბოლო სიტყვა ან ბგერა ჩაწერის დროზე ადრე შეწყვეტის გამო.
misreadings-explanation-7 = სიტყვა დამარცვლული ან განმეორებულია ამოკითხვის რამდენიმე მცდელობის გამო.
misreadings-example-1 = დავითის ორდენით არის დაჯილდოებული ერისა და სამშობლოს წინაშე თავდადებისათვის.
misreadings-example-2 = დავითი ორდენით არის დაჯილდოებული ერის და სამშობლოს წინაშე თავდადებისთვის.
misreadings-example-3 = დავითის ორდენითაა დაჯილდოვებული ერისა და სამშობლოს წინაშე თავდადებისათვის.
misreadings-example-4 = მომწონს საკუთარი ხმის ჩაწერა.
misreadings-tip-1 = [მოკვეცილია „დავითი-ს“, აკლია ა-სავრცობი „ერის-ა“ და „თავდადების-ა-თვის“]
misreadings-tip-2 = [შემოკლებულია „ორდენით არის“, ზედმეტია „ვ“ სიტყვაში „დაჯილდოებული“]
misreadings-tip-3 = [არ შეესაბამება წარმოთქმული ნაწერს]
background-noise-explanation = ჩანაწერში თითოეული სიტყვა მკაფიოდ უნდა ისმოდეს. გვსურს, მანქანური შესწავლის ალგორითმებს შეეძლოს სხვადასხვა ფონურ ხმაურში სიტყვების გარჩევა, ამიტომ შედარებით ხმამაღალი ყაყანიც და წყნარი მუსიკაც მისაღებია, თუკი არ ფარავს და ხელს არ უშლის ამოკითხული სიტყვების გაგონებას. შრიალი ან წყვეტა როცა არ გაძლევთ მოსმენის საშუალებას, მაშინ უნდა უარყოთ ჩანაწერი.
background-noise-example-1 = არსებობს სამი სხვადასხვა სახეობა.
background-noise-example-2 = [დაცემინება] არსებობს სამი სხვადასხვა [ჩახველება] სახეობა.
...
background-voices-example-1 = თამაში დაიწყო საკუთარი ქალაქის გუნდში. [კითხულობს ერთი ხმა]
background-voices-tip-1 = ვინ დაიწყო? [ეხმაურება მეორე]
...
contact-common-voice = შეეხმიანეთ Common Voice-ის გუნდს
...
adding-sentences-subheader-special-characters-explanation-1 = მხოლოდ ის ასონიშნებია მისაღები, რომელთაც ამ ენაში იყენებენ. მაგალითად, „Ω“ ბერძნული ანბანის ასოა და ქართულში არ გამოიყენება, ამიტომ ვერც ვერასდროს აღმოჩნდება ქართულად ნაწერში.
...
community-announcement-header = ერთობის განცხადება!
