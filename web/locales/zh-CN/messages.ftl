...
help-sex-or-gender-changes-explanation = 为了让人们在向我们告知其生理性别或性别认同时能够有更加全面的选择，我们提供了更加多样的选项。请用您觉得最自然的方式来做自我描述。<learnMoreLink>详细了解我们处理生理性别和性别认同的方式</learnMoreLink>。
