...
how-to-cite-explanation = 如果来源于您自己，则只需注明<italicizedText>“原创”</italicizedText>。我们需要知道您在哪里得到这些内容，以便检查其是否处于公有领域并且无版权限制。有关引用的更多信息，请参阅我们的<guidelinesLink>准则页面</guidelinesLink>。
guidelines = 准则
contact-us = 联系我们
