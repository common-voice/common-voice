...
faq-why-important-a = 说话是人类相互沟通最自然的方式。而语音技术把这种方便感带到了电脑与移动设备上。我们想让开发者能够打造效果极好的语音识别程序，比如实时翻译器和语音数字助理。但此刻，大多数打造这类应用所必需的语音数据都是私有且昂贵的。我们希望 Common Voice 共语计划提供的数据集能满足开发者所需，把语音技术带到他们所说的语言。
