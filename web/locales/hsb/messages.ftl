...
faq-important-a = Hłós je přirodny, hłós je čłowjeski. Je najlóše a najpřirodniše wašnje komunikacije. Chcemy, zo wuwiwarjo móža fantastiske wěcy wutworić, wot programow, kotrež we woprawdźitym času přełožuja hač do rjadowanskich asistentow z hłosowym spóznaćom. Ale tuchwilu dosć datow njeje, kotre su za tute typy nałoženjow zjawnje k dispoziciji. Nadźijamy so, zo Common Voice wuwiwarjam to da, štož za inowacije trjebaja.
...
faq-mission-a = Mozilla so za to zasadźuje, web wotewrjeny a za kóždeho přistupny dźeržeć. Zo by to činił, dyrbimy webtworićeljow pžez projekty kaž Common Voice wukmanić. Dokelž hłosowe technologije hižo žane nišowe nałoženja njejsu, měnimy, zo dyrbja wšěm wužiwarjam w jenakej měrja słužić. Widźimy nuznosće, dalše rěče, akcenty a demografiske daty zapřijeć, hdyž hłosowe technologije wuwiwamy a testujemy. Mozilla chce strowy a žiwy internet. To rěka, damy nowym tworićelam přistup na hłosowe daty dać, zo bychu móhli nowe, wurjadne projekty wutworić. Common Voice budźe zjawna resursa, kotraž teamam Mozilla a wuwiwarjam z cyłeho swěta pomha.
...
data-other-tatoeba-description = Tatoeba je wulka datowa banka sadow, přełožkow a zynkowe daty za wuknjenje rěčow. Tute sćehnjenje wobsahuje jednźelske teksty, kotrež je so wot tamnišeho zhromadźenstwa natočili.
