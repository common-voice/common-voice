...
language-section-launched-new-description = Za tute aktiwizowane rěče je so websydło wuspěšnje přełžiło,  a ma dosć zběranych sadow, zo by zmóžniło stajne sobudźěło přez <italic>rěčenje</italic> a <italic>słuchanje</italic>.
