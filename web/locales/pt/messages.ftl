...
contribution-misreadings-example-5-explanation = [Conteúdo não corresponde]
...
contribution-background-noise-example-1-title = <strong>{ Sneeze }</strong> Os dinossauros gigantes do <strong>{ cough }</strong> Triássico.
contribution-background-noise-example-2-title = O dino <strong>{ cough }</strong> gigante do Triássico.
