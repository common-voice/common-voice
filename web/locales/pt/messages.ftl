...
contribution-background-noise-example-1-title = <strong>{ espirro }</strong> Os dinossauros gigantes do <strong>{ tosse }</strong> Triássico.
contribution-background-noise-example-2-title = O dino <strong>{ tosse }</strong> gigante do Triássico.
contribution-background-noise-example-2-explanation = [Parte do texto não pode ser ouvido]
contribution-background-noise-example-3-title = <strong>{ estalo }</strong> dinossauros gigantes do <strong>{ estalo }</strong> -riássico.
