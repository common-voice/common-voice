...
contribution-misreadings-example-5-explanation = [Nem egyező tartalom]
contribution-misreadings-example-6-title = Iszunk kávét?
contribution-misreadings-example-7-title = Iszunk egy kávét?
...
contribution-background-noise-example-3-explanation = [A szöveg egy része nem hallható]
