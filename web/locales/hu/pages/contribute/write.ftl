...
small-batch-sentence-input-placeholder = Írja ide a közkincsű mondatokat
...
small-batch-sentence-submission = Kis számú mondat kötegelt beküldése
bulk-sentence-submission = Mondatok tömeges beküldése
single-sentence = Egyetlen mondat
small-batch-sentence = Kis számú
bulk-sentence = Tömeges
...
small-batch-instruction = <icon></icon> Több közkincsű mondat hozzáadása
multiple-sentences-error = Egy beküldéshez nem adhat hozzá több mondatot
exceeds-small-batch-limit-error = Nem küldhet be 1000 mondatnál többet
# $retryLimit represents the amount of time in minutes a user has to wait to retry an upload
rate-limit-toast-message-minutes =
    { $retryLimit ->
        [one] Sebességkorlát túllépve. Próbálja újra { $retryLimit } perc múlva.
       *[other] Sebességkorlát túllépve. Próbálja újra { $retryLimit } perc múlva.
    }
# $retryLimit represents the amount of time in seconds a user has to wait to retry an upload
rate-limit-toast-message-seconds =
    { $retryLimit ->
        [one] Sebességkorlát túllépve. Próbálja újra { $retryLimit } másodperc múlva.
       *[other] Sebességkorlát túllépve. Próbálja újra { $retryLimit } másodperc múlva.
    }
# $retryLimit represents the amount of time in minutes a user has to wait to retry an upload
rate-limit-message-minutes =
    { $retryLimit ->
        [one] Elérte az oldal beküldési korlátját. Várjon 1 percet, mielőtt újabb mondatot küldene be. Köszönjük türelmét!
       *[other] Elérte az oldal beküldési korlátját. Várjon { $retryLimit } percet, mielőtt újabb mondatot küldene be. Köszönjük türelmét!
    }
# $retryLimit represents the amount of time in seconds a user has to wait to retry an upload
rate-limit-message-seconds =
    { $retryLimit ->
        [one] Elérte az oldal beküldési korlátját. Várjon 1 másodpercet, mielőtt újabb mondatot küldene be. Köszönjük türelmét!
       *[other] Elérte az oldal beküldési korlátját. Várjon { $retryLimit } másodpercet, mielőtt újabb mondatot küldene be. Köszönjük türelmét!
    }
# $uploadedSentences represents the number of sentences accepted from the small batch submission, $totalSentences represents the total number of sentences in the small batch submission
add-small-batch-success =
    { $totalSentences ->
        [one] { $uploadedSentences } / 1 mondat összegyűjtve
       *[other] { $uploadedSentences } / { $totalSentences } mondat összegyűjtve
    }
# $uploadedSentences represents the number of sentences accepted from the small batch submission, $totalSentences represents the total number of sentences in the small batch submission
small-batch-response-message =
    { $totalSentences ->
        [one] { $uploadedSentences } / 1 mondat összegyűjtve. Kattintson <downloadLink>ide</downloadLink> az elutasított mondatok letöltéséhez.
       *[other] { $uploadedSentences } / { $totalSentences } mondat összegyűjtve. Kattintson <downloadLink>ide</downloadLink> az elutasított mondatok letöltéséhez.
    }
small-batch-sentences-rule-1 = Kövesse a „Milyen mondatokat adhatok hozzá?” oldal irányelveit.
