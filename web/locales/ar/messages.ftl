...
about-get-involved-text =
    ...
    جميل! راسِلنا عبر البريد أو على <discourseLink>دِسكورس</discourseLink>،
    أو أطلِعنا على انطباعك على <githubLink>غِت‌هَب</githubLink>،
    أو انضمّ معنا في <slackLink>Slack</slackLink>.
