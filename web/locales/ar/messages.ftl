...
faq-what-cv-a =
    أحدثت تقنية التعرف الصوتي ثورة بالكيفية التي نتفاعل بها مع الآلات، إلا أن الأنظمة المتاحة حاليا غاية ومملوكة. تُعتبر «الصوت للعموم» جزءا من مبادرة موزيلا لجعل تقنيات التعرف الصوتي أفضل ومتاحة لجميع الناس. إن «الصوت للعموم» هي قاعدة بيانات عالمية كبيرة من المقاطع الصوتية المبنية على التبرع، والتي تتيح للجميع بتدريب التطبيقات التي تعمل بالتعرف الصوتي بسهولة وسرعة، وبأي لغة حتى.
...
faq-where-src-from-q = ما هو منبع النصوص المصدر؟
