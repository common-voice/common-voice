...
share-text = ساعِدنا بتعليم الآلة الكيفية التي ينطق بها بني البشر، ساهِم بصوتك في { $link }
back-top = عُد إلى الأعلى
contribution-banner-text = لقد أطلقنا لتونا تجربة مساهمة جديدة
contribution-banner-button = خُذ نظرة عليها
...
wall-of-text-more-mobile = أغلب البيانات التي تستخدمها الشركات الكبرى ليست متاحة إلى أكثرية الناس. نرى أن هذا يقتل الإبداع. لهذا السبب أطلقنا مشروع «الأصوات للعموم»، مشروعٌ سيساعد في توفير التعرف الصوتي لجميع من في العالم.
