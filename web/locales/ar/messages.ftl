...
demographic-deidentified = يُزال من البيانات الديموغرافية المُرسلة اختياريا (مثل العمر والجنس واللغة واللكنة) - يُزال مصدرها من البيانات الصوتية التي تُرسلها ولن تُنشر للعموم في ملفك الشخصي.
...
faq-when-release-q = متى ستُطلقون بيانات «الصوت للعموم» بباقي اللغات؟
...
datasets-headline = نحن نصنع مجموعة بيانات بأصوات مفتوحة المصدر ومتعددة اللغات يُمكن لأي شخص استخدامها لتدريب التطبيقات التي تعمل بالتعرف الصوتي.
language = اللغة
...
why-email = <b>لمَ تريدون بريدي؟</b> قد يحدث ونتواصل معك مستقبلا حول أية تغييرات على مجموعة البيانات. البريد الإلكتروني الذي تقدّمه وصلة الربط بيننا وبينك.
confirm-size = أصبحنا مستعدين لبدء عملية التنزيل. الحجم: <b>{ $size }</b>
...
subscribe = اشترِك
common-voice-info = أتجول في بالك أسئلة حول «الصوت للعموم»؟ انضم إلينا في <discourseLink>منتدى دِسكورس</ discourseLink>.
