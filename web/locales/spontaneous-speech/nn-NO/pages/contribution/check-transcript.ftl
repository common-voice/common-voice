...
transcription-page-instruction = { $actiontype } <playIcon></playIcon> Lytt til lydklippet, og sjekk transkripsjonen. Stemmer det? Om ikkje, rediger det slik at det stemmer perfekt.
...
transcript-edited-error = Det oppstod ein feil under redigering av transkripsjonen
error-fetching-transcriptions = Noko gjekk gale under henting av transkripsjonar. Prøv på nytt seinare.
transcript-skipped-success = Transkripsjonen vart hoppa over
transcript-skipped-error = Det oppstod ein feil då du hoppa over transkripsjonen
