...
prompt-page-instruction = { $actionType } <micIcon></micIcon> og svar så naturleg du kan
...
error-empty-audio = Mislykka opptak. Lydfila ser ut til å vere tom. Prøv på nytt.
error-platform-webview = Opptak blir kanskje ikkje støtta i denne avgrensa nettlesaren. Bruk ein fullverdig nettlesarapp.
error-recording-too-short-seconds = Opptaket er for kort. Minimumsvarigheit er { $minDurationSeconds } sekund.
error-recording-too-long-minutes = Opptaket er for langt. Maksimal varigheit er { $maxDurationMinutes } minutt.
...
learn-how-to-use-prompts-explanation = Berre svar på spørsmålet så naturleg du kan i eit par setningar. Sørg for at språket ditt er respektfullt og ikkje støytande.
learn-how-to-use-prompts-guidance = Klikk <guidanceLink>her</guidanceLink> for å lære korleis du brukar denne sida
