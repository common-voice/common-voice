...
question-page-instruction = سوال تھلا </icon> می می { $currentLocale } خلگا سی کیا جواب سی کیا
add-question-textarea-placeholder = مثلاً “تُو ٹیکنالوجی کا کم سی کیا کؤ نِمادُو؟“
add-questions-terms-checkbox = آ یقین دے بنَدُو یرأ <wikipediaLink> مے جملہ پبلک ڈومین </wikipediaLink> ما گھیِ چھی آں مھے یے ایسی دیؤ سی اجازا چھی۔
