...
record-player-header = K̃hũ jawob e lecer
...
error-uploading-response = K̃hũ jawob sẽnũvn-e wakht, z̃aqchiz rẽpak̃hkig̃h vite.
prompt-submitted-success = Jawob komyobig̃h mes̃h cherne (g̃hate)
prompt-response-deleted-success = Jawob komyobig̃h mes̃h  vishũvetk vite.
# For the button to delete a response to a prompt
delete = Vishũv
# For the disabled button on a prompt that indicates a prompt is already submitted
submitted = Chermovd (kartev)
# For the button on the Respond to prompts page which can be used to submit all responses at once
submit-all-button = Kũk̃ht chermũv/kat̃
