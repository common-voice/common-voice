...
how-spontaneous-speech-works = Kai struodoj spontanuo runa
# text wrapped in <mark></mark> will have a blue background
prompt-bubble-title = <mark>Vaicuojums</mark>
prompt-bubble-subtitle = Mes paruodeisim jums vaicuojumu
# text wrapped in <mark></mark> will have a blue background
respond-bubble-title = <mark>Atbiļde</mark>
respond-bubble-subtitle = Atbiļdit iz vaicuojumu sovā dabiskajā runys veidā
# text wrapped in <mark></mark> will have a blue background
transcribe-bubble-title = <mark>Puorraksteit</mark>
transcribe-bubble-subtitle = Puorrakstit, kū dzierdit audio īrokstā
# text wrapped in <mark></mark> will have a blue background
check-bubble-title = <mark>Puorbaudeit</mark>
check-bubble-subtitle = Puorbaudit, voi audio īrokstā dzierdamais ir pīraksteits pareizi
# text wrapped in <mark></mark> will have a blue background
data-bubble-title = <mark>Dati</mark>
data-bubble-subtitle = Mes periodiski publicejam savuoktūs datus
...
footer-text-terms = <termsLink>Nūsacejumi</termsLink>
footer-text-cookies = <cookiesLink>Seikfaili<cookiesLink>
