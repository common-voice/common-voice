...
question-database-language = Βάση δεδομένων: { $databaseLanguage }
...
partial-questions-upload-message =
    { $totalQuestions ->
       ...
       *[other] Έγινε συλλογή { $uploadedQuestions } εκ των { $totalQuestions } ερωτήσεων. Διαβάστε τις <guidelinesLink>οδηγίες</guidelinesLink> μας για να μάθετε περισσότερα σχετικά με τον τρόπο προσθήκης ερωτήσεων.
    }
# Guidelines
