...
audio-page-instruction = { $actionType } <playIcon></playIcon> και καταγράψτε αυτό που ακούτε
...
error-fetching-audio = Κάτι πήγε στραβά κατά τη λήψη ήχου προς μεταγραφή. Δοκιμάστε ξανά αργότερα.
