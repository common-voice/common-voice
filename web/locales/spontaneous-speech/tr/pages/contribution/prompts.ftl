...
record-player-header = Yanıtınızı kaydedin
...
submit-all-button = Tümünü Gönder
...
learn-how-to-use-transcribe-guidance = Bu sayfayı nasıl kullanacağınızı öğrenmek için <guidanceLink>burayı</guidanceLink> tıklayın
learn-how-to-use-check-transcript = Metni nasıl denetleyeceğinizi öğrenin
learn-how-to-use-check-transcript-explanation = Çevrilmiş metin, kaydeden tarafından söylenen tüm kelimeleri ya da çıkarılan sesleri, tekrarlar ve kekelemeler dâhil olmak üzere içermelidir.
learn-how-to-use-check-transcript-guidance = Bu sayfayı nasıl kullanacağınızı öğrenmek için <guidanceLink>burayı</guidanceLink> tıklayın
