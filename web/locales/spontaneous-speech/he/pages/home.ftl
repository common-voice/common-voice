...
welcome-to-spontaneous-speech = ברוכים הבאים לדיבור ספונטני
# <br></br> represents a newline break
wall-of-text = Common Voice משיקה פלטפורמה שנייה המתמקדת באיסוף דיבור אורגני, ספונטני, ללא תסריט. קהילות רבות יוכלו לאסוף נתונים מהר יותר, וזה יהיה שימושי עבור מדעני נתונים ומפתחים.
why-spontaneous-speech = מדוע בנינו את 'דיבור ספונטני'
...
contact-us-email = דוא"ל: <emailFragment>commonvoice@mozilla.com</emailFragment>
signup-form-title = האם כבר הצטרפתם לקבוצת בדיקות הבטא של פרויקט 'דיבור ספונטני' של Common Voice?
signup-terms = בכך שתלחצו על 'שלח קישור לדוא"ל', אתם מסכימים ל<termsLink>תנאים וההגבלות</termsLink> ול<privacyLink>מדיניות הפרטיות</privacyLink> שלנו, ולכך שמוזילה עשויה לשלוח אליכם דואל עם מידע כיצד להשתתף בבדיקות הבטא  עבור פרויקט 'דיבור ספונטני' של Common Voice.
