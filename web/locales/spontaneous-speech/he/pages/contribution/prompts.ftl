...
record-player-header = הקליטו את התגובה שלכם
...
error-uploading-response = אירעה תקלה בעת העלאת התגובה
prompt-submitted-success = התגובה נשלחה בהצלחה
prompt-response-deleted-success = התגובה נמחקה בהצלחה
