...
record-player-header = تومو شونگو ریکارڈ تھے
...
error-uploading-response = تھئیی جواب چینیوجا جیک ٹھِیسیک بِیلیں
prompt-submitted-success = جواب سم بو چینیجِیلی
prompt-response-deleted-success = جواب سم بو کَش بِیلیں۔
...
submit-all-button = بُٹئے/ پُورے چینڈ
