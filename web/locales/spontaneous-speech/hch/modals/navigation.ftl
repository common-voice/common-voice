...
respond = Ke neutaʼeiya
# Link to the check transcriptions page in the navigation modal for mobile users
check = Ke neutaʼixɨari
# Link to the Transcribe page in the navigation modal for mobile users
transcribe = Ke neutaʼutɨa
loading = Ka nanuyutinɨʼawani / Katiniyuʼuximaayaka...
login-signup = Ke neuhakí / Ke naʼakaʼutɨa
login = Ke neuhakí
logout = Ke nanayeyaʼá
