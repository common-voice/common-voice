...
transcript-edited-error = Axa katiniuyɨní niuki ʼutɨariyari mayepatsiwakaitsie
error-fetching-transcriptions = Axa katiniuyɨní niuki ʼutɨariyari manuyutɨnɨawakaitsie. Ximɨxi, ʼarikié ke tineutaʼinɨata.
transcript-skipped-success = Xeime niuki ʼutɨariyaritsie ʼaixɨ pekatiniukawení
transcript-skipped-error = Axa katiniuyɨní niuki ʼutɨariyari xeimetsie pekaweniké
# For the button on the Check Transcriptions page to assert that a transcription is correct
correct = Aixɨ ke neuyuri
# For the button on the Check Transcriptions page to indicate that a user has finished editing a transcription
done = Mɨpaɨ kaniuyɨní
