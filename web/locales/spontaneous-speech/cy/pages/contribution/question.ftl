...
add-question-success-toast-message =
    { $totalQuestions ->
        ...
        [one] { $uploadedQuestions } o 1 cwestiwn a gasglwyd
        [two] { $uploadedQuestions } o { $totalQuestions } gwestiwn a gasglwyd
        [few] { $uploadedQuestions } o { $totalQuestions } cwestiwn a gasglwyd
        [many] { $uploadedQuestions } o { $totalQuestions } chwestiwn a gasglwyd
       *[other] { $uploadedQuestions } o { $totalQuestions } cwestiwn a gasglwyd
    }
...
partial-questions-upload-message =
    { $totalQuestions ->
        ...
        [many] { $uploadedQuestions } o { $totalQuestions } chwestiwn a gasglwyd. Edrychwch ar ein tudalennau <guidelinesLink>Canllawiau</guidelinesLink> i ddysgu mwy am sut i ychwanegu cwestiynau
       *[other] { $uploadedQuestions } o { $totalQuestions } cwestiwn a gasglwyd. Edrychwch ar ein tudalennau <guidelinesLink>Canllawiau</guidelinesLink> i ddysgu mwy am sut i ychwanegu cwestiynau
    }
# Guidelines
