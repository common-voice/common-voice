...
transcription-page-instruction = { $actionType } <playIcon></playIcon> Gwrandewch ar y clip sain, a gwiriwch y trawsgrifiad. A yw'n cyfateb? Os na, golygwch ef iddo gyd-fynd yn berffaith.
# Header of the textbox that contains a transcription of an audio
check-editbox-header = Gwirio
