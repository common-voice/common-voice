...
audio-page-instruction = { $actionType } <playIcon></playIcon> ac ysgrifenu'r hyn rydych chi'n clywed y person yn ei ddweud
...
error-fetching-audio = Aeth rhywbeth o'i le wrth estyn sain ar gyfer trawsgrifiadau. Ceisiwch eto yn nes ymlaen.
