...
error-recording-too-short = Natočenje je překrótke. Minimalne traće je { $minDurationSeconds } sekundow.
error-recording-too-long = Natočenje je předołhe. Maksimalne traće je { $minDurationSeconds } mjeńšin.
