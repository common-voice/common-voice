...
add-question-success-toast-message =
    { $totalQuestions ->
        ...
        [two] { $uploadedQuestions } z { $totalQuestions } prašenjow zhromadźenej
        [few] { $uploadedQuestions } z { $totalQuestions } prašenjow zhromadźene
       *[other] { $uploadedQuestions } z { $totalQuestions } prašenjow zhromadźenych
    }
