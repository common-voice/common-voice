...
select-your-age = Elektu vian aĝon
gender-select-label = Kiu estas via sekso aŭ genro?
select-your-gender = Elektu vian sekson aŭ genron
country-of-residence-label = Loĝlando / loĝregiono
