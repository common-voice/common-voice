...
tag-page-instruction = Sankhani <icon></icon> lemba kuti muyambe
tag-terms-checkbox = Ndikugwirizana ndi Malamulo ndi Zachinsinsi za Common Voice.
tag-popover-title = Sankhani chizindikiro
select-a-tag = Sankhani chizindikiro
edit-tag = Sinthani chizindikiro
# Shortcuts modal
