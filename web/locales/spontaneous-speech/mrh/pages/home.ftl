...
welcome-to-spontaneous-speech = Spontaneous Speech tawhta eima chaw Dy
# <br></br> represents a newline break
wall-of-text = Common Voice cha awkenie, anotatapa, châtlâh leipa biereipazy pahmaohpa châta pachâpasiapa sânona lâpi a pahy. Cha cha khitlâh hluh via liata data pahmaohna kha a chatlei viapa ta bao aw ta, data scientist-zy nata developer-zy châta hmâdao a tla aw.
