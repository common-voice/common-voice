...
welcome-to-spontaneous-speech = Degemer mat war Komzoù dieub
...
prompt-bubble-subtitle = Diskouez a raimp deoc'h ur goulenn pe ur c'hinnig
# text wrapped in <mark></mark> will have a blue background
respond-bubble-title = <mark>Respont</mark>
respond-bubble-subtitle = Respont a rit d'ar goulenn en doare naturelañ posupl
# text wrapped in <mark></mark> will have a blue background
transcribe-bubble-title = <mark>Treuzskrivañ</mark>
...
footer-text-terms = <termsLink>Termenoù</termsLink>
footer-text-cookies = <cookiesLink>Toupinoù<cookiesLink>
