...
# text wrapped with <mark></mark> will have a light red background
why-card-3-text = Melior supporto pro linguas que ha poc o nulle <mark>corpora de texto</mark> a usar (e.g. sociolectos, variantes, linguas historicamente non scripte, etc)
...
contact-us-title = Interessate in participar a iste projecto, o collaborar con nos?
contact-us-email = Email: <emailFragment>commonvoice@mozilla.com</emailFragment>
signup-form-title = Es tu jam in nostre gruppo de verificatores Beta pro le projecto de Common Voice Parolas spontanee?
signup-terms = Cliccante “Inviar un ligamine a mi email”, tu concorda con nostre <termsLink>Terminos de servicio</termsLink> e <privacyLink>Politica de confidentialitate</privacyLink> e que Mozilla pote inviar te per email informationes re como participar in le Verification beta pro le projecto de Common Voice Parolas spontanee.
signup-input-placeholder = Insere tu email
signup-button-value = Inviar un ligamine a mi email
footer-text-privacy = <privacyLink>Confidentialitate</privacyLink>
