...
empty_or_unintelligible = Empty or Unintelligible
empty_or_unintelligible-detail = The content contains a different language, it is unintelligible.
empty_or_unintelligible-answer-detail = The content is empty, contains a different language, or it is unintelligible.
