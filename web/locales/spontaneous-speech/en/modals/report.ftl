...
not_good_for_transcription = Not possible to transcribe
not_good_for_transcription-detail = The content is empty, contains a different language, or not fit for transcription in any way.
