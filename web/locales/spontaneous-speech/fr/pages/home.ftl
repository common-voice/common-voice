...
# text wrapped in <mark></mark> will have a blue background
transcribe-bubble-title = <mark>Transcrire</mark>
transcribe-bubble-subtitle = Vous notez ce que vous entendez dans les extraits audio.
# text wrapped in <mark></mark> will have a blue background
check-bubble-title = <mark>Vérifier</mark>
check-bubble-subtitle = Vous vérifiez si la transcription correspond à l’audio.
# text wrapped in <mark></mark> will have a blue background
data-bubble-title = <mark>Données</mark>
data-bubble-subtitle = Nous publions périodiquement le jeu de données.
contact-us = Contactez-nous
contact-us-title = Vous souhaitez participer à ce projet ou créer un partenariat avec nous ?
contact-us-email = Adresse e-mail : <emailFragment>commonvoice@mozilla.com</emailFragment>
signup-form-title = Faites-vous déjà partie de notre groupe de test Bêta pour le projet Parole spontanée de Common Voice ?
