...
transcript-edited-error = Bei der Bearbeitung des Transkripts ist ein Fehler aufgetreten
error-fetching-transcriptions = Beim Abrufen der Transkripte ist etwas schiefgegangen. Bitte versuchen Sie es später erneut.
transcript-skipped-success = Transkript erfolgreich übersprungen
transcript-skipped-error = Beim Überspringen des Transkripts ist ein Fehler aufgetreten
