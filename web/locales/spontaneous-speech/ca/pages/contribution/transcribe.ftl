...
editbox-header = Transcriu
editbox-placeholder = Escriu aquí allò que sentiu dir a la persona
# Message which appears when there are no more resources on this page
no-audio-continue-skipped-message = Actualment no hi ha cap àudio per transcriure en aquesta llengua. Si n'heu omès algun, podeu continuar amb el contingut omès o bé podeu revisar transcripcions i tornar-ho a provar més tard.
...
error-fetching-audio = S'ha produït un error en recuperar l'àudio per a les transcripcions. Torneu-ho a provar més tard.
