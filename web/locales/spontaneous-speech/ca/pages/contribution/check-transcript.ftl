...
transcript-edited-error = S'ha produït un error en editar la transcripció
error-fetching-transcriptions = S'ha produït un error en recuperar les transcripcions. Torneu-ho a provar més tard.
transcript-skipped-success = La transcripció s'ha omès correctament
transcript-skipped-error = S'ha produït un error en ometre la transcripció
