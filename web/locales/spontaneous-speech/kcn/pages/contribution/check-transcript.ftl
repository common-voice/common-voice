...
transcription-page-instruction = Asuma sauti al ma gata de, wu hakikisha kataba to. Sei gi wafiki? kan maa jede, midu uwo kede wafiki tamaam
# Header of the textbox that contains a transcription of an audio
check-editbox-header = Hakikisha
no-transcriptions-message = Sawede lisa kalamaa al maktub maafi ta hakikisha min rutan wede. Tafadhal, jedidu safha de au aburu marataan baden.
vote-transcript-success = Kalam al maktub de taswiit to najah
