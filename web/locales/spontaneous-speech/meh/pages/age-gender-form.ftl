# Age and Gender form
age-gender-form-title = Nkuta'vi ni tyi tyinei nú jin Tù'un Ka'an Yatyi!
age-gender-form-subtile = A nakani nu jie'e nú tyinei nú da nu'un kaa nasa'a va dani jie'e kaa nityi kuantiñu ntaka dayoo.
add-information-button = Tyisó kà tù'un jie'e nú
continue-speaking-button = Ka'an kà
age-select-label = Nasa kuìyà iñɨ nú?
select-your-age = Nakàji kuìyà nú
...
transgender = Xe'ne
non-binary = Iyo sɨ́'ɨ́ ni iyo yɨ́ɨ́ ni
do_not_wish_to_say = Ntu kuvi ni katyi ni
