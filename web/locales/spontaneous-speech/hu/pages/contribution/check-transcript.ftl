...
transcription-page-instruction = { $actionType } <playIcon></playIcon> Hallgassa meg a hangfelvételt, és ellenőrizze a leiratot. Egyezik? Ha nem, akkor szerkessze úgy, hogy tökéletesen egyezzen.
