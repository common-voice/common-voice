...
error-recording-too-short = Ieraksts ir pārāk īss. Mazākais pieļaujamais ilgums ir { $minDurationSeconds } sekundes.
error-recording-too-long = Ieraksts ir pārāk garš. Lielākais pieļaujamais ilgums ir { $maxDurationMinutes } minūtes.
...
error-empty-audio = Ierakstīšana neizdevās. Skaņu datne šķiet tukša. Lūgums mēģināt vēlreiz.
error-platform-webview = Šajā ierobežotajā pārlūkā ierakstīšana var netikt nodrošināta. Lūgums izmantot pilnvērtīgu pārlūka lietotni.
error-recording-too-short-seconds = Ieraksts ir pārāk īss. Mazākais pieļaujamais ilgums ir { $minDurationSeconds } sekundes.
error-recording-too-long-minutes = Ieraksts ir pārāk garš. Lielākais pieļaujamais ilgums ir { $maxDurationMinutes } minūtes.
...
submit-all-button = Saglabāt visu
...
learn-how-to-use-transcribe-guidance = Noklikšķiniet <guidanceLink>šeit</guidanceLink>, lai uzzinātu, kā izmantot šo lapu
learn-how-to-use-check-transcript = Uzziniet, kā pārbaudīt pierakstīto
learn-how-to-use-check-transcript-explanation = Pierakstā ir jābūt iekļautam katram ierakstā dzirdamajām vārdam un skaņai, ieskaitot atkārtojumus.
learn-how-to-use-check-transcript-guidance = Noklikšķiniet <guidanceLink>šeit</guidanceLink>, lai uzzinātu, kā izmantot šo lapu
