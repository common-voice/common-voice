...
report-modal-title = Sūtīt ziņojumu
...
different_language = Nepareiza valoda
different_language-detail = Saturs ir valodā, kas atšķiras no tā, ko es gaidīju.
...
other = Cits
report-error = Iesniedzot ziņojumu, radās kļūda
...
success = Izdevās
report-success-message = Ziņojums sekmīgi nosūtīts!
