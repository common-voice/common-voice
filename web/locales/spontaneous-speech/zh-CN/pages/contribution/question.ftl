...
question-page-instruction = 添加 <icon></icon> { $currentLocale }问题以供回答
add-question-textarea-placeholder = 例如：“你希望科技能做什么？”
add-questions-terms-checkbox = * 我确认此问题处于<publicDomainLink>公有领域</publicDomainLink>，并且我有权上传。
question-dataset-language = 数据集：{ $datasetLanguage }
