...
skipped = Saqirparisqa
audioplayer-header = Uyariy
guidelines = Kamachiqkuna
# For the button to report an item
report-button = Willakuy
# For the button to skip an item
skip-button = Saqirpariy
submit-button = Apachiy
contribute = Yanapay

## Navbar

respond-to-prompt = Tapuyman Kutichiy
transcribe-audio = Uyariykunamanta Qillqaqay
check-transcriptions = Qillqaqaykunata Qhawapay

## Not Found Page

not-found-page-header = Mana Tarisqachu
