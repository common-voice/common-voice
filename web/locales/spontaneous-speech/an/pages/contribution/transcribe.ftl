...
audio-page-instruction = { $actionType }<playIcon></playIcon> y escribe qué ascuitas decir a esta persona
editbox-header = Transcribir
editbox-placeholder = Escribe lo que ascuitas decir aquí a la persona
no-audio-message = Agora no queda audios pa transcribir en este idioma. Refresca la pachina u mira d'intentar-lo dimpués.
