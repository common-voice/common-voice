...
validation-guidelines-title = Pokyny
validation-guideline-1 = Žádné vyžadování osobních informací (např. jména, finanční informace)
validation-guideline-2 = Žádné urážlivé, předpojaté poznámky nebo citlivé otázky
validation-guideline-3 = Jednoduché a srozumitelné pro každého
validation-guideline-4 = Lze odpovědět několika větami
