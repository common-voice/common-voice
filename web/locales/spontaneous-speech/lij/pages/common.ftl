...
skipped = Ignorou
audioplayer-header = Senti
guidelines = Linie guidda
# For the button to report an item
report-button = Denonçia
...
not-found-page-header = No attrovou
not-found-page-content = No s’é posciuo attrovâ a pagina che ti çerchi
