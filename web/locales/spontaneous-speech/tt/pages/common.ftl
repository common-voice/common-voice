...
transcription-mode-auto = Автоматик
# Player - slower
player-speed-slow = Әкрен
# Player - normal speed
player-speed-normal = Нормаль
# Player - faster
player-speed-fast = Тиз
...
player-play-pause-shortcut-name = Уйнату / Туктатып тору
