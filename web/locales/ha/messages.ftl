...
show-wall-of-text = Ci gaba da Karantawa
...
status-title = Matsayar aikinnan: duba abinda muka cimma!
...
off = Kashe
on = Kunna
avatar-clip-title = Ba wa muryarka avatar
change-your-avatar-clip = Kana son chanza muryar ka?
recording-in-progress = Ɗaukan murya na kan cingaba
avatar-clip-recorded = Avatar ka yanzu na haɗe da ɓangare-ɓangare!
record-voice-wave = ƊAUKAR KALAMAN MURYA
retry-voice-wave-recording = SAKE GWADAWA
re-record = SAKE-NAƊA
delete-voice = GOGE
recording-voice-wave = Rekodi
delete-voice-clip = ko  Goge shashin muryar
ready-to-upload = Ɗaura
avatar-clip-fact = Tabbataccen abu ne da mai karatu zai shagalta da abin karantawa na shafi lokacin da yake kallon shimfiɗarsa.
recreate-voice = Sake kirkira Muryar Murya
cancel-avatar-clip-recording = Soƙe
about-avatar-clip-recording = Ƙirkiri shashin murya a zaman ɓangaren bayaninka na avatar. Kowa zasu iya shawagi ku su saurari shirinka.
...
faq-when-release2-a = Tsarin harsuna da yawa na dataset na Common Voice yanzu yana fuskantar tarin tallafi da tsaftacewa na al'umma. Idan kuna son taimaka mana kawo Voice na gama gari zuwa sababbin harsuna, je duba kayan <SentenceCollectorLink> Sentence Collection Tool </sentenceCollectorLink> don ƙara sabbin jumloli a cikin dataset, da Mozilla <pontoonLink> Pontoon </pontoonLink> don fassara gidan yanar gizon kanta. Ana ƙara sababbin harsuna zuwa Common Voice don gudummawar 5000 murya lokacin da aka tara da aka tattaro.
...
faq-what-cv-and-deepspeech-a = Bayanin Common Voice ya cika injin buɗe muryar muryar Mozilla Deep Speech. An saki sigar farko ta Deep Speech a waCommon Voice, munyi imanin cewa wannan fasahar buɗe murfin ya kamata ta kasance ga kowa. Muna fatan waɗannan fasahohin za su ba masu haɓaka damar ƙirƙirar samfuran samfuran zamani da sabis.
faq-is-goal-assistant-q = Shin manufar gina Common Voice shine domin gina maƙallin murya?
faq-is-goal-assistant-a = Manufar kundin Common Voice shine don bawa kowa a duniya damar gina ganewar magana, fitowar mai magana, ko kowane irin aikace-aikacen da ke buƙatar bayanan murya. Mataimakin murya ɗaya ne daga cikin nau'ikan aikace-aikace da yawa da zaku iya amfani da bayanan don ginawa.
...
about-listen-queue-text = Ana shigar da shirye-shiryen murya cikin layin sallama wanda zai iya karanta su don sauraro.
about-listen = Saurara
about-listen-text = Masu amfani suna tabbatar da daidaitattun shirye-shiryen bidiyo, suna bincika cewa mai magana ya karanta jumlar daidai.
...
about-yes-votes-text = Don sanya shi a cikin kundin tsarin Common Voice, dole ne a sami ingantaccen shirin murya ta masu amfani daban biyu.
...
why-email = <b> Me yasa imel? </b> Muna iya buƙatar tuntuɓar ku a nan gaba game da canje-canje ga tsarin bayanan, imel ɗin yana ba mu wurin tuntuɓarmu.
confirm-size = Ka shirya don fara saukar da<b>{ $size }</b>
size-gigabyte = GB
size-megabyte = MB
confirm-no-identify = <b>Ka amince</b> kaƙi sanin tushin mai magana a tarin Common Voice
...
listen-instruction = { $actionType }<playIcon></playIcon> Ko sunyi magana daidai?
listen-again-instruction = Aiki mai kyau! <playIcon> </playIcon> sake saurara lokacin da kuka shirya
