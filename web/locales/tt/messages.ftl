...
my = Бирма теле
myv = Эрзя теле
nb-NO = Норвег теле (Букмол)
ne-NP = Непал теле
nl = Һолланд теле
nn-NO = Яңа норвег теле
oc = Окситан теле
or = Одия теле
pa-IN = Пунжаб теле
pap-AW = Папиаменто теле (Аруба)
pl = Поляк теле
ps = Пушту теле
pt = Португал теле
rm-sursilv = Романш сурсельв теле
rm-vallader = Романш Валладер теле
ro = Румын теле
ru = Рус теле
rw = Киниаруанда теле
sah = Саха теле
...
vot = Вот теле
yue = Кантон теле
zh-CN = Кытай теле (Кытай)
zh-HK = Кытай теле (Гонконг)
zh-TW = Кытай теле (Тайвань)
