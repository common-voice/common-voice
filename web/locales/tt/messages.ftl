...
help-variants-explanation = Вариантлар — телнең билгеле бер формасы. Мәсәлән, телнең билгеле бер өлкәдә яисә мәхәлләдә яшәүче кешеләр сөйләгән формалары . Аларны диалект я шивә дип тә атыйлар.
