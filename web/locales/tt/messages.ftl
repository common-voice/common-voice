...
language-section-in-progress-description = Әзерләнүдә булган телләрне без волонтерлар өлеш кертә алсыннар өчен хәстәрләүдәбез; түбәндәге прогресс шкалалары ул телләр өчен вебсайт ни күләмдә тәрҗемә ителгән һәм никадәр җөмлә җыелган икәнен күрсәтә.
