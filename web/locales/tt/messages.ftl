...
rich-data = Язмаларыгызны мөмкин кадәр байрак итү өчен демографик характердагы берникадәр аноним мәгълүмат та тапшыра аласыз. Ул мәгълүматны нәшер иткәндә, без андагы барлык шәхси күрсәткечләрне бетерәбез.
...
demographic-deidentified = Сезнең ихтыярыгыз белән тапшырылган демографик мәгълүмат (мәсәлән, яшь, җенес, тел һәм акцент) нәшер ителәсе аудиоязмалардан бүлеп алыначак һәм беркайчан да ачык рәвештә беркая да урнаштырылмаячак.
