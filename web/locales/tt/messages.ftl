...
faq-what-determine-identity-a = Common Voice мәгълүмат җыентыгы — сөйләм белән эш итә алучы кушымталарны өйрәтү өчен кулланылучы ачык һәм һәркем дә ирешә алырлык ресурс. Проектта катнашучы кешеләрнең хәвефсезлеген саклау өчен, без мәгълүмат тупланмасын йөкләүче һәр кешедән проектта катнашучыларның приватлыгын хөрмәт итүләрен үтенәбез.
