...
template-file-additional-information = 如果還想提供其他模板中沒有的額外資訊，請聯繫 <emailFragment>commonvoice@mozilla.com</emailFragment>
...
rate-limit-toast-message-minutes =
    { $retryLimit ->
        [one] 超過速度限制。 1 分鐘後再試一次
       *[other] 超過速度限制。 { $retryLimit } 分鐘後再試一次
    }
# $retryLimit represents the amount of time in seconds a user has to wait to retry an upload
rate-limit-toast-message-seconds =
    { $retryLimit ->
        [one] 超過速度限制。 1 秒鐘後再試一次
       *[other] 超過速度限制。 { $retryLimit } 秒鐘後再試一次
    }
# $retryLimit represents the amount of time in minutes a user has to wait to retry an upload
rate-limit-message-minutes =
    { $retryLimit ->
        [one] 您已達到本頁面的送出數量限制，請稍候 1 分鐘再送出新句子。感謝您耐心等待！
       *[other] 您已達到本頁面的送出數量限制，請稍候 { $retryLimit } 分鐘再送出新句子。感謝您耐心等待！
    }
# $retryLimit represents the amount of time in seconds a user has to wait to retry an upload
rate-limit-message-seconds =
    { $retryLimit ->
        [one] 您已達到本頁面的送出數量限制，請稍候 1 秒後再送出新句子。感謝您耐心等待！
       *[other] 您已達到本頁面的送出數量限制，請稍候 { $retryLimit } 秒後再送出新句子。感謝您耐心等待！
    }
# $uploadedSentences represents the number of sentences accepted from the small batch submission, $totalSentences represents the total number of sentences in the small batch submission
add-small-batch-success =
    { $totalSentences ->
        [one] 共 { $totalSentences } 句，已收集 1 句
       *[other] 共 { $totalSentences } 句，已收集 { $uploadedSentences } 句
    }
# $uploadedSentences represents the number of sentences accepted from the small batch submission, $totalSentences represents the total number of sentences in the small batch submission
