...
why-donate-datasets-page = Mozilla Common Voice 是世界上最多元的眾包開放語音資料集 — 我們完全依靠捐款運作，每年需花費近百萬美元來提供資料集，並改進平台，以支持一百多個語言社群。如果你也重視開放且包容的資料，<b>請立即捐款支持！</b>​
confirm-size = 請準備好下載 <b>{ $size }</b> 的檔案
size-gigabyte = GB
size-megabyte = MB
confirm-no-identify = <b>您同意</b>不嘗試識別 Common Voice 資料集中錄音者的身分
