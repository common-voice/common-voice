...
banner-error-slow-1 = Ami dukhi asa ki "Common Voice" sovkas cholta. Tumi hanga pavle mhunon tumka dinvasta.
banner-error-slow-2 = Sodiak amchi website chod lok vaparun bond podpa degher asa, ani ami ata oddchonn khoi asa ti sodun kadta.
banner-error-slow-link = Stiti'che Pan
