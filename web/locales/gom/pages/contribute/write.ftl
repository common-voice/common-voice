...
new-sentence-rule-8 = Chod korun prakrutik ani ulovpak sôpi (vakya vachunk sôpem asunk zai)
...
minimum-sentences = Vakyo asunk zai: 1000 anik vǒir
...
bulk-submission-success-subheader = Tu mǒddǒt korta "Common Voice"-ache disache vakyo ekthhaivpi 'goal' purn korpak!
