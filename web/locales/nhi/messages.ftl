...
wall-of-text-start = Tlahtol isqui milauac, tlahtol isqui maceual. Ica nun sepactoc secchiuas se tipostlahtol para tomaquinas. Axan para secchiuas se tlahtoltiquitl, sepouali simi ueyi ika nextililtlahtol moniqui.
wall-of-text-more-desktop = Axan uilis titetlacolis motlahtol ica titechpalehuis ticchiuasqueh se icxitlanahuatil ica tlahtol ichtaca tlapohtoc tlen uilis quicuis aquinsa para ica quichichiuas yancuiqueh aplicaciones para tiposmeh uan web.<lineBreak></lineBreak>Xiquita se tlahcuilol para tiquinpalehuis mo quinnextilican tiposmeh quenin tlahtoan maceualmeh. Xiquita tiquitl de ocsiquen tlapalehuaneh ica secyectlalis tiquitl. ¡ohcon amo oue!
