...
wall-of-text-second = Ірі компаниялар пайдаланған деректерінің басым бөлігі адамдардың көпшілігіне қолжетімді емес. Біздің ойымызша, бұл инновацияны бәсеңдетеді. Сондықтан, біз Common Voice жобасын іске қостық, бұл - дауыс тануды барлық адамдарға қолжетімді етуге көмектесетін жоба.
