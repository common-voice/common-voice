...
faq-why-important-a =
    講嘢通常係我哋同其他人最自然嘅溝通方式，語音技術亦都令電腦同流動裝置更加方便。我哋希望開發者打造令人驚嘆嘅語音識別程式，例如即時翻譯機、有語音功能嘅數位助理等等。但係宜家用嚟建設呢啲軟件要用嘅語音資料，大部分都係好貴嘅，所以我哋希望可以提供Common Voice數據集俾開發者進行創新，亦令我哋可以用自己嘅語言打造語音技術。
...
hours-validated-explanation = 每三位使用者當中，有兩位使用者投下「正確」的錄音時數。這也就是整個計劃一萬小時目標的進度。
sst = 語音轉文字（STT）
