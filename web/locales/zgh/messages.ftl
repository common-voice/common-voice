...
wall-of-text-more-desktop =
    ⵜⵣⵎⵔⵎ ⴷⵖⵉ ⴰⴷ ⵜⴼⴽⵎ ⴰⴳⵕⴹ ⵏⵏⵓⵏ ⴼⴰⴷ ⴰⵏⵖ ⵜⴰⵡⵙⵎ ⴰⴷ ⵏⵥⴽⵓ ⵢⴰⵜ ⵜⵙⵉⵍⴰ ⵏ ⵉⵙⴼⴽⴰ ⵜⴰⴳⵕⴹⴰⵏⵜ ⵙ ⵓⵙⴰⴳⵎ ⵓⵕⵥⵉⵎ ⵏⵏⴰ ⵙ ⵉⵣⵎⵔ ⴽⵓⵢⴰⵏ ⴰⴷ ⵜⵜ ⵉⵙⵙⵎⵔⵙ
    ⴼⴰⴷ ⵉⵙⴽⵔ ⵜⵉⵙⵏⵙⵉⵡⵉⵏ ⵉ ⵡⴰⵍⵍⴰⵍⵏ ⴷ ⵓⵡⵉⴱ. ⵖⵔⴰⵜ ⴽⵔⴰ ⵏ ⵜⵡⵉⵏⵙⵜ ⴼⴰⴷ ⵜⴰⵡⵙⵎ ⴳ ⵓⵙⵙⵍⵎⴷ ⵉ ⵜⵎⴰⵛⵉⵏⵉⵏ ⵎⴰⵏⵎⴽ ⵙⴰⵡⴰⵍⵏ ⵎⴷⴷⵏ ⵏ ⵜⵉⴷⵜ. ⵛⴰⴱⴱⴰⵢⴰⵜ ⵜⴰⵡⵓⵔⵉ ⵏ ⵉⵎⴰⵔⴰⴳⵏ
