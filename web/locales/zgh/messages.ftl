...
what-needs-to-be-in-file-explanation = ⵎⴽ ⵜⵓⴼⴰⵎ, ⵛⴰⴱⴱⴰⵢⴰⵜ <templateFileLink>ⴰⴼⴰⵢⵍⵓ ⵏ ⵡⴰⵍⴱⵓⴹ</templateFileLink> ⵏⵏⵖ. ⵉⵅⵚⵚⴰ ⵜⵉⵡⵉⵏⴰⵙ ⵏⵏⵓⵏ ⴰⴷ ⵉⵍⵉⵏⵜ ⴷ ⵜⵉⴷⵔⴼⵉⵢⵉⵏ ⵙⴳ ⵉⵣⵔⴼⴰⵏ ⵏ ⵓⵎⴳⴰⵢ (CC0 ⵏⵉⵖ ⴷ ⵜⴰⵡⵓⵔⵉ ⵜⴰⵏⵚⵍⵉⵜ ⵉⵍⴰⵏ ⵜⵓⵔⴰⴳⵜ ⵏ ⵓⵎⴰⵣⴰⵏ) ⴷ ⴰⴷ ⴼⴰⵡⵏⵜ, ⴰⵖⴷⵏⵜ ⵙ ⵓⵏⵊⵕⵓⵎ, ⵍⵎⴹⵏⵜ ⴳ ⵜⵖⵔⵉ.ⵉⵅ
