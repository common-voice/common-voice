...
about-playbook-how-access-dataset-content-2 = ⵎⴽ ⴷⴰ ⵜⵙⵉⴳⴳⵉⵍⴷ ⵉⵎⴰⵙⵙⵏ ⵃⵎⴰ ⴰⴷ ⵜⵥⴽⵓⴷ ⵜⵉⵎⵓⴷⵎⵉⵡⵉⵏ ⵏ ⵡⴰⴽⴰⵣ ⵏ ⵡⴰⵡⴰⵍ ⵙ ⵓⵡⵔⵎⴰⵏ, ⵜⵣⵎⵔⴷ ⴰⴷ ⵜⵎⵎⵣⴷⵢⴷ ⴰⴽⴷ ⵎⴷⴷⵏ ⵢⴰⴹⵏⵉⵏ ⴳ ⵜⴳⵔⴰⵡⵜ <discourseLink>ⴳ ⴷⵉⵙⴽⵓⵕⵚ</discourseLink>.
...
glossary = ⵜⴰⵎⴰⵡⴰⵍⵜ
sst-explanation = ⵜⵉⵜⵉⴽⵏⵓⵍⵓⵊⵉⵢⵉⵏ ⵏ ⵜⵓⴽⵣⴰ ⵜⴰⴳⵕⴹⴰⵏⵜ (STT) ⴷⴰ ⵙⵙⵓⵖⵓⵍⵏⵜ ⴰⴳⵕⴹ ⵖⵔ ⵓⴹⵕⵉⵚ.
...
data-get-started = <speechBlogLink>ⵙⵙⵏⵜⵉ ⵙ ⵡⴰⴽⴰⵣ ⴰⴳⵕⴹⴰⵏ</speechBlogLink>
