...
faq-how-calc-hours-a = ⵍⴰ ⵏⵙⵙⵓⴹⵓⵏ ⵜⵉⵙⵔⴰⴳⵉⵏ ⵙ ⵓⵙⵓⵜⴳ ⵏ ⵜⵖⵣⵉ ⵜⴰⵏⴰⵎⵎⴰⵙⵜ ⵏ ⴽⵓ ⴰⵙⵓⵙⵔ, ⵉⵍⵎⵎⴰ ⵏⵡⵜ ⵓⵟⵟⵓⵏ ⴰ ⵅⴼ ⵡⵓⵟⵟⵓⵏ ⵓⵖⵔⵉⴷ ⵏ ⵉⵙⵓⵙⴰⵔ ⴳ ⵜⵓⵜⵍⴰⵢⵉⵏ ⴰⴽⴽⵯ.
...
size = ⵜⵉⴷⴷⵉ
validated-hr-total = ⴰⵖⵔⵓⴷ ⵏ ⵜⵙⵔⴰⴳⵉⵏ ⵣⵔⵢⵏⵉⵏ
cv-license = ⵜⵓⵔⴰⴳⵜ
