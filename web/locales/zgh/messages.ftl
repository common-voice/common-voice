...
contribution-background-voices-description = ⵜⴰⵇⵇⵓⵔⵜ ⵏ ⵜⵖⵔⴷⵉⵏ ⵉⵣⴳⴰⵏ ⵡⴰⵅⵅⴰ, ⵎⴰⵛⴰ ⵓⵔ ⵏⵅⵙ ⵉⴳⵕⴹⴰⵏ ⵓⵔⵏⵉⵡⵏ ⵏⵏⴰ ⵖⵉⵢⵏⵉⵏ ⴰⴷ ⴰⴷ ⵙⵔⴳⵏ ⵉ ⵡⴰⵍⴳⵓⵔⵉⵜⵎ ⵏ ⵜⵎⴰⵛⵉⵏⵜ ⴰⵔ ⴷ ⵉⵙⵎⴰⴳⵉ ⵜⵉⴳⵓⵔⵉⵡⵉⵏ ⵏⵏⴰ ⵓⵔ ⵍⵍⵉⵏⵉⵏ ⴳ ⵓⴹⵕⵉⵚ ⵉⵜⵜⵢⴰⵔⴰⵏ. ⵎⴽ ⵜⵣⵎⵔⴷ ⴰⴷ ⵜⵙⵍⵍⴷ ⵉ ⵜⴳⵓⵔⵉⵡⵉⵏ ⵏⵏⴰ ⵏⴰⵃⵢⴰ ⵅⴼ ⵡⵉⵏ ⵓⴹⵕⵉⵚ, ⵉⵅⵚⵚⴰ ⴰⴷ ⵜⴻⵜⵜⵢⴰⴳⴰⵢ ⵜⵓⵙⵙⵉⴼⵜ. ⵍⴰ ⵉⵜⵜⵎⵙⴰⵔ ⵓⵢⴰ ⵙ ⵓⵎⴰⵜⴰ ⴷⵉⵏⵏⴰ ⴳ ⵉⵇⵇⵉⵎ ⵓⵜⵉⵍⵉⴼⵉⵣⵢⵓⵏ ⵉⵔⵖⴰ, ⵏⵉⵖ ⴷⵉⵏⵏⴰ ⴳ ⵉⵍⵍⴰ ⴽⵔⴰ ⵏ ⵓⵎⵔⴰⵔⴰ ⵏ ⵡⴰⵡⴰⵍ ⵜⴰⵎⴰ ⵏⵏⵙ.
