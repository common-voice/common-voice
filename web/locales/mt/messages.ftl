...
email-opt-in-info-title = Issieħeb biex tirċievi aħbarijiet dwar Common Voice.
email-opt-in-info-sub-with-challenge = Irċievi emails biex ifakkruk dwar sfidi u għanijiet, aġġornamenti ta’ progress, u aħbarijiet dwar Common Voice.
...
faq-when-release2-a = Il-verżjoni multilingwi tad-data ta' Common Voice bħalissa għaddejja minn proċess ta' ġbir u ta' tindif, bl-għajnuna tal-komunità. Jekk tixtieq tgħinna nintroduċu Common Voice għal lingwi ġodda, tista' tesplora s-<sentenceCollectorLink> Sentence Collection Tool </sentenceCollectorLink> biex iżżid sentenzi ġodda mad-dataset, u tuża l-<pontoonLink> Pontoon </pontoonLink> ta' Mozilla għat-traduzzjoni tas-sit innifisu. Lingwi ġodda jiżdiedu fuq Common Voice biex jibdew jinġabru l-vuċijiet meta jkunu ġew approvati 5000 sentenza.
faq-why-mission-q = Għalfejn Common Voice jagħmel parti mil-missjoni ta' Mozilla?
faq-why-mission-a = Mozilla hija mpenjata biex iżżomm il-web miftuħa u aċċessibbli għal kulħadd. Biex nagħmlu dan għandna bżonn nagħtu s-setgħa lill-ħallieqa tal-web permezz ta' proġetti bħal Common Voice. Filwaqt li t-teknoloġiji tal-vuċi qed jinirxu lil hinn minn applikazzjonijiet speċifiċi, aħna nemmnu li għandhom iservu lill-utenti kollha bl-istess mod. Dan ifisser investiment f'iktar lingwi u akkomodazzjoni ta' aċċenti u demografija varjata meta jinbnew u jiġu ttestjati teknoloġiji tal-vuċi. Common Voice hija riżorsa pubblika disponibbli għal kulħadd, li diġà qed tiġi wżata minn timijiet u żviluppaturi tal-Mozilla madwar id-dinja fil-proġetti tagħhom.
...
about-yes-votes-text = Sabiex tiżdied mal-ġabra tal-Common Voice, il-klip trid tiġi ċċekkjata minn żewġ utenti differenti.
