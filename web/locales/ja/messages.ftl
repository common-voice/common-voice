...
shortcut-discard-ongoing-recording-label = 録音中のデータを破棄
...
faq-what-cv-a =
    音声認識技術は私たちが機械と対話する方法に革命をもたらしていますが、現在利用可能なシステムは高価で独自のものです。Common Voiceは、誰もが音声認識技術をより良く、より利用しやすくするための Mozillaのイニシアチブの一部です。 Common Voice は、寄付された音声の大規模なグローバルデータベースで、誰でもすばやく簡単に音声対応アプリを潜在的にあらゆる言語でトレーニングできます。
    
    私たちは、広く話されている言語で音声サンプルを収集するだけでなく、話者の数がより少ない言語でもサンプルを収集しています。声の多様なデータセットを公開することは、開発者、起業家、そしてコミュニティがこのギャップに自分自身で取り組むことを可能にするでしょう。Common Voice データセットに加えて、私たちは Deep Speech と呼ばれるオープンソースの音声認識エンジンも構築しています。
faq-what-cv-a-2 =
    音声認識技術は私たちが機械と対話する方法に革命をもたらしていますが、現在利用可能なシステムは高価で独自のものです。Mozilla Common Voiceは、誰もが音声認識技術をより良く、より利用しやすくするためのイニシアチブです。 Common Voice は、寄付された音声の大規模なグローバルデータベースで、誰でもすばやく簡単に音声対応アプリを潜在的にあらゆる言語でトレーニングできます。
    
    私たちは、広く話されている言語で音声サンプルを収集するだけでなく、話者の数が少ない言語でもサンプルを収集しています。声の多様なデータセットを公開することは、開発者、起業家、そしてコミュニティがこのギャップに自分自身で取り組むことを可能にするでしょう。
faq-why-important-q = なぜ重要なのですか？
faq-why-important-a =
    音声は私たちがお互いに通信する最も自然な方法であることが多く、音声技術は私たちのコンピューターやモバイル機器にその便利さをもたらしています。リアルタイムの翻訳者や音声対応のデジタルアシスタントのような素晴らしい音声認識アプリケーションを開発者が構築できるようにしたいと思います。しかし、今のところ、この種のアプリを構築するために必要な音声データのほとんどは、高価で独自のものです。Common Voice データセットが開発者に彼らが革新するために必要なものを与えて、彼ら自身の言語で音声技術を利用可能にすることを願っています。
...
faq-what-cv-and-deepspeech-a = Common Voice データセットは、Mozilla のオープンソースの音声認識エンジンである Deep Speech を補完するものです。Deep Speech の最初のバージョンは 2017 年 11 月にリリースされ、それ以来ずっと進化し続けています。 Common Voice データセットと共に、このオープンソースの音声認識技術は誰にでも利用できます。これらの技術が開発者に革新的な製品とサービスの波を生み出すことを可能にすることが私たちの願いです。
...
faq-how-privacy-q = 声を寄付した人々の匿名性とプライバシーはどのように確保されますか？
faq-how-privacy-a = データセット内のすべての音声クリップには、個人を特定する情報が含まれています。投稿者が自分のプロファイルを介して統計データを提供すると、ダウンロード用のデータセットにバンドルされる前に、その情報が自分の音声クリップから匿名化され、自分のプロファイルページで公開されなくなります。
faq-what-determine-identity-q = Common Voice データセット内の話者の「身元情報を特定できない」とはどういう意味ですか？
faq-what-determine-identity-a =
    Common Voice データセットは、さまざまな音声対応アプリケーションのトレーニングに自由に利用できる公開リソースです。投稿者のセキュリティを保護するため、Common Voice データセットをダウンロードするすべての方に、投稿者のプライバシーを尊重するよう求めています。
    
    データセット内のすべての音声クリップは、個人を特定する情報が削除されます。データセットをダウンロードするとき、貢献者の身元を特定しようとしないことに同意が必要です。つまり、データセット内の情報を投稿者の個人情報にリンクしようとすることはできません。ただし、たとえば、データセット内の情報をデータセット内に既にある他の情報にリンクすることにより、データセットを使用して音声認識、話者認識、または他のアプリケーションをトレーニングできます。
...
about-no-votes-text = ユーザーが音声クリップを拒否すると、キューに戻ります。再度拒否された場合、音声クリップは Clip Graveyard に移動されます。
...
size-gigabyte = GB
size-megabyte = MB
confirm-no-identify = Common Voice データセット内の話者の身元を特定しようとしないことに <b>同意</b> してください。
...
report-ask = この文章にはどのような問題がありますか？
