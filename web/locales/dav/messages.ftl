...
yes-receive-emails = Hee, nidumienyi imeili. Nakunde nikaie nikimanya malagho gha ughu mradi ghwa Common Voice.
...
wall-of-text-second = Data iri ritumilwagha ni kampuni mbaha nderiko mwari kutumilwa ni w'andu w'engi. Daghesha iji ilagho jaghiria kudunga malaghio maw'ishi. Kwa huw'o dazoye mradi ghwa Common Voice, na ughu mpango ni ghow'ika w'orinyi w'utaalamu ghwa kompiuta kutambukilwa ni madedo, na w'andu w'ose w'idime kutumia ughu w'utaalamu kuseko na vighirio vingi.
show-wall-of-text = Endelia Kushoma
...
about-playbook-how-add-language-collecting-sentences-content-2 = Kwadima <sentenceCollectorLinkAdd>kuchuria sentensi ndineri</sentenceCollectorLinkAdd>, angu kwadima kujosa mafungu mabaa kuidia kwa Github</bulkImportDocsLink>. Ririkanya angu sentensi suti rikaie <licenseLink>CC0 (yaani ra w'andu w'ose)</licenseLink>, angu kwadima kuandik rako kumoni.
about-playbook-how-add-language-collecting-sentences-content-3 = <sentenceCollectorFragment>W'ona maza zima zaidi ra kutumbanya sentensi</sentenceCollectorFragment>.
...
error-content-503 = Saiti iw'uyagha kafwani koni. Kwa kumanya ghangi ghaw'oneka maw'ishi, ghenda aja <matrixLink>Matrix</matrixLink> angu ghenda <githubLink>GitHub</githubLink> andu <discourseLink>Discourse</discourseLink>, kumanye ngera w'atumii w'a saiti w'aripoti shida ingi.
error-code = Ikosa ja { $code }
