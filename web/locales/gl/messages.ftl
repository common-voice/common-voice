...
wall-of-text-first = A voz é natural, a voz é humana. Por iso estamos entusiasmados ao crear tecnoloxía usábel de voz para as máquinas. Para crear sistemas de voz, os desenvolvedores necesitan unha enorme cantidade de datos de voz.
wall-of-text-second = A maioría dos datos usados polas grandes compañías non están dispoñíbeis para a maioría das persoas. Pensamos que iso abafa a innovación. Por iso lanzamos Common Voice (Voz Pública), un proxecto para axudar á facer o recoñecemento de voz aberto e accesíbel para todos.
...
listen-paragraph = A validación dos fragmentos doados é igualmente importante para o obxectivo de Common Voice. Colla unha gravación e axúdenos a crear datos de voz abertos de calidade.
...
faq-do-want-native-a = Si, precisamente! Parte das expectativas con Common Voice é recoller tantos acentos diferentes como sexa posíbel de modo que os servizos de recoñecemento de voz funcionen igualmente ben para todos. Isto significa que as doazóns de falantes non nativos son particularmente importantes.
