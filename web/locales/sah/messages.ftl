...
email-not-public = Эһиги email адрескытын көрдөрбөппүт.
recordings-and-locale-public = Хас куолас суруттарбыккыт уонна ханнык тылларга барыларыгар көстөр.
username-optin-public = Пользователь аатын көстөр эбэтэр анонимнай оҥоруоххутун сөп
username-email-not-demographic = Эһиги пользовательгыт аата уонна email адрескыт публикацияламмыт дааннайдарга суох буолуохтара.
...
status-title = Проект уопсай статуһа: төһө ыраах тиийбиппитин көрүҥ!
...
profile-create-success = Бэркэ, профиль оҥоһулунна!
profile-close = Сап
why-demographic = Бу тоҕо улахан суолталаах?
...
download-form-email =
    .label = Email суруйуҥ
    .value = Махтал, биһиги сибээскэ буолуохпут.
