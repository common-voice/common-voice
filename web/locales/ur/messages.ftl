...
record-voice-wave = آواز لہر ریکارڈ کروائیں
...
avatar-clip-fact = یہ ایک طویل عرصہ سے قائم حقیقت ہے کہ پڑھنے والے کے صفحے کی سیٹنگ کو دیکھتے وقت پڑھنے کے قابل مواد سے انحراف ہوجائے گا۔
