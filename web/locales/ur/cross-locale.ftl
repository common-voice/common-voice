...
get-involved-form-title = { $lang } کی تازہ اپڈیٹس کے لئے سائن اپ کریں:
get-involved-email =
    .label = ای میل
...
get-involved-success-text = جیسے ہی مزید معلومات دستیاب ہوتی ہے ہم آپ سے رابطہ کریں گے۔
