...
speak-paragraph = Ձայնագրումը մեր բաց տվյալների հավաքածուի ստեղծման հիմնական փուլն է։ Շատերը կասեն, որ նաև առավել հաճելի մասն է։
speak-goal-text = Ձայնագրություն է արված
listen-subtitle = Օգնեք ստուգել ձայնագրությունները
listen-goal-text = Ձայնագրություն է ստուգված
hours-recorded = Ձայնագրված ժամեր
hours-validated = Ժամ է ստուգվել
...
dashboard = Վահանակ
build-profile = Ստեղծել պրոֆիլ
avatar = Ավատար
goals = Նպատակներ
settings = Կարգավորումներ
edit-profile = Փոփոխել պրոֆիլը
profile-create-success = Հիանալի է, ձեր պրոֆիլը ստեղծվեց։
profile-close = Փակել
why-demographic = Ինչի՞ է սա կարևոր
