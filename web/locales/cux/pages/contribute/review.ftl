...
sc-review-form-usage = Did deslizar to'o kuakud nichi a noó nudu. Did deslizar to'o kued nichi gua noó. Did deslizar ku ninu tumin cho'o tama nudu. ¡Gua kumjinud dicho'od revisión ne'ed!
# Variables:
#   $sentenceSource (Number) - Associated source the user filled out when uploading the sentence
sc-review-form-source = Fuente
...
sc-review-form-reviewed-message =
    { $sentences ->
       ...
       *[other] Nudu chi a noö. ¡Ndios nadibad!
    }
...
sc-criteria-modal = Criterios ñe'e nichi noó o gua noó
sc-criteria-title = Criterios ñe'e nichi noó o gua noó
...
sc-redirect-page-subtitle-1 = Sentence Collector jino'o no plataforma principal ñe'e Common Voice. Mniñu kadi kunejud ama nudu  o nichid nichi a noó o gua noó, dicho'od am ama nudu no Common Voice.
