...
wall-of-text-second = Bona parte de i dati uxà da ƚe grandi axiende no ƚa xe acesibilƚe a gran parte de ƚe persone. Secondo noialtri sto cua sofoca l’inovasion. Par sta raxon gavemo sviƚupà Common Voice, on progeto de riconosimento vocaƚe vèrto a tuti cuanti.
...
benefits = Vantaji
rich-data = Arichisci i dati invià fornendo alcune informasion demografiche anonime. Ste informasion le vien rimose prima de rendere publici i dati.
...
off = Dixativa
on = Ativa
avatar-clip-title = Dà na vose a el to avatar
change-your-avatar-clip = Vuto canbiare ƚa registrasion vocaƚe?
recording-in-progress = Registrasion en corso…
avatar-clip-recorded = Deso el to avatar ga na registrasion vocaƚe!
record-voice-wave = Registra ƚa to vose
retry-voice-wave-recording = RIPROVA
re-record = REGISTRA DE NOVO
delete-voice = SCANSEȽA
recording-voice-wave = In registrasion
delete-voice-clip = opure Scanseƚa registrasion
ready-to-upload = CARGA
avatar-clip-fact = Se sa da tenpo che mentre se xe drio lèxare cualcosa, se vien distrati da'l layout de na pàgina.
recreate-voice = Ricrea n’onda sonora
cancel-avatar-clip-recording = ANUȽA
about-avatar-clip-recording = Crea na registrasion vocaƚe cofà parte de'l profiƚo de'l to avatar. Altri utenti i poderà scoltare ƚa to registrasion movendo el mouse so ƚa to icona.
...
faq-why-10k-hours-a = El xe sirca el nùmaro de ore necesarie par adestrare on software de riconosimento vocaƚe.
faq-how-calc-hours-q = En che modo Common Voice calcoƚa ƚe ore?
faq-how-calc-hours-a = Calcolemo ƚe ore stimando ƚa lunghesa media de ogni registrasion e moltiplichemo cuel nùmaro par el nùmaro totaƚe de registrasion en tute cuante ƚe ƚengue.
...
about-listen-queue-text = Le registrasion ƚe vien caricà e inserìe en na coda de clip pronti par scoltare.
about-listen = Scolta
...
about-no-votes-text = Co on utente bocia na registrasion, ƚa torna ne ƚa Coa. Se la vien bocià na seconda volta, la vien trasferìa ne'l Cimitero de ƚe registrasion.
...
localization-explanation = El xe el proceso che traduxe e adata i contenudi par altre ƚengue.
sentence-collection = Rancura de fraxi
sentence-collection-explanation = Racojere fraxi de publico dominio o scriverne de nove soto licensa de publico dominio.
hours-recorded-explanation = El contegio de ƚe ore de registrasion vocaƚe che gavemo rancurà fin deso.
...
data-other-voxforge-description = VoxForge el xe sta creà apoxitamente par rancurare trascrisioni de detati da uxare ne i motori de riconosimento vocaƚe gratuiti e open source.
...
language-section-launched-description = Par ƚe seguenti ƚengue operative el sito web el xe stà conpletamente <localizationGlossaryLink>localixà</localizationGlossaryLink> e ƚa <phraseCollectionGlossaryLink>rancurede fraxi</sentenceCollectionGlossaryLink> el xe rivà a avere dimensioni suficienti da garantire suficiente materiaƚe da <speakLink>registrare</ speakLink> e <listenLink>scoltare</listenLink> en modo continuativo.
languages-show-more = Vixualixa pì eƚementi
languages-show-less = Visualixa manco eƚementi
...
goal-help-validation = Te ghe jutà Common Voice a rivare a <goalPercentage></goalPercentage> de'l traguardo de'l dì { $goalValue } par ƚe convaƚide.
...
report-ask = Che problemi sito drio riscontrare co sta fraxe?
report-offensive-language = Ƚenguagio ofensivo
report-offensive-language-detail = La fraxe utilixa on lenguajo irispetoso o ofensivo.
...
report-offensive-speech-detail = Ƚa registrasion uxa on linguagio irispetoso o ofensivo.
...
clips-you-validated = Registrasion che te ghe convalidà
todays-recorded-progress = Progreso de Common Voice de oncò so ƚe registrasion imese
todays-validated-progress = Progreso de Common Voice de oncò so ƚe registrasion convalidà
stats = Statisteghe
...
lose-goal-progress-warning = Se te modifeghi l’obietivo te poderisi perdare i atuali progresi.
