...
get-involved-text = Grasie par el to interese a contribuire ne ƚa lingua { $lang }. El nòstro conpito el xe pareciare tute ƚe ƚengue par el ƚancio e mantegnere axornà i vari team via email. Se te voi darne na man, inserisi ƚa to email cua soto.
get-involved-form-title = Registrate par risevere axornamenti so ƚa ƚengua { $lang }:
get-involved-email =
    .label = Email
