...
or = ఒడియా
pl = పోలిష్
pt-BR = పోర్ట్యుగీస్ (బ్రెజిల్లియన్)
ro = రొమానియన్
ru = రష్యన్
sk = స్లోవక్
sq = అల్బేనియన్
...
status-title = మొత్తం ప్రాజెక్ట్ స్థితి: మనము ఎంత దూరం వచ్చామో చూడండి!
status-hours =
    { $hours ->
