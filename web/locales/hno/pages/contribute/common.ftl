...
goal-help-recording = تساں کامن وائس کو <goalPercentage></goalPercentage>اسدے روز دے{ $goalValue }ریکاڈنگ دے ہدف تے { $goalValue }پہنچنڑا بچ مدد کیتی ہے۔
goal-help-validation = تساں کامن وائس کو <goalPercentage></goalPercentage>اسدے روز دے{ $goalValue }تصدیقی ہدف تے { $goalValue }پہنچنڑا بچ مدد کیتی ہے۔
contribute-more =
    { $count ->
        [one] ہور{ $count }کرنا واسطے تیارہو؟
       *[other] ہور{ $count }کرنا واسطے تیارہو؟
    }
speak-empty-state = اساں کول اس زبان بچ ریکارڈ کرنا واسطے جملے مُک گئے ہن۔۔۔۔
no-sentences-for-variants = ہو سکدا ہے تسدی زبان دا لہجہ جملیاں تو باہر ہوا۔ اگر تسں’ سکھی ہو، تسں دوسرے جملے اپنڑی زبان بچ دکھنا واسطے اپنڑی ترتیب بدلا ہکدے ہو۔
speak-empty-state-cta = جملے شامل کرو
speak-loading-error = اسیں تسدے بولنڑا واسطے کوئی جملہ نیں گھن ہکیاں۔بعد بچ دوبارہ کوشش کریو۔
record-button-label = اپنڑی آواز ریکارڈ کرو
...
request-language-text = حالاں تک کامن وائس تے اپنڑی زبان نیں دکھ ری؟
request-language-button = ہک زبان دی درخواست کرو
...
shortcut-vote-yes = ہاں
# Must be one letter that appears in the { vote-no } string.
# Must be different from { shortcut-skip }, { shortcut-vote-yes } and { shortcut-play-toggle }
shortcut-vote-no = ناں
...
contribution-reader-effects-title = پڑھنا والے دے اثرات
contribution-reader-effects-description = لوگاں دیاں زیادہ تر ریکارڈنگ انہاں دی قدرتی آواز بچ گلاں دیاں ہوندیاں ہن۔ تسیں کدی کدار غیرمیعاری ریکارڈنگ کو قبول کر سگدے ہو جڑی چیخنا، گوشا کرنا، یا ظاہری طورتے ‘ڈرامے’ دی آواز بچ ہے۔ براہ مہربانی گائی دی ریکاڈنگاں ہور جڑیاں کمپیوٹر دے استعمال نال ترتیب دتیا ہون کو رد کرو۔
contribution-just-unsure-title = صرف غیر یقینی؟
contribution-just-unsure-description = اگر تساں کو کوئی ہجی چیز ملدی ہے جس دا احاطہ اے ہدایات نیں کردیاں، تے براہ مہربانی فِر اپنڑے بہترین فیصلے دے مطابق وٹ دیو۔ اگر تسیں واقعی فیصلہ نہ کر ہکدے او، سکپ بٹن استعمال کرو تے اگلی ریکارڈنگ تے چلے جلو۔
see-more = <chevron></chevron>ہور دِکھو
see-less = <chevron></chevron>تھوڑا دِکھو
