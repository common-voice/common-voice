...
da = Ikinyadanemariki
de = Ikidage
dsb = Igisorube cy'epfo
dv = Ikimaridiviye/ Ikidivehi
el = Ikigereki
en = Icyongereza
eo = Ikesiperanto
es = Igihisipaniya
...
hours-validated = Amasaha yemejwe
voices-online = Amajwi ubu ari ku murongo wa murandasi.
todays-progress = Uko ibintu byifasha ubu.
help-reach-goal = Dufashe ku.....
read-terms-q = Wasomye amabwiriza yacu?
ready-to-record = Witeguye gutanga ijwi ryawe?
all-locales = Byose
today = None/ uyu munsi
x-weeks-short =
    { $count ->
        [one] Icyumweru kimwe
       *[other] Ikindi cyumweru
    }
x-months-short =
    { $count ->
        [one] Kimwe
...
benefits = Urwunguko
rich-data = Oherezanya imbonwa zawe hamwe n'andi makuru mbarurishamibare yose ya ngombwa yawe bwite. Tubanza kuyagenzura mbere yo kuyashyira ahagaragarira buri wese.
improve-audio = Amakuru arebana n'utanga amajwi atuma imbonwa z'amajwi zikoreshwa mu kwimenyereza kumenya ukubonera kw'imvugo zinozwa.
keep-track = Komeza ugenzure uko ibyo ukora bigenda mu ndimi nyinshi.
compare-progress = Reba uko ibyo ukora bitera indi ntambwe ugereranyije n'abandi batanga umusanzu mu isi hose.
view-goals = Garagaza uko ibyo ukora bigenda ku bwawe cyangwa ugereranyije n'ibyo umushinga ugamije.
join-newsletter = Ushobora kongeraho urutonde rwa imeri yacu kugira ngo ubone amakuru mashya arebana n'umushinga.

## What's public

whats-public = Ni iki Rusange?
email-not-public = Ntituzagira rusange imeri yawe.
...
email-to-download = Shyiramo imeri kugira ngo umanure
why-email = Kuki imeri ari ngombwa? Tuzakenera kukubaza ibyahindutse ku ikusanyirizo ry'imbonwa, bityo imeri ikaba inzira yo kukugeraho.
confirm-size = Witeguye gutangira kumanura ....
size-gigabyte = Jigabayiti
size-megabyte = Megabayiti
confirm-no-identify = Wemeye ko utazagerageza kumenya irangamimerere ry'abavuze batanga amajwi mu ikusanyirizo ry'imbonwa rya porogaramu y'Ijwi Rusange.
download-language = Manura
validated-hours = Amasaha yemejwe
recorded-hours = Amahasa y'amajwi yafashwe
whats-inside = Mu ikusanyirizo ry'imbonwa rya porogaramu y'Ijwi Rusange harimo iki?
dataset-description-hours = Buri kintu kiri mu ikusanyirizo ry'imbonwa z'amajwi kigizwe n'ijwi ryafashwe n'idosiye yumwandiko waryo. Menshi mu masaha y'ibyafashwe ari mu ikusanyirizo ry'imbonwa na yo arimo amakuru bwite nk'imyaka, igitsina n'imvugo y'umuntu bishobora gufasha gutoza imashini ntahurajwi kuboneza neza.
want-dataset-update = Ukenera amakuru mashya y'ibyakozwe buri gihe twasohoye ubwoko bushya bw'ikusanyirizo ry'imbonwa z'amajwi rya porogaramu y'Ijwi Rusange? Iyandikishe ku kanyamakuru kacu.
