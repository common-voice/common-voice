...
read-terms-q = Қолланыў шәртлеримизди оқыдыңыз ба?
all-locales = Ҳәммеси
today = Бүгин
x-weeks-short =
    { $count ->
...
email-not-public = Биз сизиң электрон почтаңызды жәрияламаймыз.
username-email-not-demographic = Сизиң пайдаланыўшы атыңыз ҳәм электрон почтаңыз жәрияланатуғын мағлыўматлар менен байланыстырылмайды.
...
about-listen = Тыңлаң
about-is-it-valid = Клип дурыс па?
about-yes-votes = ≥ 2 "Аўа" даўыс
about-no-votes = ≥ 2 "Яқ" даўыс
about-dataset-new = Common Voice мағлыўматлар топламы
about-get-involved = Қатнасыў
about-stay-in-touch-button = Дизимнен өтиў
about-nav-why-common-voice = Не ушын?
about-nav-how-it-works = Қалайынша?
about-nav-partners = Сериклер
...
about-playbook-how-localize = Сайтты локализациялаў қалай ислейди?
about-playbook-how-localize-content-1 = Common Voice сайтын аўдарыў <strong>Pontoon</strong> арқалы әмелге асырылады.
about-playbook-how-localize-content-5 = Жәрдем ушын, бизиң түсиндирме видеомызды көриң

## How to add sentences

about-playbook-how-add-sentences = Мне қалай гәплерди қосыўым мүмкин?

## How to record quality

about-playbook-how-record-quality = Жоқарғы сападағы клипти қалай жазып алыўым мүмкин?
about-playbook-how-record-content-2 = Ҳәдден зыят сыртқы шаўқымнан сақланың — сизди еситиў аңсат болыўы керек.
