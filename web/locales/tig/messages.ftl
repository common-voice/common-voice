...
return-to-cv = ዲብ Common Voice ኣቅብሉተ
email-input =
    .label = ኢሜል
submit-form-action = ኣቅርብ
loading = ሊሸሕን ህላ
email-opt-in-info = ኢሜላተ እግለ ለምጽአኒ ሓዘ ከምስል ናይ ሃደፍ ላለአዝክር, ው ከምስልሁማ  ናይ ተጣውርየ, ው ኣኽባር ናይ Common Voice.
email-opt-in-info-title = ዲብ ቃኢመት ኢሜል ናይ Common Voice ተሓበሮ
email-opt-in-info-sub-with-challenge = ኢሜል ከበት ከምሰል ናይ ታሓዲ ሃደፍ ላለአዝክር ው ናይ ተጣውርየ ው ናይ ኣኽባር Common Voice.
...
about-yes-votes-text = ናይ ሶት ክሊፕ ዲብ መጅሙዓት ባያናት Common Voice እግል ትእተ አብ ክልኦት ሙስተኽድሚን ትትሓቀቀ ባ
...
about-clip-graveyard-text = Clip Graveyard ናይ ሶት ክሊፕ ዲብ Common Voice ማጅሙዓት ባያናት ለይኣተት ትፃብጥ ዎ ክምሰልላ ብዕድ ማጅሙዓት ባያናት እግል ልትከራረ ቃድር
...
size-gigabyte = GB
size-megabyte = MB
confirm-no-identify = ዲብ ባያናት ናይ Common Voice ሃውየት ናይ ሙሳህም ግል ታእምር ግል ኢትጀርብ <b>ትዋፍቅ</b>
