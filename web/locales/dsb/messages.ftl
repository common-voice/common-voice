...
language-section-launched-new-description = Za toś te aktiwěrowane rěcy jo se websedło wuspěšnje pśełožyło,  a ma dosć zezběranych sadow, aby zmóžniło stawne sobuźěło pśez <italic>powědanje</italic> a <italic>słuchanje</italic>.
