...
wall-of-text-more-desktop = Sasa unaweza kuchangia sauti yako kwa kutusaidia kutengeneza chanzo-wazi cha hifadhi ya sauti ili mtu yeyote atumie kutengeneza programu bunifu kwa vifaa na mtandao. Soma sentensi kusaidia mashine kujifunza jinsi watu wanavyoongea. Angalia kazi za wachangiaji wengine kuendeleza ubora. Ni rahisi!
...
wall-of-text-second = Kiasi kikubwa cha data kinachotumika na makampuni makubwa haipatikani kwa watu wengi. Tunafikiri kuwa hili ni pingamizi kwa uvumbuzi. Kwa hivyo tumeanzisha mradi wa Common Voice ili kusaidia kutengeneza (teknolojia ya) utambuzi wa sauti na kupatikana kwa kila mtu.
