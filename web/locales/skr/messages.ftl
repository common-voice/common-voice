...
email-opt-in-privacy-v2 =
    ای میلاں وصول کرݨ دی چوݨ نال تساں ایہ بیاں ݙیندے پئے ہوسو جو 
     تساں موزلا دی  <privacyLink>رازداری پالیسی</privacyLink> دی تفصیل دے مطابق انہاں معلومات بارے موزلا دے اختیارات نال متفق ہو۔
