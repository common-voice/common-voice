...
wall-of-text-first =
    آواز فطری ہے ، آواز انسان ہے۔ ایں کیتے اساں آپنی مشیناں   کیتے قابل  استعمال وائس  ٹیکنالوجی  پیدا کرݨ وچ پرچوش ہیں۔
     پر وائس  سسٹم  بناوݨ کیتے ڈیویلپراں کوں ہک ٻہوں مقدار وچ آواز  ڈیٹا  دی ضرورت ہے.
wall-of-text-second =
    وݙیاں کمپنیاں دے زیر استعمال زیادہ تر ڈیٹا لوکاں دی اکثریت کوں دستیاب کائنی تھیندا۔ اساں سوچیندے ہیں
    جہڑا اختراع کوں دبیندے۔ ایں سانگے اساں کامن وائس منصوبہ شروع کیتا ہے، آواز بݨاوݨ دی مدد کیتے منصوبہ
