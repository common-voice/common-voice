...
sentence =
    .label = Cümle
sentence-input-placeholder = Kamu malı cümlenizi buraya yazın
small-batch-sentence-input-placeholder = Kamu malı cümlelerinizi buraya yazın
...
sc-review-small-batch-title = Birden çok cümle nasıl eklenir?
...
small-batch-sentence-submission = Küçük miktarda toplu cümle gönderimi
bulk-sentence-submission = Toplu cümle gönderimi
single-sentence = Tek cümle
small-batch-sentence = Küçük miktar
bulk-sentence = Büyük miktar
