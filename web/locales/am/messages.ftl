...
sc-howto-cite-item-1 = ድህረ ገጹን ለምሳሌ "የጋራ ልሳን - https://commonvoice.mozilla.org/" ማካተት ይችላሉ።
sc-howto-cite-item-2 = የአካዳሚክ ማመሳከሪያ ዘይቤን መጠቀም ይችላሉ፣ ለምሳሌ የሃርቫርድ ስታይል "Mozilla (2021) Common Voice. Available at https://commonvoice.mozilla.org/ (Accessed: 15th September 2021)"
...
community-announcement-header = የማህበረሰብ ማስታወቂያ!
community-announcement-explanation = ከታች ያለው መመሪያ ለአዲሱ ዓረፍተ ነገር ሰብሳቢ ባህሪያት ነው፣ እሱም በመጋቢት እና ሚያዚያ 2023 በሙሉ ወደ ዋናው የጋራ ልሳን መድረክ ይዋሃዳል። እስከዚያው ግን የቀደመውን መሳሪያ <scLink>https://commonvoice.mozilla.org/sentence-collector/</scLink>መጠቀም ይችላሉ።
# WRITE PAGE
write-instruction-second-part = የሕዝብ ጎራ ዓረፍተ-ነገር
