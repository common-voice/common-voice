...
# BULK SUBMISSION 
sc-bulk-upload-instruction-first-part = ጫን
sc-bulk-upload-instruction-second-part = የሕዝብ ጎራ ዓረፍተ-ነገሮች
drag-your-file-here = ለመጫን ፋይልዎን ወደዚህ ይጎትቱት
drop-file-here = ለመጫን ፋይልዎን እዚህ ጣል ያድርጉ
