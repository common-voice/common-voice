...
voices-online = Hetkel hääli saidil
todays-progress = Tänased edusammud
...
keep = Säilita
remove = Kustuta
keep-info = Sinu anonüümsed helisalvestised jäävad Common Voice'i andmekogumisse. Kui oled oma profiili kustutanud, ei saa sa enam esitada taotlust enda salvestiste andmekogumist eemaldamiseks.
remove-info = Me vaatame läbi sinu taotluse enda häälesalvestiste andmekogumist eemaldamise kohta. Kui su taotlus on heaks kiidetud, võtame ühendust ka nendega, kes on andmekogumi alla laadinud, ning nõuame neilt su häälesalvestiste eemaldamist.
why-delete-recordings =
    Common Voice salvestusi kasutavad akadeemikud, väikeettevõtted ja kõnetuvastuse harrastajad, et aidata luua ja parendada avalikult kättesaadavaid ressursse, nagu häälmudelid.
