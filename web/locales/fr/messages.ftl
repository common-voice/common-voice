...
clips = extraits
goal-type-record = enregistrements
goal-type-validation = validations
toward-goal = C’est <goalPercentage></goalPercentage> de l’objectif { $goalType } quotidien de Common Voice. Merci
goal-help-specific = Grâce à vous, Common Voice a atteint <goalPercentage></goalPercentage> de son objectif quotidien de { $goalValue } { $goalType } !
