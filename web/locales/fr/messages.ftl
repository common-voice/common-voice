...
record-again-instruction2 = Continue comme ça et enregistres-en un de plus.
record-last-instruction = <checkIcon></checkIcon> C’est le dernier !
review-tooltip = Vérifier et ré-enregistrer au besoin
unable-speak = Impossible de parler en ce moment
review-instruction = Examine et ré-enregistre si nécessaire
...
listen-instruction = { $actionType } <playIcon></playIcon> Est-ce que la phrase était correctement prononcée ?
