...
splits = Разбіўка
email-to-download = Пазначце эл.пошту для спампоўкі
why-email = <b>Навошта электронная пошта?</b> Магчыма, у будучыні нам спатрэбіцца звязацца з вамі наконт зменаў у наборы дадзеных, і пошта дапаможа гэта зрабіць.
confirm-size = Вы гатовы ініцыяваць спампоўку <b>{ $size }</b>
size-gigabyte = ГБ
size-megabyte = МБ
confirm-no-identify = <b>Вы пагаджаецеся</b> не спрабаваць вызначыць асобы прамоўцаў у наборы дадзеных Common Voice
...
clips-uploaded = Кліпаў загружана
