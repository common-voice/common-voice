...
demographic-deidentified-clarity = Дэмаграфічныя звесткі, не абавязковыя для дасылання (напрыклад, узрост, пол, мова і яе рэгіянальны варыянт) ніколі не будуць публікавацца ў вашым профілі і не будуць звязвацца з вашым акаўнтам у наборы дадзеных. Да асобных аўдыёзапісаў будзе далучацца дэмаграфічная інфармацыя для больш дакладнага аналізу, напрыклад, на той выпадак, калі даследчык захоча натрэніраваць мадэль для пэўнага дэмаграфічнага сегмента.
...
why-demographic-explanation = Ананімізаваныя звесткі пра карыстальніка, такія як узрост, пол і рэгіянальны варыянт мовы, дапамогуць палепшыць аўдыёдадзеныя, на якіх трэніруюцца праграмы распазнавання маўлення. Вашыя імя карыстальніка і адрас электроннай пошты ніколі не будуць звязвацца з дадзенымі, якія вы дасылаеце, і вы можаце самі выбраць, ці зрабіць імя карыстальніка публічным.
...
faq-why-important-a =
    Маўленне – часта самы натуральны сродак узаемадзеяння паміж людзьмі, і галасавыя тэхналогіі надзяляюць гэтай выгодай таксама нашыя камп'ютары і мабільныя дэвайсы. Мы хочам даць магчымасць распрацоўшчыкам ствараць файныя прылады з функцыяй распазнавання маўлення, кшталту сінхронных перакладчыкаў і лічбавых памочнікаў з падтрымкай голасу. Але на сённяшні дзень большасць галасавых дадзеных, патрэбных для стварэння такіх прылад, з'яўляюцца дарагімі і прапрыетарнымі. Мы спадзяемся, што набор дадзеных Common Voice дасць распрацоўшчыкам тое, што ім трэба для інавацый і ўкаранення тэхналогій маўлення на іх родных мовах.
    
    Каб зрабіць распазнаванне маўлення яшчэ больш універсальным, мы збіраем узоры галасоў не толькі на шырока распаўсюджаных мовах, але і на мовах, якія горш падтрымліваюцца камерцыйнымі сервісамі распазнавання маўлення з-за меншай колькасці носьбітаў. Публікацыя разнастайнага набору галасавых дадзеных дапаможа праграмістам, прадпрымальнікам і цэлым моўным супольнасцям самастойна ліквідаваць гэты недахоп.
...
faq-is-goal-assistant-a = Мэта набору дадзеных Common Voice – дазволіць кожнаму ў свеце ствараць прылады з функцыяй распазнавання маўлення, распазнавання асобы таго, хто гаворыць, альбо з іншай функцыянальнасцю, якая патрабуе галасавых дадзеных. Галасавы памочнік – гэта толькі адзін са шматлікіх тыпаў прылад, для стварэння якіх вы можаце выкарыстаць наш набор дадзеных.
...
faq-why-my-lang-new-a = Mozilla не аддае перавагу ніводнай з моў. Наадварот, Common Voice – гэта цалкам добраахвотная ініцыятыва супольнасцей, але трэба зрабіць <multilangLink>некалькі крокаў, каб дадаць новую мову</multilangLink> і пачаць збіраць ахвяраваныя галасы. Па-першае, трэба перакласці сайт Common Voice, каб удзельнікі супольнасці маглі працаваць з сайтам на сваёй мове. Па-другое, трэба мець вялікую калекцыю свабодных ад капірайту сказаў, каб людзі маглі агучваць іх. Як толькі абодва гэтыя патрабаванні будуць задаволеныя, мова "стартуе" на Common Voice, і ўдзельнікі могуць пачаць запісваць свае галасы і правяраць чужыя ахвяраванні. Калі вы хочаце дапамагчы, каб новая мова стартавала, пачніце з нашай <sentenceCollectorLink>прылады для збору сказаў</sentenceCollectorLink>.
...
about-partnership =
    Common Voice – гэта сумесны праект, і мы не можам абысціся без супольнасці нашых партнёраў і ўдзельнікаў, каб пабудаваць самы вялікі ў гісторыі адкрыты набор галасавых дадзеных.
    
    Мы хочам падзякаваць наступным людзям і арганізацыям за іх дапамогу:
...
mycroft-secondary-description = Гэта праграмнае забеспячэнне з адкрытым зыходным кодам, якое можна свабодна мадыфікаваць, пашыраць і паляпшаць. Mycroft можа быць выкарыстаны паўсюль, ад навуковых праектаў да энтэрпрайзных прылад.
