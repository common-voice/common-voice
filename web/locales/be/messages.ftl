...
faq-why-important-a =
    Маўленне – часта самы натуральны сродак узаемадзеяння паміж людзьмі, і галасавыя тэхналогіі надзяляюць гэтай выгодай таксама нашыя камп'ютары і мабільныя прылады. Мы хочам даць магчымасць распрацоўшчыкам ствараць файныя праграмы з функцыяй распазнавання маўлення, накшталт сінхронных перакладчыкаў і лічбавых памочнікаў з падтрымкай голасу. Але на сённяшні дзень большасць галасавых дадзеных, патрэбных для стварэння такіх праграм, з'яўляюцца дарагімі і прапрыетарнымі. Мы спадзяваемся, што набор дадзеных Common Voice дасць распрацоўшчыкам тое, што ім трэба для інавацый і ўкаранення тэхналогій маўлення на іх родных мовах.
...
faq-why-mission-a = Mozilla прыкладае ўсе намаганні, каб падтрымліваць Інтэрнэт адкрытым і даступным для кожнага. Каб рабіць гэта, мы мусім узмацніць стваральнікаў Сеціва з дапамогай такіх праектаў, як Common Voice. Сфера ўжытку маўленчых тэхналогій пашыраецца, і мы верым, што яны павінны ў роўнай ступені служыць усім карыстальнікам. Гэта патрабуе інвеставаць у большую колькасць моў і прыстасоўвацца да разнастайных маўленчых і дэмаграфічных асаблівасцей падчас распрацоўкі і тэсціравання тэхналогій. Common Voice – гэта публічны рэсурс, даступны для кожнага, і каманды Mozilla, а таксама распрацоўшчыкі з усяго свету ўжо выкарыстоўваюць яго ў сваіх уласных праектах.
...
sc-my-no-sentences = Сказаў не знойдзена
# Variables:
#   $batchId (String) - A unique ID identifying the submission of sentences - sentences uploaded together all have the same batch ID
sc-my-submission = Адпраўка: { $batchId }
# Variables:
#   $source (String) - Associated source the user filled out when uploading the sentence
sc-my-source = Крыніца: { $source }
sc-my-delete = Выдаліць выбраныя сказы
