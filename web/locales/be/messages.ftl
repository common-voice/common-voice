...
contribution-varying-pronunciations-description-extended = З іншага боку, калі вы лічыце, што чытач напэўна ніколi раней не сустракаў слова, і проста зрабіў няправільную здагадку наконт вымаўлення, калі ласка, адхіліце кліп. Калі вы няўпэўненыя, скарыстайцеся кнопкай пропуску.
...
contribution-reader-effects-description = Большасць запісаў - гэта людзі, якія размаўляюць сваім звычайным голасам. Вы можаце прыняць выпадковыя нестандартныя запісы, дзе чытач крычыць, шэпча, або відавочна перадае напiсанае "драматычным" голасам. Калі ласка адхіляйце праспяваныя запісы, або запісы, якія выкарыстоўваюць голас сінтэзаваны камп'ютарам.
contribution-just-unsure-title = Проста не ўпэўненыя?
contribution-just-unsure-description = Калi вам трапілася нешта не апісанае ў гэтых інструкцыях, калі ласка галасуйце адпаведна вашаму меркаванню. Калі вы сапраўды не можаце вырашыць, націсніце на кнопку пропуску і пераходзьце да наступнага запісу.
