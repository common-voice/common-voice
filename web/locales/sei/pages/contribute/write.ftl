...
write = Insaaspoj aha
write-instruction = Icaaitom pocooo ihaaht ocoaaj pac ano nsiiquim aha <icon></icon>
write-page-subtitle = Icaaitom hant hizac an hant coii quih icaaitom ihmaa hant z an hant coii cöispaho hac miizj hant tap ma iiqui hapacatx cc-0 pac haa toii ma, quiicot soii caha.
sentence =
    .label = Icaaitom
sentence-input-placeholder = Icaaitom pocooo ihaht ocoaaj inyaaspoj quih hizaax an hant insiiquim aha
small-batch-sentence-input-placeholder = Icaaitom pocooo ihaht ocoaaj inyaasipl quih hizaax an hant insiiquim aha
...
new-sentence-rule-1 = <noCopyright>Caasopoj quij pocooo cöisiiht hac miizj ta ma, iiqui ocatx iha</noCopyright> (<cc0>cc-0</cc0>)
new-sentence-rule-2 = Icaaitom spaspoj ca coi, icaaitom quih iij caahjoj quih 15 quih hant iicp copa an icoii quiya ha
...
try-upload-again = Haptco mos ipaai isoocta ah, archivo quih hizac iiqui nsqueetx aha
