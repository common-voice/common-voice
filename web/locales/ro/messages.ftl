...
report-bugs-link = Ajută-ne să raportăm probleme
logout = Deconectare
...
data-subtitle = Construim un set de date de voci, deschis și disponibil în domeniul public, pe care îl poate folosi oricine ca să antreneze aplicații cu acționare vocală.
