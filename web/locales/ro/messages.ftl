...
status-hours =
    { $hours ->
        [one] { $hours } oră validată până acum!
        [few] { $hours } ore validate până acum!
       *[other] { $hours } de ore validate până acum!
    }
# Variables:
...
faq-when-release2-a = Versiunea multilingvă a setului de date Common Voice este în prezent în curs de grupare și curățare de către comunitate. Dacă vrei să ne ajuți să aducem limbi noi în Common Voice, accesează <sentenceCollectorLink>Unealta de colectare de fraze</sentenceCollectorLink> și adaugă propoziții noi în setul de date și intră pe Mozilla <pontoonLink>Pontoon</pontoonLink> pentru traducerea site-ului web propriu-zis. Când au fost colectate 5000 de propoziții aprobate, noi limbi sunt adăugate în Common Voice pentru contribuții vocale.
...
faq-what-quality-q = Ce nivel de calitate audio este necesar pentru ca o secvență vocală să fie folosită în setul de date?
faq-what-quality-a = Vrem ca setul de date Common Voice să reflecte calitatea audio cu care un motor de recunoaștere vocală se va confrunta în realitate, așa că vrem varietate. În plus față de diversitatea comunității de vorbitori, un set de date cu o calitate audio variabilă va ajuta motorul de recunoaștere vocală să învețe să gestioneze variate situații din lumea reală, de la vorbire în fundal până la zgomote de autovehicule. Atât timp cât secvența ta vocală este inteligibilă, înseamnă că este suficient de bună pentru adăugare în setul de date.
...
about-listen-text = Utilizatorii validează acuratețea secvențelor vocale donate, verificând faptul dacă vorbitorul citește propoziția corect.
about-is-it-valid = Secvența este validă?
about-is-it-valid-text = O secvență vocală este marcată cu „validă” când un utilizator îi acordă un vot de Da.
about-yes-votes = ≥ 2 voturi de Da
about-yes-votes-text = Pentru a ajunge în setul de date Common Voice, o secvență vocală trebuie validată de doi utilizatori diferiți.
about-no-votes = ≥ 2 voturi de Nu
about-no-votes-text = Când un utilizator respinge o secvență vocală, aceasta reintră în Coadă. Dacă este respinsă a doua oară, secvența este mutată în Cimitirul de secvențe vocale.
...
about-clip-graveyard = Cimitir de secvențe vocale
...
common-voice-info-new = Ai întrebări despre Common Voice? Idei de îmbunătățire sau feedback despre o limbă anume? Intră pe <discourseLink>forumul Discourse</discourseLink> și spune-ne.
...
select-language = Selectează o limbă...
other-language = Altă limbă
...
language-section-launched-description = Pentru aceste limbi lansate, site-ul web a fost <localizationGlossaryLink>localizat</localizationGlossaryLink> cu succes și are suficiente <sentenceCollectionGlossaryLink>propoziții colectate</sentenceCollectionGlossaryLink> pentru a permite contribuții curente de <speakLink>Vorbire</speakLink> și <listenLink>Ascultare</listenLink>.
...
todays-validated-progress = Progresul de astăzi pe Common Voice pentru secvențe vocale validate
stats = Statistici
awards = Premii
you = Tu
...
recorded-clips = Secvențe vocale înregistrate
validated-clips = Secvențe vocale validate
total-approved = Total aprobate
overall-accuracy = Acuratețe generală
set-visibility = Setează-mi vizibilitatea
visibility-explainer = Această setare controlează vizibilitatea ta în clasament. Când este ascunsă, progresul tău va fi privat. Înseamnă că imaginea ta, numele tău de utilizator și progresul nu vor apărea în clasament. Reține că sunt necesare ~{ $minutes }min pentru actualizarea clasamentului cu popularea modificărilor.
visibility-overlay-note = Notă: Când este setată pe „Vizibil”, această setare poate fi modificată din <profileLink>Pagina de profil</profileLink>
...
share-n-daily-contribution-goal = Partajează-ți { $count } Obiectivul de înregistrări zilnice pentru { $type }
# $type is one of share-goal-type-*
share-n-weekly-contribution-goal = Partajează-ți { $count } Obiectivul de înregistrări săptămânale pentru { $type }
share-goal-type-speak = Se vorbește
share-goal-type-listen = Se ascultă
share-goal-type-both = Vorbire și ascultare
# LINK will be replaced with the current URL
goal-share-text = Tocmai am creat un obiectiv personal de donații de voce pentru #CommonVoice -- vino alături de mine și hai să ajutăm să învățăm mașinile cum vorbesc oamenii reali { $link }
