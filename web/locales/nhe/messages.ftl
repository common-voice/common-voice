...
error-clip-upload-server = La carga de este clip sigue fallando en el servidor. Vuelve a cargar la página o vuelve a intentarlo más tarde.
...
how-many-per-day = ¡Excelente! ¿Cuántos clips por día?
how-many-a-week = ¡Excelente! ¿Cuántos clips a la semana?
which-goal-type = ¿Quieres hablar, escuchar o ambos?(masculino)
...
share-goal-type-speak = Discurso
share-goal-type-listen = Escuchando
share-goal-type-both = Hablando y escuchando
weekly-goal-created = Tu objetivo semanal ha sido creado
daily-goal-created = Tu objetivo diario ha sido creado
...
delete-q = ¿Le gustaría solicitar que también se eliminen sus grabaciones de voz o prefiere mantenerlas en el conjunto de datos de Common Voice?
keep = Mantener
remove = Eliminar
