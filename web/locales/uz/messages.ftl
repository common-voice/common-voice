...
confirm-size = <b>{$size}</b> hajmdagi ma'lumotlarni yuklab olishga tayyorman 
size-gigabyte = GB
size-megabyte = MB
confirm-no-identify = Common Voice ma'lumotlar to'plamidagi gapirganlar shaxsini aniqlashga urinmaslikka <b>rozilik bildiraman</b> 
download-language = { $language } tilini yuklab olish
