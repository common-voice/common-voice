...
yes-receive-emails = Daa, saattõka millõ epošti. Я хочу быть в курсе новостей проекта Common Voice.
...
home-title = Common Voice — kase on Mozilla duumõ, kui mašina õppõb kastõ, ku inimin jõka päive pajatõb.
...
listen-subtitle = Avittaga meill löütä õikad ääned
...
voices-online = Äänte paraikaa onlainiz
...
status-hours =
    { $hours ->
       ...
       *[other] Пока проверено { $hours } часа!
    }
# Variables:
...
create-voice-wave = Создать приветствие
...
about-avatar-clip = Создайте собственное приветствие. Другие пользователи смогут прослушать его.
...
faq-what-is-cv = Mikä on Common Voice?
...
about-become-a-partner = Стать партнёром
about-partnership =
...
mycroft-secondary-description = Это программное обеспечение с открытым исходным кодом, которое можно свободно изменять, расширять и улучшать. Mycroft может использоваться в любой отрасли, от научного проекта до корпоративного программного обеспечения.
...
deepspeech-info = Набор данных Common Voice дополняет открытый движок распознавания речи Deep Speech от Mozilla, который вы можете использовать при создании своих приложений. Прочитайте наш <githubLink>обзор на GitHub</githubLink> или присоединитесь к <discourseLink>разделу DeepSpeech на форуме Discourse</discourseLink>, чтобы узнать, как начать работу.
