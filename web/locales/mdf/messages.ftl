...
sc-criteria-item-5-2 = Кда валрисьмось тиф критериятнень вяре каршес, люпштак &quot;Ёрдамс&quot; тяштенять кержи ширеса. Кафтолдондярят - нолдак сонь вакска, мольхть сай валрисьмонди.
