...
faq-why-important-a =
    Axaftin bi gelemperî awayê herî xwezayî ye ku em pê bi hev re têkiliyê datînin û teknolojiyên dengî vê rehetiyê digihînin komputer û amûrên me yên mobîl. Em dixwazin pêşdebiran bi hêz bikin ku dikaribin sepanên newaze yên naskirina dengêan yn wekş wergêrên hevdem û arîkarên dîjîtal ên xwedan deng ava bikin. Lê niha piraniya daneyên dengî ji bo avakirina van celeb sepanan hewce dikin biha ne û taybet ine. Em hêvîdar in ku koma daneyan ya Common Voiceê dê tişta pêwîst bide pêşdebiran ku tiştên nû çêkin û dikaribin teknolojiya naskirina dengan ji bo zimanên xwe pêşkêş bikin.
    
    Ji bo ku naskirina dengan hê gerdûnîtir be, em nimûneyên dengan yên bi zimanên pir tên axaftin û her wisa yên bi zimanên pir nayên axaftin û xizmetên naskirina dengan yên bazirganî wan ji nedîtî ve tên jî berhev dikin. Weşandina daneyên dengî yên cur bi cur dê pêşvebiran, muteşebisan û civakan han bide ku vê valahiyê dagirin
...
faq-is-goal-assistant-a = Armanca koma daneyan ya Common Voiceê ev e ku li cîhanê her kes dikaribe sepanên naskirina dengan, yên naskirina axêveran yan jî her seoaneke jê re daneyên dengan divên çêke. Sepana asîstana dengî seoanek ji gelek sepanên din e ku mirov dikare bi alkariya koma daneyan ava bike.
...
listen-instruction = Li îkona <playIcon></playIcon>'ê { $actionType }. Hevok rast hatiye xwendin?
...
speak-empty-state = Ji bo tomarkirinê, di vî zimanî de hevok neman...
...
report-different-language-detail = Ew Ji zimanê ku pê diaxivim cudatir bi zimanekî hatiye nivîsandin.
report-difficult-pronounce = Bilêvkirina wê zehmet e
report-difficult-pronounce-detail = Di nav wê de peyv an jî hevokên ku xwendin û bilêvkirina wan zehmet e, hene.
report-offensive-speech = Axaftina êrîşkar
report-offensive-speech-detail = Klîba dengî xwedî zimanekî bêhurmet an jî êrîşkar e.
...
why-delete-recordings =
    Tomarên Common Voiceê ji hêla akademisyen, karsaziyên piçûk, û meraqdarên dengnasînê ve têne bikaranîn da ku alîkariya rahênan û mezinbûna çavkaniyên anonîm ên wekî modelên dengî, bikin.
