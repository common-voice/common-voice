...
small-batch-sentence-input-placeholder = یاستہ عوامی جملہ آنی اتیو شعݩ
citation-input-placeholder = توستہ جملہ ستہ وسائلہ ستہ حوالہ پرہ(ضروری)
citation =
    .label = حوالہ
sc-write-submit-confirm = اوزہ تصدیق کوتوم اینہ جملہ<wikipediaLink>عوامی ڈومین اسہ</wikipediaLink>او ایݩ اینا پالو تستہ کہ اجازت اسہ
sc-review-write-title = اوزہ گجی جملہ سنالوم؟
sc-review-small-batch-title = سکال جملہ کائی کہ سنا ستہ آئی
new-sentence-rule-1 = <noCopyright>کائی حق اشاعت نہ آئی</noCopyright>ڈن(<cc0>سی سی</cc0>)
