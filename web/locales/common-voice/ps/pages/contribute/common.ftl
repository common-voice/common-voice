...
no-sentences-for-variants = ستاسو د ژبې توپیر ممکن د جملو څخه بهر وي! که تاسو آرام یاست، تاسو کولی شئ خپل ترتیبات بدل کړئ ترڅو په خپله ژبه کې نورې جملې وګورئ.
...
change-preferences = غوره‌توبونه بدلول
login-signup = ننوتنه/ نوملیکنه
vote-yes = هو
vote-no = نه
datasets = اومتوک‌ټولگې
languages = ژبې
about = په اړه
partner = ملگری
