...
banner-error-slow-1 = خپہ مُو ہو۔ کامن وائیس سٞمسو چٞلنت۔ چھیں دلچسپی ایں ماٞربینی۔
banner-error-slow-2 = مٞہ باٞر رش حصول کٞرنت تے مٞہ حلٞن اِیں مسئلیں تفتیش کٞرنت۔
banner-error-slow-link = سٹیٹس آں پال
error-something-went-wrong = خپہ مُو ہو ،پرہ کیشکٞہ مسئلہ یات۔
error-clip-upload = اِی کلپ آں اپلوڈ ہوگ فیل ہوانتا، دوبارہ کوشش جاری ساٞت؟
error-clip-upload-server = اِیں کلپ آں اپلوڈ ہوگ  سروٞر تھی فیل ہوانت۔ دوبارہ پاݪ لؤڈ کٞر یا دِگیراں کوشیش کٞر۔
