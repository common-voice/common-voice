...
misreadings-explanation-4 = Сүзнең азагы әйтелмичә кала, мәсәлән: "минем белән" урынына "мин белән".
...
background-voices-explanation = Фонда каты булмаган шау-шу булса, бу рөхсәт ителә. Ләкин чит кеше аерым сүзләр сөйләгәнен ишетсәгез, клипне кире кагарга кирәк. Гадәттә мондый хәл, фонда телевизор эшләсә, яки якын-тирәдә кемнәрдер сөйләшсә, очрый.
...
adding-sentences-subheader-speakable-explanation = Иң яхшы җөмләләр табигый сөйләм кебек җиңел укылырга тиеш. Җөмләләрдә фонетика һәм сүзләрнең төрле булуы зур әһәмияткә ия булса да, без җөмләләр яздыруны волонтерлар өчен шулай ук кызык һәм мавыктыргыч та ясарга тырышабыз.
