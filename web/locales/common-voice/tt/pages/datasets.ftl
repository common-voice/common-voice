...
datasets-speech-bubble-content = Шәп яңалыклар! Тиздән Кинәт туган сөйләм проекты булдырылачак! Яңартуларны күзәтеп торыгыз һәм соңгы яңалыкларны белү өчен кичекмәстән <discordLink>Discord платформабызга</discordLink> кереп чыгыгыз.
language = Тел
...
why-donate-datasets-page = Mozilla Common Voice — дөньяда иң төрле эчтәлекле һәм кулланучылар өчен ачык мәгълүматлар җыелмасы. Һәм без иганәләр хисабына эш итәбез. Мәгълүматлар җыелмаларын урнаштыруга һәм 100 артык тел җәмгыятьләре өчен платформаны яхшыртуга елына миллион долларга якын акча китә. Ачык, инклюзив мәгълүматларның эшчәнлегенә булышырга теләсәгез, <b>акчалата иганә ясагыз!</b>
