...
email-subscription-title-v3 = ลงทะเบียนเพื่อรับข่าวสารอัปเดตจาก Common Voice และ Mozilla Foundation
...
about-us-menu-item-tooltip = เรียนรู้เกี่ยวกับภารกิจและทีมงานเบื้องหลัง Common Voice
...
about-menu-aria-label = เมนูสำหรับเข้าถึงพันธมิตร ข่าวแจกและเรื่องราว ชุมชนและภาษา
about-us-menu-aria-label = เมนูตัวเลือกเกี่ยวกับ
about-us-menu-item-aria-label = เมนูตัวเลือกเกี่ยวกับเรา
...
community-section-title-202601 = ขับเคลื่อนโดยชุมชนระดับโลก เพื่อชุมชนระดับโลก — รองรับ 290 ภาษา และจะมากขึ้นอีกในเร็ว ๆ นี้!
...
find-us-on-matrix-content-v2 = Matrix เป็นโปรโตคอลแบบเปิดและขนาดย่อมสำหรับการสื่อสารกระจายศูนย์แบบเรียลไทม์ และเป็นแพลตฟอร์มการสนทนาแบบเปิดที่ Mozilla เลือกใช้ เราอยู่ในห้อง "common-voice:mozilla.org"
# label for button
find-us-on-element-action-1 = Element
find-us-on-matrix-action-2 = ไคลเอนต์อื่น ๆ
