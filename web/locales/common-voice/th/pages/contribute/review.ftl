...
sc-review-instruction = ตรวจสอบ <icon></icon> ดูว่าประโยคนี้ถูกต้องตามหลักภาษาหรือไม่
...
review-error-rate-limit-exceeded = คุณไปเร็วเกิน โปรดใช้เวลาสักครู่เพื่อตรวจทานประโยคเพื่อให้แน่ใจว่าถูกต้อง
# SENTENCE-COLLECTOR-REDIRECT PAGE
sc-redirect-page-title = เรากำลังทำการเปลี่ยนแปลงครั้งใหญ่
sc-redirect-page-subtitle-1 = เครื่องมือรวบรวมประโยคได้ย้ายไปยังแพลตฟอร์มหลักของ Common Voice แล้ว ตอนนี้คุณสามารถ<writeURL>เขียน</writeURL>ประโยคหรือ<reviewURL>ตรวจทาน</reviewURL>ประโยคที่ส่งเข้ามาได้บน Common Voice
...
# menu item
review-sentences = ตรวจทานประโยค
