...
contribution-volume-description = ระดับเสียงของผู้อ่านแต่ละคนจะมีช่วงที่แตกต่างกันตามธรรมชาติ ให้ปฏิเสธก็ต่อเมื่อระดับเสียงดังเกินไปจนคลิปเสียงที่อัดนั้นใช้ไม่ได้ หรือเบาเกินไปจนคุณไม่ได้ยินเนื้อหาที่พูดถ้าไม่เห็นข้อความที่เขียน (ซึ่งพบได้บ่อย)
