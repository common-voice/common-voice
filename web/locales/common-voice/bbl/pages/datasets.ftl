...
dataset-description-hours = ცჰაც მონაცემ წარმოდგენადელნო და ცჰანაკცჰა დეჲნი/უნიკალურ  MP3-ევაჲ ოჴუხ აღაზ ტექსტურ ფაილევაჲ. <b>{ $total }</b> სავთულიჩო ჩანაწერაჼ ჲაჴჴოჩო  დაყე/ნაწილე და დემოგრაფიულ მონაცემიაჲ, მუჲლნე და: ასაკ, სქეს, აქცენტ, უნეშაძ₾ებალა გამოდგომალალო იშ ჲაბწინო საშუალბაჼ ნიფსხოლ ღაზარჲაჼ. კრებულე
want-dataset-update = { "" }
