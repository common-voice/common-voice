...
share-title-new = <bold> ლატათ თხოჼ </bold> ა́ში́რ ლე́ხოშ
keep-track-profile = ბჵარკ ლე́ლბებ ჰეჲ ჰა́თხიხრეხ პროფილ საშუალბევ
login-to-get-started = ჩუ ღობ, ლე მა́ ა́ნგრიშ თაგჲებ საქმ ჰ̦ალო̆ ჲო́ლჲაჼ
target-segment-first-card = აჰ̦ ჰ̦აიჼ დაყ ჩუ ჴეჰ̦ო თხეჼ დუჲჰ̦რელუჩო̆ მიზნობრივ კრებულე
target-segment-generic-card = აჰ̦ დაყ ჩუ ჴეჰ̦ო  მიზნობრივ კრებულენაჲნო̆
target-segment-first-banner = ლა́ტათ თხოჼ თაგდოლო́თხ Common Voice-ეჼ დოჲჰ̦რელუჼ მიზნობრივ კრებულ { $locale } მატტანეჲნო̆
