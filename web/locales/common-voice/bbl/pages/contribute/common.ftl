...
shortcut-discard-ongoing-recording-label = ინცჲოტუჲნ ჩაწერ გაუქმადჲარ
...
contribution-misreadings-description-extended-list-3 = დაცუშ და ალ'ინო̆: ლევლა "ცუჲნო̆, მა წერალა:" ცო-აჲნო̆, ლე პირიქით; ლე მა ალ'ანდეწინ:ი̆ "თხო დათხო̆" ლევლა: "თხო და"
...
contribution-misreadings-example-1-title = "წინ... წინ ქევხაჲ მაცხეჸ ჰალო ვა ჩავარვიენო"
contribution-misreadings-example-2-title = "წინ ქევხ მაცხეჸ ჰალო ვა ჩავარვიენო"
contribution-misreadings-example-2-explanation = დეწ ხილ'აჼ: " "ქევხაჲ"
contribution-misreadings-example-3-title = "წინ ქევხაჲ მაცხეჸ ჰალო ვა ჩავარვიეჼ -"
contribution-misreadings-example-3-explanation = ჩაწერენ  მაყ ბა ბალ'ინო დოშ ბოლომციჼ ალ'ლომციჼ
contribution-misreadings-example-4-title = "წინ ქევხაჲ მაცხეჸ ჰალო ვა ჩავარვიენო, ჰაჸ"
contribution-misreadings-example-4-explanation = სოუბო̆ დოშ და ჩაწე́რადიენო̆
contribution-misreadings-example-5-title = "ხკოლიხ ნიყ დაჰ ცო ბაგეგ ჭაღბიენო." ჩანაწერ წუნბადჲოშ თხილუშ ხილ'ათ, მაცმე́ ლე დოშ, ლე ინტონაცია (მახვილ) უჲშტი̆ ცო ლე́ვლა, მოჰ̦ე შუჼ ხაწენდა, და́ხაჸ მე, ცჰ̦ეჲნი̆ მატტლო შაძლე́ბალა დუჴ ჴეჩ-ჴეჩნა́ჲრეჼ  ა́ლ'არ დალო̆, მენხუ ცომაცნი́ ცო ხაწენდა შუჼ ეჴ საზო́გადოებე. დეხო́თხ, ცოშუღეშ ამბუჲ  ჲუჲნშიგოჰ̦ა́ მა́მ დავდოთ
contribution-misreadings-example-6-title = ხკოლიხ ნიყ დაჰ ცო ბაგ ჭაღბიენო
contribution-misreadings-example-6-explanation = დეწ ხილ'აჼ: "ცო ბაგეგ"
