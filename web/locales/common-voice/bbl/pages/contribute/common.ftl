...
contribute = ჰ̦აიჼ დაყ ჩუ დაჰ̦არ { $count }
review = შემოწმადარ
skip = დაჰ̦ დითარ
...
goal-help-recording = { "" }
goal-help-validation = აჰ ლატრევ Common Voice-ე დინლუჩო მიზნეჼ { $goaIValue }  ჩანაწერაჼ<goaIPercentage></goaIPercentage> ჰალ დოდალიჼ!
contribute-more = ლეჸი ჰონ ტყოჸ { $count } თაგდარ?
...
keep-track-profile = ბჵარკ ლე́ლბებ ჰეჲ ჰა́თხიხრეხ პროფილ ძალუვ
...
see-less = <chevron></chevron>დაცდიენო̆
