...
minimum-sentences = წინადა́დებ  ჰ̦ამა́ხეჸ კაძიკ 1000 ჲე̦წ ხილ'აჼ
maximum-file-size = ფაილეჼ ჲუწოლ სოუბ ცო ჲეწ ხილ'აჼ 25 მბაიტეხ
what-needs-to-be-in-file = უხ დეწ ფაილე ხილ'აჼ?
what-needs-to-be-in-file-explanation = დეხოთხ ბჵარკ ლალბოლეჲში <templateFileLink>ფაილ ნიმუშეხ</templateFileLink>. შუჼ წინადადბი ჲეწ ხილ'აჼ ლე ჵამანეჸ საკუთრებ (CC0-ლიცენზიევ, ლე წინადადებ ჩუ ჴეჰჩოვ შაჲრვაჼ ჲიენო) ნე ჲეწ წერადჲალაჼ შარეჩო მატტავ, . ნიფსიჩ ორთოგრაფიევ, ატტაჲში მე ხეტტლალო. ჩუ ჲაჰინო წინადადებ იშტ 10-15 წამე ჲეწე ხეტტჲალა ნე ჩუჰ ცო ხილ'აჼციფრი, საკუთარ წარიშ ლე მა უმ ნიშნი
