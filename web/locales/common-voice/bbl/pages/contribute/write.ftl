...
login-instruction-multiple-sentences = <loginLink>ჩუ ღობაეთ </loginLink> ლე მა <loginLink> თაგჲებათ </loginLink> ანგრიშ მელ'მი წინადადებ ლატჲანაჲნო
how-to-cite = წყარო მოჰ ჲეწე ჩაწერადჲაჼ?
how-to-cite-explanation-bold = წყაროღ ღალხილ'ო საკუთრებეჼ უფლებ ცო ჭირბალეჲნი მასალენ ბმულ, ლე მა ნაწარმოებენ წე ქუჲრთლრნა ბოლომციჼ
