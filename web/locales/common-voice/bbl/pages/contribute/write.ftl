...
bulk-upload-additional-information = ლეჸე́ჰ̦ შუჼ თხო́გო̆ საბუ́ხ ხაჸი́თაჼ ეჴ ფა́ილეხ, დეხო́თხ, წერილ დაჸითათ ეჴ ა́დრესმაქ
...
try-upload-again-md = ტყო́ჸ ცადლიბათ ჰ̦ალო̆ ჴო́წდარ/ატვირთოდარ
select-file = ფა̆ილ ჩა̆ვარდებათ
select-file-mobile = ფაილ ჩა̆ვარდარ ჰ̦ალო̆ ჴო̆წდანაჲნო̆
...
what-needs-to-be-in-file-explanation = დეხო́თხ ბჵარკ ლალბოლე́ჲში̆ <templateFileLink>ფა́ილ ნიმუშეხ</templateFileLink>. შუჼ წინადა́დბი ჲეწ ხილ'აჼ ლე ჵამა́ნეჸ საკუთრებ (CC0-ლიცენზიევ, ლე წინადა́დებ ჩუ ჴე́ჰ̦ჩოვ შა́ჲრვაჼ ჲიენო̆) ნე́ ჲეწ წე́რადჲალაჼ შარეჩო̆ მატტავ, . ნიფსიჩო̆ ორთოგრა́ფიევ, ა́ტტაჲში̆ მე ხე́ტტლალო. ჩუ ჲაჰ̦ინო̆ წინადა́დებ იშტ 10-15 წამე ჲეწე ხე́ტტჲალა ნე́ ჩუჰ̦ ცო ხილ'აჼ ციფრი, საკუთარ წარი́შ ლე მა́ უ̂მ ნიშნი
upload-progress-text = ჰ̦ალო̆ ჴო́წჲარ/ატვირთვ ჲუჲტო̆...
sc-bulk-submit-confirm = დასტურ ლე́ვჲოს, მე ე წინადა́დბი <wikipediaLink>ჰ̦ამა́ნეჸ საკუთრებ ჲა</wikipediaLink>ჲე́ ჲა სო́გო ჰ̦ალო̆ ჴო́წჲარეჼ / ატვირთოდჲარეჼ უფლებ
