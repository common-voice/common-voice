...
# Text wrapped in <mdcLink></mdcLink> will be rendered as an external link to Mozilla Data Collective
announcement-release = ჩვენი ერთობის ძვირფასო წევრებო, ახალი გამოშვების სრულად სანახავად იხილეთ <mdcLink>Mozilla Data Collective</mdcLink>. შემოუერთდით, 500-ზე მეტ საერთაშორისო მონაცემთა კრებულთან წვდომისთვის, საზოგადოებისვე მიერ შექმნილი საზოგადოების საკეთილდღეოდ.
