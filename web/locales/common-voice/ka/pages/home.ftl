...
wall-of-text-start = ხმა არის ბუნებრივი, ხმა არის ადამიანური. სწორედ ეს გვხიბლავს, როცა ვქმნით ხმოვან ტექნოლოგიებს მანქანებისთვის. ხმოვანი სისტემის შექმნა კი მეტად დიდი ოდენობით ხმოვან ჩანაწერებს საჭიროებს.
...
wall-of-text-first = ხმა არის ბუნებრივი, ხმა არის ადამიანური. სწორედ ეს გვხიბლავს, როცა ვქმნით ხმოვან ტექნოლოგიებს მანქანებისთვის. ხმოვანი სისტემის შესაქმნელად კი შემმუშავებლებს მეტად დიდი ოდენობით ხმოვანი ჩანაწერები ესაჭიროებათ.
