...
code-switching = მეტყველების გადართვა
...
code-switching-focus-emotional-explanation = მეტყველების გადართვა ხალხს ახასიათებს გრძნობების გამოხატვისას, მღელვარებისას ან საგანგებო შემთხვევებისას. მაგალითად:
code-switching-cultural-topics-explanation = საჭმელი, ჩვეულებები, დღესასწაულები და ოჯახური გარემოებები, აგრეთვე იწვევს მეტყველების გადართვას.
# What to Avoid
...
code-switching-transcribe-intro = პასუხების ნაწერად ქცევისას, როცა წააწყდებით მეტყველების გადართვას, მოსაუბრის ენა წარმოადგინეთ ზუსტად ისე, როგორც არის – გამართვის, შესწორების ან გამარტივების გარეშე. ეს ეხება ენების ცვლას, სასაუბრო მეტყველებასა და ენაში გამორეულ უცხო სიტყვებსაც.
# Tagging
