...
review-the-transcription-explanation-3 = კიდევ ერთხელ, შეგიძლიათ მონიშნოთ შეურაცხმყოფელი, მავნე ან სხვაგვარად შემაშფოთებელი მასალა და აღარ წააწყდებით, სანამ Common Voice მისი გუნდით არ გადაამოწმებს და უკეთ არ გამოიძიებს საკითხს.
