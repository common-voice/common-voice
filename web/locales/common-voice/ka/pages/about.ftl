...
about-playbook-how-grow-language-content-8-v2 = <strong>იყავით შემოქმედებითი!</strong> თქვენი ენის ერთობა იქნება ყველასგან გამორჩეული ეს მხოლოდ ერთ-ერთი გზაა დასაწყებად. აგრეთვე, სასურველია, ერთობასთან დასაკავშირებელი არხები დაამატოთ <communitiesLink>დოკუმენტში COMMUNITIES.md GitHub-ზე</communitiesLink>.
