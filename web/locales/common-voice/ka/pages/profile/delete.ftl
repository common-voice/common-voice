...
why-delete-recordings =
    Common Voice-ის ჩანაწერები გამოიყენება მკვლევრების, მცირე დაწესებულებებისა და ხმის ამოცნობის საშუალებების შემუშავების მოყვარულების მიერ თავიანთი დამზადებული სისტემების დასახვეწად.
