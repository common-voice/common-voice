...
get-involved-text = { $lang }ত অৱদান দিবলৈ আপোনাৰ আগ্ৰহৰ বাবে ধন্যবাদ। আমি এই প্ৰকল্পটোত প্ৰতিটো ভাষা যোগ কৰি প্ৰকাশ কৰাৰ বাবে যথেষ্ট কষ্ট কৰোঁ আৰু দলবিলাকক ইমেইলৰ জৰিয়তে আপডে’ট দিওঁ। যদি আপুনি অৱদান দিব বিচাৰে, অনুগ্ৰহ কৰি তলত আপোনাৰ ইমেইল প্ৰদান কৰক।
get-involved-form-title = { $lang } আপডে’টৰ বাবে ছাইন আপ কৰক:
get-involved-email =
    .label = ইমেইল
