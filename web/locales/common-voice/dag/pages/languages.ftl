...
get-involved-text = Ti paɣiya q suhu ni yu ni a tɔhira sabira { $lang }. Ti kuli kpaŋdila ti maŋa ni che ka yi balli (zuliya yɛltɔɣa) ŋɔ kpe daa  ka kuli ni labiri teeri yi laɣingu din kɔɣiri ka bihira email soli zuɣu. A yi bɔri ni a tɔhi sabi, nyin pahimi suɣulo sabi a email yuli sɔŋ gbunni ŋɔ.
get-involved-form-title = Sabimi a yuli zaŋ chaŋ { $lang } lahabaya teebu polo:
get-involved-email =
    .label = Email yuli
