...
dataset-description-hours = Kpɛhibu kam dini zaŋ n-niŋ lahabaya mini kukɔli kpanjɔɣu ŋɔ ni maa mali la MP3 din gahim ka mali di sabbu faali. Bin <b>{ $total }</b> nima maa pam kukɔli yaara hawa nima din be lahabali mini kukɔli kpanjɔɣu ŋɔ puuni lahi mali la maŋmaŋa lahabaya kamani yuma, paɣa bee do' tali, ni kukɔli niɣimbu din yɛn sɔŋsi ka yɛltɔɣa baŋbu bɔhimbu n-niŋ viɛnyɛla. Lahabaya kpanjɔɣu maa mali la <b>{ $valid }</b> dihitabili hawa nima <b>{ $languages }</b> zuliya yɛltɔɣa puuni, amaa saha shɛli kam, ti kuli pahiri la kukɔya ni zuliya yɛltɔɣa nima. Lihi mi ti <languagesLink> zuliya yɛltɔɣa nima yaɣili </languagesLink> n-ti sɔli ka di zaŋ a zuliya yɛltɔɣa m-pahi bee ka a pili tɔhibu.
