...
public-domain-explanation-1 = 因為 Common Voice 語音資料庫採取 <cc0>CC0授權</cc0> 的方式釋出，確保所有的句子都屬於 <publicDomain>公眾授權</publicDomain>（無版權限制）萬分重要。請務必指提交你確定無任何版權疑慮的句子，並且標示明確的出處。
