...
target-segment-learn-more = 了解閣較濟
...
report-offensive-language-detail = 這句話當中有無尊重其他人抑是冒犯性的語言。
report-grammar-or-spelling = 文法 / 拼字錯誤
report-grammar-or-spelling-detail = 這句話的文法抑是拼法有錯誤。
report-different-language = 其他語言
report-different-language-detail = 這句話是其他語言的句子。
report-difficult-pronounce = 無法度發音
report-difficult-pronounce-detail = 這句話內底有真僫發音的文字抑是語詞。
report-offensive-speech = 冒犯人的錄音片段
report-offensive-speech-detail = 這個片段中有無尊重其他人抑是冒犯性的語言。
...
shortcut-discard-ongoing-recording-label = 擲掉目前个錄音
shortcut-submit = 轉去
...
contribution-for-example = 舉一个例
contribution-misreadings-title = 誤讀
contribution-misreadings-description = 聆聽錄音的時，詳細確認錄下的語音內容佮畫面頂懸顯示的文字完全相符，有任何一點仔錯誤就退回更正。<br />下跤是定定看著的錯誤類型：
contribution-misreadings-description-extended-list-1 = 錄音內容欠缺語尾助詞，例如<strong>「咧」</strong>抑是<strong>「矣」</strong>。
contribution-misreadings-description-extended-list-2 = 欠缺<strong>華語「們」</strong>等量詞抑是複數型態錯誤。
contribution-misreadings-description-extended-list-3 = 閱讀的時略過抑是多去某麼字。例如「錄音的注意事項」一句中，只唸出「錄音注意事項」（無唸出「的」字），抑是唸成「錄音時的注意事項」（多出「時」字）。
contribution-misreadings-description-extended-list-4 = 因為傷緊揤停止錄音造成句尾予截斷。
contribution-misreadings-description-extended-list-5 = 錄音中多次嘗試念出某麼文字。
...
contribution-misreadings-example-3-explanation = （錄音的句尾予截斷）
contribution-misreadings-example-4-title = 三疊紀的足大恐龍。
contribution-misreadings-example-4-explanation = （錄音內容比實際的句子多了某麼字）
contribution-misreadings-example-5-title = 咱欲出去買咖啡。
contribution-misreadings-example-6-title = 咱欲買咖啡。
contribution-misreadings-example-6-explanation = （欠缺「出」）
contribution-misreadings-example-7-title = 咱欲出去買一甌咖啡。
contribution-misreadings-example-7-explanation = （原句當中無「一甌」）
contribution-misreadings-example-8-title = 大黃蜂路過。
contribution-misreadings-example-8-explanation = （內容完全無符合）
