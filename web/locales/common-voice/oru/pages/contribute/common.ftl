...
speak-loading-error = ماخ دی بئے جملي نک واکِن که ترتو ته غوېڅن پاره وه پېش کيېن۔ څُټکی بئے کوشش کېوَن
...
contribution-misreadings-example-3-title = ته ځنډ زمانه ا سمندئ ډائنوسورـ۔
contribution-misreadings-example-3-explanation = [ته آخېری لفظ ا غړنؤ په وجه ته ریکارډنګ ا سېره بند کؤ]
