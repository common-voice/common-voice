...
you = تُو
everyone = هر سړئ
contribution-activity = ا پېش سُک کری
...
goal-share-text = از يې په په يي ساعت ته آواز ته پېشکؤ مشترک آواز کی ذاتي مقصد ټپيېک ۔۔ مُن ګډ مل سئ که مشین کی له شام کيېن که ا خلق بُو اراخه نر څخل ژغېن { $link }
weekly-goal-created = ترتُو ا هفته وار مقصد جوړ ݭیوک
daily-goal-created = ترتُو ا ریوزانۀ مقصد جوړ ݭیوک
track-progress = ته مُخکی څېک ا خالت ته ترتُو ته شمېر صفحه لاسته وُر
return-to-edit-goal = ته مقصد ته اېډټ کؤ پاره ر کان ګه ګِتس اېنچی
share-goal = ترمُن ا مقصد شریک کوئ
