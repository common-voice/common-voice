...
citing-sentences-subheader-academic-reference-explanation = Mae modd i chi ddefnyddio arddull cyfeirio Academaidd, e.e. arddull Harvard "Mozilla (2021) Common Voice. Ar gael yn https://commonvoice.mozilla.org/ (Cyrchwyd: 15fed Medi 2021)"
...
adding-sentences-subheader-abbreviations-explanation = Mae'n well osgoi byrfoddau ac acronymau fel “USA” neu “ICE” yn y testun ffynhonnell oherwydd bod modd eu darllen mewn ffordd nad yw'n cyd-fynd â'u sillafu. Yn ogystal, efallai bydd mwy nag un darlleniad cywir ar gyfer un talfyriad.
adding-sentences-subheader-punctuation = Atalnodi
adding-sentences-subheader-punctuation-explanation = Dim ond pan fydd hynny'n hollol angenrheidiol y mae angen cynnwys symbolau ac atalnodi arbennig. Er enghraifft, mae collnod yn cael ei gynnwys mewn geiriau Cymraeg fel “mae'r” a “wedi'u” ac mae angen ei gynnwys yn y testun ffynhonnell, ond mae'n annhebygol y bydd angen symbol arbennig fel “@” neu “#” arnoch chi.
...
easy-to-understand-explanation = Dewiswch gwestiynau syml sy'n hawdd i unrhyw un eu deall, waeth beth yw eu diwylliant neu eu cyd-destun.
...
length = Hyd
length-explanation = Dylai'r cwestiwn gael ei ateb mewn ychydig o frawddegau.
...
process-steps-explanation = Cwestiynau sy'n gofyn i rywun restru sawl cam.  Mae camau rhestru'n annog y defnyddiwr i adrodd ateb yn hytrach nag ymateb mwy naturiol.
...
offensive-content-sensitive-information-explanation-explanation-3 = Cwestiynau a allai achosi i rywun rannu gwybodaeth sensitif, a allai sbarduno ymatebion
...
code-switching-focus-emotional-explanation = Mae pobl yn aml yn cyfnewid codau wrth fynegi emosiwn neu frys. Enghraifft:
code-switching-focus-emotional-explanation-example = “Dywed wrtha i beth ddywedodd dy rieni pan ddwedes ti dy newyddion mawr wrthyn nhw - yn union beth wnaethon nhw ei ddweud.”
code-switching-direct-quotes-header = Gofynnwch am Ddyfyniadau Uniongyrchol neu Ail-greu
code-switching-direct-quotes-explanation = Anogwch y cyfranogwyr i atgynhyrchu sut mewn gwirionedd y dywedwyd pethau. Enghraifft:
code-switching-direct-quotes-explanation-example = “Beth oedd dy union eiriau pan glywest ti?”
code-switching-cultural-topics-header = Dewiswch Testunau Diwylliannol Penodol
code-switching-cultural-topics-explanation = Mae bwyd, traddodiadau, gwyliau a deinameg teuluol yn aml yn denu cyfnewid codau.
code-switching-cultural-topics-explanation-example = “Sut wyt ti'n disgrifio'r Eisteddfod Genedlaethol i rywun sy dim ond yn siarad Saesneg?”
code-switching-informal-scenarios-header = Archwiliwch Sefyllfaoedd Anffurfiol
code-switching-informal-scenarios-explanation = Mae sgyrsiau gyda ffrindiau neu negeseuon testun yn aml yn cynnwys cyfnewid mwy naturiol. Enghraifft:
code-switching-informal-scenarios-explanation-example = “Pa jôcs mae dy ffrindiau bob amser yn eu dweud - a sut maen nhw'n eu dweud?”
# What to Avoid
...
code-switching-review-criterion-3 = Peidio â defnyddio, na cheisio, iaith niweidiol neu sarhaus
code-switching-review-does-not-header = Ac <bold>NAD YW</bold> yn cynnwys:
code-switching-review-offensive-content = <bold>Cynnwys sarhaus neu wybodaeth sensitif</bold>
code-switching-answer-header = Cynnwys sarhaus neu wybodaeth sensitif
code-switching-review-no-1 = Cwestiynau a allai ofyn am wybodaeth all adnabod personol
code-switching-review-no-2 = Cwestiynau a allai achosi mynegi casineb neu deimladau rhagfarnllyd neu dramgwyddus eraill
