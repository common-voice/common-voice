...
code-switching-review-criterion-3 = Yn peidio â defnyddio, na cheisio, iaith niweidiol neu sarhaus
code-switching-review-does-not-header = Ac <bryf>NAD YW</beidd> yn cynnwys:
...
code-switching-answer-bullet-3 = Defnyddiwch eiriau y byddech chi'n eu defnyddio mewn gwirionedd, hyd yn oed pe baen nhw wedi'u benthyca neu'n gymysg
code-switching-answer-bullet-4 = Does dim ffordd “berffaith” o ateb
code-switching-authentic-header = Atebwch yn Naturiol a Dilys
