...
report-offensive-speech-detail = Mae gan y clip iaith amharchus neu dramgwyddus.
...
contribution-misreadings-description-extended-list-2 = Mae <strong>'au'</strong> coll ar ddiwedd gair.
...
contribution-background-noise-description = Rydym am i'r algorithmau addysgu peiriannau allu trin amrywiaeth o synau cefndir, ac mae modd derbyn synau cymharol uchel hyd yn oed ar yr amod nad ydyn nhw'n eich rhwystro rhag clywed y testun cyfan. Mae cerddoriaeth gefndir dawel yn iawn; ond nid cerddoriaeth sy'n ddigon uchel i'ch rhwystro rhag clywed pob gair.
contribution-background-noise-description-extended = Os yw'r recordiad yn torri i fyny, neu os oes ganddo graclo, gwrthodwch oni bai bod y testun cyfan yn dal i allu cael ei glywed.
...
contribution-background-noise-example-2-explanation = [Does dim modd clywed rhan o'r testun]
contribution-background-noise-example-3-fixed-title = <strong>[Craclo]</strong>dinosoriaid anferth y <strong>[pesychu] </strong>-riasig.
contribution-background-voices-title = Lleisiau Cefndir
contribution-background-voices-description = Mae sŵn cefndir tawel yn iawn, ond nid ydym am gael lleisiau ychwanegol a allai achosi i algorithm peiriant  adnabod geiriau sydd ddim yn y testun ysgrifenedig. Os gallwch chi glywed geiriau gwahanol ar wahân i eiriau'r testun, rhaid gwrthod y clip. Fel arfer, mae hyn yn digwydd lle mae'r teledu wedi'i adael ymlaen, neu lle mae sgwrs yn digwydd gerllaw.
contribution-background-voices-description-extended = Os yw'r recordiad yn torri i fyny, neu os oes ganddo graclo, dylech ei  wrthod oni bai bod clywed y testun cyfan i gyd.
...
contribution-volume-description = Bydd amrywiadau naturiol yn y sain recordio rhwng darllenwyr. Gwrthodwch dim ond os yw'r sain mor uchel nes bod y recordiad yn torri i fyny, neu (yn fwy cyffredin) os yw mor isel fel does dim modd i chi glywed yr hyn sy'n cael ei ddweud heb edrych ar y testun ysgrifenedig.
