...
sc-criteria-item-6 = Os ydych chi'n mynd yn brin o frawddegau i'w hadolygu, helpwch ni i gasglu rhagor o frawddegau!
...
sc-review-empty-state = Does dim brawddegau i'w hadolygu yn yr iaith hon ar hyn o bryd.
...
sc-redirect-page-subtitle-1 = Mae'r Casglwr Brawddegau yn symud i lwyfan craidd Common Voice. Nawr gallwch <writeURL>ysgrifennu</writeURL> brawddeg neu <reviewURL>adolygu</reviewURL> brawddeg unigol wedi ei gyflwyno ar Common Voice.
sc-redirect-page-subtitle-2 = Gofynnwch gwestiynau i ni ar <matrixLink>Matrics</matrixLink>, <discourseLink>Discourse</discourseLink> neu <emailLink>e-bost</emailLink>.
# menu item
review-sentences = Adolygu Brawddegau
