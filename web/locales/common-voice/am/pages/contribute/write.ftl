...
sc-review-small-batch-title = ብዙ ዓረፍተ ነገሮችን እንዴት ማከል እንደሚቻል
...
login-instruction-multiple-sentences = ብዙ ዓረፍተ ነገሮችን ለመጨመር <loginLink> ይግቡ</loginLink> ወይም <loginLink>ይመዝገቡ</loginLink>
...
small-batch-sentence-submission = የጥቂት ክምችት ዓረፍተ ነገር ማስረከብ
...
review-questions-menu-item-tooltip = የግምገማ ጥያቄዎች
...
review-questions-menu-item-aria-label = በማህበረሰቡ የቀረቡ አዳዲስ ጥያቄዎችን ይገምግሙ እና ድምጽ ይስጡ
