...
listen-instruction = { $actionType }<playIcon></playIcon> cerg yashtẽs̃h drũst jumla k̃hanẽna?
listen-again-instruction = khub yark! <playIcon></playIcon> tiyorẽt ki vitẽ dẽbora kẽs̃hũy
listen-3rd-time-instruction = 2 rẽdest, jori lecẽr <playIcon></playIcon>
listen-last-time-instruction = <playIcon></playIcon> okhẽri
listen-empty-state = Spo s̃hik̃hẽb kẽlipsht vek̃hk hũmin- wẽraqẽ rifresh car yoy cẽbasẽn kushish car.
...
listen-contribute-menu-tooltip = Joyẽnẽ towsiq, tẽrjũma dẽdẽg̃h
...
validate-readings-menu-item-aria-label = jẽmoati mimbarvẽ jamla k̃hetk joynẽvẽ towsiq car
