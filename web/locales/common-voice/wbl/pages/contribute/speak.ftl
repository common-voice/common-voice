...
record-must-allow-microphone = Tawri dẽ maykrofun g̃hẽtak ijozat dẽrkor
...
record-instruction = { $actionType }<recordIcon></recordIcon> andi jũmlaẽ s̃hukh joy
...
share-clip = K̃hu kẽlipẽ Qiti Car
...
review-submit-title = Didig̃h woz jama Car
