...
record-abort-title = awalgũni rikord̃ing vec̃hũv
record-abort-text = haniv lẽcẽrnẽ maniyi yem ki tub k̃hũ tẽrẽqiyẽ nũs
record-abort-submit = Kẽlipvẽ jama car
record-abort-continue = ricord̃ing vec̃hũv
record-abort-delete = Kẽlipẽ bũt woz niwiz
review-aborted = Upload̃ ki resẽnẽ, cerg tub k̃hũ rikordẽ bũta?
review-submit-title = Didig̃h woz jama Car
review-submit-msg = Rikord̃ingẽr s̃hobos̃h!<lineBreak></lineBreak>niv yem k̃hũ  destũ klipẽ didig̃h woz jama car
review-recording = Didig̃h
review-rerecord = woz rikord̃
review-cancel = Jama k̃hakẽ rad car
