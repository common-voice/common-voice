...
wall-of-text-more-desktop = Nives̃h tu sakẽr yi open voys d̃atãsẽt̃ k̃hakẽr k̃hũ owozẽ atya rẽdhoẽ bas wez ki s̃heg̃hd eppvẽ (apps) ẽsbob (device) woz tenz̃et(web). ya  jũmla joyd taki mashin disht ki khalgẽsh aslẽn cẽrsokht k̃hand, digarvẽ yark z̃hẽmũrnẽr. sherik wocẽn miyorẽ baf k̃hakẽr. yemi atumẽr sidam
...
wall-of-text-second = Lup kampunishites̃h ki kumd d̃ataẽ istimolẽn ghafch khalgẽs̃h da ne g̃hat. sakrẽs̃h sẽdhũyd bidat/ k̃hũ k̃hetkẽs̃h tẽrdest gon. askan sakẽ Kommon Voys shẽru kert, yi projekt̃ kumd ki oqozẽ shẽnokht cart woz kuk̃ht da ghat
...
no-clips-to-validate = sẽdhũydẽs̃h ki hadẽm zik ki chiz klip kẽs̃hỹnẽr nas. sakẽr caq s̃heg̃hd pẽs qẽtor rikord̃ẽr mẽdad woc
toggle-play-tooltip = pley mod̃ẽ t̃agẽl (toggle) k̃hakẽr pakhch { shortcut-play-toggle }
speak-paragraph = voys klipẽ ricod̃ingi spo d̃at̃aset̃ẽ lazmi hisa: yisarẽb k̃hanẽn yemi mẽshkhũlig̃h bẽ tey
speak-goal-text = klipvẽ ricord̃
listen-paragraph = Atya k̃hetk klipvẽ towsiqi kommon voysẽr gha zẽrũrat. kẽs̃hũy wos yi fẽristẽ dũrz woz sak meyari open zẽrya owozẽ d̃atã k̃hakẽr sakẽr medad woc
...
ready-to-record = K̃hũ owazẽ atya rẽdhorẽt tẽyora?
