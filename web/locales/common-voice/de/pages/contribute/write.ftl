...
rate-limit-message-minutes =
    { $retryLimit ->
        [one] Sie haben zu viele Sätze übermittelt. Bitte warten Sie eine Minute, bis Sie einen weiteren Satz übermitteln. Vielen Dank für Ihre Geduld!
       *[other] Sie haben zu viele Sätze übermittelt. Bitte warten Sie { $retryLimit } Minuten, bis Sie einen weiteren Satz übermitteln. Vielen Dank für Ihre Geduld!
    }
# $retryLimit represents the amount of time in seconds a user has to wait to retry an upload
rate-limit-message-seconds =
    { $retryLimit ->
        [one] Sie haben zu viele Sätze übermittelt. Bitte warten Sie eine Sekunde, bis Sie einen weiteren Satz übermitteln. Vielen Dank für Ihre Geduld!
       *[other] Sie haben zu viele Sätze übermittelt. Bitte warten Sie { $retryLimit }Sekunden, bis Sie einen weiteren Satz übermitteln. Vielen Dank für Ihre Geduld!
    }
...
review-questions-menu-item-tooltip = Fragen überprüfen
...
review-questions-menu-item-aria-label = Überprüfen Sie bestehende Sätze, die von der Gemeinschaft eingereicht wurden, und stimmen Sie darüber ab.
