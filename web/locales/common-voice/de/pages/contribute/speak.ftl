...
record-platform-webview = Sie sind womöglich hier gelandet, weil Sie auf einen Link in einer Social-Media-App geklickt haben. Sie verwenden einen app-internen Browser, der keine Audioaufnahmen unterstützt.
record-platform-not-supported-webview = Auf Mobilgeräten können Sie mit dem Browser Ihres Systems mitwirken…
