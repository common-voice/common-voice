...
about-playbook-how-grow-language-content-8-v2 = <strong>Werden Sie kreativ!</strong> Ihre Sprachgemeinschaft wird einzigartig sein, und dies sind nur einige Möglichkeiten, für den Einstieg. Bitte erwägen Sie, Ihre Gemeinschafts-Kanäle zum <communitiesLink>COMMUNITIES.md-Dokument auf GitHub</communitiesLink> hinzuzufügen.
