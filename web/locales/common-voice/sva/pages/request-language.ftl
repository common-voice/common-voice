...
request-language-heading = ლა̈ნჭუ̂ედ მახე ნინი ბედჟი
request-language-explanation-1 = ჩუ̂ათმოწმა̈ნ ა̈რიმა ისგუ ნინ<languagesPageLink> Common Voice-ეშ ჰერლე გუ̂ერდჟი</languagesPageLink>. ჰე მო̄მა, შეაუ̂სე ალ ფორმა ი ნა̈ჲ<strong> ქა ჯიზზიდ ელ. წერილს ი აგიხსნით იჟი ხეკუ̂ესე  ესგენად ისგუ ნინ</strong>.
