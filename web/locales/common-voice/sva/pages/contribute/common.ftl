...
review =
    ...
    2
    ❌
    ამზაუ̂ ხოჩა დარა̈ლგარ ლა̄̈სუ̂ხ ი ქართუ̂ებლი გუნ ხოჩა მახად ანჴა̈დ. ჴ ბგერის ჩანაცვლებამ ხ-თი გამოიწვია სიტყვის მნიშვნელობის შეცვლა: მაჴად "მოსავალი", მახად "ხელახლა".
