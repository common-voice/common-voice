...
contribution-varying-pronunciations-title = განსხვავებულ გამოთქმა დიალექტარისგა
contribution-varying-pronunciations-description = ფირთხილდ ხარდა̈ს, უ̂ოდე ნა̄̈ქუ̂ისგს ჩუ̂ათწჷნუ̂ი ეჯ მიზეზშუ̂, ერე მუჭუ̂და̄̈ნიდ უსწოროდ რა̄̈ქუ̂ე სიტყუ̂ა, ინტონაცია იშგნა̄̈გ ჩუ̂ემინ, ჲედ კითხვის ნიშა̈ნ ჰა̈დურდ დე̄სა ა̈დჭოდა̄ნე. თელ სოფლიოისგა ხუ̄̈ჲ ნუკუ̂იშ გარგლა ა̈რი, ხედუ̂ა̄̈ჲ ჲერხი სი  ისგუ გირკიდ საზოგადოებაისგა შეიძლება მა̄მ ჯესმე̄ნს. ჰემა იმა̈რგ, ნა̈ბ ლა̄ხო ეჯია̈რს, ერუ̂ა̄̈ჲ შეიძლება ისგუ̂აშა̄ლ მომ გა̈რგლი.
contribution-varying-pronunciations-description-extended = მე̄რმეჲ, სი ჰე̄მა ჯაბჟა, ერე მუჭუ̂და̄̈ნის ალ სიტყვა ათხად დეშომა ხასმა ი მიჩო̄უ̂შ ლჷქადდ ა̈ნმეჴრე, ეჩქა  უ̂არ ლექა. ჰე დოშ ხი დარწმუნებულ, ეჩქა ესოთლ ქალიცუ̂რე̄ ღილიკს.
...
contribution-background-noise-example-1-fixed-title = <strong>[იჩჩხიელხ]</strong> ტრიასულ პერიოდიშ ხოშე̄მიშთა̄ნ დინოზავრა̈ლ <strong>[იჴუ̂შიე̄ლხ]</strong>.
