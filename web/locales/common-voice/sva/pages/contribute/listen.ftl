...
validate-readings-menu-item-tooltip = ჩუ̂ათდასტურა̈უ̂ ისგუ̂ა ნინჟი მომხმარებლი ნა̈ირუ̂ წინადადება̈ლ
...
validate-readings-menu-item-aria-label = ჩუ̂ათმოწმა̈ნ თემი წეუ̂რალე ნასყა̈უ̂ ლჷჭუ̂და̄ნა̈რ
