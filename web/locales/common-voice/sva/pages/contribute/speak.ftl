...
why-donate-explanation-1 = ალ ინფორმაცია სავალდებულო მა̄მ ლი - ეჯა ხეკუ̂ეს ესქჷმა, ჰემა სი ჯიცხა. მონაცემრე ლა̈ქუ̂ეყნა̈უ̂ჟი პერსონალურ ინფორმაციას ფსევდონიმიზაციას ხუ̂ა̈ჩოდ ი გუ̂ის ხუ̂აჰუ̂დიდ, ერე ისგუ ჟახე ი ელფოსტა ი ამკა̈ლი ინფორმაცია̄̈ლ ნუმა ლესვხ კავშირისგა ეჯკა̈ლი დემოგრაფიულ მონაცემა̈რცახა̈ნ, იმუ̂ა̄̈იჟი ლი შდიქ (ჰასა̈კ) ი სქეს.
