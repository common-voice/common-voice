...
record-again-instruction = გუნ ხოჩამდ ლი!<recordIcon></recordIcon> სგა̄თიჲრ ისგუ ამუნღუ̂ე̄ კლიპ
...
review-tooltip = ქა̄თსინჯა̈უ̂ ი მახად ათი̄რ სგა კლიპ ამჩუ სგუ̂ებდ ლა̄ზდ
share-clip = გააზიარე ისგუ კლიპ
share-common-voice = გააზიარე Common Voice
review-instruction = ქა̄თთე̄რა̄̈უ̂ ი მაწჷხჟი მახად ათი̄რ სგა კლიპა̈რ
...
why-donate-explanation-1 = ალ ინფორმაცია სავალდებულო მა̄მ ლი - ეჯა ხეკუ̂ეს ესქჷმა, ჰემა სი ჯიცხა. მონაცემრე ლა̈ქუ̂ეყნა̈უ̂ჟი პერსონალურ ინფორმაციას ფსევდონიმიზაციას ხუ̂ა̈ჩოდ ი გუ̂ის ხუ̂აჰუ̂დიდ, ერე ისგუ ჟახე ი ელფოსტა ი ამკა̈ლი ინფორმაცია̄̈ლ ნუმა ლესუ̂ხ კავშირისგა ეჯკა̈ლი დემოგრაფიულ მონაცემა̈რცახა̈ნ, იმუ̂ა̄̈იჟი ლი შდიქ (ჰასა̈კ) ი სქეს.
...
speak-contribute-menu-aria-label = გახმოვანება̄̈ პარამეტრალე მენიუ
...
answer-questions-menu-item-aria-label = ქა̄თზიზ მახე შეკითხვა საზოგადოება̈შდ, ერე ქა̄̈დჭოდა̄ნას ი ქალოხპასხუ̂ას
