...
about-header-description-v2 = <p>Common Voice ლი ჩიჲა̈შდ ხელმისაწუ̂დომ ხმოუ̂ან მონაცემრე ნაკრებ, ხედუ̂ა̄̈ჲ ამშიჲე თელ მსოფლიოშ მოხალისე გამხმოუ̂ანებლარე ჟჷრშუ̂. ხა̈ლხს, ხედუ̂ა̄̈ჲს ხაკუ ხმოუ̂ან აპლიკაცია̄ლე ლისყი, ჩუხა̈მჲედახ ა̈ნსჷრგებლახ ალ მონაცემა̈რ მანქანურ ლითუ̂რი̄ მოდელრე ლასყე̄ნად.</p><p> ლა̈დი̄ ლადეღჟი, ხმოუ̂ან მონაცემრე ხოშა ნა̄̈თი კომპანია̄̈ლს ხეკუთუ̂ნიხ ი ალა ხოჟუ̂მე ინოვაციას. ხმოვან მონაცემრე ნაკრებ მა̄დხუ̂ა̄̈ჲ გარ ხარხ წარმოდგენილ: მა̄მაინგლისურენოუ̂ან, ფერადკანია̈ნ, შეზღუდულ შესაძლებლობა̄ლე ამსუ̂ა̄ლდა̈რს, ლეზუ̂რა̄ლეს ი  LGBTQIA+ ხა̈ლხს. ალა ეჯას ა̈ნშა̈ნი, ერე ხმოვან ტექნოლოგია საერთოდ მა̄მა ამშიჲე ფიშირ ნინრეშდ, ი იმუ̂ა̄̈ჲ ამშიე, ეჩე̄ი ჩია̈შდ ეშხუ̂ნა̈ირდ ხოჩა̄მდ შეიძლება მა̄მ ამშიჲე̄დს. ნა̈ჲ ნაკუ ამი̄  ჟილისპე ხა̈ლხი მობილიზაციოშ ჩია̄̈გ, ერე ამკა̈ლია̈რე ჰერი გაზიარებულ ლესსუ̂.
how-does-it-work-title-v2 = იმჟი ამშჲე Common Voice?
how-does-it-work-text = ნა̈ჲ ხუ̂ასყე̄ნედ ხმოვან მონაცემრე ბაზას ღია წყაროხა̈ნქა. ქალა̄ნო ისგუ ჰერ, ჩუ̂ათმოწმა̈ნ მე̄რმა̄ლე კლიპარე სიზუსტე, ში ლო̄ხოსყ მონაცემრე ნაკრებიშ ლისკე̄თეს ჩი̄ა̈შდ.

## How does it work section

about-language-req-subtitle = ჲერუ̂ა̄ლე იჰრი ნინი ლიქმეს.
about-localization-title = უ̂ებსაიტი ლოკალიზაცია
about-localization-subtitle = უ̂ებსაიტი ტექსტ ითჷრგმა̈ნი ალ ნინჟი.
...
about-voice-contrib-title = ხმოუ̂ან წვლილ
about-voice-contrib-subtitle = ხა̈ლხ ანღრი ი ტუ̄ლიხ მინე აზრს.
about-voice-validation-title = ჰერი ლიდასტურა̄̈ვი
about-voice-validation-subtitle = მე̄რმა̄̈ლ ამუ̂წმა̄̈ნიხ, ლიხმა საგუნზილ ალ ხმოუ̂ან კლიპა̈რ.
about-dataset-release-title = მონაცემრე ხორეუ̂ი ქა ლიფშუ̂დე
about-dataset-release-subtitle = ნა̈ჲ ხუ̂ა̈ქუ̂ეყნა̈უ̂იდ კრებულს ჩი 3 თუ̂ეისგა.
about-subscribe-text = ჯაკუმა Common Voice-ცახან კონტაქტჟი ლისედ?
about-speak = გა̈რგლა
about-speak-text = აუ̂ტორა̈ლ სგა̄̈ჲრიხ ხმოუ̂ან კლიპა̈რს შემოწირულ წინადება̄ლე ხორეუ̂ხა̈ნქა ლაჭუ̂და̄ნოშ.
about-listen-queue = ლიჰუ̂ნა̈რი̄ რიგ
about-listen-queue-text = ხმოუ̂ან კლიპა̈რ ესღრიხ სგა ლეზზი̄ რიგთე̄სგა, ხედუ̂ა̄̈ჲ ამა̄რე ალ კლიპა̈რს ლეჰუ̂ნა̈რიდ.
about-listen = ლა̈მჰუნა̈რ
about-listen-text = მუჭუ̂და̄̈ნიდ სწორდ ა̈დჭო̄და̄ნე ჰა მო̄მა, ეჯნოშ მომხმარებელ ამოწმა̈ნი შემოწირულ კლიპრე სიზუსტეს.
about-is-it-valid = ამშჲემა კლიპ?
about-is-it-valid-text = ხმოუ̂ან კლიპ ჟიინშა̈ნი მჷშა̈ჲდ, შომუ̂ა̈ჲ მომხმარებელ "ა̄დუს" ხაჰუ̂დი ჰერს.
about-yes-votes = ≥ 2 "ა̄დუ" ჰერ
...
about-clip-graveyard-text = კლიპრე ლასფლა̈უ̂ისგა ა̈რიხ ხმოუ̂ან კლიპა̈რ, ხედუ̂ა̄̈ჲ დეშ ათხუ̂იდხ Common Voice ხორეუ̂ისგა. იმუ̂ა̄̈ჲჟი მონაცემრე ხორეუ̂ხან, კლიპრე ლასფლა̈უ̂ხა̈ნი ჩუ ხაყა ჩამოტვირთუ̂ას.
about-get-involved = ჩაერთე სიი
about-get-involved-text-2 = ჯაკუმა ლიმურჯუ̂ი, ერე Common Voice ხოშა ა̈დსიკთენს? ჰა̈დურ ეზა̈რ! კავშირ ლახა̈ჲ ნიშგუ̂ეჲცახა̈ნ ელფოსტოშ ჰედ <discourseLink>Discourse</discourseLink> ფორუმა̈რჟი, ჰედ ქა̄ხზიზ შეტყობინება̄̈ლ საიტცახა̈ნ პრობლემა̄ლე ბედჟი <githubLink>GitHub</githubLink>, ჰედ შეუერთდი <matrixLink>Matrix</matrixLink> საზოგადოება̄̈ ჩათს.
about-stay-in-touch = იმჟი ხუ̂არდედ კაუ̂შირჟი?
...
about-stay-in-touch-text-2 = სი ჩუ ჯა̈მჲედა  Mozilla-შ ნჷნრე საზოგადოება̄̈ მე̄რმე წეუ̂რალე ლითერ<discourseLink> თემატურ საკითხა̈რჟი ლამბუ̂ა̄ლდ</discourseLink></discourseLink>, ჰედ <matrixLink></matrixLink> რჩეუ̂ა̄ლე შიშდ ლაკა̈დდ.
about-nav-why-common-voice = იმღა?
about-nav-how-it-works = იმჟი?
about-nav-partners = პარტნიორა̈ლ
about-nav-get-involved = ჩაერთე სიი
about-nav-how-it-works-2 = იმჟი ამშჲე Common Voice?
about-nav-playbook = ჟ'ა̈ხმეჴერ იმჟი ა̈ხკჷდა მონაწილეობა

## Community Playbook Content
## What is a language

about-playbook-what-is-language = მა̈ჲ ლი ნინ Common Voice-ჟი?
about-playbook-what-is-language-content-1 = ნინი ბედჟი ლაჭკუ̂ა̈რდ ხუ̂ა̄̈ჲ შუკუ̂ ა̈რი. ლიგჷრგა̈ლი̄ ლათა̈რ მოდელარე მიზნარეშდ Common Voice გუ̂აჭრა̈ჟი ფოკუსირებას "უშხუ̂ა̄რე ლა̈მჴა̈რჟი", ჰედ "ხამჲე̄დახმა ალ ნინჟი მჷგჷრგა̄ლას უშხუ̂ა̄რე ლიმჴერე, ლახ ა̈ხკუ̂ეჰნიხ?"
about-playbook-what-is-language-content-2 = ნა̈ჲ ნაკუჩ, ერე ლაგჷრგა̈ლი მოდელა̈რ ხოჩა̄მდ ა̈ცხრიდეხ მაშე̄ნე მო̄შ-მო̄შ მჷგჷრგალა̄̈ ლი̄მბუ̂ა̄̈ლსი. ამი̄შდ ხმოუ̂ან მონაცემრე ნაკრებ ხეკუ̂ე̄სე ერე ხეკუთუ̂ნო̄ლდე̄დს ხუ̂ა̄̈ჲ მო̄შ-მო̄შ ამსუ̂ა̄ლდს.
about-playbook-what-is-language-content-3 = ჲერხი ნინა̈რს ხუღუ̂ახ ხუ̂ა̄̈ჲ განსხუ̂აუ̂ება̄̈ლ გრამატიკაისგა, ლექსიკაისგა ი გამოთქმაისგა. ამი̄ ბა̈დშუ̂ ნა̈ჲ <ctaLink>სგ'ე̄ნღუ̂ა უ̂არიანტა̈ლ</ctaLink>2022 ზაუ̂. ალა საშუალებას ხაჰუ̂დი საზოგადოება̈ლს ქ'ა̄̈ნთჷშახ მინე ნინა̈რ მონაცემრე ხოშა ხორეუ̂ისგა.
...
about-playbook-how-record-quality = იმჟი ალიჲრად ხარისხია̈ნ კლიპ?
about-playbook-how-record-content-1 = ლა̈ხგჷრგა̈ლ ნორმალურ ჰერშუ̂! მთაუ̂არ ლი ისგუ ლიგჷრგა̈ლი̄ სა̈ხ − ნა̈ჲ ნაწჷხ ისგუ ბუნებრიუ̂ აქცენტ, ჰერი ჩუ̂ეულებრიუ̂ ნაკლა̈თხი, სტილ ი ინტონაცია.
...
about-playbook-how-grow-language-content-1 = მო̄შ-მო̄შ ხა̈ლხიშდ Common Voice-თე̄ჲსგა წუ̂ლილი ლიი საშუალება̄̈ ლიჰუ̂დი ეჩიი გარანტია ლი-ე მონაცემარე ხორეუ̂ს ა̈ნსჷრგები მა̈ჲ ლა̈თჲა̄ლს ლი ხოფში̄რა მა̄რე. ნა̈ჲ ჟ'ოხსყედ რესურსა̈ლ ი შაბლონა̈რ, იმშა ლისჷრგები სი ჯა̈ჲმედა!
about-playbook-how-grow-language-content-2 = მოუ̂ლენა̄̈ლ
about-playbook-how-grow-language-content-3 = სი ჩუ ჯა̈მჲედა ღონისძიებალე ლისყე̄ნე ი ხა̈ლხი ლიმურჯუ̂ი, ერე სგ'ა̄დიახ მინე წუ̂ლილ. ალა, ს'ერ ანღელი, ეჩან ხოშა იოლ ლი. ამი̄ ლისყი ჯემა̈რგ ონლაინ უ̂იდეოკონფერენცია̄̈ ხელსაწყოშ, ჰედ პირადად, უსაფრთხო ლახ ლი.<eventTemplate> ხეწდ ნიშგუ̂ეჲ შაბლონა̈რს ი რესურსა̈რს ღონისძიება̄̈ ლა̈ფშუ̂დად</eventTemplate>.
