...
about-is-it-valid-text = ხმოვან კლიპ ჟიინშა̈ნი მჷშა̈ჲდ, შომუ̂ა̈ჲ მომხმარებელ "ა̄დუს" ხაჰუ̂დი ჰერს.
...
about-stay-in-touch-text-2 = სი ჩუ ჯა̈მჲედა  Mozilla-შ ნჷნრე საზოგადოება̄̈ მე̄რმე წევრალე ლითერ<discourseLink> თემატურ საკითხა̈რჟი ლამბუ̂ა̄ლდ</discourseLink></discourseLink>, ჰედ <matrixLink></matrixLink> რჩევა̄ლე შიშდ ლაკა̈დდ.
...
about-playbook-what-is-language-content-1 = ნინი ბედჟი ლაჭკუ̂ა̈რდ ხუ̂ა̄̈ჲ შუკუ̂ ა̈რი. ლიგჷრგა̈ლი̄ ლათა̈რ მოდელარე მიზნარეშდ, Common Voice გუ̂აჭრა̈ჟი ფოკუსირებას "უშხვა̄რე ლა̈მჴა̈რჟი", ჰედ "ხამჲე̄დახმა ალ ნინჟი მჷგჷრგა̄ლას უშხუ̂ა̄რე ლიმჴერე, ლახ ა̈ხკუ̂ეჰნიხ?"
about-playbook-what-is-language-content-2 = ნა̈ჲ ნაკუჩ, ერე სამეტყველო მოდელა̈რ ხოჩა̄მდ ა̈ცხრიდეხ მაშე̄ნე მო̄შ-მო̄შ მჷგჷრგალა̄̈ ლი̄მბუ̂ა̄̈ლსი. ამი̄შდ ხმოვან მონაცემრე ნაკრებ ხეკუ̂ე̄სე ერე ხეკუთვნო̄ლდე̄დს ხუ̂ა̄̈ჲ მო̄შ-მო̄შ ამსუ̂ა̄ლდს.
about-playbook-what-is-language-content-3 = ჲერხი ნინა̈რს ხუღვახ ხუ̂ა̄̈ჲ განსხვავება̄̈ლ გრამატიკაისგა, ლექსიკაისგა ი გამოთქმაისგა. ამი̄ ბა̈დშუ̂ ნა̈ჲ <ctaLink>სგ'ე̄ნღუ̂ა ვარიანტა̈ლ</ctaLink>2022 ზაუ̂. ალა საშუალებას ხაჰუ̂დი საზოგადოება̈ლს ქ'ა̄̈ნთჷშახ მინე ნინა̈რ მონაცემრე ხოშა ხორეუ̂ისგა.
