...
about-header-description-v2 = <p>Common Voice ლი ჩიჲა̈შდ ხელმისაწვდომ ხმოვან მონაცემრე ნაკრებ, ხედუ̂ა̄̈ჲ ამშიჲე თელ მსოფლიო მოხალისე გამხმოვანებლარე ჟჷრშუ̂. ხა̈ლხს, ხედუ̂ა̄̈ჲს ხაკუ ხმოვან აპლიკაცია̄ლე ლისყი, ჩუხა̈მჲედახ ა̈ნსჷრგებლახ ალ მონაცემა̈რ მანქანურ ლითუ̂რი̄ მოდელრე ლასყე̄ნად.</p><p> ლა̈დი̄ ლადეღჟი, ხმოვან მონაცემრე ხოშა ნა̄̈თი კომპანია̄̈ლს ხეკუთვნიხ ი ალა ხოჟუ̂მე ინოვაციას. ხმოვან მონაცემრე ნაკრებ მა̄დხუ̂ა̄̈ჲ გარ ხარხ წარმოდგენილ: მა̄მაინგლისურენოვან, ფერადკანია̈ნ, შეზღუდულ შესაძლებლობა̄ლე ამსუ̂ა̄ლდა̈რს, ლეზუ̂რა̄ლეს ი  LGBTQIA+ ხა̈ლხს. ალა ეჯას ა̈ნშა̈ნი, ერე ხმოვან ტექნოლოგია საერთოდ მა̄მა ამშიჲე ფიშირ ნინრეშდ, ი იმა̄̈ჲ ამშიე, ეჩეი ჩია̈შდ ეშხუნა̈ირდ ხოჩა̄მდ შეიძლება მა̄მ ამშიჲე̄დს. ნა̈ჲ ნაკუ ამი̄  ჟილისპე ხა̈ლხი მობილიზაციოშ ჩია̄̈გ, ერე ამკა̈ლია̈რე ჰერი გაზიარებულ ლესსუ̂.
...
about-voice-validation-subtitle = მე̄რმა̄̈ლ ამუ̂წმა̄̈ნიხ, ლიხმა საგუნზილ ალ ხმოვან კლიპა̈რ.
