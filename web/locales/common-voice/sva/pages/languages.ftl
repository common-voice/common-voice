...
language-section-last-updated = ღუ̂ეშგმე ლიმხე
languages-show-more = ხეწდ ხოში̄ლს
languages-show-less = ხეწდ ხოხუ̂რა̄მ
language-meter-in-progress = პროგრეს
language-total-progress = მა̈გ
language-search-input =
    .placeholder = ლითხე̄ლი
language-speakers = მომხსენებლა̈რ
localized = ლოკალიზებულ
sentences = წინადადება̄̈ლ
language-validation-hours = საღათა̈რ
