...
your-languages = ისგუ ნინა̈რ
toward-next-goal = ეჩუნღუ̂ე̄ში მიზანთე
goal-reached = მიზან მიღწეულ ლი
...
both-speak-and-listen-long = ერქჷდა (გა̈რგლა ი ლიჰუ̂ნა̈რი)
daily-goal = ჩილა̈დღია̈ მიზან
...
track-progress = ხათე̄უ̂რა̄̈ლ პროგრესს ამჩუ ი ისგუ̂ა სტატისტიკა̄̈ გვერდჟი
return-to-edit-goal = ა̈ნტხ ამხაუ̂ ი დაარედაქტირე ისგუ მიზან შომუ̂ა̄̈ჲ ჯიცხე̄ნს.
share-goal = გააზიარე მიშგუ მიზან
