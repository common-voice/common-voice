...
action-items-section-subtitle = ჩი̄ს ჩუ ხა̈მჲედა ჟ'ა̈ნჷნთხილას მიჩა ნინ, ქ'ა̄ნცოცხლაუ̂ას ი ანკჷლთხას ტექსტი გაზიარებოშუ̂, ლასყე̄ნიშ, კურირებოშ.
...
download-contribution-certificate-content = ატუ̂ირთე სერტიფიკატ ისგუ̂ა ღონისიება̄ლეშდ ხედ ისგო̄უ̂დ წვლილ ემა ათხა̈ჲ Common Voice-თე — ისგუ̂ურ ალა შეუძლებელ ლი!
# label for button
download-contribution-certificate-action = ჟ'ა̄̈ხიკ სერტიფიკატ
contribute-github = სგ'ა̄თხა̈ჲ ისგუ წუ̂ლილ GitHub-თე
contribute-github-content = ალ პროექტ მა̄მ ისყო̄ლ ლახ მა̄მა ისგუნა̈ირ ხა̈ლხ. 🎉 Common Voice-თე ჩართუ̂ა̄̈ ხუ̂ა̄̈ჲ ნუკუ̂იშ შუკუ̂ ა̈რი - სი მა̄მ ჯაწჷხ კოდირება̄̈ ლიხა̈ლ ისგუ წუ̂ლილი ლა̈ჲე̄სგიდ ამხაუ̂თე̄ჲსგა!
# label for button
contribute-github-action = სგ'ა̄თხა̈ჲ ისგუ წუ̂ლილ GitHub-თე
