...
language-text-card-content = Δημιουργήστε ή μοιραστείτε μηνύματα προτροπής δημόσιου τομέα, προτάσεις και κείμενο για μετάφραση, μικρά γλωσσικά μοντέλα και πολλά άλλα.
coming-soon = Προσεχώς
