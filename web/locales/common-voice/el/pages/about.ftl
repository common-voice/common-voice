...
how-does-it-work-text = Δημιουργούμε πληθοποριστικά ένα σύνολο δεδομένων φωνών ανοικτού κώδικα. Δωρίστε τη φωνή σας, επικυρώστε την ακρίβεια των αποσπασμάτων άλλων χρηστών, βελτιώστε το σύνολο δεδομένων για όλους.
...
about-no-votes-text = Όταν ένας χρήστης απορρίψει ένα απόσπασμα, αυτό θα επιστρέψει στην ουρά. Αν απορριφθεί για δεύτερη φορά, θα μετακινηθεί στο Κοιμητήριο αποσπασμάτων.
...
about-clip-graveyard-text =
    Το Κοιμητήριο αποσπασμάτων περιλαμβάνει τα αποσπάσματα που δεν κατάφεραν να ενταχθούν στο σύνολο δεδομένων του Common Voice. Όπως και το σύνολο δεδομένων, το Κοιμητήριο είναι διαθέσιμο προς λήψη.
    
    Θα θέλαμε να ευχαριστήσουμε τους εξής ανθρώπους και οργανισμούς για τη βοήθειά τους με το έργο:
...
about-playbook-how-grow-language-content-8-v2 = <strong>Γίνετε δημιουργικοί!</strong> Η κοινότητα για τη δική σας γλώσσα θα είναι μοναδική και αυτοί είναι μόνο μερικοί τρόποι για να ξεκινήσετε. Σκεφτείτε το ενδεχόμενο να προσθέσετε τα κανάλια της κοινότητάς σας στο έγγραφο <communitiesLink>COMMUNITIES.md στο GitHub</communitiesLink>.
