...
keep = Διατήρηση
remove = Αφαίρεση
keep-info = Οι ανώνυμες ηχογραφήσεις σας θα παραμείνουν στο σύνολο δεδομένων του Common Voice. Μόλις διαγράψετε το προφίλ σας, δεν θα μπορείτε πλέον να αιτηθείτε τη διαγραφή τους από το σύνολο δεδομένων.
