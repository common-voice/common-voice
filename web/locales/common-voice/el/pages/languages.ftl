...
get-involved-text =
    Ευχαριστούμε για το ενδιαφέρον σας σχετικά με τη συνεισφορά στα { $lang }. Εργαζόμαστε σκληρά για να ετοιμάσουμε κάθε γλώσσα και ενημερώνουμε συνεχώς
    τις ομάδες μέσω email. Αν θέλετε να συνεισφέρετε, συμπληρώστε το email σας παρακάτω.
...
get-involved-privacy-info = Υποσχόμαστε να χειριστούμε τις πληροφορίες σας με προσοχή. Διαβάστε περισσότερα στη <privacyLink>Δήλωση απορρήτου</privacyLink> μας.
