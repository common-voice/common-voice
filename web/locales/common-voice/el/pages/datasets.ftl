...
datasets-headline-mdc = Το σύνολο των δεδομένων του Mozilla Common Voice είναι πλέον διαθέσιμο αποκλειστικά στο Mozilla Data Collective.
# New/upcoming datasets page headline text
datasets-positioning-mdc =
    Από το Common Voice 23.0, όλο το σύνολο των δεδομένων του Common Voice είναι διαθέσιμο αποκλειστικά για λήψη μέσω του Mozilla Data Collective!
    
    Αυτή η σελίδα λειτουργεί ως αρχείο ιστορικού για προηγούμενες εκδόσεις του συνόλου δεδομένων του Mozilla Common Voice. Οι εκδόσεις αρχείων θα πρέπει να χρησιμοποιούνται μόνο σε συγκεκριμένα ερευνητικά σενάρια, όχι για εκπαίδευση, ώστε να σεβαστούν τα θέλω όσων έχουν ζητήσει να αποκλειστούν οι συνεισφορές τους.
datasets-speech-bubble-content = Συναρπαστικά νέα! Η Αυθόρμητη ομιλία έρχεται σύντομα! Μείνετε συντονισμένοι για ενημερώσεις και φροντίστε να ελέγξετε το <discordLink>Discord</discordLink> μας για τις πιο πρόσφατες πληροφορίες.
language = Γλώσσα
...
data-explanatory-text = Πιστεύουμε ότι οι μεγάλες και δημόσιες βάσεις φωνητικών δεδομένων προάγουν την καινοτομία και τον υγιή εμπορικό ανταγωνισμό στη φωνητική τεχνολογία που βασίζεται στη μηχανική μάθηση. Πρόκειται για μια παγκόσμια προσπάθεια και προσκαλούμε τον καθένα να συμμετάσχει. Στόχος μας είναι να αρθούν οι περιορισμοί της φωνητικής τεχνολογίας, αντανακλώντας την ποικιλία των φωνών από όλο τον κόσμο.
