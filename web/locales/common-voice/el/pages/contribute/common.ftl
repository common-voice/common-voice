...
no-sentences-for-variants = Ενδέχεται να μην διατίθενται προτάσεις στην παραλλαγή της γλώσσας σας! Αν αισθάνεστε άνετα, μπορείτε να αλλάξετε τις ρυθμίσεις σας για να βλέπετε άλλες προτάσεις στη γλώσσα σας.
...
contribution-varying-pronunciations-description-extended = Από την άλλη, αν θεωρείτε ότι ο αναγνώστης ίσως να μην έχει έρθει ποτέ ξανά αντιμέτωπος με τη λέξη και δεν μάντεψε σωστά την προφορά της, κάντε απόρριψη. Αν δεν γνωρίζετε σίγουρα, κάντε κλικ στο κουμπί «Παράλειψη».
