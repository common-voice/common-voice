...
bulk-upload-additional-information = Jolic cośo dalšne informacije wó toś tej dataji, stajśo se z <emailFragment>commonvoice@mozilla.com</emailFragment> do zwiska.
template-file-additional-information = Jolic cośo dalšne informacije wó toś tej dataji, kótarež njejsu w pśedłoze wopśimjone, stajśo se z <emailFragment>commonvoice@mozilla.com</emailFragment> do zwiska.
...
write-contribute-menu-aria-label = Meni nastajenjow Pisaś
