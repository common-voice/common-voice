...
download-contribute-menu-aria-label = Ześěgnjeńske nastajenja za pśistup k datam Common Voice
datasets-show-more = Wšykne datowe sajźby pokazaś
datasets-show-less = Nejnowše datowe sajźby pokazaś
