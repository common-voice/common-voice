...
error-title-429-no-time = Пребрзо идеш. Молим те, успори и покушај поново за тренутак.
error-title-429-with-time =
    { $retryAfter ->
        [one] Пребрзо идеш. Покушај поново за { $retryAfter } секунду.
        [few] Пребрзо идеш. Покушај поново за { $retryAfter } секунде.
       *[other] Пребрзо идеш. Покушај поново за { $retryAfter } секунди.
    }
