...
record-platform-webview = Potser heu arribat aquí fent clic en un enllaç d'una aplicació de xarxes socials. Esteu utilitzant un navegador integrat a l'aplicació que no admet l'enregistrament d'àudio.
record-platform-not-supported-webview = En dispositius mòbils podeu contribuir utilitzant el navegador del vostre sistema…
