listen = ݭُنڈِؤ
listen-subtitle = کھنٹَنی تصدیقہ مِنزی امَنی مدد کېرِؤ
listen-instruction = { $actionType }<playIcon></playIcon>تسُوئیں جُملا سئ ژَوونا؟
...
listen-contribute-menu-tooltip = ریڈِنگَنی توثیق کېرِؤ۔ نقل نامَنہ جائزہ گوو
validate-readings-menu-item-tooltip = تانُو گاݭٹےصارِفَنی رکاڈ بِسنت ریڈِنگَنی توثیق کېرِؤ
review-transcriptions-menu-item-tooltip = تانُو گاݭٹے صارِفَنی بکَنہ جمع کېرَئیسنت نقل نامَنہ جائزہ گوو
