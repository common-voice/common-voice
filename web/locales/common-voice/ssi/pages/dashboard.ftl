...
visibility-explainer = یو کتار آپ کے لیڈر بورڈا کا نجریے کُو کابُو کرتی ہے۔ جِدؔ چھپی جاوئے تو، آپ کی پرگتی اپٹؔی ہؤگی. اس کا متلب ہے کہ آپ کا پھوٹُو ، چلانواڑے کا ناو اور پرگتی لیڈر بورڈاپ  چاوی نائی ہؤے۔ دھیانام راکھو کہ لیڈر بورڈ ریفریش بدلاو کُو آباد کرنے نتر ~{ $minutes }منٹ لگاوتا ہے۔
