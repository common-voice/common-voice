...
not-receiving-emails-info =
    آپ ہلی لکشے کی یاد دؔوانواڑے جِدؔا ای میلز وسول <bold>نائی</bold> کرنے کے لئے تیار کیا گیا ہے، میرا
    کامن وائس کے بارے میں پیشرفت کی تازہ کاریاں اور نیوز لیٹر
