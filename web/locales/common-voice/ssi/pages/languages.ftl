...
get-involved-text =
    { $lang } میں پاتی ٻاݨیم تھاری رُچیا نتر تھارا دھنواد۔ ہم ہر ٻولیا کُو لانچا نتر تیار کرنے اور ٻݨائی راکھݨیں نتر کٹھن محنت کرتے ہے
    سںٚگّٹھنے کُو ای میلا جریئے اپ ڈیٹ کرا. اگر تھم یوگدان کرنا چاہوتے ہے تو، کِرپا کری کن نیچے اپنا ای میل دؔی دؔو.
get-involved-form-title = { $lang } اپ ڈیٹسا نتر سائن اپ کرو:
get-involved-email =
    .label = ای میل
get-involved-opt-in = ہاوے، مِسکُو ای میل دِؔگلاو. ہوں سادھارݨ اواجاپ اس ٻولیا کی پرگتیا باریم  چاٹؔکا رہݨا چاہوتا ہے۔
