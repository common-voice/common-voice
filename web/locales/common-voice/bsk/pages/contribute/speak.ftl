...
record-cta = record ećar duun
record-platform-not-supported = mimar baxṣiṣ etin. maa platform e gute kheenulo madat ayeći bi
record-platform-not-supported-desktop = maa desktop ate devices download no miriin ce duunas maamay baan
...
record-cancel = dubaara recording cancel etin
record-instruction = daa jumlan śatine ġatanin
...
record-abort-text = muuto phat ne niyas matlab maa etum duro chilane meeymi
...
review-aborted = upload cat manimi. maymo recording eeras ray ećaana?
