...
speak-loading-error = ვეგორ თქვანო ოკითხირალი ზიტყვასქვილეფქ. ქორთხინთ, კინ ქოცადათჷნი.
...
target-segment-first-card = თქვა წილი მიშაიღუნა ჩქინი მაართანი მიზანიერი სეგმენტიშა
...
target-segment-learn-more = დიგურე უმოსი
change-preferences = პარამეტრეფიში თირუა
login-signup = მიშულა / აკოქიმინუა
vote-yes = ქო
vote-no = ვარ
datasets = მუნაჩემეფიში ნაკათა
languages = ნინეფი
about = ჩქინ გურშენი
partner = მალათირე
...
report = მოხსენება
report-title = მოხსენებაში ჯღონა
report-ask = მუ კილს ორწყეთ თე ზიტყვასქვილეფს?
...
report-offensive-speech = ნინამოწიკვილი ჩიება
report-offensive-speech-detail = ინნაჭარას უმანგუ დო ნინამოწიკვილი ზიტყვეფი რე.
report-other-comment =
    .placeholder = კომენტარი
success = გომორძგუა
continue = გაგძელება
report-success = მოხსენებაქი წიმოძინელო ქიჯღონინჷ
...
shortcut-discard-ongoing-recording-label = მალი ინოჭარუაში გაურქვება
...
contribution-criteria-link = ქიგეგით წილიში მიშაღალაში კრიტერიუმეფი
contribution-criteria-page-title = წილიში მიშაღალაში კრიტერიუმეფი
contribution-criteria-page-description = ქიგეგით მუს ოკო დეკვირათ ინოჭარილეფიში მორჩქილაფას დო გაუჯგუშით ხონარიში ინოჭარუა!
...
contribution-misreadings-example-1-title = ახალ დუდმახვენჯი გიშაგორილი რე.
contribution-misreadings-example-2-title = ახალ დუდმახვენჯი გიშაგორილი რე.
...
contribution-misreadings-example-4-explanation = [ზედმეტი ზიტყვა რე ინოჭარილი]
contribution-misreadings-example-5-title = ყავაში ოშუმუშა გალე გუმმურთ.
contribution-misreadings-example-6-title = ყავაში ოშუმუშა გალე გუმმურთ.
contribution-misreadings-example-6-explanation = [ოკო რდას "ჩქი ვორეთ"]
contribution-misreadings-example-7-title = ყავაში ოშუმუშა გალე გუმმურთ.
