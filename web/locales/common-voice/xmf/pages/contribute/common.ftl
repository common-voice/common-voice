...
contribution-misreadings-description-extended-list-3 = დაკუნტორებული რე ზიტყვა, მაგალთო იკითხირუაფუ "კოჩიე", მარა ჭარუ "კოჩი რე" ვარდა მიკორთელო.
...
contribution-misreadings-example-3-explanation = [ინოჭარილი მეჭყვადილი რე ზიტყვაში გათებაშახ]
