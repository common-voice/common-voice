...
contribution-misreadings-example-3-explanation = [ინნაჭარა მეჭყვადილ რე ზიტყვაში გათებაშახ]
...
contribution-varying-pronunciations-description = მივესალმებუთ ჩიებაში შხვადოშხვა კილოეფს! თხილას ორდათ ინნაჭარაშ ვარებაშახ, მუჟამს საქვარ ოხუ ზიტყვაშ უწორო თქუალას, მახვილიშ შხვა არდგილს გეშკვაფას ვარდა კითხვაშ ლიშანიშ გილაჸუბეჩუას. მუშენდა ართ ნინას ბრელ შხვადოშხვანერი თქუალა რე, ნამუშ უმენტაშობა შილებე მორჩქილაფირი ვაგაფუდანინი. ქორთხინთ, გეთვალისწინათ თინეფ ხოლო, მით შხვადოშხვანერო იჩიებუნი.
...
contribution-varying-pronunciations-example-1-explanation = [წინადადებაშ ბოლო ხმოვანქ კანკალე დიალექტის შილებე დეგინძორასჷნი].
contribution-varying-pronunciations-example-2-title = ხე გეჭოფუ.
contribution-varying-pronunciations-example-2-explanation = [კითხვაშ ნაწილაკის (ქო ვარდა ვარ) ირო მახვილ გიაშკუმალუ]
...
contribution-volume-description = ბუნებრივ რე განსხვავება მაკითხირალეფიშ ხონარიშ დონეეფს შკას. ვარიას ქიგუნჭირით, მუჟამს ხონარ თიცალ მაღალ რე, ინნაჭარა მითმეჭყორდუ. ვარდა თიცალ დაბალ რე, ნაჭარაშა თოლიშ მეუნაფაშ უმუშო აზრიშ გჷშაღალა გიჭირა.
...
contribution-just-unsure-title = ეჭვი გოპარუნანო?
