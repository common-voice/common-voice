...
sentence =
    .label = წინადადება
sentence-input-placeholder = გემშიღით თაქ თქვანი საყოველთაო საკუთრებაშე წინადადება.
small-batch-sentence-input-placeholder = გემშიღით თაქ თქვანი საყოველთაო საკუთრებაშე წინადადებეფი.
citation-input-placeholder = ქიმუთითით თქვანი წინადადებეფიში წყარო (აუცილებელ რე)
citation =
    .label = წყარო
sc-write-submit-confirm = ვადასტურენქ, ნამდა თე წინადადება <wikipediaLink> საყოველთაო საკუთრება რე </wikipediaLink> დო მიღუ თიში ეტვირთუაშ ნება.
sc-review-write-title = მუ წინადადებეფი შემლებუ გევუძინენი?
sc-review-small-batch-title = მუჭო გევუძინა ართ-ჟირ წინადადება
new-sentence-rule-1 = <noCopyright> საავტორო უფლება </noCopyright> ვაუღუნ ფერი <cc0>cc</cc0>
new-sentence-rule-2 = [15 ვარა ნაკლები ზიტყვამი წინადადება]
...
new-sentence-rule-7 = ქიმუთითით მანგი ციტატა.
new-sentence-rule-8 = იდეალურო ბუნებრივი დო ოჩიებე ნინათ (ანდვილას გეშეკითხანინი)
login-instruction-multiple-sentences = <loginLink> მიშელით </loginLink> ვარდა <loginLink>  გაკეთით </loginLink> ანგარიშ ართ-ჟირ წინადადებაშ გიოძინალო
how-to-cite = წყარო მუჭო მეუთითანი?
...
bulk-upload-additional-information = ქუგოკონა მუთუნ ინფორმაციაშ გეძინა თე ფაილიშ გურშენდა, რთხინთ, ქუმობჭარათ commonvoice@mozilla.com</emailFragment>
template-file-additional-information = ქუგოკონა მუთუნ ინფორმაციაშ გეძინა თე ფაილიშ გურშენდა, რთხინთ, ქუმობჭარათ commonvoice@mozilla.com</emailFragment>
try-upload-again = ხოლო ქოცადით ფაილიშ თაქ გინოღალა.
try-upload-again-md = ხოლო ქოცადით ეტვირთუა.
select-file = გეჲშაგორით ფაილი.
select-file-mobile = ფაილიშ გუშაგორუა ეიოტვირთალო.
accepted-files = ფაილიშ მეღებულ სახეობა რე: ხვალე .tsv
