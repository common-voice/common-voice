...
error-something-went-wrong = ბოდიშის გიხადენთ, მუდგარენ ხარვეზიქ გორჩქინდ
error-clip-upload = ათე ინნაჭარაქ ხოლო ვეგიძინინ, გოკონანო ხელახაშო ქოცადათჷნი?
error-clip-upload-server = ინნაჭარაშ გეძინაქ ვემიხერხინ. ახაშო გონწყით ხასილა ვარდა კინ ქოცადით.
