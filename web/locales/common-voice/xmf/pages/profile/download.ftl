...
download-start = პროფილიშ მუნაჩემეფიშ გიმოჭარუა
download-request = ინნაჭარეფიშ მოთხუალა
download-requests = კინოხონი ინნაჭარეფიშ გიმოჭარუაშ მოთხუალა
download-requests-info = მუჟამს მითხინთ თქვან ინნაჭარეფსჷნი, ჩქი თინეფს ფშაყარანთ ართი ვარა ართ-ჟირ ZIP ფაილს. თაქ რე თქვანი კინოხონი მოთხუალეფი:
download-request-button = გიმოჭარუა
