...
self-citation-explanation = Sådan citerer du dig selv, hvis du selv har skrevet indholdet.
...
adding-sentences-subheader-numbers = Tal
adding-sentences-subheader-numbers-explanation = Der bør ideelt set ikke være cifre i kildeteksten, fordi de kan give problemer, når de læses højt. Måden et tal læses på afhænger af kontekst og kan skabe forvirring i datasættet. For eksempel kunne tallet "2409" læses nøjagtigt som både "fireogtyve nul ni" og "to tusinde fire hundrede ni".
