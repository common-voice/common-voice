...
sc-review-lang-not-selected = تمي ڪوئي پڻ ٻولي نٿِي سُونڍي۔ ميرڀونئِي ڪرينَ تمارا <profileLink>Profile</profileLink> مانه زائو ان ٻولي سُونڍو۔
sc-review-title = جُملون رو جائزو ليو
sc-review-loading = جُملا Load ﻿﻿﻿ٿئه ريا۔۔۔
...
sc-review-form-usage = جُملا رِي من﻿ظُورِي ۿارُو ۿاوَئہ پاهئہ Swipe  ڪرو۔ رد ڪريا ۿارُو ڏاوَئہ پاهئہ Swipe ڪرو۔ ساڏيا ۿارُو اُونسو Swipe ڪرو۔ <strong> آپرو جائزو ۮيوو مت ڀُولو!</strong>
# Variables:
...
sc-criteria-item-4 = جيڪيۮِي جُملو اِيئا معيار مانه پُورو اُوترئہ، تون click ڪرو&quot; منظُور&quot; ۿاوَئہ پاهئہ بٽڻ مانه click ڪرو۔
sc-criteria-item-5-2 = جيڪيۮِي جُملو اِيئا معيار مانه پُورو اُوترئہ، تون click ڪرو، &quot; رد &quot; ڏاوَئہ پاهئہ ۮِيڌل بٽڻ مانه click ڪرو۔ جيڪيۮِي تمي جُملا را ڀارام ۾ مطمئن نٿِي، تون هايا جُملا نئہ ساڏينَ آڳۯ وڌي هيڪوه۔
