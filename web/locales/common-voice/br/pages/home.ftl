...
join-newsletter = Koumantit d'hol lizher-kelaouiñ evit resev keleier eus ar raktres.

## What's public

whats-public = Petra a vez embannet ?
email-not-public = Ne vo rannet ho chomlec'h postel gant den.
recordings-and-locale-public = Foran e vo an niver a enrolladennoù hoc'h eus graet hag e pe raktres hoc'h eus kemeret perzh.
username-optin-public = Gallout a rit dibab ma vo diskouezet hoc’h anv-implijer pe get.
demographic-deidentified-clarity-2 = Ar roadennoù personel diret lakaet (da sk. an oad, ar jener, ar yezh pe ar pouez-mouezh) ne vint ket biken lakaet a-wel d'an holl  war ho profil, ha ne vint ket liammet d’ho kont er strobad roadennoù. An enrolladennoù son a vo liammet gant ar roadennoù-se evit ma vefe resisoc’h an dielfennadenn - da skouer e c'hallfe un enklasker kaout c’hoant da glask ur patrom gourdonañ evit ul lodenn resis eus ar boblañs.
username-email-not-demographic = Ne vo ket liammet hoc’h anv-implijer hag ho chomlec’h postel gant ar roadennoù embannet.

## Landing

welcome-staff = Degemer mat dit, implijad e { $company } !
help-contribute = Gallout a rit kemer perzh e savidigezh ur strobad roadennoù mouezh liesseurt ha frank a wirioù en ur grouiñ ur profil war Common Voice hag en ur reiñ ho mouezh.
login-company = Kevreit / Emezelit gant chomlec’h postel { $company }
profile-not-required = N'eo ket ret bezañ krouet ur profil evit kemer perzh met talvoudus eo memes tra. Gwelit perak a-is.
read-more-about = Lenn hiroc’h war ar bajenn A-zivout

## NAV ITEMS

answer-questions = Respontit d'ar goulennoù <small>(A-raok pell)</small>
answer-questions-coming-soon = Respont da c'houlennoù <small>(a-raok pell)</small>
review-transcriptions = Adwelet an treuzskrivadurioù <small>(A-raok pell)</small>
...
hero-subtitle-1 = <bold>Perak e tlefe an naouegezh artifisiel mont en-dro evit un nebeud yezhoù er bed hepken ?</bold>
hero-subtitle-2 = Mont a ra hor yezh da stummañ hon istor, hor c'humuniezh, hor sevenadur. Savomp ar strobadoù roadennoù a fell deomp kaout.
# icon is an arrow that points downwards
get-started = Kregiñ ganti <icon><icon>
