...
about-playbook-how-add-sentences-content-3 = Можете да използвате <scraperLink>извличането на изречения</scraperLink>, за да използвате кратки изречения от Wikipedia.

## How to record quality

about-playbook-how-record-quality = Как да запиша висококачествен гласов клип?
about-playbook-how-record-content-1 = Говорете с обикновения си глас! Начинът, по който говорите е добре дошъл - искаме акцента такъв, какъвто е. Искаме обичайните обем, стил и интонация.
about-playbook-how-record-content-2 = Избягвайте твърде много заден шум - трябва да се чува лесно.
about-playbook-how-record-content-3 = Прочетете внимателно изречението - не пропускайте, променяйте или добавяйте думи.
about-playbook-how-record-content-4 = Уверете се, че платформата прави запис, преди да започнете да говорите, и че спира едва след като приключите.
about-playbook-how-record-content-5 = <accuracyLink>Вижте повече относно критериите за точност.</accuracyLink>
...
about-playbook-how-funded-content-2 = Непрекъснатото публикуване на наборите от данни, подобряването на платформата и провеждането на <africaMradiLink>общностни програми</africaMradiLink> струват много пари.
about-playbook-how-funded-content-3 = Ако вие или вашата организация желаете да допринесете за проекта, можете да направите <donateLink>дарение</donateLink> или да се свържете с нашия екип за партньорства на <emailFragment>commonvoice@mozilla.com</emailFragment>.
