...
activity-needed-calculation-fixed = 100 души, които записват по 100 изречения на ден, могат да генерират 13 часа аудио. При поддържане на това темпо, за по-малко от 3 месеца могат да бъдат достигнати 1000 часа.
