...
first-cta-gender-select-default-option = ఒక ఎంపికను ఎంచుకోండి
first-cta-gender-select-help-text =
    .label = మీ లింగాన్ని మీరు ఎలా వివరిస్తారు?
...
# menu item
read-sentences = వాక్యాలను చదవండి
# text wrapped in <small></small> will be shown in a smaller font size
read-sentences-coming-soon = వాక్యాలను చదవండి <small>(త్వరలో వస్తుంది)</small>
