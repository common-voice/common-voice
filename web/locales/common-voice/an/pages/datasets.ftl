...
download-dataset-tag = Selecciona lo conchunto de datos d'a luenga deseyeada y tría la versión que quiers baixar.
...
dataset-splits = Divisions (edat y sexo)
...
why-donate-datasets-page = Mozilla Common Voice ye lo conchunto de datos de voces ubiertas colectivo mas diverso d'o mundo, y nos financiamos integrament con donativos. Cuesta cuasi un millon de dólars a l'anyo alochar los conchuntos de datos y millorar la plataforma pa las mas de 100 comunidaz lingüisticas que penden d'o que femos. Si valoras los datos ubiertos y inclusivos, <b>fe un donativo hue!</b>
...
confirm-join-mailing-list = Quiers suscribir-te a la lista de correu de Common Voice
...
sha256-checksum-copied = S'ha copiau la suma de verificación SHA256
sha256-checksum-copied-error = No s'ha puesto copiar la suma de verificación SHA256
clipboard-not-supported = Lo portapapers no ye compatible
no-information-available = Sin información disponible
dataset-metadata-sex = Sexo
# dataset metadata - age of contributor
dataset-metadata-age = Edat
donate-modal-message = Lo conchunto de datos se ye baixando!
dataset-donate-modal-heading = Sabebas que…
donate-modal-explanation-1 = Cuesta cuasi un millor de dólars per anyo alochar los conchuntos de datos y millorar la plataforma pa las mas de 100 comunidaz lingüisticas que penden d'o que femos?
# Text in <bold></bold> will shown in bold
donate-modal-explanation-2 = <bold>Si valoras los datos ubiertos y inclusivos, fe un donativo hue!</bold>
...
license-mixed = Mixta
# MENU ITEM TOOLTIPS
download-contribute-menu-tooltip = Descargar las nuestras bases de datos de voz
# MENU ITEM ARIA LABELS
download-contribute-menu-aria-label = Opcions de descarga pa acceder a los datos de Common Voice
