...
about-listen-queue = Coda d'ascuita
about-listen-queue-text = Las gravacions de voz se ninvian a una coda que las prepara pa poder ascuitar-las.
about-listen = Ascuitar
...
about-is-it-valid-text = Cuan un usuario apreba una gravación, amaneixerá como "valida".
...
about-no-votes-text = Cuan un usuario refusa una gravación de voz, torna ta la coda. Si se refusa una segunda vegada, la gravación de voz se treslada a lo fosal de gravacions.
