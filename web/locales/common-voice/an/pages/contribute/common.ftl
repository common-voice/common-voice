...
report-ask = Cuál ye lo problema d'esta frase?
...
report-different-language-detail = Ye escrita en un idioma distinto a lo que yo charro.
...
contribution-criteria-page-description = Comprende que cal mirar cuan escuites fragmentos de voz y aduya a fer tamién mas rica la tuya voz.
contribution-for-example = per eixemplo
contribution-misreadings-title = Lecturas erronias
contribution-misreadings-description = Cuan escuites, compreba cudiadosament que lo que s'ha gravau ye exactament lo que s'ha escrito; refusa-lo encara que nomás i haiga errors menors. Una error muito común.
...
contribution-misreadings-description-extended-list-3 = Leyer fendo elisions que no se troben en o texto. Per eixemplo, pronunciar «ta casa» si en o texto sale «enta casa», u viceversa.
...
contribution-varying-pronunciations-description = Para cuenta antes de refusar un fragmento perque lo lector ha pronunciau malament una parola. L'aragonés tien una ampla variedat de pronuncias, y puet estar que no l'haigas sentiu en a foyeta. No se pronuncia igual en aragonés occidental, oriental, central u meridional. D'esta manera puez apreciar a aquellos que parlan d'una manera diferent a la tuya.
contribution-varying-pronunciations-description-extended = D'atra man, si creyes que la persona que leye no conoixeba ixa parola y simplement la ha pronunciada mal, alavez refusa-la. Si no yes seguro, preta lo botón "omitir" y atro revisor avaluará si ye ixe caso u no.
contribution-varying-pronunciations-example-1-title = Éls minchan mengranas.
contribution-varying-pronunciations-example-1-explanation = [«Éls» se puede pronunciar de diferents trazas, seguntes la variant dialectal]
...
contribution-background-noise-description = Queremos que los algoritmos d'aprendizache automatico sigan capables de maniar diferents ruidos de fondo. Se pueden acceptar rudios relativament fuertes, siempre que no impidan ascuitar la totalidat d'o texto. La musica de fondo tranquila ye bien; la mosica masiau fuerte, que evite que haigaz se sentir totas las parolas, no lo ye.
...
contribution-just-unsure-description = Si te trobas con bella cosa no cubierta con estas directrices, vota seguntes lo tuyos millor cirterio. Si realment no lo puez decidir, preta lo botón Omitir y pasa a la siguient voz cuan quieras.
