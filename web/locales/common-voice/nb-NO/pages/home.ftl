...
email-subscription-title-v3 = Registrer deg for å få oppdateringer fra Common Voice og Mozilla Foundation
...
scripted-card-header = Manusbasert tale
...
find-us-on-matrix-content-v2 = Matrix er en åpen, lett protokoll for desentralisert sanntidskommunikasjon og Mozillas foretrukne åpne diskusjonsplattform. Vi er i rommet «common-voice:mozilla.org».
# label for button
find-us-on-element-action-1 = Element
find-us-on-matrix-action-2 = Andre klienter
