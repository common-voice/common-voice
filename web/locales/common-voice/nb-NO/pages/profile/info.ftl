...
delete-api-key-confirmation-description = Er du sikker på at du vil slette API-innloggingsinfoen <bold>{ $apiKeyName }</bold>? Denne handlingen kan ikke angres.
...
add-api-key-name-error = Legg til et API-innloggingsinfonavn
