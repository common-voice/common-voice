...
record-error-unknown-format = Kunne ikke fastslå lydformatet. Prøv å bruke en annen nettleser.
...
thanks-for-voice-toast-error = Det oppstod en feil under innsending av informasjon om stemmen din
