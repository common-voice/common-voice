...
contribution-varying-pronunciations-description-extended = På den annen side, hvis du tror at leseren sannsynligvis aldri har kommet over ordet før, og bare gjetter feil på uttalen, kan du avvise. Hvis du er usikker, bruk hopp over-knappen.
...
contribution-reader-effects-description = De fleste opptak er av folk som snakker med sin naturlige stemme. Du kan godta en og annen ikke-standard innspilling som blir ropt, hvisket eller åpenbart levert med en "dramatisk" stemme. Avvis sangopptak og de som bruker en datamaskinsyntetisert stemme.
