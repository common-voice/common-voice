...
request-for-scripted-speech-toggle = Forespørsel om manusbasert tale
...
need-help-deciding-platform-explanation-1 = <strong>Manusbasert tale</strong> (tradisjonelt det du kjenner som Common Voice) er hvor du kan lese setninger høyt på språket ditt.
...
request-language-found-pontoon-not-launched =
    ...
    Du kan legge til rette for språkstart på <strong>manusbasert tale</strong> ved å oversette
...
request-language-found-cv-contribution =
    Hurra! Språket ditt er allerede live på Common Voice <strong>manusbasert tale</strong>.
    Du kan bidra <homePageLink>her</homePageLink>.
request-language-found-cv-sentences-lack =
    Språket ditt er allerede på språklisten til Common Voice.
    Du kan legge til rette for språkstart på <strong>manusbasert tale</strong> ved å bidra med setninger <sentencesContributionLink>her</sentencesContributionLink>.
request-language-found-spontaneous-speech =
    Språket ditt er allerede tilgjengelig på Common Voice <strong>spontan tale</strong>.
    Klikk <spontaneousSpeechLink>her</spontaneousSpeechLink> for å bidra – husk å endre bidrags-/dataspråket før du begynner å bidra!
request-language-already-available-scs = Manusbasert tale allerede tilgjengelig
request-language-already-available-sps = Spontan tale allerede tilgjengelig
