...
record-platform-not-supported-webview = ໃນອຸປະກອນມືຖືທ່ານສາມາດປະກອບສ່ວນໂດຍໃຊ້ຕົວທ່ອງເວັບຂອງລະບົບຂອງທ່ານ…
...
record-error-empty-recording = ບໍ່ມີການບັນທຶກສຽງ. ກະລຸນາກວດສອບໄມໂຄຣໂຟນຂອງທ່ານ ແລະ ລອງໃໝ່ອີກຄັ້ງ.
record-error-unknown-format = ບໍ່ສາມາດລະບຸຮູບແບບສຽງໄດ້. ກະລຸນາລອງໃຊ້ໂປຣແກຣມທ່ອງເວັບອື່ນ.
