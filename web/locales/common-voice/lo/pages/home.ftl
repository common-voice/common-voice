...
email-subscription-title-v3 = ລົງທະບຽນເພື່ອຮັບການອັບເດດຂອງ Common Voice ແລະ Mozilla Foundation
...
review-questions = ຄຳຖາມທົບທວນຄືນ
...
about-menu-aria-label = ເມນູເພື່ອເຂົ້າເຖິງການຮ່ວມມື, ສື່ມວນຊົນ ແລະ ເລື່ອງລາວຕ່າງໆ, ຊຸມຊົນ ແລະ ພາສາຕ່າງໆ
