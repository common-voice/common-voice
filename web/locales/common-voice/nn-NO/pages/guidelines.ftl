...
misreadings-example-1 = Vi skal ut og skaffe kaffi.
misreadings-example-2 = Vi går ut for å skaffe meir kaffi.
misreadings-example-3 = Vi går ut for å skaffe meir kaffi.
...
code-switching-ask-bilingual-contexts-explanation-example = «Når du snakkar med søskenbarna dine, blandar dokker engelsk og norsk?»
