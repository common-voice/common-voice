...
partnerships-header-text = Det skal mykje til for å gjere Common Voice til røyndom! Vi gjer det ikkje åleine. Interessert i å samarbeide med oss? Vi vil gjerne høyre frå deg.
...
partnerships-community-description = Samfunnet er det bankande hjartet til Common Voice – dei kjem frå heile verda, og er språkaktivistar, vitskapsmenn og kunstnarar. Du kan lære meir om korleis du blir involvert på <about>Om</about>-sida vår, og i <community>Felleskapsguiden</community>. Om du er interessert i ein djupare organisatorisk partnarskap, <emailFragment>ta kontakt.</emailFragment>
partnerships-foundations-header = Stiftingar
partnerships-foundations-description = Vi samarbeider med stiftingar, sivilsamfunn og samfunnspartnarar for å gjere internett til ein sunnare stad, med eit spesielt fokus på Aust-Afrika. Finn ut meir om det <programmaticWork>programmatiske arbeidet vårt.</programmaticWork>
