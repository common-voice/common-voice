...
request-language-heading = Yeni bir dil talep edin
request-language-explanation-1 =
    Dilinizin <languagesPageLink>Common Voice Dilleri sayfasında</languagesPageLink> olup olmadığını kontrol edin.
