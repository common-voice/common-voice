...
varying-pronunciations-tip-1 = [Orta Anadolu şivesinde "Kastamonu" "Gastamonu" olarak, "ciğer" ise "ciger" olarak okunabilir]
varying-pronunciations-tip-2 = [Karadeniz şivesinde "gidiyorum" "cideyrum" olarak okunabilir]
