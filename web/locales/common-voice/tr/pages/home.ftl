...
find-us-on-matrix-content-v2 = Matrix, merkeziyetsiz ve gerçek zamanlı iletişim için açık ve hafif bir protokoldür ve Mozilla’nın tercih ettiği açık tartışma platformudur. "common-voice:mozilla.org" odasındayız.
# label for button
find-us-on-element-action-1 = Element
find-us-on-matrix-action-2 = Diğer istemciler
