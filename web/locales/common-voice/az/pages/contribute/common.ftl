...
shortcut-record-toggle-label = Yaz/Dayandır
request-language-text = Dilinizi hələlik Common Voice-də görmürsüz?
request-language-button = Dil tələb edin
...
shortcut-play-toggle-label = Oxut/Dayandır
