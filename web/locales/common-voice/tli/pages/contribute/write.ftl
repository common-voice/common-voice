...
write = kayshaxít
write-instruction = <icon></icon> yóo x̱'atánk ldakát ḵaa atx̱ liyéix̱
write-page-subtitle = Wéi yóo x̱'atánk yáat akaadéi wootee, ldakát ḵaa atx̱ liyéix̱ atx̱ satee. (cc-0 Licensed dataset)
sentence =
    .label = yóo x̱'atánk
sentence-input-placeholder = ldakát ḵaa yóo x̱'atángi yáat toot keeldál'
small-batch-sentence-input-placeholder = ldakát ḵaa yóo x̱'atángi yáat toot keeldál'
citation-input-placeholder = kunaax̱ daak kananeek goot'á sáwé yeedlaaḵ wéi yóo x̱'atánk ( tlél aadéi yéi g̱esaneiyi yé)
citation =
    .label = yéi yadudziḵaayi át
sc-write-submit-confirm = agree x̱adaayaḵá yáa yóo x̱'atánk ldakát ḵaa yóo x̱'atánkx̱ sitee ḵá permission ax̱ jeewu ijeedéi kḵwateeyí (<wikipediaLink>public domain</wikipediaLink>)
sc-review-write-title = Daaḵw aa yóo x̱'atánk akaadéi nag̱atee?
new-sentence-rule-1 = Ldakát ḵaa atx̱ layéx̱.Tlél ḵustí Copyright x̱'ayáx̱ (cc-0)
new-sentence-rule-2 = Jinkaat ḵá keijin yóo x̱'atánk ḵín, yóo x̱'atángi aa-g̱aa
new-sentence-rule-3 = ayáx̱ yóo x̱'atángi-x̱ layéx̱
new-sentence-rule-4 = ayáx̱ kayshixít ḵá ayáx̱ yóo x̱'atán
new-sentence-rule-5 = Tlél kayildáalk'iḵ numbers ḵá special characters
new-sentence-rule-6 = Tlél kayildáalk'iḵ ch'a g̱oot aa letters
new-sentence-rule-7 = ayáx̱ Citations akaadéi keeldál'
new-sentence-rule-8 = tlél uldzee aadéi oong̱waatóowu yé wéi yóo x̱'atánk
login-instruction-multiple-sentences = <loginLink>Login</loginLink> or <loginLink>sign up</loginLink> to add multiple sentences
how-to-cite = Waa sá agux̱layéix̱ wéi yéi yadudziḵaayi át?
how-to-cite-explanation-bold = Cite with a URL link or the full name of the work.
how-to-cite-explanation = { "" }
guidelines = Ax̱'áyáx̱
contact-us = aadéi haa wdux̱oox̱u yé
...
single-sentence-submission = Tléix' aa yóo x̱'atánk ajeenáḵ aa
small-batch-sentence-submission = Batchk' yóo x̱'atánk ajeenáḵ
bulk-sentence-submission = Batch-tlein yóo x̱'atánk ajeenáḵ
single-sentence = Single
small-batch-sentence = Small batch
bulk-sentence = Bulk batch
sentence-domain-combobox-label = yagéi yóo tutángi aa yóo x̱'atánk
sentence-domain-select-placeholder = tlél nás'gi aa yaanáx̱ (i toowáa sigwéini)
...
sc-bulk-submit-confirm = agree x̱adaayaḵá yáa yóo x̱'atánk ldakát ḵaa yóo x̱'atánkx̱ sitee ḵá permission ax̱ jeewu ijeedéi kḵwateeyí (<wikipediaLink>public domain</wikipediaLink>)
...
# menu item
add-sentences = akaadéi natí tsóok yóo x̱'atánk
...
transcribe-audio-menu-item-tooltip = kayshaxít daa sáwé iya.áx̱ji
...
transcribe-audio-menu-item-aria-label = kayshaxít daa sáwé iya.áx̱ji
