...
write = Qillqay
write-instruction = <icon></icon> nisqa simita yapay, llapa runaq kamachisqan rimayta
write-page-subtitle = Kaypi yanapasqa rimaykuna huk cc-0 huñiyninyuq willay huñuman llapa runapaq yapasqa kanqa.
sentence =
    .label = Rimay
sentence-input-placeholder = Kaypi yachasqa rimayniykita qillqay
small-batch-sentence-input-placeholder = Kaypi yachasqa rimakunaniykita qillqay
...
new-sentence-rule-2 = Sapa rimaypi 15 simikunamanta pisi
new-sentence-rule-3 = Allin simi kamachiqwan yanapachikuy
new-sentence-rule-4 = Use correct spelling and punctuation
new-sentence-rule-5 = Mana yupaykuna, sananpakuna ima
