...
about-playbook-how-localize-content-3 = 译文翻译自英文，不过您也可以看到其他语言的<strong>提议</strong>。点击 <strong>个人资料</strong>图标，然后点击 <strong>Settings</strong>（设置）链接并添加您使用的任何语言。右下角有一个名为 <strong>Locales</strong>（多语言）的译文列表。译文会于一天后应用到网站上。
...
about-playbook-how-grow-language-content-8-v2 = <strong>发挥创意吧！</strong>您的语言社区是独一无二的，这里只是提供几种入门方式。请考虑将您的社区频道添加到 <communitiesLink>GitHub 上的 COMMUNITIES.md 文档</communitiesLink>。
