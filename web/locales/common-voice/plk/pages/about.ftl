...
about-header-description-v2 =
    <p>کامن وائس ایْک عوامی شان گیْ دستیاب صوتی ڈیٹاسیٹُن، کھاںݩسڑ دُنیے رضاکارو آوازو قوت صالبِن۔ اسہ جک کھاݩس وائس ایپلی کیشنز سنون کھوشَن سیْس مشین چلیونے ماڈلی تربیات دونے کِرِیا ڈیاٹا سیٹ استعمال تھونانَ<p>
     <p>وخ دہ بسکہ صوتی ڈیٹا سیٹس کمپنیو ملکِیاتَن، کھاݩس جدت چپ تھینَن۔ صوتی ڈیٹا سیٹس گہ کم نمائندگی تھینَن۔ غیر انگرزی دین آں رنگ رنگے جک، معذور جک، چیئے قام گہ    جک۔ آ سے مطلب آ نیْ چہ آواز گیْ چلیجیئے ٹیکنالوجی لے جِبو کِرِیا بالکل کوْم نہ تھینیْ، آں کُدی آس کوْم تِھینیْ، بونانیْ چہ آس بُٹو کِرِیا ایْک شانِیؤ مُݜٹیْ کارگردگی نہ پشیبائی۔ بیْس ہر زائی دہ جک متحرک تھے، سیݨے آواز بگے آسَس بگون لُکھوݨَس۔</p>
how-does-it-work-title-v2 = کامن وائس اےْ مالی امداد کاتھ تِھجانیْ؟
how-does-it-work-text = بیْس آوازو ایک اوزگار ڈیٹا سیٹ کراؤڈ سورس تھوݨَس۔ تومیْ آواز عطیہ تِھیا، مُتہ جگو کلپی سُوݩڇھریے اسہ سے توثیق تِھیا۔ ڈیٹا سیٹ بُٹو کِرِیا مِݜٹوْ سنِیا۔
...
about-listen-queue = کوْݨ دیا - کِھڇی
about-listen-queue-text = صوتی کلپس جمع تھونے کِھڇی دہ داخل تِھجنَن، کھاݩس کوْݨ دیون تیِار تِھینیْ۔
...
about-playbook-how-validate-content-4 = اگر کوئے کلپ دُو جک سہ رَد تھینَن، تو اسے ڈیٹاسیٹو مختلف ذیلی سیٹو مجی اسہ جاری تِھجنَن۔
