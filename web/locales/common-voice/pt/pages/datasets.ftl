...
license-mixed = Mista
# MENU ITEM TOOLTIPS
download-contribute-menu-tooltip = Baixar nossos conjuntos de dados de voz
# MENU ITEM ARIA LABELS
download-contribute-menu-aria-label = Opções de download para acessar dados do Common Voice
