...
download-requests = Pedidos de transferência de gravações anteriores
download-requests-info = Quando solicita suas gravações, nós reunimos as mesmas num ou vários arquivos ZIP. Consulte os seus pedidos anteriores:
