...
small-batch-sentence-input-placeholder = تانی عوامی جولال اماں تہ
citation-input-placeholder = تانی جولال ٹبوت گییہ
citation =
    .label = منییل
...
sc-review-small-batch-title = کتہ ملٹیپل جولال ملے۔
new-sentence-rule-1 = دی کاپی ترال رل گیبی پابندی نین
new-sentence-rule-2 = ا جملا بنجیش  ٹکیل دا کم بیدہ
