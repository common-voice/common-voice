...
banner-error-slow-1 = بشخنداری، کامن وائس آہستہ کاریم کننگ اے۔ نما است خوائی نا منت وار۔
banner-error-slow-2 = ننے آ داسہ بھاز کلہواک بننگ او و نن داسہ ویلاتا باروٹ پٹ پول کننگ اون۔
banner-error-slow-link = اسٹیٹس پیج
error-something-went-wrong = بشخنداری، گڑا غلط مسونے
error-clip-upload = کلپ نا اپلوڈ بے سرسہب مننگ اے، ولدا کوشست کریسہ کبو؟
error-clip-upload-server = کلپ نا سرور ٹی اپلوڈ بے سرسہب مننگ اے۔ پنہ ئے واپس لوڈ کبو یا رزس پدان ولدا کوشست کبو۔
error-title-404 = نن نم کن ہمو  پنہ ئے پٹنگ کتون
