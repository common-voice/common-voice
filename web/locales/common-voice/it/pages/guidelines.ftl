...
code-switching-informal-scenarios-explanation = Le conversazioni con gli amici o gli scambi di messaggi includono spesso cambi di codice più naturali. Esempio:
...
code-switching-dont-header = Altre cose da non fare:
code-switching-dont-1 = Non utilizzare un linguaggio eccessivamente formale
# Reviewing a Question
code-switching-review-subheader = Convalidare una domanda
...
code-switching-use-both-languages = <bold>Utilizza entrambe le lingue se è il modo in cui ti esprimi normalmente.</bold> Anche cambiare lingua solamente per una o due parole può essere utile. Esempio:
