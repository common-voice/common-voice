...
no-api-keys-description =
    ...
    una sola volta.
api-key-name-input =
    .label = Nome credenziali API
create-api-key-header = <bold>Avviso importante: generazione delle credenziali API</bold>
...
api-key-name-display-label = Nome credenziali API
