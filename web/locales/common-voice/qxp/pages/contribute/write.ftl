...
citation-input-placeholder = Qillqasqa rimayniykipaq maymanta hamusqanmanta churay (hunt'ana)
citation =
    .label = Maymanta
sc-write-submit-confirm = Kay rimayqa <wikipediaLink>llaqtaq kayninpin</wikipediaLink> hinallataq ñuqam siqachinaypaq kamachisqa kani.
sc-review-write-title = Ima rimaykunatataq yapayman?
sc-review-small-batch-title = Imaynatataq achka rimaykunata yapakunman
new-sentence-rule-1 = <noCopyright>Mana copyright</noCopyright> harkaykuna (<cc0>cc0</cc0>)
new-sentence-rule-2 = Sapa rimay 15 simikunakamallan
new-sentence-rule-3 = Allin simi kamachiywan tupanan
new-sentence-rule-4 = Allin qillqasqa hinallataq sanampasqa kanan
...
add-sentence-error = Rimay yapaypi pantay
