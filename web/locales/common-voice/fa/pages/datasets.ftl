...
resource-playbook-info = <playbookLink>راهنمایی‌های مفید</playbookLink> در مورد کل مسیر آوای مشترک، از محلی‌سازی تا استفاده از مجموعه داده‌ها، و همچنین نحوه ارتباط با اجتماع ما را پیدا کنید.
...
your-feedback = آیا برای این‌که چطور می‌توانیم مجموعه داده‌های آوای مشترک را بهتر کنیم ایده‌ای دارید؟ در دیسکورس به ما بگویید
go-discourse = رفتن به دیسکورس
...
donate-modal-explanation-2 = <bold>اگر برای داده‌های باز و فراگیر ارزش قائل هستید، همین امروز اهدا کنید!</bold>
data-download-singleword-title = دریافت بخش هدف تک کلمه‌ای.
data-download-singleword-callout-v2 = این یک بخش مبتنی بر موارد استفاده است که داده‌هایی برای تشخیص اعداد گفتاری و تشخیص بله / خیر فراهم می‌کند.
