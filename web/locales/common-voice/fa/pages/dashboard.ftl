...
activity-needed-calculation-fixed = اگر ۱۰۰ نفر در یک روز ۱۰۰ جمله ضبط کنند، ۱۳ ساعت صدا تولید می‌شود. اگر به همین صورت پیش برود، کم‌تر از ۳ ماه به ۱۰۰۰ ساعت می‌رسد.
how-many-per-day = عالی است! چه تعداد قطعهٔ صوتی در روز؟
