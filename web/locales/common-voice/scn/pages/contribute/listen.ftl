...
# Menu item
validate-readings = Cuntrolla i liggiuti

## MENU ITEM TOOLTIPS

listen-contribute-menu-tooltip = Cuntrolla i liggiuti, rividi i trascrizzioni
validate-readings-menu-item-tooltip = Cuntrolla i liggiuti riggistrati di l'utenti nnâ to lingua
review-transcriptions-menu-item-tooltip = Rividi i trascrizzioni mannati di l'utenti nnâ to lingua
