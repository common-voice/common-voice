...
record-error-too-short = La grabación es demasiado corta
record-error-too-long = La grabación es demasiado larga
record-error-too-quiet = La grabación es demasiado lenta
...
record-last-instruction = <recordIcon></recordIcon> Qhipa uñstawi!
...
record-abort-text = Jichhax sarxañax nayrar sartañ chhaqhayañ sañ muni
record-abort-submit = Grabacionanak uñt’ayaña
record-abort-continue = Finish recording
record-abort-delete = Clips ukanakat mistuña & chhaqtayaña
review-aborted = Upload aborted. Do you want to delete your recordings?
review-submit-title = Uñakipt’aña & Uñt’ayaña
review-submit-msg = Thank you for recording!<lineBreak></lineBreak>Now review and submit your clips below.
review-recording = Uñakipaña
review-rerecord = Re-record
review-cancel = Uñt’ayawi chhaqtayaña
...
terms-agree = Nayax iyawstwa
terms-disagree = Janiw nayajj iyaw siskti
# FIRST POST SUBMISSION CTA
first-cta-header-text = ¡Voice clips ukanakam churatamat yuspajarapxsma!
first-cta-subtitle-text = By telling us about yourself, you will help developers build more inclusive technology
why-donate = ¿Kunatsa jisktʼaskta?
