...
about-playbook-how-grow-language-content-8-v2 = <strong>Legyen kreatív!</strong> Nyelvi közössége egyedülálló lesz, és ez csak néhány módszer a kezdéshez. Fontolja meg a közösségi csatornái hozzáadását a <communitiesLink>COMMUNITIES.md dokumentumhoz a GitHubon</communitiesLink>.
