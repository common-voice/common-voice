...
contribution-varying-pronunciations-description-extended = Másrészt, ha úgy gondolja, hogy az olvasó valószínűleg még sosem találkozott a szóval, és egyszerűen csak tévesen tippelt a kiejtésre, akkor utasítsa el. Ha bizonytalan, használja a kihagyás gombot.
