...
record-platform-webview = Előfordulhat, hogy egy közösségimédia-alkalmazás hivatkozására kattintva érkezett erre az oldalra. Olyan alkalmazásbeli böngészőt használ, amely nem támogatja a hangfelvétel funkciót.
record-platform-not-supported-webview = Mobileszközökön a rendszerböngésző használatával működhet közre…
...
record-error-unknown-format = A hangformátum nem határozható meg. Próbálja meg egy másik böngésző használatával.
