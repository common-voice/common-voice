...
datasets-speech-bubble-content = Spännande nyheter! Spontana tal är på väg! Håll ögonen öppna efter uppdateringar och se till att kolla vår <discordLink>Discord</discordLink> för den senaste informationen.
language = Språk
