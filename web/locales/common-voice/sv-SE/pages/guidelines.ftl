...
answer-questions-tip-3 = Håll ditt svar inom 15 sekunder
...
special-tags-example = Och sedan åkte I [noise] på semester. Tja, [noise] [skratt] det var inte precis en semester [skratt]
...
code-switching-use-bilingual-prompts-explanation = Använd tvåspråkiga frågor som införlivar båda språken i din fråga: Exempel:
code-switching-use-bilingual-prompts-explanation-example = “¿Qué te dijo tu mamá när du kom hem den dagen?”
