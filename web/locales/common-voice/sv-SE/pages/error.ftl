...
error-content-500 = Ett oväntat fel uppstod. Försök igen senare. För hjälp, gå med i <matrixLink>Matrix community chat</matrixLink>, övervaka webbplatsfrågor via <githubLink>GitHub</githubLink> eller besök <discourseLink>våra Discourse-forum</discourseLink>.
error-title-502 = Anslutningen avbröts
error-content-502 = Det går inte att upprätta en stabil anslutning till våra servrar just nu. Försök igen senare. För hjälp, gå med i <matrixLink>Matrix community chat</matrixLink>, övervaka webbplatsfrågor via <githubLink>GitHub</githubLink> eller besök <discourseLink>våra Discourse-forum</discourseLink>.
...
error-title-504 = Begär timeout
error-content-504 = Begäran tog för lång tid att slutföra. Detta är vanligtvis tillfälligt. Försök igen. För hjälp, gå med i <matrixLink>Matrix community chat</matrixLink>, övervaka webbplatsfrågor via <githubLink>GitHub</githubLink> eller besök <discourseLink>våra Discourse-forum</discourseLink>.
error-code = Fel { $code }
...
error-duplicate-clips-some = Vi laddade upp { $uploaded } av dina klipp — resten har redan laddats upp. Låt oss fortsätta med nästa parti!
