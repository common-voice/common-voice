...
api-credentials-use-case-1 = Skickar in ljudprover
api-credentials-use-case-2 = Hämtar datamängder
api-credentials-use-case-3 = Analysera och förbättra talmodeller Denna samarbetsplattform hjälper inte bara till att bygga mer exakta röstigenkänningssystem utan ger också användare möjlighet att bidra till utvecklingen av röstteknik.
api-credentials-description-conclusion = Denna samarbetsplattform hjälper inte bara till att bygga mer exakta röstigenkänningssystem utan ger också användare möjlighet att bidra till utvecklingen av röstteknik.
create-api-key-button = Skapa API-inloggningsuppgifter
your-api-keys = Dina API-inloggningsuppgifter
no-api-keys-header = <bold>För närvarande finns det inga API-inloggningsuppgifter kopplade till ditt konto.</bold>
no-api-keys-description = För att skapa din första API-nyckel, klicka på "Skapa API-inloggningsuppgifter", namnge sedan dina API-inloggningsuppgifter och skapa unika API-inloggningsuppgifter genom att klicka på "Skapa API-inloggningsuppgifter." Kopiera sedan den hemliga nyckeln omedelbart, eftersom den bara visas en gång.
api-key-name-input =
    .label = API-inloggningsnamn
create-api-key-header = <bold>Viktigt meddelande: Generering av API-referenser</bold>
create-api-key-description = Genom att klicka på "Generera inloggningsuppgifter" skapas unika autentiseringsuppgifter för ditt konto. Av säkerhetsskäl visas den hemliga nyckeln <bold>endast en gång</bold>. Vänligen kopiera och förvara den säkert. Om du förlorat måste du skapa en ny nyckel, eftersom den inte kan hämtas.
generate-api-key-button = Generera inloggningsuppgifter
save-api-key-info = <bold>Spara dina nycklar säkert:</bold> Förvara dina nycklar säkert och undvik att exponera dem i offentliga arkiv. Den hemliga nyckeln är endast tillgänglig nu och kommer inte att visas igen.
save-api-key-info-description = Förvara dina nycklar säkert och undvik att exponera dem i offentliga förråd. Den hemliga nyckeln är endast tillgänglig nu och kommer inte att visas igen.
...
cancel-api-key-confirmation-description = Är du säker på att du vill avbryta genereringen av en API-inloggningsuppgifter?
...
copy-api-credential-success-toast-message = Kopierad lyckades
...
max-api-keys-reached = Överskriden API-behörighetsgräns på 10
