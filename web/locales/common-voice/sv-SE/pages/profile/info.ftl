...
api-credentials-description = Få åtkomst till en global datamängd av användarbidragna röstinspelningar med Common Voice API. Förbättra dina applikationer med högkvalitativ taligenkänning genom endpoints för:
