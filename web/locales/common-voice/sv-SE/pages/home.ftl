...
find-us-on-matrix-content-v2 = Matrix är ett öppet, lätt protokoll för decentraliserad realtidskommunikation och Mozillas föredragna öppna diskussionsplattform. Vi är i rum "common-voice:mozilla.org".
# label for button
