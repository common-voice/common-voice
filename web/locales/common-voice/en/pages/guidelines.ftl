...
what-makes-a-good-question-explanation = A  good question for public participation datasets should be:
what-makes-a-good-question-explanation-criteria-1 = easy to understand
what-makes-a-good-question-explanation-criteria-2 = generally relevant
what-makes-a-good-question-explanation-criteria-3 = colloquially understandable
what-makes-a-good-question-tip = You might also want to consider spanning multiple sectors, contexts and domains.
...
spelling-and-pronunciation-explanation = Use correct spelling and grammar where appropriate.
length = Length
length-explanation = The question should be answered in just a couple of sentences.
...
process-steps-explanation = Questions which require someone to list several steps
offensive-content-sensitive-information = Offensive content / sensitive information
