...
write = Тхы
write-instruction = <icon></icon> цӏыф жъугъэмэ апае зы гущыӏэухыгъэ хэгъэуцу
write-page-subtitle = Мыщ къыщытыгъэ гущыӏэухыгъэхэр зэкӏэри зылъыӏэсын алъэкӏыщт къэтыгъэ лицензиеу сс-0 зыпылъым хэдгъэхьащт.
sentence =
    .label = Гущыӏэухыгъ
sentence-input-placeholder = Цӏыф жъугъэмэ апае гущыӏэухыгъэ мыщ дэжьым игъахь.
small-batch-sentence-input-placeholder = Цӏыф жъугъэмэ апае гущыӏэухыгъэ мыщ дэжьым игъахь.
...
new-sentence-rule-2 = Гущыӏэухыгъэ пэпчъ 15-м нахь макӏэ гущыӏэ
new-sentence-rule-3 = Бзэхабзэр тэрэзэу гъэфедэ
...
sc-bulk-submit-confirm = Сэ къэсэгъэшъыпкъэжьы мы гущыӏэухыгъэхэр<wikipediaLink>цӏыф жъугъэмэ апае</wikipediaLink> ыкӏи ахэр тезгъэуцонымкӏэ изын сиӏ.
...
add-sentences-menu-item-aria-label = Зэхэщэгъэ купыр еджэным пае гущыӏэухыгъэ кӏэхэр хэгъахъу
review-sentences-menu-item-aria-label = Зэхэщэгъэ купым фэгъэхьыгъэу щыӏэ гущыӏэухыгъэхэм яплъыжь
add-questions-menu-item-aria-label = Зэхэщэгъэ купыр еджэным ыкӏи джэуап къытыным пае упчӏакӏэхэр егъэхь
transcribe-audio-menu-item-aria-label = Мэкъэ тетхагъэхэр текст транскриптцие шӏы
