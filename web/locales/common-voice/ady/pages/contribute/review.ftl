...
review-error = Гущыӏэухыгъэм еплъыжьызэ хэукъоныгъэ хъугъэ.
...
sc-redirect-page-subtitle-1 = Гущыӏэухыгъэу Коллекторыр Комон Войс платформым икупкӏ техьажьы. Джы гущыӏэухыгъэ <writeURL>птхын</writeURL> плъэкӏыщт е Комон Войсым къыщытыгъэ гущыӏэухъыгъэ зырызхэм <reviewURL>уахэплъэщт</reviewURL>.
