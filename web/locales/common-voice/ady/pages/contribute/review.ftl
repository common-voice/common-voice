...
sc-redirect-page-subtitle-1 = Гущыӏэухыгъэу Коллекторыр Комон Войс платформым икупкӏ техьажьы. Джы гущыӏэухыгъэ <writeURL>птхын</writeURL> плъэкӏыщт е Комон Войсым къыщытыгъэ гущыӏэухыгъэ зырызхэм <reviewURL>уахэплъэщт</reviewURL>.
