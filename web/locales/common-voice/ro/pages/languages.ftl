...
language-section-in-progress-new-description = Aceste limbi sunt în prezent în curs de dezvoltare de către comunitate. Barele de progres arată cât de departe am ajuns cu fiecare limbă în <localizationGlossaryLink>localizarea site-ului</localizationGlossaryLink> și <sentenceCollectionGlossaryLink>adunarea de propoziții</sentenceCollectionGlossaryLink>.
...
language-validation-progress = Progresul validării
...
get-involved-text =
    ...
    la curent echipele prin e-mail. Dacă vrei să contribui, te rugăm să ne lași adresa ta de e-mail mai jos.
...
get-involved-stayintouch = La Mozilla construim o comunitate în jurul tehnologiei vocale. Am vrea să te ținem la curent cu noutăți, surse noi de date și să aflăm mai multe despre cum folosești aceste date.
get-involved-privacy-info = Promitem să prelucrăm cu grijă datele tale. Citește mai multe în <privacyLink>Notificarea noastră privind confidențialitatea</privacyLink>.
get-involved-success-title = Te-ai înscris cu succes pentru contribuții la { $language }. Îți mulțumim!
get-involved-success-text = Te vom ține la curent cu mai multe informații pe măsură ce devin disponibile.
