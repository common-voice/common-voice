...
visibility-explainer = הגדרה זו שולטת בהופעה שלך בטבלת המובילים. בעת הסתרה, ההתקדמות שלך תהיה פרטית. פירוש הדבר שהתמונה שלך, שם המשתמש וההתקדמות שלך לא יופיעו בטבלת המובילים. לידיעתך, ריענון טבלת המובילים ועדכון השינויים לוקחים כ־{ $minutes } דקות.
