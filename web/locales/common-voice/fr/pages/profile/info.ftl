...
api-credentials-use-case-1 = Envoi d’échantillons audio
api-credentials-use-case-2 = Récupération des jeux de données
api-credentials-use-case-3 = Analyse et amélioration de modèles vocaux
