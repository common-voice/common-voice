...
review-questions-menu-item-tooltip = Vérifier les questions
...
review-questions-menu-item-aria-label = Vérifiez et votez pour les nouvelles questions proposées par la communauté
