...
record-error-uploaded-clip-too-long = Votre enregistrement dépasse la durée maximale de { $duration } secondes. Veuillez enregistrer un échantillon plus court.
