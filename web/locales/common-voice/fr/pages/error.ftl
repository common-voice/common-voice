...
error-title-429-no-time = Vous allez trop vite. Veuillez ralentir et réessayer dans un instant.
error-title-429-with-time =
    { $retryAfter ->
        [one] Vous allez trop vite. Veuillez réessayer dans { $retryAfter } seconde.
       *[other] Vous allez trop vite. Veuillez réessayer dans { $retryAfter } secondes.
    }
