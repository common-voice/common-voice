...
about-playbook-how-grow-language-content-8-v2 = <strong>Faites preuve de créativité !</strong> Votre communauté linguistique sera unique, et ce ne sont là que quelques pistes pour commencer. N’hésitez pas à ajouter vos canaux communautaires au document <communitiesLink>COMMUNITITES.md sur GitHub</communitiesLink>.
