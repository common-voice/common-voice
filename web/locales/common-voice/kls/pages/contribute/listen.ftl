...
listen-contribute-menu-tooltip = Mahik sahi kari, newishila geri jagai
validate-readings-menu-item-tooltip = Sahi kari user- ze recarding, mahikas bati tai zuban una
review-transcriptions-menu-item-tooltip = Dubara user- jama kari te newishila tan zuban una.

## MENU ITEM ARIA LABELS

listen-contribute-menu-aria-label = Ko'n' karikas option Jaiga
validate-readings-menu-item-aria-label = Sahi kaei, comety aini mochan ze memberanan jama kada
review-transcriptions-menu-item-aria-label = Dubara jagai, te newishila ze recard kada mon, te sahi albat
