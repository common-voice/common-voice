...
about-header-description-v2 =
    ...
    <p>Aichea kallant, chodxe avazache mhaiti-kox (voice dataset) komponi-che malok-hokacher asa, ani oxem 'innovation'-acho ghollo damun urta. Voice datasets also underrepresent: non-English speakers, people of colour, disabled people, women and LGBTQIA+ people. This means that voice-enabled technology doesn’t work at all for many languages, and where it does work, it may not perform equally well for everyone. Ami hem bodlunk sodtai sogle zagear lokank aplo avaz vanttpak divunk.</p>
