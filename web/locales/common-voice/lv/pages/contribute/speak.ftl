...
record-platform-webview = Iespējams, jūs nokļuvāt šeit, noklikšķinot uz saites sociālo mediju lietotnē. Jūs izmantojat lietotnes pārlūkprogrammu, kas neatbalsta audio ierakstīšanu.
record-platform-not-supported-webview = Mobilajās ierīcēs varat sniegt savu ieguldījumu, izmantojot sistēmas pārlūkprogrammu…
record-platform-not-supported-desktop = Datoros varat lejupielādēt jaunāko:
record-platform-not-supported-ios-non-safari = Lūgums iOS operētājsistēmā turpināt ar “Safari”, lai iespējotu ierakstīšanu…
