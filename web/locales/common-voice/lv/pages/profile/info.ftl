...
profile-create-success = Profils izveidots sekmīgi.
...
variant-contribution-options-header = Ieguldījuma variantu iespējas
...
api-key-modal-confirmation-header = Vai tiešām?
...
copy-api-credential-success-toast-message = Sekmīgi ievietoti starpliktuvē
copy-api-credential-error-toast-message = Kļūda ievietojot starpliktuvē
