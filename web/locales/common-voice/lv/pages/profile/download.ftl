...
download-recordings-info = Ietver mp3 datnes un saistītus teikumus. Sagatavošanās var aizņemt kādu laiku
...
download-request-archive-single = Viena ZIP datne, kas satur
download-request-archive-multiple = Sadalīt { $archiveCount } ZIP failos, kas satur
download-request-assembling-description = Datnes tiek apkopotas. Lūgums vēlāk pārbaudīt vēlreiz.
download-request-refresh-button = Atjaunināt
download-request-modal-title = Lejupielāžu saites
download-request-modal-description = Šeit ir saites ZIP datņu lejupielādēšanai.
