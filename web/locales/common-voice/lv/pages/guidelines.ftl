...
reader-effects-explanation = Lielākajā daļā ierakstu ir cilvēki, kas runā savā dabiskajā balsī. Reizēm ierakstos ir pieļaujamas nelielas atkāpes — izkliegšana, čukstēšana vai acīmredzami “dramatiska" balss. Lūgums noraidīt dziedātos ierakstus un tos, kas ierunāti ar datora radītu balsi.
...
offensive-content-sensitive-information = Aizvainojošs saturs vai jūtīga informācija
...
offensive-content-sensitive-information-explanation-explanation-3 = Jautājumi, kas kādam varētu likt izpaust jūtīgas, iespējami aizkaitinošas atbildes
...
code-switching-not-tag-mixed-words = <bold>Jaukti vai morfoloģiski pielāgoti vārdi.</bold> Neatzīmēt vārdus, kas sajauc valodas vai kuriem ir pievienotas galotnes no citas valodas. Piemēri:
