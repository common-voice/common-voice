...
about-menu-aria-label = Menu voor toegang tot Partnerschappen, Pers en verhalen, Gemeenschap en Talen
...
find-us-on-matrix-content-v2 = Matrix is een open, lichtgewicht protocol voor gedecentraliseerde, realtime communicatie en het open voorkeursdiscussieplatform van Mozilla. U vindt ons in de ruimte ‘common-voice:mozilla.org’.
# label for button
find-us-on-element-action-1 = Element
find-us-on-matrix-action-2 = Overige clients
...
developers-section-title-202608 = Publiek toegankelijke open spraakgegevenssets in meer dan 330 talen
developers-section-subtitle-v2 = Gegevenssets voor ASR en andere NLP-contexten – gemaakt via deelname van de gemeenschap.
