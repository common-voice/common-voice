...
# Sentence Domain dropdown option
automotive_transport = Автомобілебудування і транспорт
# Sentence Domain dropdown option
finance = Фінанси
# Sentence Domain dropdown option
service_retail = Обслуговування і роздрібна торгівля
# Sentence Domain dropdown option
general = Загальне
# Sentence Domain dropdown option
...
minimum-sentences = Мінімальна кількість речень у файлі: 1000
...
add-questions-menu-item-aria-label = Надсилайте нові запитання для прочитання і відповіді спільнотою
