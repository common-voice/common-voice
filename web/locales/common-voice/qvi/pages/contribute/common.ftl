...
report = Willana
report-title = Willakuyta kachay
...
report-different-language = shuk shimi
...
contribution-criteria-link = Yachakushun ashtawan imashina yanapayta
...
contribution-varying-pronunciations-example-1-title = Todos los amigos tomaban café.
contribution-varying-pronunciations-example-1-explanation = [Está bien si se pronuncian los -s final (como en España o en México) o no (como en Cuba)]
contribution-varying-pronunciations-example-2-title = Ésta bien que lo diga.
contribution-varying-pronunciations-example-2-explanation = ['Está' cuando es verbo nunca se pronuncia con fuerza de voz en la primera sílaba]
...
see-more = </chevron></chevron>astawan tukuy
see-less = <chevron></chevron>Pisillata tukuy
