...
sentence =
    .label = Rimay
sentence-input-placeholder = Kayman llapan runapaq rimayniykita killkay
small-batch-sentence-input-placeholder = Kayman llapan runapaq rimayniykikunata killkay
...
login-instruction-multiple-sentences = <loginLink>Yaykuy</loginLink> icha <loginLink>killqakuy</loginLink> achka rimaykunata yapanaykipaq
...
# Sentence Domain dropdown option
news_current_affairs = Mushuk willakuykuna, kanan watakunachaw imanaykuna
# Sentence Domain dropdown option
technology_robotics = Mushuk imakunawan robotica
sentence-variant-select-label = Rimaypa shuk niraq pashtachiynin
sentence-variant-select-placeholder = shuk niraq pashtachiyninta akray (munarqa)
...
bulk-upload-additional-information =
    Ashwan willay kay willañiqipita quyta munarqa, kayman qillqamuy <emailFragment>commonvoice@mozilla.com</emailFragment>
...
multiple-sentences-error = Shuklla apachiypaqqa manami achka rimaykuna yapayta atinkichu
...
write-contribute-menu-aria-label = Killkay akranakuna
...
add-questions-menu-item-aria-label = Mushuk tapukuykunata runakuna ñawinchashpa kutichiyaamunanpaq apachiy
transcribe-audio-menu-item-aria-label = Kunka rimaykunata wiyanapaq killkay
