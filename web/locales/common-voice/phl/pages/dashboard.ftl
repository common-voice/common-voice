...
todays-recorded-progress = آجُکو کمن وائسی ہواز ریکاڈ تھئنی جُھلی کرام جاری
todays-validated-progress = آجُکو کمن وائسی ہواز ریکاڈ توثیق تھئنی جُھلی کرام جاری
stats = اعداد وشمار
awards = ایوارڈز
you = تو
everyone = ہر آک
contribution-activity = مدد تھئنی کرام
top-contributors = بُٹھیم دی زیات مدد تھاٹو
recorded-clips = ریکاڈ تھیلہ کلپز
validated-clips = تصدیق بھیلہ ہاویزی کلپز
total-approved = بُٹھے منظور بِھلہ
