listen = سُڻو
listen-subtitle = مدت ڪري ميآر وآريٚ آوآز سآݩ
listen-instruction = { $actionType } <playIcon>ڪيٚ اُئآݩ سهيٚ جملو گآلهآيو؟
listen-again-instruction = ڀلو ڪم<playIcon></playIcon>سُڻو ٻيهر جڏي اڀيٚݩ تيآر هُجو
...
listen-abort-title = ڪليٚپس ريٚ تسديٚڪ کتم ڪرو؟
listen-abort-cancel = تسديٚيٚڪ جآريٚ رکو
listen-abort-confirm = تسديٚڪ کتم ڪرو
# Menu item
validate-readings = تسديٚڪ سآݩ پڙهڻ
# text wrapped in <small></small> will be shown in a smaller font size
validate-readings-coming-soon = ريٚڪآڊئيٚنگ تسديٚڪ کآݩ <small>آڻ وآريٚ اهي جلديٚ</small>
...
listen-contribute-menu-aria-label = سُڻو آپشن مينيو
validate-readings-menu-item-aria-label = تسديٚڪ سآݩ پڙهيٚ جمآ ڪئيل ڪميونٽيٚ وآرآن رو
review-transcriptions-menu-item-aria-label = ڏسو لکيل متن ريٚڪآڊئيٚنگ رآ جملآ سهيٚ نموٚني سآݩ
