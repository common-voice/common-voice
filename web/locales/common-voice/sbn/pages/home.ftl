...
no-clips-to-validate = لڳي دو تا ايئي ٻوليٚ ميݩ سُڻڻ لآ ڪو با ڪليٚپس ڪونهي۔ ڪتآر ڀرڻ ميݩ اسآݩ ريٚ مدت ڪرو۔ هآڻي ڪجه جملآ ريڪآڊ ڪرتي۔
...
action-items-section-subtitle = ڪو بآ مآڻهوٚ لکت ائيٚنٚ تڪريٚر ڊيٽآ سيٽس شيئر ڪري، ٺآهي ائيٚنٚ ڪيوريٽ ڪري پنڊريٚ ٻوليٚ کي مهڦوٚز ڪري، بهآل ڪري ائيٚنٚ بُلند ڪري سگهي دو۔
scripted-card-header = لکل تڪريٚر
scripted-card-content = پنڊريٚ ٻوليٚ ميݩ زور سآݩ جملآ پڙهو ائيٚݩ دُنيآ ميݩ سڀ کآݩ وڌيٚڪ متنوآ آوآميٚ شرآڪت وآريٚ تڪريٚر ڊيٽآ سيٽ ميݩ هيسو وٺو.
...
join-discord-community-content = ٻوليٚ برآدريآنٚ ري بهسن مينٚ هيسو وٺو، سوآل پُڇو، ائيٚنٚ آڻ وآرينٚ وآڪيآنٚ ائيٚنٚ ڳآلينٚ بآبت سکو۔
