...
data-download-modal = تو <size>{ $size }GB</size> ءِ ڈاؤن لوڈ کنگ ءِ بندات کنگ ءَ ئے، دیم ءَ روان کن ئے؟
data-subtitle = ما آواز ءِ یک پچیں ءُُ سرکاری دستیابیں ڈیٹاسیٹے جوڑ کنگ ءَ ایں کہ ہرکس تقریر ءِ اہلیں ایپلی کیشنز ءِ تربیت ءِ ھاترا کارمرز کنت۔
data-explanatory-text = مارا یقین اِنت کہ مزنیں ءُ سرکاری رنگ ءَ دستیابیں آواز ءِ ڈیٹاسیٹ مشین لرننگ ءِ بنیاد ءَ تقریر ٹیکنالوجی ءِ تہا جدت ءُ صحت مند تجارتی مقابلہ ءَ را دیم ءَ برگ ءَ اَنت۔ اے یک جھان ءِ جھدے ءُ ما ھرکس ءَ بھر زورگ ءِ دعوت دئیں۔ مئے مول ءُ مراد ایش انت کہ تقریر ءِ ٹیکنالوجی ءَ گیشتر ھوار کنگ ءَ کمک بہ کنیں، دنیا ءِ دراھیں توارانی تنوع ءِ عکاسی ءَ بہ کنت۔
data-get-started = <speechBlogLink>گپ ءِ شناخت ءَ گوں بندات کن اِت</speechBlogLink>
data-other-title = دگہ توار ءِ ڈیٹاسیٹ...
data-other-goto = ء برو{ $name }
data-other-download = ڈاٹا ڈاؤن لوڈ کن
data-bundle-button = ڈیٹاسیٹ بنڈل ءَ ڈاؤن لوڈ کن اِت
data-bundle-description = مشترکہ آواز ءِ ڈیٹا ءِ ہمراہی ءَ دگہ درستیں آواز ءِ ڈیٹاسیٹ ءِ سرا۔
release-version = تہر
dataset-date = تاریخ
