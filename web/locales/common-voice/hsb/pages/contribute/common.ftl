...
contribution-background-noise-description = Chcemy, zo algoritmy mašinelneho wuknjenja móža z wjele wšelakorymi pozadkowymi šumami wobchadźeć a samo relatiwnje hłósne šumy so akceptuja, pod wuměnjenjom, zo tomu njezadźěwaja, zo so cyły tekst słyši.
