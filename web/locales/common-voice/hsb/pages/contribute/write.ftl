...
guidelines = Směrnicy
contact-us = Kontakt
add-sentence-success = 1 sada zhromadźena
...
bulk-upload-additional-information = Jeli chceće dalše informacije wo tutej dataji, stajće so z <emailFragment>commonvoice@mozilla.com</emailFragment> do zwiska.
template-file-additional-information = Jeli chceće dalše informacije wo tutej dataji, kotrež w předłoze wobsahowane njejsu, stajće so z <emailFragment>commonvoice@mozilla.com</emailFragment> do zwiska.
...
write-contribute-menu-tooltip = Sady přidać a přepruwować, prašenja přidać, awdijo transkribować
