...
offensive-content-explanation = Sady so přez moderaciski proces zhromadźenstwa přepruwuja, ale tutón proces perfektny njeje. Jelei sadu widźiće abo słyšiće, kotrež was křiwdźi abo hněwa – na přikład, dokelž so přećiwo našim <participationGuidelines>wobdźělenskim směrnicam zhromadźenstwa</participationGuidelines> přeńdźe – wužiwajće prošu tłóčatko Zdźělić we wužiwarskim powjerchu. Móžeće so tež z nami přez <emailFragment>commonvoice@mozilla.com</emailFragment> do zwiska stajić.
