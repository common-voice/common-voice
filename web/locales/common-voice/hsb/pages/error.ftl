...
error-clip-upload-too-large = Waša natočenska dataja je přewulka za nahraće. Spytajće prošu krótši klip natočić.
...
error-title-429-no-time = Sće přespěšny. Prošu budźće pomalši a spytajće za wokomik hišće raz.
error-title-429-with-time =
    { $retryAfter ->
        [one] Sće přespěšny. Prošu spytajće za { $retryAfter } sekundu hišće raz.
        [two] Sće přespěšny. Prošu spytajće za { $retryAfter } sekundźe hišće raz.
        [few] Sće přespěšny. Prošu spytajće za { $retryAfter } sekundy hišće raz.
       *[other] Sće přespěšny. Prošu spytajće za { $retryAfter } sekundow hišće raz.
    }
