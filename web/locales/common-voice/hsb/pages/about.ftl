...
about-playbook-how-grow-language-content-5 = Móžeće socialne medije wužiwać, zo byšće powěsć rozšěrjał. Dźělće přinoški, kotrež rozjasnjeja, čehodla je wažnje, a skontaktujće druhich ludźi, zo byšće so wo problemach kaž rěčne prawa, rěčna WI abo stroniskosć w technice rozmołwjał. Wobhladajće sej dalše rady wo <campaignLink>přewjedźenju socialneje kampanje inkluziwnje wobsah, kotryž móžeće znowa wužiwać.</campaignLink>.
...
about-playbook-how-grow-language-content-8-v2 = <strong>Budźće kreatiwny!</strong> Waše rěčne zhromadźenstwo budźe jónkróćne być a te su jenož někotre móžnosće, zo byšće započał. Prošu rozwažće <communitiesLink>dokumentej COMMUNITIES.md na GitHub</communitiesLink> swoje kanale zhromadźenstwa přidać.
...
about-playbook-how-funded-content-2 = Płaći wjele pjenjez, hdyž datowe sadźby njepřestawajcy hospodujemy a wozjewjamy, platformu polěpšamy a <africaMradiLink>programy zhromadźenstwa</africaMradiLink> přewjedźemy.
about-playbook-how-funded-content-3 = Jeli wy chceće abo waša organizacija chce k projektej přinošować, móžeće <donateLink>darić</donateLink> abo so z našim teamom partnerstwa na <emailFragment>commonvoice@mozilla.com</emailFragment> do zwiska stajić.
