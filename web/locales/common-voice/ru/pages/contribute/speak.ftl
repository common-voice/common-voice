...
record-platform-webview = Вы могли бы попасть сюда, перейдя по ссылке в приложении для социальных сетей. Вы используете встроенный браузер, который не поддерживает запись аудио.
record-platform-not-supported-webview = На мобильных устройствах вы можете помочь, используя системный браузер…
record-platform-not-supported-desktop = На настольных компьютерах, вы можете скачать последний:
...
record-error-empty-recording = Ни одного звука не было захвачено. Пожалуйста, проверьте свой микрофон и попробуйте снова.
record-error-unknown-format = Не удалось определить аудиоформат. Пожалуйста, попробуйте использовать другой браузер.
...
why-donate-explanation-2 = Чтобы технология работала хорошо для всех, данные, которые помогают разработчикам создавать технологии, должны отражать самых разных людей. Например, если мы не включим говорящих с определённым акцентом, технология не будет работать для людей с таким акцентом. <learnMore>Узнайте больше о важности метаданных.</learnMore>
