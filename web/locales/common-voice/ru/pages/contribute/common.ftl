...
contribution-misreadings-description-extended-list-1 = Пропуск части слова в начале записи. Например, если произносится <strong>«ивет»</strong> вместо <strong>«привет»</strong>.
...
contribution-misreadings-example-8-title = Мимо пронёсся шмель.
...
contribution-varying-pronunciations-description = Будьте осторожны, прежде чем отклонять клип на том основании, что читатель неправильно произнёс слово, поставил ударение не в том месте или, по-видимому, проигнорировал знак вопроса. Во всем мире используется большое разнообразие произношений, некоторые из которых вы, возможно, не слышали в своём местном сообществе. Пожалуйста, не отвергайте тех, кто может говорить иначе, чем вы.
...
contribution-background-voices-example-1-explanation = Ты идёшь? <strong>[зовёт кто-то другой]</strong>
...
contribution-just-unsure-description = Если вы столкнётесь с чем-то, что не охвачено этими рекомендациями, проголосуйте, исходя из вашего здравого смысла. Если вы действительно не можете решить, используйте кнопку пропуска и переходите к следующей записи.
