...
about-sentence-collection-title = Сбор предложений
...
about-clip-graveyard-text = «Кладбище записей» состоит из голосовых записей, которые не вошли в голосовой набор Common Voice. Также как и основной набор, набор «Кладбища записей» тоже доступен для скачивания.
...
about-playbook-what-is-language-content-3 = Некоторые языки имеют огромные различия в грамматике, словарном запасе и произношении. По этой причине в 2022 году мы <ctaLink>представляем «Варианты»</ctaLink>. Это даёт сообществам возможность различать свои языки в большом наборе данных.
...
about-playbook-how-grow-language = Как можно эффективно помочь развитию вашего языка на Common Voice?
...
about-playbook-how-grow-language-content-8-v2 = <strong>Проявляйте творческий подход!</strong> Ваше языковое сообщество будет уникальным, и это всего лишь несколько способов начать работу. Пожалуйста, добавьте свои каналы сообщества в документ <communityLink>COMMUNITES.md на GitHub</communitiesLink>.
...
about-playbook-how-project-governance-content-1 = Mozilla Common Voice стал возможен благодаря разнообразному сообществу активистов, лингвистов, специалистов по данным, учёных и инженеров-программистов со всего мира. Проект курирует Mozilla Foundation.
