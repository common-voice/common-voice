...
visibility-explainer = Этот параметр контролирует вашу видимость в топе. Когда вы скрыты, ваш прогресс будет приватным. Это означает, что ваше изображение, имя пользователя и прогресс не будут отображаться в списке лидеров. Обратите внимание, что обновление списка лидеров занимает примерно { $minutes } мин.
...
help-reach-hours-pluralized =
    { $hours ->
        [one] { $language }: помогите достичь { $hours } часа с помощью личной цели
        [few] { $language }: помогите достичь { $hours } часов с помощью личной цели
       *[many] { $language }: помогите достичь { $hours } часов с помощью личной цели
    }
...
activity-needed-calculation-fixed = 100 человек, записывающие 100 предложений в день, могут создать 13 часов аудио. Поддерживая эту производительность, 1000 часов можно достичь за 3 месяца.
