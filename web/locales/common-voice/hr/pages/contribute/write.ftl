...
new-sentence-rule-2 = Manje od 15 riječi po rečenici
new-sentence-rule-3 = Koristi ispravnu gramatiku
new-sentence-rule-4 = Koristi ispravan pravopis i interpunkciju
new-sentence-rule-5 = Bez brojeva i posebnih znakova
...
add-sentence-success = 1 rečenica sakupljena
add-sentence-error = Greška pri dodavanju rečenice
required-field = Ispuni ovo polje.
single-sentence-submission = Podnesak jedne rečenice
small-batch-sentence-submission = Slanje rečenica u malim količinama
bulk-sentence-submission = Podnesak više rečenica
single-sentence = Jedna rečenica
small-batch-sentence = Mala količina
bulk-sentence = Veća količina
sentence-domain-combobox-label = Domena rečenice
sentence-domain-select-placeholder = Odaberi do tri domene (opcionalno)
# Sentence Domain dropdown option
agriculture_food = Poljoprivreda i prehrana
# Sentence Domain dropdown option
automotive_transport = Vozila i transport
# Sentence Domain dropdown option
finance = Financije
# Sentence Domain dropdown option
service_retail = Usluge i maloprodaja
# Sentence Domain dropdown option
general = Opće
# Sentence Domain dropdown option
healthcare = Zdravstvo
# Sentence Domain dropdown option
history_law_government = Povijest, pravo i politika
# Sentence Domain dropdown option
language_fundamentals = Osnove jezika (npr. znamenke, slova, novac)
# Sentence Domain dropdown option
media_entertainment = Mediji i zabava
# Sentence Domain dropdown option
nature_environment = Priroda i okoliš
# Sentence Domain dropdown option
news_current_affairs = Vijesti i aktualne teme
# Sentence Domain dropdown option
...
bulk-upload-failed-toast = Prijenos nije uspio, pokušaj ponovo.
bulk-submission-success-header = Hvala na podnesku rečenica!
