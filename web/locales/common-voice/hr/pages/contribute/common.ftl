...
contribution-misreadings-description = Kada slušaš, provjeri poklapaju li se snimka i tekst; odbij čak i pri manjim greškama. <br />Česte greške uključuju:
...
contribution-varying-pronunciations-description = Budite oprezni prije nego što odbijete isječak na temelju toga da je čitatelj krivo izgovorio riječ, da je naglasak stavio na krivo mjesto ili da je očito zanemario upitnik. Postoji mnogo vrsta izgovora koji se koriste diljem svijeta, od kojih neke možda niste čuli u svojoj lokalnoj zajednici. Molimo da budete otvoreni prema ideji da možda neki govore drugačije od vas.
...
contribution-varying-pronunciations-example-1-title = Na glavi je nosio beretku.
contribution-varying-pronunciations-example-1-explanation = [‘Beret’ je u redu bez obzira je li naglasak na prvom slogu (UK) ili drugom (SAD)]
contribution-varying-pronunciations-example-2-title = Njegova je ruka bila podignuta.
contribution-varying-pronunciations-example-2-explanation = ['Raised' se na engleskom jeziku uvijek izgovara kao jedan slog, a ne kao dva]
...
contribution-background-noise-example-1-fixed-title = <strong>[Kihaj]</strong> Divovski dinosauri iz <strong>[kašljaj]</strong> trijasa.
contribution-background-noise-example-2-fixed-title = Divovski dino <strong>[kašalj]</strong> trijas.
contribution-background-noise-example-2-explanation = [Dio teksta se ne čuje]
contribution-background-noise-example-3-fixed-title = <strong>[Pucketanje]</strong> divovski dinosauri iz<strong>[pucketanje]</strong> -rijasa.
