...
error-clip-upload-too-large = Vaša datoteka je prevelika za prijenos. Pokušajte snimiti kraći isječak.
error-clip-upload-server-error = Došlo je do pogreške prilikom obrade vašeg isječka. Ponovno učitajte stranicu ili pokušajte ponovno kasnije.
