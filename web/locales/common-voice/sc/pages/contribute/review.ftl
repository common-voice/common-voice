...
sc-review-form-usage = Iscurre a dereta pro aprovare sa fràsia. Iscurre a manca pro dda refudare. Iscurre in artu pro dda brincare. <strong>No t’iscaressas de imbiare sa revisione tua!</strong>
# Variables:
...
sc-review-form-button-submit =
    .submitText = Acabba sa revisione
# Variables:
#   $sentences (Number) - Number of sentences the user has reviewed in this session
sc-review-form-reviewed-message =
    { $sentences ->
        [0] Nissuna fràsia revisionada.
        [one] 1 fràsia revisionada. Gràtzias!
       *[other] { $sentences } fràsias revisionadas. Gràtzias!
    }
sc-review-form-review-failure = Sa revisione no est istada sarvada. Torra·nche a proare a pustis.
...
sc-review-instruction = Controlla <icon></icon> chi sa fràsia siat curreta dae su puntu de vista linguìsticu.
sc-review-rules-title = Sa fràsia rispetat is lìnias ghia?
