speak = Uqallagiñ
speak-now = Uqalugiuŋ akkupak
speak-subtitle = Atuġukkikput iġñan
record-cta = Immiisaġiñ
record-platform-not-supported = Aḷakkaa, qaqasauraġaġviiñ akkupak savaŋitchuq
record-platform-not-supported-desktop = Qaqasaurakun ikayuutaurumiñaqtutin atuġlugu…
record-platform-not-supported-ios-non-safari = iOS iPhone-kun atuġlugu Safari immiiyumiñaqtutin…
record-must-allow-microphone = Uqaun atullasipkaqtuksraġigiñ.
record-no-mic-found = Uqautaitchuq.
record-error-too-short = Immiqsaq naitpaitchuq.
record-error-too-long = Immiqsaq takivaitchuq.
record-error-too-quiet = Immiqsaq nipakitpaitchuq.
record-cancel = Nutqaqtirruŋ immiisatqiun
record-instruction = Titiġuŋ una { $actionType }<recordIcon></recordIcon> aasii taiġuaġlugu uqaluk tusaġnaġlutin
record-stop-instruction = Titiġuŋ una { $actionType }<stopIcon></stopIcon> naatchiguviñ
record-three-more-instruction = Piŋasut kisiŋŋuqtut!
record-again-instruction = Aarigaa! <recordIcon></recordIcon> Aasii tuglia immiigguuŋ
record-again-instruction2 = Ki kiika, immiivsaaġiñ <recordIcon></recordIcon>
record-last-instruction = <recordIcon></recordIcon> Aqulliq!
review-tooltip = Iluaġmagaakki aasii immiitqikki uqaluit uvuŋa
share-clip = Qairruŋ immiqsan
share-common-voice = Qairruŋ Common Voice
review-instruction = Iluaġmagaakki aasii immiitqikki pitqiaksrauppata
record-submit-tooltip = { $actionType } qaitki itqanaiġuviñ
clips-uploaded = Immiqsat Ikuaniŋaruat
record-abort-title = Immiqsianiqqaaġluŋa?
