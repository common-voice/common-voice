...
about-header-description-v2 =
    <p>Common Voice es un collection de datos vocal publicamente disponibile que existe gratias al voces de contributores voluntari de tote le mundo. Illes qui vole producer applicationes vocal pote usar le collection de datos pro trainar modellos de apprendimento automatic.</p>
    <p>Al presente, le major parte de collectiones de datos vocal es proprietate de grande companias, lo que suffoca le innovation. De plus, le voces de homines blanc e anglophone ha un representation disproportional. Isto significa que le technologia actionate per voce non functiona del toto pro multe linguas, e si functiona, non livra un qualitate equal pro totes. Nos vole cambiar isto mobilisante le gente de tote le mundo pro compartir lor voce.</p>
...
about-sentence-collection-subtitle = Le phrases es colligite pro esser legite a alte voce.
...
about-voice-contrib-subtitle = Le personas veni e contribue con lor voces.
...
about-dataset-release-title = Publication del collection de datos
about-dataset-release-subtitle = Nos publica le collection de datos cata tres menses.
about-subscribe-text = Vole tu mantener te in contacto con Common Voice?
about-speak = Parlar
about-speak-text = Le contributores registra lor retalios vocal legente ab un banca de phrases donate.
...
about-stay-in-touch-text-2 = Tu pote incontrar altere personas in le communitates linguistic de Mozilla adherente a <discourseLink>Discourse</discourseLink> pro conversationes topic, o a <matrixLink>Matrix</matrixLink> pro consilios rapide.
...
about-playbook-how-add-language-content-1 = Primo, verifica si tu lingua <languageLink>jam existe</languageLink>. Si non, tu debe <strong>traducer le sito e colliger phrases</strong>.
...
about-playbook-how-add-language-translating-content-2 =
    ...
    ma si illo non ha lo tue, tu pote <pontoonRequestLink>requirer que tu lingua sia addite</pontoonRequestLink>.
...
about-playbook-how-add-language-collecting-sentences-content-1 = <sentenceCollectorVideo>Reguarda nostre guida re le uso de Sentence Collector</sentenceCollectorVideo>.
about-playbook-how-add-language-collecting-sentences-content-2 =
    ...
    Memora que le phrases debe esser de <licenseLink>CC0 (public dominio)</licenseLink>, o pote scriber los tu mesme.
...
about-playbook-how-localize-content-2 = <pontoonAccountLink>Crea un conto</pontoonAccountLink> si tu non ha un. Tunc, elige le <strong>(‘Team’)</strong> de tu lingua e pois elige le projecto, <t0/><pontoonCvLink>Common Voice</pontoonCvLink>. Illac il habera le files a traducer. Clicca sur un, alora illo monstrara le parolas in anglese e un campo pro traducer los.
...
about-playbook-how-record-content-4 = Verifica que le platteforma es in registration ante que tu initia a parlar, e que illo solo cessa un vice que tu ha finite.
...
about-playbook-how-grow-language-content-3 = Tu pote developpar eventos pro adjutar personas a collaborar. Il es plus facile que lo que tu pensa. Tu pote facer lo online con un instrumento de video-conferentias, o in persona si illo es secur. <eventTemplate>Discoperi nostre modellos e ressources pro developpar eventos</eventTemplate>.
...
about-playbook-how-validate-content-4 = Si un registration es rejectate per 2 personas, illo es publicate in un sub-ensemble differente del collection de datos.
