...
visibility-explainer = ݜُو ترتیب یا سِٹِنٚگ لیڈر بورڈاں پشژؤں کان٘ٹرول کیری تُھو۔ گی وخ چہ پلیل ہُوند کھیں تیں کریل کام مُت کسے لیل نی ہوتُھو۔ اسیں مطلب ݜُو تھی چے تیں فُٹُو، نؤں  تے کریل کام لیڈربورڈ لا نی پشژا تُھو۔یادی رڇھہ چے لیڈر بورڈ تازائ ہویں مہ کچھ کچھ { $minutes }  ملٹہ بیں تھی چے ݜَیں تبدیلی سموں مژ داخل ہوں۔
