...
contribution-varying-pronunciations-example-1-explanation = [‘بېرِٹ’صحیح تُھو کہ سامُوٹھ رکنہ لا زُور ایلوں (یوکے) آں کہ دُویُوں رُکنہ لا(یو ایس)]
contribution-varying-pronunciations-example-2-title = تسیں ہا اُڇھ-ژیل آن٘س
contribution-varying-pronunciations-example-2-explanation = ‘[اُڇھژیل’ کوستَیں مہ ایک رُکنہ مہ بنُژ تُھو، دُویُوں مہ نئ]
...
contribution-background-noise-description-extended = کہ رکاڈِن٘گ ݜژِیا یا مژمہ کڑسَیں نِکئ لُوں آں بُٹی لکیلی صحیح نی پڑژِلُوں تے رِکاڈِن٘گ کگائ
