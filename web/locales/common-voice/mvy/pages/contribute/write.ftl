...
new-sentence-rule-1 = سیوں لا<noCopyright> کاپی رائیٹ </noCopyright>  آں (<cc0>cc-0</cc0>) پابندی نی ہو۔
new-sentence-rule-2 = اک جُملہ مہ 15 لفظؤں نہ کم لفظہ /ہوں ہواں۔
new-sentence-rule-3 = صحیح گرامر استعمال کرہ
new-sentence-rule-4 = صحیح ادائیگی تے زیر زبر استعمال کرہ
new-sentence-rule-5 = ہِندسی تے خاص نشانہ نی ہوں
new-sentence-rule-6 = مُت زبوں/ژِبہۡ واں حرفہ استعمال نیرہ
new-sentence-rule-7 = صحیح حوالہ جات شامل کری
new-sentence-rule-8 = سئیں جُملی استعمال کری چےۡ سئیں پڑھئیں مہ آسان ہُواں/ہوں۔
