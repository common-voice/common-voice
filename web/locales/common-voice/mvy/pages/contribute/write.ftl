...
citation =
    .label = حوالہ
sc-write-submit-confirm = مہ تصدیق کرم تُھو/کرانٚت چےۡ ݜُو جُملہ <wikipediaLink> عوامی ڈومین والا تھی </wikipediaLink> آں مِگے اس بُوئ اُکھالئیں یعنی اپلوڈ کرئیں اجازہ تُھو۔
sc-review-write-title = مہ گھئین/گھِن٘لیۡ جُملی شامِل‌ کرہانٚت/کراہاں تُھو؟
sc-review-small-batch-title = بیکتُوک جُملی اکٹھی گِشے شامل کرانٚتے/کراں تھو؟
new-sentence-rule-1 = <noCopyright> کاپی رائیٹ نیتُھو </noCopyright> پابندیہ <cc0> سی سی -0</cc0>
new-sentence-rule-2 = اک جُملہ مہ 15 لفظؤں نہ کم لفظہ ہواں
new-sentence-rule-3 = صحیح گرامر استعمال کرہ
new-sentence-rule-4 = صحیح ادائیگی تے زیر زبر استعمال کرہ
new-sentence-rule-5 = ہندسی تے خاص نشانہ نہ کال تھے۔
new-sentence-rule-6 = مُت زبوں حرفہ استعمال نیرہ
new-sentence-rule-7 = صحیح حوالہ جات شامل کری
new-sentence-rule-8 = سئیں جُملی استعمال کری چہ سئیں پڑھئیں مہ آسان ہُواں۔
login-instruction-multiple-sentences = <loginLink>داخل ہُو</loginLink>یا <loginLink>اماں رجسٹر کرہ </loginLink> تے چہ توۡ بیکتُوک جُملی شامل کرہاں۔
how-to-cite = مہ حوالہ گِشے دم؟
how-to-cite-explanation-bold = کم اوکاں پُور ناں یا یو آر ایل لنک ہِن حوالہ دے۔
