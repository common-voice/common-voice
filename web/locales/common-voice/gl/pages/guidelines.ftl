...
misreadings-explanation-1 = É importante ler correctamente todas as palabras da frase. Ao validar, comprobe con moita atención que o fragmento gravado se corresponde exactamente co texto escrito, respectando, obviamente, as correspondencias ortográfico-fonéticas do galego, mesmo cando estas non aparecen na escrita (por exemplo, a pronuncia [ɔ] tanto para "ao" como para "ó"). Non dubide en rexeitar aqueles fragmentos nos que se engaden ou omiten palabras.
misreadings-explanation-2 = Os erros máis comúns son:
misreadings-explanation-3 = Falta a primeira palabra (como "Un" ou "O") no comezo da gravación.
...
misreadings-example-1 = Estou indo a coller un café.
misreadings-example-2 = Tou indo a coller un café.
misreadings-example-3 = Estou indo a coller un café grande.
misreadings-example-4 = A abella pasou rápido.
misreadings-tip-1 = [Debería ser "Estou"]
misreadings-tip-2 = [Non aparece 'grande' no texto orixinal]
...
background-voices-tip-1 = Non vés? [pronunciado por outra]
...
public-domain-explanation-4 = Póñase en contacto con autores, dramaturgos ou guionistas e pregúntelles se estarían dispostos a dedicar unha pequena parte das súas obras ao dominio público.
