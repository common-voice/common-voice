...
create-api-key-description = Ao premer «Xerar credenciais» crearase credenciais únicos para a súa conta. Por razóns de seguridade, a chave secreta amósase <bold>só unha vez</bold>. Cópiea e gárdea nun lugar seguro. Se a perde, deberá xerar unha nova, xa que non se pode recuperar.
