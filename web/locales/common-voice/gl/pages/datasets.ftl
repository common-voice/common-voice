...
size-gigabyte = GB
size-megabyte = MB
confirm-no-identify = <b>Acepto</b> non tentar determinar a identidade dos falantes do conxunto de datos de Common Voice
...
resource-playbook-info = <playbookLink>Atope orientacións útiles</playbookLink> sobre Common Voice, desde a súa tradución ata o uso do conxunto de datos, alén de como contactar coa nosa comunidade.
...
donate-modal-explanation-2 = <bold>Se valora os datos abertos e inclusivos, doe hoxe!</bold>
data-download-singleword-title = Descargue o segmento específico de palabras únicas
data-download-singleword-callout-v2 = Este é o subconxunto pensado para o desenvolvemento de casos de uso que contén datos para mellorar o recoñecemento de díxitos e a detección das palabras 'si' e 'non'.
...
data-download-modal = Vai comezar a descargar <size>{ $size }GB</size>, quere seguir?
...
data-bundle-description = O conxunto de datos de Common Voice máis todos os demais conxuntos de datos anteriores.
...
datasets-show-more = Amosar todos os conxuntos de datos
datasets-show-less = Amosar os conxuntos de datos máis recentes
