...
overall-hr-total = کل۔ مجموعی ایچ آر
cv-license = لائسنس
audio-format = آیڈیو فارمیٹ
dataset-splits = تقسیم(عمر اڤن جنس)
number-of-voices = آوازف تعداد
splits = تقسیم
email-to-download = پے ڈاؤن لوڈ کڑا دیر ڤے ای میل دل
why-email = <b>ڤے ای میل چی کوسَم٘تے</b> ماخ لے تو دیبال ڤے ڈیٹا سیٹ پے بادل کڑا دیر رابطہ کڑا بݰ ای۔ ای میل لے تو رابطہ کڑان ذریعو۔
confirm-size = تو ژے ملن <b>{ $size }</b> ڈاؤن لوڈ پے شروع کڑا دیر تیار استت
size-gigabyte = جی بی
...
data-download-button = کامن وائس ڈیٹا ڈاؤن لوڈ ݰوئے
data-download-yes = ہوٓ/دی
data-download-deny = نو
data-download-license = لائسنس<licenseLink>سی سی زیرو</licenseLink>
data-download-modal = تو<size>{ $size }جی بی</size> ڈاؤن لوڈ شروع کینیتے، ژے آپیرن اویتیآ؟
