...
clips-with-count-pluralized =
    { $count ->
        [one] Kiliippii <bold>{ $count }</bold>
       *[other] Kiliippiiwwan <bold>{ $count }</bold>
    }
goal-help-recording = Ati galma sagalee waraabuu guyyaa { $goalValue } keessaa <goalPercentage></goalPercentage> akka ga’u Common Voice gargaarteetta!
...
keep-track-profile = Profaayilii fayyadamuun adeemsa hojii kee itti fufi
...
target-segment-add-voice = Sagalee Kee Ida'i
...
report-different-language = Qooqa addaa
report-different-language-detail = Himni kun afaan ani dubbachaa jiru irraa qooqa biraan barreeffame.
...
contribution-misreadings-title = dogoggora dubbisaalee
...
contribution-varying-pronunciations-title = Sagaleessuu garaagaraa
...
contribution-background-noise-example-2-fixed-title = Daaynoosara guddaa <strong>[cough]</strong> Yeroo Tiriyaassik.
...
contribution-reader-effects-title = Dhiibbaa Dubbataa
