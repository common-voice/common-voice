...
about-new-lang-subtitle = اماں یہ باݜا عام کاڻ تہ ویب سائٹ ݜروع کُرُومہ
...
about-subscribe-text = ائی عام کاڻنہ ملی تھین گٹینُمہ
about-speak = مُشکُل
...
about-yes-votes-text = عام کاڻ تہ ڈیٹہ سیٹہ کاڻ تہ کلپ نتئیں کی، دوپوگلہ باݜہ پریال ساں توثیق کُرن ضروری درو
...
about-dataset-new = عامل کاڻ تہ ڈیٹہ سیٹ
about-dataset-new-text = عام کاڻ تہ ڈیٹہ سیٹ زرگونہ لاکونہ کاڻ تہ سمپل کلپ تھینا تئیں مدد کنا ڈیویلپر کاݩ زانال اوزا ژوپیں کی
...
about-get-involved-text-2 = عام کاڻ اچکھ ایس  ابُت کُرئیں کی مدد کُرن گٹِنُمہ، لے ابُت ای میل تہ زریعہ یا بہ مُشکُل، فورم نم سائٹ تہ مسلہ نم تہ زریعہ جمع کُرا،GitHub، یا بہ شامل با، میٹریکس، برادری تہ چیٹ
...
about-nav-how-it-works-2 = عام کاڻ کنو بئی کرم کُنا
about-nav-playbook = حصہ گین تہ طریقہ ڇِھیڇا

## Community Playbook Content
## What is a language

about-playbook-what-is-language = عام کاڻہ کیرا باݜہ درو
...
about-playbook-how-add-language-translating-content-2 = ائی ترجمہ تہ پرئی  Pontoon ٹول استعمل کُنُمہ، Pontoon نہ لے باڜہ نم درو، اگر مِنہ باݜہ نی درو بہ پھرکی بی تانوں باݜہ شامل کُرئیں کی درخواست کُرا۔ پھرکی عام کاڻ تہ پراجیکٹہ تانوں گیاڅیئں کی، درخواست کُرا GitHub کی۔ ترجمہ سائہ اچھک ایس دڇھا
