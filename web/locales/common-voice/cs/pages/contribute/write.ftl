...
sentence =
    .label = Věta
sentence-input-placeholder = Zde zadejte svou větu dostupnou pod public domain
small-batch-sentence-input-placeholder = Zde zadejte své věty dostupné pod public domain
...
sc-review-small-batch-title = Jak přidat více vět
...
review-questions-menu-item-aria-label = Zkontrolujte a hlasujte pro nové otázky odeslané komunitou
