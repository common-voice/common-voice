...
data-download-yes = inde
data-download-deny = iyayi
data-download-license = Layisensi: <licenseLink>CC-0</licenseLink>
data-other-goto = Pitani ku { $name }
release-version = Mtundu
dataset-date = tsiku
license = Layisensi: <licenseLink>CC-0</licenseLink>
license-mixed = Zosakaniza
