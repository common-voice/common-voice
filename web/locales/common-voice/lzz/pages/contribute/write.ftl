...
new-sentence-rule-7 = Cireǩi muşi tzori otzirams
new-sentence-rule-8 = İyen şuǩuri/ iven ǩonari natureli do osinapu nenaten (cumle oǩitxu ǩolai ort̆asen)
login-instruction-multiple-sentences = Çkva çkva ç̌arape oǩatu şeni <loginLink>amaxti</loginLink> va na <loginLink>kononç̌ari</loginLink>
how-to-cite = Cireǩi muç̌ote votziraten?
how-to-cite-explanation-bold = Ar URL linkite vana dulyaşi coxote cireǩi otzirit.
how-to-cite-explanation = Hantepe tkani zit̆ape ren na, <italicizedText>“Çkimi tkvala”</italicizedText> tkvi. Ham teksti so dzirit, na maçkinanen diç̌irs do haşote xalǩişi na ren do telifi xaǩepe na uvinams ǩontroli maxenenan. Tkvala tkanişeni çkva çkinoba gorumt na <guidelinesLink>Ǩilavuziş pavri</guidelinesLink> otzǩedit.
