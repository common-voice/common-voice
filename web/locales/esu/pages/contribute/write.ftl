...
write = Igaulluki
write-instruction = Yuut tamarmeng aturyugngalriamek igausngalriamek ilaluku <icon></icon>
write-page-subtitle = Ilakumalriit igausngalriit wani yuut tamarmeng aturyugngalriamun qemagciqut cc-0 licensed dataset-aamun.
sentence =
    .label = Igausngalria
sentence-input-placeholder = Igarluten wani igausngalriavnek yuut tamarmeng aturyugngalriamek
small-batch-sentence-input-placeholder = Igarluten wani igausngalriavnek yuut tamarmeng aturyugngalrianek
citation-input-placeholder = Igarluten naken igausngalriim igausngacianek (piarkauguten)
citation =
    .label = Naken Igausngacia
sc-write-submit-confirm = Elluakaqa una igausngalria <wikipediaLink>yuut tamarmeng aturyungalriarumaluni</wikipediaLink> upload-aryugngaluku-llu.
