...
misreadings-explanation-3 = השמטה של תחילית (למשל ו' החיבור או ה' הידיעה)
misreadings-explanation-4 = בלבול במין בשם המספר, למשל קריאה שגויה "שלושה בנות" במקום "שלוש בנות".
misreadings-explanation-5 = הלחמה בדיבור או עיוות של מילים, למשל "יומולדת" במקום "יום הולדת".
misreadings-explanation-6 = השמטה של המילה האחרונה או סיום מוקדם של ההקלטה.
misreadings-explanation-7 = חזרה על מילה כמה פעמים בנסיון להקריאה נכון.
