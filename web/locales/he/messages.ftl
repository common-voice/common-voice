...
contribution-varying-pronunciations-description = אנא, שימו לב לפני שאתם דוחים מקטע על סמך זה שביטוי המילה שגוי, עם הדגש במקום הלא נכון, או עם התעלמות לכאורה מסימן שאלה. יש מגוון רחב של הגיות בשימוש ברחבי העולם, שאת חלקן אולי לא שמעתם בקהילה המקומית שלכם. אנא השאירו מקום גם לאלה שאולי דוברים אחרת מכם.
...
new-sentence-rule-1 = <noCopyright>אין הגבלות על זכויות יוצרים</noCopyright> (<cc0>CC0</cc0>)
new-sentence-rule-2 = פחות מ-15 מילים
new-sentence-rule-3 = השתמשו בדקדוק נכון
new-sentence-rule-4 = השתמש באיות ובסימני פיסוק נכונים
...
new-sentence-rule-8 = אם ניתן, שיהיה טבעי וקולח (צריך להיות קל לקרוא את המשפט)
how-to-cite = כיצד לצטט?
how-to-cite-explanation-bold = יש לצטט עם קישור כתובת URL או השם המלא של היצירה.
how-to-cite-explanation = אם אלו המילים שלכם, יש לכתוב פשוט <italicizedText>"ציטוט עצמי"</italicizedText>. עלינו לדעת היכן מצאתם את התוכן הזה כדי שנוכל לבדוק שהוא בנחלת הכלל ולא חלות הגבלות על זכויות יוצרים. למידע נוסף על ציטוט, עיינו ב<guidelinesLink>דף ההנחיות</guidelinesLink> שלנו.
guidelines = הנחיות
