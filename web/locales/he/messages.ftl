...
data-subtitle = אנו בונים מערך נתונים פתוח ופומבי של קולות, שכולם יכולים להשתמש בו כדי לאמן יישומים מופעלי-קול.
data-explanatory-text = אנו מאמינים שמערכי נתונים קוליים גדולים וזמינים באופן פומבי, מסייעים לאמץ חדשנות ותחרות מסחרית בריאה בתחום טכנולוגיית זיהוי הקול על בסיס לימוד מכונה. מדובר במאמץ גלובלי ואנו מזמינים את כולם להצטרף. מטרתנו היא לעזור בהפיכתן של טכנולוגיות זיהוי למכילות יותר, ושישקפו מגוון רחב של קולות מכל רחבי העולם.
