...
sc-home-title = Common Voice Sentence Collector-ыш пагален ӱжына
...
sc-stats-summary = Common Voice Sentence Collector { $sentenceCount } ойлончым { $languageCount } йылме дене поген!
