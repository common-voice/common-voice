...
browse-file = Seret dan lepas atau <browseWrap> Layari </browseWrap>
...
about-subscribe-text = Ingin kekal berhubung dengan Common Voice?
about-speak = Cakap
...
visibility-explainer = Tetapan ini mengawal keterlihatan papan pemukaAnda. Apabila disembunyikan, kemajuan Anda akan menjadi peribadi. Ini bermakna imej, nama pengguna dan kemajuan Anda tidak akan muncul di papan pendahulu. Ambil perhatian bahawa muat semula papan pendahulu mengambil masa - { $minutes }minit untuk mengisi perubahan.
...
partnerships-community-header = Komuniti, Kreatif dan Masyarakat Sivil
partnerships-community-description = Komuniti ialah nadi utama Common Voice - mereka datang dari seluruh dunia, dan merupakan aktivis bahasa serta saintis dan artis. Anda boleh mengetahui lebih lanjut tentang cara untuk melibatkan diri pada halaman <about>Tentang Kami</about> dan dalam <community>playbook Komuniti</community> kami. Jika anda berminat dengan perkongsian organisasi yang lebih mendalam, <emailFragment>hubungi kami.</emailFragment>
partnerships-foundations-header = Yayasan
partnerships-foundations-description = Kami bekerjasama dengan yayasan, masyarakat sivil dan rakan kongsi komuniti untuk menjadikan internet tempat yang lebih sihat, dengan tumpuan khusus pada Afrika Timur. Ketahui lebih lanjut tentang <programmaticWork>kerja programmatik kami.</programmaticWork>
partnerships-governments-header = Kerajaan
