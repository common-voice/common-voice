...
wall-of-text-more-mobile = Dauguma didelių kompanijų duomenų nėra prienami plačiajai visuomenei. Mes manome, jog tai slopina inovacijas, dėl to vykdome „Common Voice“ – projektą, kurio pagalba kalbos atpažinimo technologijos taps atviros ir pasiekiamos visiems.
...
help-reach-goal = Padėk mums pasiekti { $goal }
read-terms-q = Ar perskaitei mūsų Sąlygas?
ready-to-record = Jau nusiteikei pasidalinti savo balsu?
all-locales = Visos kalbos
today = Šiandien
x-weeks-short = { $count } sav.
x-months-short = { $count } mėn.
...
about-subtitle = „Common Voice“ yra „Mozillos“ iniciatyvos padėti apmokyti įrenginius tikrų žmonių kalbų dalis. Greta „Common Voice“ duomenų rinkinio mes taip pat kuriame atvirojo kodo kalbos atpažinimo variklį „Deep Speech“.
...
about-listen-queue-text = Balso įrašai patenka į eilę ir parengiami perklausymui.
about-listen = Perklausymas
about-listen-text = Naudotojai patikrina pateiktų įrašų kokybę, patvirtindami, jog balso įrašas sutampa su pateiktu sakiniu.
...
about-no-votes-text = Naudotojui atmetus balso įrašą, šis grįžta į eilę. Kitam naudotojui atmetus įrašą antrą kartą, jis keliauja į Įrašų kapines.
