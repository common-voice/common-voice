...
contribute-more = ¿A je tijnandei nga s'ian { $count } sa?
...
target-segment-first-card = Tiisenkanájin nga kuíchujin chubare ju tjin nya sijé xá kui.
...
shortcut-play-toggle-label = Tikja'ae/Tikasen i
