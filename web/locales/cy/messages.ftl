...
offensive-content = Cynnwys Amrhiodol
...
varying-pronunciations-example = Roedd y llwybr yn aneglur.
...
misreadings-explanation-4 = Colli ‘s’ ar ddiwedd gair.
...
misreadings-example-4 = Gwibiodd y cacwn heibio.
...
background-voices-tip-1 = Ydych chi'n dod? [galwad gan lais arall]
...
reader-effects-explanation = Mae'r mwyafrif o recordiadau o bobl yn siarad yn eu llais naturiol. Gallwch dderbyn ambell recordiad ansafonol sy’n cael ei weiddi, ei sibrwd, neu ei gyflwyno’n amlwg mewn llais ‘dramatig’. Gwrthodwch recordiadau wedi'u canu a'r rhai sy'n defnyddio llais wedi'i syntheseiddio gan gyfrifiadur.
...
still-have-questions = Oes gennych chi gwestiynau o hyd?
...
public-domain-explanation-1 = Mae'n bwysig iawn bod pob brawddeg testun yn un <publicDomain>parth cyhoeddus</publicDomain> (<cc0>cc0</cc0>) gan fod set ddata Common Voice yn cael ei rhyddhau o dan drwydded cc0. Dim ond os ydych yn siŵr y dylech lwytho brawddeg, a dylech gynnwys y dyfyniad perthnasol bob tro.
...
citing-sentences-explanation-1 = Mae’n bwysig cynnwys dyfyniadau fel y gallwn wirio bod brawddegau yn y parth cyhoeddus ac nad oes unrhyw gyfyngiad hawlfraint arnynt.
...
citation =
    .label = Dyfyniad
self-citation = Hunanddyfynnu
self-citation-explanation = Dyma sut rydych chi'n dyfynnu'ch hun os gwnaethoch chi ysgrifennu'r cynnwys eich hun.
...
adding-sentences-subheader-speakable-explanation = Mae'r brawddegau gorau yn naturiol ac yn sgyrsiol - dylen nhw fod yn hawdd i rywun eu darllen. Tra bod amrywiaeth ffonetig a geiriau gwahanol mewn brawddegau yn bwysig, rydym hefyd yn ceisio gwneud recordio brawddegau mor ddifyr a hwyliog â phosibl i’n cymuned wirfoddol.
...
adding-sentences-subheader-special-characters-explanation-1 = Rhaid i nodau fod yn ddilys yn yr iaith sy'n cael ei siarad. Er enghraifft, nod yn yr wyddor Rwsiaidd yw “ж” ond nid yw byth yn cael ei defnyddio yn Gymraeg ac felly dylai fyth ymddangos mewn unrhyw destun ffynhonnell Cymraeg.
...
reviewing-sentences-explanation-3 = Os ydych chi'n ansicr am y ddedfryd, gallwch chi hefyd ei hepgor a symud ymlaen i'r un nesaf.
