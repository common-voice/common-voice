...
citing-sentences-explanation-1 = Mae’n bwysig cynnwys dyfynebau fel y gallwn wirio bod brawddegau yn y parth cyhoeddus ac nad oes unrhyw gyfyngiad hawlfraint arnynt.
...
citation =
    .label = Dyfyneb
self-citation = Hunanddyfynebu
self-citation-explanation = Dyma sut rydych chi'n dyfynebu'ch hun os gwnaethoch chi ysgrifennu'r cynnwys eich hun.
