...
partnerships-governments-description = Rydym wrth ein bodd i gefnogi ymgysylltiad y sector cyhoeddus â thechnoleg, arloesi a hawliau iaith. Os ydych yn bwriadu rhedeg project neu ymgyrch fawr, <emailFragment>cysylltwch.</emailFragment>
partnerships-academia-header = Prifysgolion, Academyddion ac Ymchwilwyr
partnerships-academia-description = Mae arloesi agored wrth wraidd yr hyn a wnawn. Ar gyfer cydweithrediadau ymchwil, casglu data neu gyfweliadau, <emailFragment>cysylltwch.</emailFragment>
