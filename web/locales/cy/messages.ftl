...
contribution-criteria-link = Deall meini prawf cyfrannu
...
contribution-misreadings-description-extended-list-1 = Ar goll <strong> 'Mae' </strong> neu <strong> 'Y' </strong> ar ddechrau'r recordiad.
...
contribution-misreadings-description-extended-list-4 = Colli diwedd y gair olaf trwy orffen y recordiad yn rhy fuan.
...
contribution-misreadings-example-4-explanation = [Cofnodwyd mwy na'r testun gofynnol]
contribution-misreadings-example-5-title = Rydyn ni'n mynd allan i gael coffi.
contribution-misreadings-example-5-explanation = [Cynnwys heb ei gyfateb]
...
contribution-varying-pronunciations-description-extended = Ar y llaw arall, os credwch nad yw'r darllenydd fwy na thebyg erioed wedi dod ar draws y gair o'r blaen, a'i fod wedi dyfalu yn anghywir ar yr ynganiad, gwrthodwch hynny. Os ydych chi'n ansicr, defnyddiwch y botwm hepgor.
contribution-background-noise-title = Sŵn Cefndir
contribution-background-noise-description = Rydym am i'r algorithmau dysgu peiriannau allu trin amrywiaeth o synnau cefndir, ac mae modd derbyn synau cymharol uchel hyd yn oed ar yr amod nad ydyn nhw'n eich rhwystro rhag clywed y testun cyfan. Mae cerddoriaeth gefndir dawel yn iawn; ond nid cerddoriaeth sy'n ddigon uchel i'ch rhwystro rhag clywed pob gair.
...
contribution-background-noise-example-1-title = <strong>{ Sneeze }</strong> Deinosoriaid anferth y <strong>{ cough } </strong>Triasig.
contribution-background-noise-example-2-title = Deino anferth <strong>{ cough }</strong> y Triasig.
contribution-background-noise-example-2-explanation = [Nid oes modd clywed rhan o'r testun]
contribution-background-noise-example-3-title = <strong>{ Crackle }</strong>deinosoriaid anferth y <strong>{ cough } </strong>-iasig.
...
contribution-background-voices-description-extended = Os yw'r recordiad yn torri i fyny, neu os oes ganddo gracellau, dylech ei  wrthod oni bai bod y testun cyfan yn dal i allu cael ei glywed.
contribution-background-voices-example-1-title = Deinosoriaid anferth y Triasig. <strong>[wedi'i ddarllen gan un llais]</strong>
contribution-background-voices-example-1-explanation = Wyt ti'n dod? <strong> [galwad gan lais arall] </strong>
contribution-volume-title = Sain
...
contribution-just-unsure-title = Dal yn Ansicr?
