...
contribution-misreadings-example-3-explanation = [Regjistrim i ndërprerë para fundit të fjalës së fundit]
contribution-misreadings-example-4-title = Dinozaurët gjigantë të Triasikut. Po.
contribution-misreadings-example-4-explanation = [Regjistruar më tepër se sa teksti i kërkuar]
...
contribution-background-noise-description-extended = Nëse regjistrimi ndërpritet, ose ka kërcitje, hidheni poshtë, veç në qoftë se ende mund të dëgjohet teksti në tërësinë e vet.
...
contribution-background-voices-description-extended = Nëse regjistrimi ndërpritet, ose ka kërcitje, hidheni poshtë, veç në qoftë se ende mund të dëgjohet teksti në tërësinë e vet.
...
contribution-reader-effects-description = Shumica e regjistrimeve janë nga persona që flasin me zërin e tyre natyror. Mund të pranoni me raste regjistrime jo standarde, ku bërtitet, pëshpëritet ose, kuptueshëm, kryer nën një zë “dramatik”. Ju lutemi, hidhni poshtë regjistrime të kënduara dhe ato që përdorin një zë të krijuar nga kompjuteri.
contribution-just-unsure-title = Thjesht i Pasigurt?
contribution-just-unsure-description = Nëse ndeshni diçka që nuk e mbulojnë këto udhëzime, ju lutemi, votojeni në përputhje me gjykimin tuaj. Nëse vërtet s’vendosni dot, përdorni butonin e anashkalimit dhe ecni më tej me regjistrimin pasues.
