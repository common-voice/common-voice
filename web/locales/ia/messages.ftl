...
email-opt-in-info-sub-with-challenge = Recipe emails como mementos de defias e objectivos, actualisationes de progresso e bulletines de novas re Common Voice.
...
listen-instruction = { $actionType }<playIcon></playIcon> non ha illes pronunciate accuratemente le phrases?
