...
contribution-misreadings-example-5-explanation = [Contento discorde]
...
contribution-background-noise-example-1-title = <strong>{ Sneeze }</strong> Le gigantesc dinosauros del <strong>{ cough }</strong>trias.
contribution-background-noise-example-2-title = Le gigantesc dino <strong>{ cough }</strong> trias.
contribution-background-noise-example-2-explanation = [Parte del texto non pote esser audite]
contribution-background-noise-example-3-title = <strong>{ Crackle }</strong> gigantesc dinosauros de <strong>{ crackle }</strong> -rias.
contribution-background-noise-example-3-explanation = [Parte del texto non pote esser audite]
