...
demographic-deidentified-clarity = Необавезни демографски подаци (нпр. старост, пол, језик или акцент) никада неће бити објављени на вашем профилу, нити ће бити повезани са вашим налогом у скупу података. Појединачни аудио снимци ће бити повезани са демографским подацима ради прецизније анализе - на пример, истраживач ће можда желети да направи детаљнији модел обуке за одређени део популације.
