...
about-no-votes-text = Када корисник одбије гласовни исечак, исти се враћа у ред чекања. Ако се одбије други пут, гласовни исечак се пребацује у Clip Graveyard (гробље за одбијене исечке).
about-dataset-new = Скуп података Common Voice-а
...
record-platform-not-supported-ios = <bold>iOS</bold> корисници могу преузети нашу бесплатну апликацију:
