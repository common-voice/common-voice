...
request-language-text-learn = Научете како да го побарате тука!
...
faq-why-my-lang-new-a = Mozilla не избира или фаворизира ниту еден јазик над друг. Наместо тоа, Common Voice е иницијатива чисто водена од заедницата, но потребни се <multilangLink>неколку чекори за да се додаде нов јазик</multilangLink> и за да се започне со собирање на говорни донации. Прво, веб-страницата на Common Voice треба да биде преведена за членовите на заедницата да можат да пристапат до искуството за придонесувачи на нивниот јазик. Следно, ни треба голема збирка на реченици без авторски права за луѓето да ги читаат на глас. Откако и двете овие барања ќе бидат задоволени, на Common Voice јазикот се „лансира“ за луѓето да започнат да го снимаат својот глас и да ги потврдуваат донациите на другите. Ако сакате да помогнете во лансирањето на нов јазик, започнете со нашата <sentenceCollectorLink>алатка за собирање реченици</sentenceCollectorLink>.
...
about-partnership =
    Common Voice е проект за соработка и ние зависиме од нашата заедница на партнери и придонесувачи за да се изгради најголемата база на податоци на гласови досега, објавена како слободен софтвер.
    
    Би сакале да им се заблагодариме на следниве луѓе и организации за нивната помош во проектот:
...
mycroft-secondary-description = Ова е софтвер објавен како слободен софтвер кој може слободно да се ремиксира, прошири и подобри. Mycroft може да се користи во што било, од научен проект до апликација за претпријатие за софтвер.
