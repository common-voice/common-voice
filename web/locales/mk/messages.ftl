...
demographic-deidentified = Опционално доставените демографски податоци (на пр. возраст, пол, јазик и акцент) се деидентификуваат од вашите доставени говорни податоци и никогаш нема да бидат објавени на вашиот профил.
...
why-demographic-explanation = Анонимизираните податоци за корисниците, како што се возраста, полот и акцентот, помагаат во подобрување на аудио податоците што се користат за тренирање на точноста на моделите за препознавање говор. Вашето корисничко име и е-пошта никогаш нема да бидат поврзани со вашите доставени податоци и можете да изберете дали да го направите вашето корисничко име јавно или анонимно.
...
off = Исклучен
on = Вклучен
avatar-clip-title = Дајте глас на вашиот аватар
change-your-avatar-clip = Дали сакате да го смените вашиот говорен клип?
recording-in-progress = Гласовното снимање е во тек
avatar-clip-recorded = Вашиот аватар сега вклучува говорен клип!
record-voice-wave = СНИМИ ГЛАСОВЕН БРАН
retry-voice-wave-recording = ОБИДИ СЕ ПОВТОРНО
re-record = ПРЕСНИМИ
...
avatar-clip-fact = Одамна е утврдено дека на читателот ќе биде одвлечено вниманието од текстуалната содржина на страницата поради нејзиниот изглед.
recreate-voice = Рекреирајте го говорниот бран
cancel-avatar-clip-recording = Откажи
about-avatar-clip-recording = Создадете гласовна снимка како дел од вашиот аватар.  Другите ќе можат да ја слушнат вашата снимка.
...
skip = Прескокни
shortcuts = Кратенки
clips-with-count = <bold>{ $count }</bold> Снимки
contribute-more =
    { $count ->
