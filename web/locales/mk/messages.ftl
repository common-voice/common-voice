...
demographic-deidentified-clarity = Опционално доставените демографски податоци (на пр. возраст, пол, јазик и акцент) никогаш нема да бидат објавени на вашиот профил и нема да бидат поврзани со вашата сметка во базата на податоци. Индивидуалните аудио снимки ќе бидат поврзани со демографски податоци со цел поточна анализа - на пример, истражувач можеби ќе сака да насочи модел за обука на одреден демографски сегмент.
...
help-reach-hours = Помогнете да стигнеме до { NUMBER($hours) } часа на { $language } со лична цел
help-reach-hours-general = Помогнете Common Voice да достигне { NUMBER($hours) } часа на јазик со лична цел
set-a-goal = Поставете цел
cant-decide = Не можете да се одлучите?
activity-needed-calculation =
    { NUMBER($totalHours) } часа се постигнува за нешто повеќе од { NUMBER($periodMonths) }
    месеци ако { NUMBER($people) } луѓе снимаат { NUMBER($clipsPerDay) } снимки на ден.
