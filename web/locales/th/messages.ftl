...
language-section-launched-description = สำหรับภาษาที่เปิดตัวแล้วเหล่านี้ เว็บไซต์ได้ถึก<localizationGlossaryLink>แปล</localizationGlossaryLink>เรียบร้อยและมี<sentenceCollectionGlossaryLink>ประโยคที่รวบรวม</sentenceCollectionGlossaryLink>มากพอที่จะอนุญาตให้ไปยังขั้นตอนการมีส่วนร่วมในการ<speakLink>พูด</speakLink>และ<listenLink>ฟัง</listenLink>
