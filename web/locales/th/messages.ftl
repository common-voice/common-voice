...
keep-me-posted =
    .label = ฉันต้องการรับข่าวสารปัจจุบันเกี่ยวกับสิ่งที่เกิดขึ้นกับ Common Voice
...
data-download-modal = คุณกำลังจะดาวน์โหลดไฟล์ขนาด <size>{ $size }GB</size> คุุณต้องการดำเนินการต่อหรือไม่?
