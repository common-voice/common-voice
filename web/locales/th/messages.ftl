...
about-playbook-how-add-sentences-content-4 = ประโยคที่ได้รับการตรวจสอบแล้วจะถูกส่งออกทุกวันพุธ และจะพร้อมใช้งานหลังจากรุ่นถัดไป
...
sc-howto-cite-item-1 = คุณสามารถรวมเว็บไซต์ เช่น "Common Voice - https://commonvoice.mozilla.org/"
...
citation =
    .label = การกล่าวถึง
what-can-i-add = ฉันสามารถเพิ่มประโยคแบบไหนได้บ้าง?
...
sc-review-instruction-second-part = ประโยคนี้เป็นประโยคที่ถูกต้องทางภาษาหรือไม่?
