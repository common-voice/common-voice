...
status-hours =
    { $hours ->
       ...
       *[other] iwoora { $hours } sirumeeleya mpaakha vaava!
    }
# Variables:
...
manage-subscriptions = Olela milepiho sa imayili
manage-email-subscriptions = Wethiha mulepiheryo
email-already-used = Ela  e-meeyili  ela  eniira  erumeeliwaka  ni  ekootha emoha wovirikana
add-language = Yoohela ntaava nanyu
change-email-setings = Muvirikanihe e-mail  anyu murumeelaka ikofikurasawu sa Itentitaati seyiya sinikelaniwa mumeilni
...
faq-description = Nikhuru wala eporoxeetu Common Voice yuupuweleliwe ni nikhuru na Mozilla wi yaaxuttihe atthu atthu yaathoonyiheryaka  namuna anilavulaaya
...
about-is-it-valid-text = Ekiliipi yoopakiwa ni nsu nkhalelo aya "tiwoorerela" mutthu yoola onirumeela namuna yeela onnithoonya wi Hooye.
...
about-clip-graveyard = Mahiye a ikiliipi
...
about-nav-playbook = Musuwele moota woowirela mpantta
...
about-playbook-how-record-quality = Manamuna xeeni nikhaleha otakiha ekiliipi emosa ya nsu notepexa oreera?
about-playbook-how-record-content-4 = Miikupaleelihe wiira ekaruma eniira ekaravariki ehinatthi opacerya ni ela enimweemela nyuwo mwamaliha.

## How to grow language

about-playbook-how-grow-language = Moota xeene nikhale ahu vekekhayi opaka manamuna owunuuherya nttaava nimosa muhina mwa Common Voice?
about-playbook-how-grow-language-content-2 = Mithukumano
about-playbook-how-grow-language-content-6 = Opatthani ni iphiro

## How to validate

about-playbook-how-validate = Manamuna xeeni kikhaale aka osuwela vakhala kookhala okupaleela ikiliipi ya nsu?
about-playbook-how-validate-content-1 = Mwaawenrene vale <strong>wiiwa</strong> ni <strong>wiiwelela</strong>, woomalelani ti <strong>yooreerela otthunela</strong>.
about-playbook-how-validate-content-3 = Moonelavale wiira oromola enkha <strong>woohiweraneya wiiwexexa</strong>, wala wookhala <strong>onyakula munceene mpuwa</strong>, wala akhala<strong>atthu akina alavulaka tho</strong>, vano nyuwa mookhala mukhoottaka mutthico. <accuracyLink>muwehawehe tho ihapari mmuthito soovarela miteko sahu woowakhuvana </accuracyLink>.
about-playbook-how-validate-content-4 = viira muthoonyo mmosa okhoottiwaka na atthu 2, ole  onoovonyeriwa muhina mwa nikhuru novirikana na mihuupi.

## How to access dataset

about-playbook-how-access-dataset = Manamuna sxeene ampwanyiwa aya  nikhuuru na mihuupi?
about-playbook-how-access-dataset-content-2 = Mwiiraka oomwaavyaka ikaruma sa muthinto soosuwelatho awutomaatiku sa nsu, mookhala oolupanyeya ni mutthu mukina mmuttettheni, <discourseLink>moovanelani</discourseLink>.
...
about-playbook-how-project-governance-content-4 = Wiira mpatta ni ophavela moolumo anittareya wa tthu a mmuttettheni
...
datasets-heading = Nikhuuru na mihupi
...
cv-license = Elicensa
audio-format = Nkhalelo wa mwiiwelo
dataset-splits = Okawanyeya (Iyaka ni Mulopwana na axitiana)
...
size-gigabyte = GB
size-megabyte = MB
confirm-no-identify = <b>Nyuwo munnikupali</b> muphavelaka woonaxaxa nipuro onikhumaawe mutthu yoola nnikhuruni na itaatu sa  Common Voice
...
other-datasets = Mixovo mikina sa mitthaka sa masu
...
language-section-in-progress = Yeettaka
language-section-launched = Okhumiwa
...
clips-with-count-pluralized =
    { $count ->
        [one] <bold>{ $count }</bold> ikiliipi emosa
...
both-speak-and-listen-long = Hoothe  (olavula ni wiiwa)
...
lose-goal-progress-warning = Mwavukula meettelo ya ephiro mumphavelaanyu otthara, nyuwo munoovonya meettelo anyu.
want-to-continue = Muniphavela otthikela?
finish-editing = Okhomoni wa nlaka nopaacerya?
...
cant-decide = Khamwiniisona saana?
...
demo-eofy-header = Opacera  woonaxaxiwa wa mphira woomalela wa eyaakha ya 2009
...
contribution-misreadings-example-1-title = Matinosawuru oorekamasa a oTiriyaasiku
contribution-misreadings-example-2-title = etinosawuru oorekamasa a oTiriyaasiku.
...
contribution-background-voices-title = Nsu noottayi
...
sc-submit-err-select-lang = Mutthanle nttava nimosa.
...
sc-submit-add-sentences = Muhela malove ookwanela  <wikipediaLink>oosuweliwa wala oolamaleliwa mmuttettheni</wikipediaLink>
...
# PARTNERSHIPS PAGE
partnerships-header = Wiraana
partnerships-get-in-touch = Wuulume ni
partnerships-become-a-partner = Mwiire mpantta wa nikhuru na Common Voice.
...
new-sentence-rule-8 = Voreerela ve ephaattu  ni natural  ni vekekwhayi( vahaana vakhalaka vokweeya osoma muulumo)
how-to-cite = Erumeeliwa sayi?
how-to-cite-explanation-bold = Muthanle elinki ya nikhuru URL wala muhimye nsina noomalela na nikhuru nenla
guidelines = Malamulo
contact-us = Wuulume ni hiyo
add-sentence-success = Malove emosa ookwanenela athanliwea
...
sentences-fetch-error = Yookhala etthu evonyen´ye okathi waaphaveliwa oruuhiwa malove ookwanela.
review-error = Yookhala etthu evonyen´ye okathi  loonaxaxiwaaya nlove nla nookwanela.
...
bulk-upload-success-toast = Makhuru a malove ookwanela aveleelihiwa
