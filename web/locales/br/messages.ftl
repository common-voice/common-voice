...
wall-of-text-first = Naturel eo ar vouezh, denel eo ivez. Abalamour da-se eo ez eus pres warnomp krouiñ un deknologiezh mouezh evit hor mekanikoù. Met evit krouiñ seurt sistemoù mouezh, an diorroerien o devez ezhomm da gaout kalz standilhonoù a roadennoù mouezh.
wall-of-text-second = Ar pep brasañ eus ar roadennoù hegerz gant ar c’hompagnunezhioù na vezont ket hegerz evit darn vuiañ an dud. Setu aze evit petra hon eus loc'het Common Voice, ur raktres hag a sikour ac'hanomp da lakaat an anaouadur mouezh digor hag hegerz d'an holl.
