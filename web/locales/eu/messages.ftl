...
citation =
    .label = Aipua
self-citation = Norbera aipatzea
...
new-sentence-rule-3 = Ez egin akats gramatikorik
new-sentence-rule-4 = Ez egin akats ortografikorik eta esaldia ondo puntuatu
new-sentence-rule-6 = Ez erabili atzerriko karaktererik
