...
example = Adibidea
varying-pronunciations-explanation-1 = Azentu desberdinak ongi etorriak dira! Esaldiak dauden euskalkian irakurri behar dira (ezin duzu hitzik ordezkatu), baina soinuak desberdin ahoskatzea zilegi da. "Mila" ez dute berdin ahoskatzen Baionan eta Gasteizen, ezta "Jon" berdin ahoskatzen Bermeon eta Usurbilen. Kontuz ibili pertsona batek hitz bat gaizki ahoskatu duela pentsatu eta bere grabazioa baztertzearekin. Euskara ahoskatzeko hamaika modu daude eta horietako batzuk agian ez dituzu zure komunitate lokalean inoiz entzun. Mesedez izan zaitez eskuzabala zuk ez bezala hitz egiten duten pertsonen grabazioak balioztatzeko unean.
