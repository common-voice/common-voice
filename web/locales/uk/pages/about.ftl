...
how-does-it-work-text = Ми створюємо громадський відкритий набір голосових даних. Додайте свій голос, перевіряйте правильність записів інших людей, зробіть набір даних кращим для всіх.
...
about-voice-validation-subtitle = Інші люди перевіряють ці голосові записи.
...
about-speak-text = Учасники озвучують речення з набору даних.
...
about-is-it-valid-text = Озвучення позначається "перевіреним", коли користувач проголосує за нього Так.
...
about-no-votes-text = Коли користувач відхиляє голосовий запис, він повертається до черги. Якщо відхилено другий раз, голосовий запис переміщується до "Кладовища".
...
about-clip-graveyard-text = Кладовище записів складається з озвучень, які не ввійшли до набору даних Common Voice. Як і набір даних, кладовище записів доступне для завантаження.
...
about-playbook-how-record-quality = Як записати високоякісне озвучення?
...
about-playbook-how-validate = Як мені зрозуміти, чи схвалювати озвучення?
...
about-playbook-how-validate-content-2 = <strong>Не відхиляйте озвучення, в яких мовець має акцент, відмінний від вашого</strong> – важливо, щоб розпізнавання голосу працювало краще для всіх.
about-playbook-how-validate-content-3 = Якщо ви вважаєте, що через вимову запис <strong>неможливо зрозуміти</strong>, <strong>забагато фонового шуму</strong>, або <strong>чутно розмову інших людей</strong>, тоді варто його відхилити. <accuracyLink>Читайте більше інформації в наших критеріях точності</accuracyLink>.
about-playbook-how-validate-content-4 = Якщо озвучення відхилено 2 особами, воно випускається в іншому піднаборі даних.
