...
contribution-background-noise-example-1-title = <strong>{ Sneeze }</strong> Любові не буває <strong>{ cough }</strong> забагато.
contribution-background-noise-example-2-title = Любові не <strong>{ cough }</strong> забагато.
contribution-background-noise-example-2-explanation = [Частину тексту не чути]
contribution-background-noise-example-3-title = <strong>{ Crackle }</strong> не буває <strong>{ crackle }</strong> -агато.
contribution-background-noise-example-3-explanation = [Частину тексту не чути]
