...
faq-why-important-a =
    Мовлення часто є найбільш природним способом спілкування один з одним, і голосові технології дають цю зручність нашим комп'ютерам та мобільним пристроям. Ми хочемо допомогти розробникам створювати потужні програми з розпізнаванням голосу, такі як перекладачі в режимі реального часу та цифрові помічники з підтримкою голосу. Але зараз більшість голосових даних, необхідних для створення таких програм, є комерційними та дорогими. Ми сподіваємося, що набір даних Common Voice надасть розробникам те, що їм потрібно для інновацій та зробить мовленнєві технології доступними на їх мові.
    
    Щоб зробити розпізнавання голосу ще більш універсальним, ми збираємо голосові зразки широко розповсюдженими мовами, а й ті у кого менша кількість носіїв що часто недооцінена комерційними програмами розпізнавання мовлення. Публікація різноманітного набору голосів дасть змогу розробникам, підприємцям та усім спільнотам вирішувати цю проблему самостійно.
