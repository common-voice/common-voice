...
de-identified-explanation = Процес, за допомогою якого дані профілю учасника приховуються у наданих голосових записах під час запаковування для завантаження, як частина набору даних.
