...
faq-what-cv-a =
    Технологія розпізнавання голосу революціонізує спосіб взаємодії з машинами, але наявні в даний час системи є комерційними і дорогими. Common Voice є частиною ініціативи Mozilla щодо покращення технологій розпізнавання голосу доступним для всіх. Common Voice - це масивна база даних зібраних голосів, яка дозволяє будь-кому швидко та легко підключити до програми голосу підтримку на будь-якій мові.
    
    Ми збираємо не лише голосові зразки на багатьох мовах, але й у ті що мають меншу кількість носіїв мов. Публікація різноманітного набору голосів дає можливість розробникам, підприємцям та громадам вирішувати цю проблему самостійно. Окрім набору даних Common Voice, ми також створюємо механізм розпізнавання мови з відкритим кодом, який називається Deep Speech.
...
data-download-singleword-callout = Цей сегмент містить дані, які застосовуються для покращення розпізнавання чисел, виявлення слів так/ні та дані тестування слів пробудження пристрою для <fxLink>Firefox Voice</fxLink>.
