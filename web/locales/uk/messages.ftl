...
why-demographic-explanation-2 = Анонімні дані користувачів про вік, стать і акцент допомагають вдосконалити аудіодані, що використовуються для навчання точності розпізнавання мови. Ваше ім'я користувача та адреса електронної пошти ніколи не будуть пов'язані з відправленими вами даними, крім того, ви також можете керувати доступністю свого імені користувача іншим, чи залишатися анонімними.
