...
yes-receive-emails = Так, надсилайте мені листи. Я бажаю бути в курсі подій проекту Common Voice .
...
home-title = Проект Common Voice - це ініціатива Mozilla навчити машини розуміти мову людей.
...
wall-of-text-more-mobile =
    ...
    що це запобігає інноваціям. Ось чому ми запустили проект Common Voice, направлений зробити
    технологію розпізнавання голосу відкритою для всіх.
wall-of-text-more-desktop =
    Тепер ви можете записати свій голос і допомогти нам створити відкриту базу даних, яку зможе
    використовувати будь-хто для розробки інноваційних додатків для пристроїв та інтернету.<lineBreak></lineBreak>
    Прочитайте речення, щоб допомогти машинам вивчити мову людей. Погляньте на роботу
    інших помічників, щоб покращити якість. Це дуже просто!
...
wall-of-text-second = Більшість даних, що використовуються великими компаніями недоступні людям. Ми вважаємо, що це перешкоджає інноваціям. Ось чому ми запустили проект Common Voice, направлений зробити технологію розпізнавання голосу відкритою для всіх.
...
listen-paragraph = Перевірка голосових записів є теж дуже важливим процесом проекту Common Voice. Прослухайте записи, щоб допомогти нам створити якісну базу голосових даних.
...
view-goals = Порівнюйте свій прогрес з особистими цілями та цілями проекту.
join-newsletter = За бажанням підпишіться на нашу розсилку про новини та нову інформацію про проекти.
...
status-title = Загальний статус проекту: погляньте, як далеко ми зайшли!
...
faq-description = Проект Common Voice є частиною ініціативи Mozilla, яка допомагає навчити машини розуміти мову людей.
...
about-header-description =
    Обидва ці проекти є частиною наших зусиль для подолання розбіжностей в цифровому мовленні. Технології розпізнавання голосу дають більше людяності нашим девайсам, але розробникам потрібна велика кількість голосових даних для їх створення. На даний час більшість цих записів є комерційними та дорогими.
