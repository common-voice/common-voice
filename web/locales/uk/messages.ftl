...
demo-contribute-card-body = Тепер, коли ви знаєте трохи більше про Common Voice, чому б не спробувати? Клацніть на піктограму мікрофона, щоб почати читати речення вголос. <br/><br/> Якщо ви віддаєте перевагу перевірці чужих голосових внесків, натисніть на значок відтворення. Якщо записаний вами голос відповідає словам, записаним на екрані.
