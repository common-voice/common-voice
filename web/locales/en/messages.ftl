...
varying-pronunciations-example = On his head he wore a beret.
varying-pronunciations-tip-1 = [‘Beret’ is OK with stress on the first syllable (UK)]
varying-pronunciations-tip-2 = [‘Beret’ is OK with stress on the second syllable (US)]
