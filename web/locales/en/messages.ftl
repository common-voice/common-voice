...
offensive-content-explanation = Sentences are vetted through a community-moderation process, however this process is not failsafe. If you see or hear a sentence that offends or upsets you - for example because it violates our <participationGuidelines>community participation guidelines</participationGuidelines> - please do use the flag button in the UI. You can also reach out to us at <emailFragment>commonvoice@mozilla.com</emailFragment>.
...
public-domain-explanation-1 = It is very important that all text sentences are public domain (cc0) as the Common Voice dataset is released under a cc0 license. Only ever upload a sentence if you are sure, and always include the relevant citation.
...
adding-sentences-subheader-offensive-content-explanation = If the sentence is offensive or upsetting - for example because of explicit content, or another violation of our community participation guidelines - you should reject the sentence. You can also reach out to us at commonvoice@mozilla.com to escalate the issue.
