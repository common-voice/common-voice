...
why-donate-explanation-2 = For technology to work well for everyone, the data that helps developers to build technology needs to reflect a diverse range of people. For example, if we don't include any speakers with a particular accent, then the technology won't work well for people with that accent.
why-donate-explanation-3 = To make sure we're building fair, equitable A.I., we need to be able to measure diversity in training data. That's where your tags come in! <learnMore>Learn more about why metadata matters.</learnMore>
