...
stayintouch = get-involved-stayintouch = Nosotros en Mozilla estamos construyendo una comunidad en torno a la tecnología de la voz. Nos gustaría mantenernos al tanto con las actualizaciones, las nuevas fuentes de datos y saber más sobre cómo usted utiliza estos datos.
privacy-info = Nosotros prometemos manejar su información con cuidado. Lea más en nuestra <privacyLink>Política de privacidad</privacyLink> .
