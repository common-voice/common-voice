...
faq-when-release-a = Αυτή τη στιγμή, η πολυγλωσσική έκδοση του συνόλου δεδομένων του Common Voice ομαδοποιείται και καθαρίζεται με την υποστήριξη της κοινότητας. Αν θέλετε να μάθετε περισσότερα σχετικά με την υποστήριξη αυτής της προσπάθειας, παρακαλούμε <contactLink>επικοινωνήστε μαζί μας</contactLink>. Προς το παρόν, στοχεύουμε σε μια ημερομηνία δημοσίευσης τον Ιανουάριο του 2019. Ύστερα, θα ενημερώνουμε περιοδικά το σύνολο δεδομένων με νέες γλώσσες και φωνητικά κλιπ ενώ θα γίνονται διαθέσιμα. Δεν έχει αποφασιστεί ακόμη κάποιος επαναληπτικός ρυθμός κυκλοφορίας δεδομένων.
