...
contribution-misreadings-example-5-title = Θα αλλάξουμε ρούχα.
contribution-misreadings-example-6-title = Θ’ αλλάξουμε ρούχα.
contribution-misreadings-example-6-explanation = [Πρέπει να είναι «Θα»]
contribution-misreadings-example-7-title = Θα αλλάξουμε τα ρούχα.
