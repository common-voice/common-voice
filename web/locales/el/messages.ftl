...
contribution-misreadings-example-5-title = Μου αρέσει πολύ ο καφές.
contribution-misreadings-example-6-title = Μ’ αρέσει πολύ ο καφές.
contribution-misreadings-example-6-explanation = [Πρέπει να είναι «Μου»]
