...
accept-privacy = Αποδέχομαι να χειρίζεστε αυτές τις πληροφορίες, όπως εξηγείτε στην <privacyLink>πολιτική απορρήτου</ privacyLink> της Mozilla
...
go-languages-page = Μετάβαση στη σελίδα γλώσσας
