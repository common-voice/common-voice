...
sc-howto-findpd-partner-2 = Μπορούν επίσης να βοηθήσουν έμπειροι γλωσσολόγοι. Δοκιμάστε να απευθυνθείτε σε τοπικά πανεπιστήμια γλωσσολογίας (τόσο σε καθηγητές όσο και σε φοιτητές) και δείτε αν μπορούν να βοηθήσουν στη συγκέντρωση ενός ηχητικά ποικιλόμορφου συνόλου προτάσεων στη γλώσσα σας.
