...
contribution-misreadings-description-extended-list-4 = Λείπει το τέλος της τελευταίας λέξης λόγω της πρόωρης διακοπής της ηχογράφησης.
contribution-misreadings-description-extended-list-5 = Γίνονται πολλές προσπάθειες για την ανάγνωση μιας λέξης.
