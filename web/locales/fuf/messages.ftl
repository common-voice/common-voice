...
error-clip-upload = yongooitaylAndwabanful ɓɓ, emɗoji ng?
error-clip-upload-server = yongooitaylAndwabanful ɓɓojytu.wafaaatfradinanatyiSann.
...
demo-language-select-card-body = Alla e ballitte ko ɓuri 259k neɗɗo e ko ɓuri ɗemɗe 50, ɗee keɓe nana kuutoree ngam eeltude jaaɓnirɗe ɓeydaaɗe-haala yoo ɓyr waawde faamde daande neɗɗaŋke.
card-button-next = Yeeso
card-button-back = Rutto
demo-language-select-label = Weɗɗit Ɗemɗe
demo-eofy-header = Bayyinal Maayirɗe-Hitaande 2019
demo-eofy-sub_header = Leemre Keɓe Sawto, Hebiima Aawteede
demo-account = Konte

## Demo Account

demo-account-card-header = Jogaade konte waɗɗaaki ngam wallitde, kono ena nafa.
demo-account-card-body = E bannge ñaamo oo, mon kollirat ɓure kam e humpitooji ɗi min mbaɗata e peñcu. Huutoro jokkorɗe les ɗee ngam fuɗɗoraade  konte Common Voice e kaɓirgol maa.
demo-account-enter-email =
    .label = Naatnu iimeel ngam neldude jokkorde winndito
demo-account-sign-up = Neldu jokkorde winndito
