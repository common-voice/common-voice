...
banner-error-slow-1 = Ni dispiaci, Common Voice sta jennu adaciu. Grazzi pû to ntiressi.
...
faq-why-mission-a = A missiuni di Mozilla è tèniri a riti raputa e accissìbbili pi tutti. Pi fallu, ci âm'a dari putiri ê criaturi di cuntinuti, cu pruggetti comu a Common Voice. I ticnuluggìi vucali stannu prulifirannu abbestra di l'appricazzioni assai spicializzati, e nuiautri cridemu chi ànnu a sèrbiri a tutti l'utenti nnâ stissa manera. Chistu veni a diri cchiù assai lingui, cchiù assai accenti e cchiù assai genti quannu si tèstanu i tecnuluggìi vucali. Common Voice è na risursa pùbblica dispunìbbili a tutti, e i squatri e i diviluppatura di Mozilla nna tuttu u munnu u stannu già usannu macari nnî nostri pruggetti.
faq-what-cv-and-deepspeech-q = Qual'è a diffirenza ntra Common Voice e Deep Speech?
faq-what-cv-and-deepspeech-a = U nzemi di dati di Common Voice camina nzèmmula ô muturi di ricanuscimentu vucali lìbbiru di Mozilla, Deep Speech. A prima virsiuni di Deep Speech fu pubbricata nnô nuvèmmiru dû 2017 e à' cuntinuatu a èssiri diviluppatu di tannu. Nzèmmula a Common Voice, cridemu chi sta ticnuluggìa lìbbira di ricanuscimentu vucali àv'a èssiri dispunìbbili pi tutti. Spiramu chi sti ticnuluggìi pirmittirannu ê diviluppatura di crijari n'unnata di prudutti e sirbizza nnuvativi.
faq-is-goal-assistant-q = L'ubbittivu di Common Voice è chiḍḍu di custrujiri n'assistenti vucali?
faq-is-goal-assistant-a = L'ubbittivi dû nzemi di dati Common Voice è di pirmèttiri a tutti nnô munnu di custrujiri appricazzioni di ricanuscimentu vucali, di ricanuscimentu di parranti o tutti l'autri casi unni sèrbinu dati vucali. N'assistenti vucali è sulu un tipu di st'appricazzioni unni putissi abbisugnari di sti dati.
...
faq-how-privacy-a = Tutti i nfurmazzioni di dintificazzioni pirsunali vennu livati dî riggistrazzioni vucali. Quannu un cullabburaturi ni duna dati dimugràfici cû so prufilu, sti nfurmazzioni vennu scullijati dî riggistrazzioni prima chi chisti vennu misi nnô nzemi di dati, e nun vennu mai pubblicati nnô so prufilu.
...
about-dataset-new-text = U nzemi di dati di Common Voice cunteni cintinara di migghiara di campiuna vucali chi ajùtanu i diviluppatura a custrujiri mutura di ricanuscimentu vucali.
...
request-language-form-info-explanation = Agghiunci cchiù nfurmazzioni pussìbbili ncapu â lingua. A tipu:
...
request-language-form-info-explanation-list-3 = Lijami a siti chi ni ponnu ajutari a capiri a lingua
