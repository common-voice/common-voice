...
about-is-it-valid = Hè validu u campione ?
about-is-it-valid-text = Un campione vucale hè marcatu cum’è «validu» quandu un utilizatore li dà un votu cù iè.
...
hours-validated-explanation = U contu di l’ori arrighjistrati chì sò stati cunvalidati da 2 à nant’à 3 utilizatori chì anu vutatu « Iè ». Quiddi marcanu u prugressu versu u scopu glubale di 10 000 ori di u prughjettu.
sst = Discorsu-à-u-testu (Speech-to-text, STT)
sst-explanation = E tecnulugie di discorsu-à-u-testu (Speech-to-text, STT) cunvertiscenu i dati vucali in testi.
...
download-request-refresh-button = Attualizà
...
contribution-misreadings-description-extended-list-3 = Si pò leghje elisioni chì ùn ci sò micca, cum’è « ch’ùn » à a piazza di « chì ùn », o l'inversu.
...
contribution-misreadings-example-2-title = I dinusauru giganti di u Triassicu.
...
contribution-misreadings-example-6-title = Andemu fora per piglià un caffè.
contribution-misreadings-example-6-explanation = [Deve esse « Ci n'andemu »]
contribution-misreadings-example-7-title = Ci n'andemu fora per piglià caffè.
contribution-misreadings-example-7-explanation = [Manca l’articulu « un » per rispettà u testu originale]
...
contribution-varying-pronunciations-example-1-title = Venite quì ch'o vi possi fighjà.
contribution-varying-pronunciations-example-1-explanation = Secondu à u locu, a prima lettera di a parolla « Venite » si prununcia « V » o « B ».
...
contribution-background-noise-example-1-fixed-title = <strong>[sternutu]</strong> I dinusauri giganti di u <strong>[tossa]</strong> Triassicu.
contribution-background-noise-example-2-fixed-title = I dinu <strong>[tossa]</strong> u Triassicu.
contribution-background-noise-example-2-explanation = [Una parte di u testu ùn si pò sente]
contribution-background-noise-example-3-fixed-title = <strong>[scricchittime]</strong> -sauri giganti di <strong>[scricchittime]</strong> -ssicu.
...
contribution-background-voices-example-1-explanation = Venite ? <strong>[chjamatu da un altra voce]</strong>
