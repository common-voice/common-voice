...
goal-reached = مصد پورا ہوئی
clips-you-recorded = آوازان رکارڈ ارو
clips-you-validated = آوازان تسدیق ارو
todays-recorded-progress = ہنونو کمان وائسو آواز رکارڈکوریکوسورا کوروم
todays-validated-progress = ہنونو کمان وائسو آواز اوازان تصدیق کوریکوسورا کوروم
stats = حالات
awards = تمغہ
you = تو
everyone = ہر کا
contribution-activity = مدد کوریکو کوروم
top-contributors = ساف سار زیاد مدد کوراک
