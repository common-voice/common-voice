...
dataset-description-hours = دیٹا سیٹا لکھیرو ہر اشناری  ایم پی 3 وا  توغو سون ݯوکیرو فائلان مڑاغ۔ ڈیٹاسیٹا زیاد <b>{ $total }</b> رکارڈ بیرو گھنٹہ ابادیو معلومات تے موژی عمر، جنس وا لہجہ کی ہیت
