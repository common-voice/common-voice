...
demographic-deidentified = При необязательном предоставлении демографических данных (таких как возраст, пол, язык и акцент), они обезличиваются и никогда не будут сделаны публичными в вашем профиле.
...
faq-what-quality-a = Мы хотим, чтобы набор данных Common Voice отражал качество звука, которое движок преобразования речи в текст будет слышать в реальной жизни, поэтому мы ищем разнообразие. В дополнение к разнообразному сообществу авторов клипов, набор данных с различным качеством звука научит движок распознавания речи справляться с различными реальными ситуациями, от фоновых разговоров до автомобильных шумов. Пока ваш голосовой клип понятен, он нужен для набора данных.
...
faq-where-src-from-q = Откуда берется исходный текст?
faq-where-src-from-a =
    Наш исходный текст состоит из оригинальных пожертвований участников, а также диалога из сценариев фильмов из общественного достояния, таких как <italic>It’s a Wonderful Life</italic>.
    
    Вы можете просмотреть наши исходные предложения в этой папке GitHub.
faq-why-not-ask-read-q = Почему бы вам не попросить людей читать книги или статьи из Википедии на разных языках?
faq-why-not-ask-read-a = Чтобы сделать набор данных Common Voice как можно более полезным, мы решили разрешить использовать только исходный текст, доступный по лицензии Creative Commons (CC0). Использование стандарта CC0 означает, что исходный текст труднее найти и собрать, но в то же время это позволяет любому использовать полученные голосовые данные без ограничений использования или авторизации от Mozilla. В конечном итоге мы хотим сделать набор многоязычных данных максимально полезным для всех, включая исследователей, университеты, стартапы, правительства, организации социального назначения и любителей.
...
faq-how-privacy-a = Все голосовые клипы в наборе данных очищаются от личной информации. Когда участник предоставляет демографические данные через свой профиль, эта информация обезличивается из их голосовых клипов перед тем, как связывается для загрузки в набор данных, и никогда не публикуется на странице своего профиля.
...
faq-what-determine-identity-a =
    Набор данных Common Voice - это открытый и общедоступный ресурс, который можно использовать для обучения самых разных приложений с поддержкой речи. Чтобы защитить безопасность наших участников, мы просим всех, кто загружает набор данных Common Voice, соблюдать конфиденциальность участников.
    
    Все голосовые клипы в наборе данных очищаются от личной информации. Загружая набор данных, вы соглашаетесь не пытаться определить личность какого-либо участника. Это означает, что вы не можете пытаться связать информацию в наборе данных с личной информацией участника. Однако вы можете использовать набор данных для обучения распознаванию речи, распознаванию оратора или других приложений, например, связывая информацию в наборе данных с другой информацией, уже имеющейся в наборе данных.
...
de-identified-explanation = Процесс, с помощью которого информация профиля участника убирается из пожертвованных им голосовых клипов, когда они упаковываются для загрузки, как часть набора данных.
