...
error-content-404 = Возможно, поможет наша <homepageLink>домашняя страница</homepageLink>? Чтобы задать вопрос, пожалуйста, присоединитесь к <matrixLink>чату сообщества Matrix</matrixLink>, отслеживайте проблемы на сайте через <githubLink>GitHub</githubLink> или посетите <discourseLink>наши форумы Discourse</discourseLink>.
error-title-503 = У нас неожиданный простой
error-content-503 = Работа сайта будет возобновлена как можно скорее. Для получения последней информации присоединяйтесь к <matrixLink>чату сообщества Matrix</matrixLink>, посетите <githubLink>GitHub</githubLink> или <discourseLink>наши форумы Discourse</discourseLink>, чтобы отправлять и отслеживать проблемы с работой сайта.
...
demo-get-started = Давайте начнем
