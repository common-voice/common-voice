...
about-dataset = Набор данных Common Voice
about-dataset-text = Набор данных Common Voice содержит сотни тысяч образцов голосов, которые помогают разработчикам создавать инструменты распознавания голоса.
