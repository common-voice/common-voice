...
speak-empty-state-variants = На вашем языковом варианте может не быть предложений! Если вам удобно, вы можете изменить свои настройки, чтобы увидеть другие предложения на вашем языке.
