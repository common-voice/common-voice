...
rich-data = Предоставляя анонимные демографические данные, вы делаете их максимально полными. Мы де-идентифицируем все демографические данные перед публикацией.
...
demographic-deidentified = При необязательном предоставлении демографических данных (таких как возраст, пол, язык и акцент), они де-идентифицируются и никогда не будут сделаны публичными в вашем профиле.
...
faq-why-important-a =
    Речь часто является наиболее естественным способом общения друг с другом, и голосовые технологии очень удобны для наших компьютеров и мобильных устройств. Мы хотим дать возможность разработчикам создавать удивительные приложения для распознавания голоса, такие как переводчики в реальном времени и цифровые помощники с поддержкой голоса. Но сейчас большая часть голосовых данных, необходимых для создания приложений такого типа, является дорогой и запатентованной. Мы надеемся, что набор данных Common Voice даст разработчикам то, что им нужно для инноваций и сделает речевые технологии доступными на их родном языке.
    
    Чтобы сделать распознавание голоса еще более универсальным, мы собираем образцы голоса на широко распространенных языках, а также образцы с меньшим количеством говорящих, которые часто недооцениваются коммерческими службами распознавания речи. Публикация разнообразных наборов голосов позволит разработчикам, предпринимателям и целым речевым сообществам самим устранить этот пробел.
...
faq-when-release-a = Многоязычная версия набора данных Common Voice в настоящее время проходит обработку и очистку при поддержке сообщества. Если вы хотите узнать больше о поддержке этих усилий, пожалуйста, <contactLink> свяжитесь с нами </ contactLink>. В настоящее время мы ориентируемся на дату публикации - январь 2019 года. После этого мы будем периодически обновлять набор данных новыми языками и голосовыми клипами по мере их появления. Частота повторения цикла повторного выпуска ещё не определена.
faq-why-mission-q = Почему Common Voice является частью миссии Mozilla?
faq-why-mission-a = Mozilla стремится к тому, чтобы сеть была открытой и доступной для всех. Для этого нам нужно расширить возможности веб-разработчиков с помощью таких проектов, как Common Voice. Поскольку голосовые технологии распространяются за пределы нишевых приложений, мы считаем, что они должны одинаково обслуживать всех пользователей. Это означает инвестирование в большее количество языков и учёт различных акцентов и демографии при создании и тестировании голосовых технологий. Common Voice - это общедоступный ресурс, доступный каждому, и команды и разработчики Mozilla по всему миру уже используют его в наших собственных проектах.
