...
faq-why-my-lang-a = Mozilla не выбирает и не предпочитает какой-либо один язык другому. Common Voice - это целиком инициатива сообщества, и для добавления нового языка и начала сбора голосов <multilangLink>необходимо выполнить несколько шагов</multilangLink>. Во-первых, необходимо перевести веб-сайт Common Voice, чтобы члены сообщества могли получить доступ к материалам для участников на своем родном языке. Далее нам нужна большая коллекция предложений, не ограниченная авторскими правами, чтобы люди могли читать их вслух. Как только оба этих требования будут выполнены, язык в Common Voice перейдёт в статус "запущен", и люди смогут начать записывать свой голос и проверять голоса других людей. Если вы хотите помочь запустить какой-либо язык, перейдите к <sentenceCollectorLink>инструменту для сбора предложений</sentenceCollectorLink> и загрузите какие-либо предложения.
