...
sc-criteria-modal = ⓘ Критерии оценки
sc-criteria-title = Критерии оценки
...
sc-criteria-item-6 = Если вы закончили оценку предложений, пожалуйста, помогите нам собрать новые!
