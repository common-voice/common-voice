...
demo-contribute-card-body = Теперь, когда вы знаете немного больше о Common Voice, почему бы не попробовать? Щёлкните по значку микрофона, чтобы начать произносить предложения вслух. <br/><br/>Если вы предпочитаете проверять голосовые записи других людей, щёлкните по значку воспроизведения. Соответствует ли голосовая запись, которую вы прослушиваете, словам, записанным на экране.
